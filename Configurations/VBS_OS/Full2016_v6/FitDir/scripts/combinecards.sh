...
workDir=/afs/cern.ch/user/m/mlizzo/work/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBS_OS/Full2016_v6/nAODv5_v6 
...
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_cferr1" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_cferr2" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_hf" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_hfstats1_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_hfstats2_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_jes" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_lf" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_lfstats1_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_btag_lfstats2_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_eff_e_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_eff_hwwtrigger_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_eff_m_2016" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ QCDscale_VV" >> ${combinedcardsDir}/mjj.txt
#echo "nuisance edit drop DY vbs_lowZ CMS_eff_prefiring_2016 Up" >> ${combinedcardsDir}/mjj.txt
...
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_cferr1" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_cferr2" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_hfstats1_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_hfstats2_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_jes" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_lf" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_lfstats1_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_btag_lfstats2_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_eff_e_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_eff_hwwtrigger_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_eff_m_2016" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ QCDscale_VV" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L dy_ee_highZ CMS_eff_prefiring_2016 Up" >> ${combinedcardsDir}/mjj.txt
