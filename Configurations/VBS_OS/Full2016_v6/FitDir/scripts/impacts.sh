...
combineTool.py -M Impacts -d ${workspaceDir}/mjj.root -m 125 -t -1 --setParameters r_vbs=1 --redefineSignalPOIs=r_vbs --X-rtd MINIMIZER_analytic -o ${workspaceDir}/impacts_2016_mjj.json

plotImpacts.py -i ${workspaceDir}/impacts_2016_mjj.json -o ${workspaceDir}/impacts_2016_mjj
