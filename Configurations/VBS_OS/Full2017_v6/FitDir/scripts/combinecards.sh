...
echo "nuisance edit drop Vg vbs_lowZ CMS_eff_prefiring_2017 Down" >> ${combinedcardsDir}/mjj.txt 
echo "nuisance edit drop Vg vbs_lowZ QCDscale_VV Down" >> ${combinedcardsDir}/mjj.txt 

echo "nuisance edit drop Fake_e vbs_ee_lowZ CMS_fake_e_2017 Up" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_lowZ CMS_fake_m_2017 Down" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_lowZ CMS_fake_stat_e_2017 Up" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_lowZ CMS_fake_stat_m_2017 Up" >> ${combinedcardsDir}/mjj.txt

echo "nuisance edit drop Fake_e vbs_ee_highZ CMS_fake_e_2017 Up" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_highZ CMS_fake_m_2017 Down" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_highZ CMS_fake_stat_e_2017 Up" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Fake_e vbs_ee_highZ CMS_fake_stat_m_2017 Up" >> ${combinedcardsDir}/mjj.txt
...
echo "nuisance edit drop Vg top_ee CMS_btag_hfstats1_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_btag_hfstats2_2017" >> ${combinedcardsDir}/mjj.txt
...
echo "nuisance edit drop Vg top_ee CMS_btag_lfstats1_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_btag_lfstats2_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_eff_e_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_eff_hwwtrigger_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_eff_m_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee QCDscale_VV" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop Vg top_ee CMS_eff_prefiring_2017 Up" >> ${combinedcardsDir}/mjj.txt
...
echo "nuisance edit drop VgS_L top_ee CMS_btag_hfstats1_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_btag_hfstats2_2017" >> ${combinedcardsDir}/mjj.txt
...
echo "nuisance edit drop VgS_L top_ee CMS_btag_lfstats1_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_btag_lfstats2_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_eff_e_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_eff_hwwtrigger_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_eff_m_2017" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee QCDscale_VV" >> ${combinedcardsDir}/mjj.txt
echo "nuisance edit drop VgS_L top_ee CMS_eff_prefiring_2017 Up" >> ${combinedcardsDir}/mjj.txt
