...
#/eos/home-b/bpinolin/ML_output/VBSOS/sr/models/new_DNN/lowZ/v0/
...
#qgl_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/VBSOS/SignalRegions/2017/comb_v7/macro/'
#
...
if btag_algo=="deepcsv":
    aliases['bVeto'] = {
        'expr': 'Sum$(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Jet_btagDeepB[CleanJet_jetIdx] >  0.4941) == 0' # medium 0.4941 loose 0.1522
    }
    ...
    aliases['bVeto'] = {
        'expr': 'Sum$(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Jet_btagDeepFlavB[CleanJet_jetIdx] >   0.0521) == 0' # medium 0.3033 loose 0.0521
    }
...
mva_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/VBSOS/SignalRegions/2017/comb_addshape/mva/'
