...
#CATEGORY:  sr_highZ  VARIABLE:  events Up/Down variation =  1.00538233726 / 1.00541146358
#CATEGORY:  dycr  VARIABLE:  events Up/Down variation =  1.0051608821 / 1.00518765497
#CATEGORY:  sr_lowZ  VARIABLE:  events Up/Down variation =  1.0103742246 / 1.01048297736
#CATEGORY:  topcr  VARIABLE:  events Up/Down variation =  1.00665425218 / 1.00669882787
    ...
    unc_dict = {}
    unc_dict['sr_lowZ']   =  '1.01043' 
    unc_dict['sr_highZ']   =  '1.00540' 
    unc_dict['topcr']   =  '1.00668' 
    unc_dict['dycr']   =  '1.00517' 
...
#VBSvariations = ['LHEScaleWeight[0]/1.0600', 'LHEScaleWeight[2]/0.9449'] # LO samples include only variations on muF scale : Inclusive volume 
#Normalizations calculated in the fiducial volume: 
#h nominal integral = 7.44409
#h LHEScaleWeight[0] ratio to nominal = 1.07372
#h LHEScaleWeight[1] ratio to nominal = 1
#h LHEScaleWeight[2] ratio to nominal = 0.933065
VBSvariations = ['LHEScaleWeight[0]/1.07372', 'LHEScaleWeight[2]/0.933065'] # LO samples include only variations on muF scale : Fiducial volume
