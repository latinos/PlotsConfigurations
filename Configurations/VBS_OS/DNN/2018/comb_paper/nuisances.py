...
#CATEGORY:  sr_highZ  VARIABLE:  events Up/Down variation =  1.02784571514 / 1.02864330856
#CATEGORY:  dycr  VARIABLE:  events Up/Down variation =  1.0130950274 / 1.01326878247
#CATEGORY:  sr_lowZ  VARIABLE:  events Up/Down variation =  1.04049525474 / 1.04220432983
#CATEGORY:  topcr  VARIABLE:  events Up/Down variation =  1.0970674563 / 1.1075024452

        unc_dict = {}

        unc_dict['sr_highZ']  =   '1.02824'
        unc_dict['sr_lowZ']  =   '1.04135'
        unc_dict['topcr']  =   '1.10228'
        unc_dict['dycr']  =   '1.01318'
...
#VBSvariations = ['LHEScaleWeight[0]/1.0594', 'LHEScaleWeight[2]/0.9453'] # LO samples include only variations on muF scale: inclusive
#h nominal integral = 7.23327 : Fiducial
#h LHEScaleWeight[0] ratio to nominal = 1.07412
#h LHEScaleWeight[1] ratio to nominal = 1
#h LHEScaleWeight[2] ratio to nominal = 0.933178
VBSvariations = ['LHEScaleWeight[0]/1.07412', 'LHEScaleWeight[2]/0.933178'] # LO samples include only variations on muF scale: fiducial 
...
####### estimate of QCD scale variations to account for in 2016
#cuts2j = ["sr_lowZ", "sr_highZ", "topcr", "dycr"]
#for cut in cuts2j:
#  nuisances['QCDscale_WWewk_' + cut] = {
#      'name': 'QCDscale_WWewk',
#      'kind': 'weight_envelope',
#      'type': 'shape',
#      'samples': {
