...
void init_hww_DYmvaDNN_2j(TTree* tree){
    ...
    readerDNN_2j->BookMVA("PyKeras","/afs/cern.ch/work/d/ddicroce/Latinos/CMSSW_11_0_0_pre7/src/LatinoAnalysis/NanoGardener/python/data/DYSFmva/2018_v5/TMVAClassification_PyKeras_2018_2j.weights.xml"); 
