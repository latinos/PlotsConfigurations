...
optim={}
#optim['dymva0p80']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.80 ' 
#optim['dymva0p805']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.805 ' 
#optim['dymva0p81']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.81 '
#optim['dymva0p815']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.815 ' 
#optim['dymva0p82']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.82 ' 
#optim['dymva0p825']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.825 ' 
###optim['dymva0p83']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.83 ' 
###optim['dymva0p835']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.835 ' 
###optim['dymva0p84']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.84 ' 
###optim['dymva0p845']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.845 ' 
#optim['dymva0p85']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.85 '
###optim['dymva0p855']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.855 ' 
###optim['dymva0p86']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.86 '
###optim['dymva0p865']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.865 '
###optim['dymva0p87']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.87 '
########optim['dymva0p875']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.875 '
########optim['dymva0p88']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.88 ' 
...
optim['dymva0p975'] = ' && hww_DYmvaDNN_VBF(Entry$) > 0.975 '
optim['dymva0p98']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.98 ' 
optim['dymva0p985']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.985 ' 
optim['dymva0p99']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.99 ' 
optim['dymva0p995']  = ' && hww_DYmvaDNN_VBF(Entry$) > 0.995 '
