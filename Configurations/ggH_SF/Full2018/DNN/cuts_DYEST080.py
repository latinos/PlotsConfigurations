...
cuts['2j_VH_ee_in'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                  && 2jVH \
                  && fabs(91.1876 - mll) < 7.5  \
...
cuts['2j_VH_uu_in'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                  && 2jVH \
                  && fabs(91.1876 - mll) < 7.5  \
                  && hww_DYmvaDNN_VH(Entry$) > 0.8 \
               '
...
cuts['2j_VH_df_in'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                  && 2jVH \
                  && fabs(91.1876 - mll) < 7.5  \
                  && hww_DYmvaDNN_VH(Entry$) > 0.8 \
               '
...
cuts['2j_VH_ee_out'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                  && 2jVH \
                  && fabs(91.1876 - mll) > 15  \
                  && hww_DYmvaDNN_VH(Entry$) > 0.8 \
               '
...
cuts['2j_VH_uu_out'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                  && 2jVH \
                  && fabs(91.1876 - mll) > 15  \
                  && hww_DYmvaDNN_VH(Entry$) > 0.8 \
               '
...
cuts['2j_VH_df_out'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                  && 2jVH \
                  && fabs(91.1876 - mll) > 15  \
                  && hww_DYmvaDNN_VH(Entry$) > 0.8 \
               '
