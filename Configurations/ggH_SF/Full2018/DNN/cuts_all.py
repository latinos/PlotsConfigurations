...
cuts['hww2l2v_13TeV_2018_DYin_2jdf_ee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2018_DYin_2jdf_mm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2018_DYin_btag_2jdf_ee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2018_DYin_btag_2jdf_mm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2018_DYin_2jdf_ee'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2018_DYin_2jdf_mm'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
