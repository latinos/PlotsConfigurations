...
dymva0jet = 'dymva_alt_dnn_0j  > 0.5 && dymva_alt_dnn_0j  < 0.945'
dymva1jet = 'dymva_alt_dnn_1j  > 0.5 && dymva_alt_dnn_1j  < 0.900'
dymva2jet = 'dymva_alt_dnn_2j  > 0.5 && dymva_alt_dnn_2j  < 0.960'
dymvaVBF  = 'dymva_alt_dnn_VBF > 0.5 && dymva_alt_dnn_VBF < 0.970'
dymvaVH   = 'dymva_alt_dnn_VH  > 0.5 && dymva_alt_dnn_VH  < 0.825'
