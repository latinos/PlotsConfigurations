...
cuts['hww2l2v_13TeV_0j'] = {
   'expr': 'sr && (Lepton_pdgId[0]==-Lepton_pdgId[1]) && zeroJet && Higgs0jet && pTWW <= 200',
   'categories' : {
...
cuts['hww2l2v_13TeV_1j'] = {
   'expr': 'sr && (Lepton_pdgId[0]==-Lepton_pdgId[1]) && oneJet && Higgs1jet && pTWW <= 200',
   'categories' : {
...
cuts['hww2l2v_13TeV_2j'] = {
   'expr': 'sr && (Lepton_pdgId[0]==-Lepton_pdgId[1]) && 2jggH && Higgs2jet && pTWW <= 200',
   'categories' : {
...
cuts['hww2l2v_13TeV_hpt'] = {
   'expr': 'sr && (Lepton_pdgId[0]==-Lepton_pdgId[1]) && Higgshpt && pTWW > 200',
   'categories' : {
...
cuts['hww2l2v_13TeV_top']  = {
   ...
   'categories' : {
      '0j_ee'  : 'pTWW <= 200 && zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '0j_mm'  : 'pTWW <= 200 && zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      '1j_ee'  : 'pTWW <= 200 &&  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '1j_mm'  : 'pTWW <= 200 &&  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      '2j_ee'  : 'pTWW <= 200 &&   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '2j_mm'  : 'pTWW <= 200 &&   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      'hpt_ee' : 'pTWW >  200 &&            (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      'hpt_mm' : 'pTWW >  200 &&            (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
   }
}
...
cuts['hww2l2v_13TeV_DYin']  = {
   ...
   'categories' : {
      '0j_ee'  : 'pTWW <= 200 && zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '0j_mm'  : 'pTWW <= 200 && zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      '0j_df'  : 'pTWW <= 200 && zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
      '1j_ee'  : 'pTWW <= 200 &&  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '1j_mm'  : 'pTWW <= 200 &&  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      '1j_df'  : 'pTWW <= 200 &&  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
      '2j_ee'  : 'pTWW <= 200 &&   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      '2j_mm'  : 'pTWW <= 200 &&   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      '2j_df'  : 'pTWW <= 200 &&   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
      'hpt_ee' : 'pTWW >  200 &&            (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11)',
      'hpt_mm' : 'pTWW >  200 &&            (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
      'hpt_df' : 'pTWW >  200 &&            (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
   }
}
