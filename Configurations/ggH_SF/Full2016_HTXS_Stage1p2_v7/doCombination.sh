...
cd $HOME/work/unblinding/latinos/CMSSW_10_6_4/src/
eval `scramv1 runtime -sh`
cd -

# Datacard directory
datacardDir=$CMSSW_BASE/src/PlotsConfigurations/Configurations/ggH_SF/Full2016_HTXS_Stage1p2_v7/datacards
echo "Datacard directory:"
echo ${datacardDir}

# Output directory
outputDir=$CMSSW_BASE/src/PlotsConfigurations/Configurations/ggH_SF/Full2016_HTXS_Stage1p2_v7/Combination
mkdir -p ${outputDir}
