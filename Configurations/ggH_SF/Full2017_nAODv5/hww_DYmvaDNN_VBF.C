...
void init_hww_DYmvaDNN_VBF(TTree* tree){
    ...
    readerDNN_VBF->BookMVA("PyKeras","/afs/cern.ch/work/d/ddicroce/Latinos/CMSSW_11_0_0_pre7/src/LatinoAnalysis/NanoGardener/python/data/DYSFmva/2017_v5/TMVAClassification_PyKeras_2017_VBF.weights.xml"); 
