...
cuts['hww2l2v_13TeV_2016_2jee_vbf_lowmjj'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vbf_lowmjj'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfmm \
...
cuts['hww2l2v_13TeV_2016_2jee_vbf_highmjj'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vbf_highmjj'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfmm \
...
## Loose dymva + H sel for DY Acc
cuts['hww2l2v_13TeV_2016_2jee_vbf_lowmjj_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vbf_lowmjj_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfmm \
...
cuts['hww2l2v_13TeV_2016_2jee_vbf_highmjj_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vbf_highmjj_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && Higgsvbfmm \
...
cuts['hww2l2v_13TeV_2016_top_2jee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && btag2 \
                             && ZVeto \
                             && '+dymvaVBFee+' \
...
cuts['hww2l2v_13TeV_2016_top_2jmm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && btag2 \
                             && ZVeto \
                             && '+dymvaVBFmm+' \
...
cuts['hww2l2v_13TeV_2016_WW_2jee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && '+dymvaVBFee+' \
...
cuts['hww2l2v_13TeV_2016_WW_2jmm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && '+dymvaVBFmm+' \
...
cuts['hww2l2v_13TeV_2016_DYin_2jee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jmm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jdf_ee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jdf_mm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && bVeto \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_btag_2jee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_btag_2jmm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_btag_2jdf_ee_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_btag_2jdf_mm_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jVBF \
                             && btag2 \
                             && '+dymvaVBFmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_2jee_vbf_AccDen'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && dymva_dnn_VBF > 0.8 \
...
cuts['hww2l2v_13TeV_2016_2jmm_vbf_AccDen'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && dymva_dnn_VBF > 0.8 \
...
cuts['hww2l2v_13TeV_2016_WW_2jee_vbf_WWAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && mll > 80 \
...
cuts['hww2l2v_13TeV_2016_WW_2jmm_vbf_WWAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jVBF \
                             && bVeto \
                             && ZVeto \
                             && mll > 80 \
...
cuts['hww2l2v_13TeV_2016_2jmm'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetmm \
...
cuts['hww2l2v_13TeV_2016_2jee_vh2j'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vh2j'] = ' (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetmm \
...
## Loose dymva + H sel for DY Acc
cuts['hww2l2v_13TeV_2016_2jee_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetee \
...
cuts['hww2l2v_13TeV_2016_2jmm_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetmm \
...
cuts['hww2l2v_13TeV_2016_2jee_vh2j_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetee \
...
cuts['hww2l2v_13TeV_2016_2jmm_vh2j_HAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && Higgs2jetmm \
...
cuts['hww2l2v_13TeV_2016_top_2jee'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && btag2 \
                             && ZVeto \
                             && '+dymva2jetee+' \
...
cuts['hww2l2v_13TeV_2016_top_2jmm'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && btag2 \
                             && ZVeto \
                             && '+dymva2jetmm+' \
...
cuts['hww2l2v_13TeV_2016_WW_2jee'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && '+dymva2jetee+' \
...
cuts['hww2l2v_13TeV_2016_WW_2jmm'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && '+dymva2jetmm+' \
...
cuts['hww2l2v_13TeV_2016_DYin_2jee'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jmm'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jdf_ee'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetee+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_DYin_2jdf_mm'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && 2jggH \
                             && bVeto \
                             && '+dymva2jetmm+' \
                             && fabs(91.1876 - mll) < 7.5  \
...
cuts['hww2l2v_13TeV_2016_2jee_AccDen'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && dymva_dnn_2j > 0.8 \
...
cuts['hww2l2v_13TeV_2016_2jmm_AccDen'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && dymva_dnn_2j > 0.8 \
...
cuts['hww2l2v_13TeV_2016_WW_2jee_WWAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && mll > 80 \
...
cuts['hww2l2v_13TeV_2016_WW_2jmm_WWAccNum'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) \
                             && 2jggH \
                             && bVeto \
                             && ZVeto \
                             && mll > 80 \
