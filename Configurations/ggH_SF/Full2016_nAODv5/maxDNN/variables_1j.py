...
variables['events']  = {'name': '1',      
                        ...
                        'xaxis' : 'events', 
                         'fold' : 3,
                   'linesToAdd' : ['.L /afs/cern.ch/user/d/ddicroce/work/Latinos/CMSSW_11_0_0_pre7/src/PlotsConfigurations/Configurations/ggH_SF/Full2016_nAODv5/hww_DYmvaDNN_1j.C+']
