...
#No merging
command="text2workspace.py Full2018_SF_ggH_HTXS_Stage1p2_v7.txt -o Full2018_SF_ggH_HTXS_Stage1p2_v7.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
...
#Merge some bins
command="text2workspace.py Full2018_SF_ggH_HTXS_Stage1p2_v7.txt -o Full2018_SF_ggH_HTXS_Stage1p2_merged_v7.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
poi=''
for sample in sampleNames:
  # consider only ggH signal
  if 'ggH_hww' not in sample: continue
