...
'''
#No merging
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2018_SF_ggH_HTXS_Stage1p2.root -t -1  --setParameters > FitResult.txt"
...
#Merge some bins
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2018_SF_ggH_HTXS_Stage1p2_merged_v7.root -t -1 --setParameters "
poi = ''
for sample in sampleNames:
  if 'ggH_hww' not in sample: continue
  if 'FWDH' in sample: continue
