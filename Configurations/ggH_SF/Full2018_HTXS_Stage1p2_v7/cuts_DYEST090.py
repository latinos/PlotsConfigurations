...
cuts['0j'] = {
   'expr': 'zeroJet && dymva_alt_dnn_0j > 0.9' ,
   'categories' : {
...
cuts['1j'] = {
   'expr': 'oneJet && dymva_alt_dnn_1j > 0.9' ,
   'categories' : {
       'ee_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && fabs(91.1876 - mll) <  7.5',
       'mm_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && fabs(91.1876 - mll) <  7.5',
       'df_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && fabs(91.1876 - mll) <  7.5',
...
cuts['2j'] = {
   'expr': '2jggH && dymva_alt_dnn_2j > 0.9' ,
   'categories' : {
       'ee_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && fabs(91.1876 - mll) <  7.5',
       'mm_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && fabs(91.1876 - mll) <  7.5',
       'df_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && fabs(91.1876 - mll) <  7.5',
...
cuts['VH'] = {
   'expr': '2jVH && dymva_alt_dnn_VH > 0.9' ,
   'categories' : {
       'ee_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && fabs(91.1876 - mll) <  7.5',
       'mm_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && fabs(91.1876 - mll) <  7.5',
       'df_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && fabs(91.1876 - mll) <  7.5',
...
cuts['VBF'] = {
   'expr': '2jVBF && dymva_alt_dnn_VBF > 0.9' ,
   'categories' : {
       'ee_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && fabs(91.1876 - mll) <  7.5',
       'mm_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && fabs(91.1876 - mll) <  7.5',
       'df_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && fabs(91.1876 - mll) <  7.5',
...
cuts['hpt'] = {
   'expr': 'pTWW > 200 && (dymva_alt_dnn_0j > 0.9 || dymva_alt_dnn_1j > 0.9 || dymva_alt_dnn_2j > 0.9 || dymva_alt_dnn_VH > 0.9 || dymva_alt_dnn_VBF > 0.9)' ,
   'categories' : {
       'ee_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && fabs(91.1876 - mll) <  7.5',
       'mm_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && fabs(91.1876 - mll) <  7.5',
       'df_in'         : '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && fabs(91.1876 - mll) <  7.5',
