...
cuts['hww2l2v_13TeV'] = {
   ...
   'categories' : {
       ...
       'HAccNum_0j_ee_pt2lt20' : ' zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && Higgs0jet && Lepton_pt[1]< 20 && dymva_dnn_0j > 0.8',
       'HAccNum_0j_mm_pt2lt20' : ' zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Higgs0jet && Lepton_pt[1]< 20 && dymva_dnn_0j > 0.8',
       'HAccNum_0j_ee_pt2ge20' : ' zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && Higgs0jet && Lepton_pt[1]>=20 && dymva_dnn_0j > 0.8',
       'HAccNum_0j_mm_pt2ge20' : ' zeroJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Higgs0jet && Lepton_pt[1]>=20 && dymva_dnn_0j > 0.8',
       'HAccNum_1j_ee'         : '  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && Higgs1jet && dymva_dnn_1j > 0.8',
       'HAccNum_1j_mm'         : '  oneJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Higgs1jet && dymva_dnn_1j > 0.8',
       'HAccNum_2j_ee'         : '   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && Higgs2jet && dymva_dnn_2j > 0.8',
       'HAccNum_2j_mm'         : '   2jggH && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Higgs2jet && dymva_dnn_2j > 0.8',
   }
}
