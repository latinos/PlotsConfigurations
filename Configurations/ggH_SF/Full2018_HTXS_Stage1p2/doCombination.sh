...
## work directory
outputDir=/afs/cern.ch/work/c/calderon/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH_SF/Full2018_HTXS_Stage1p2/Combination
...
datacardDir=/afs/cern.ch/work/c/calderon/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH_SF/Full2018_HTXS_Stage1p2/datacards
...
# Fix some nuisances givinf problems

#echo "nuisance edit drop  ggH_hww_GE2J_MJJ_GT700_PTHJJ_0_25 hww2l2v_13TeV_hpt_mm_pth200_300" >> ${datacardDir}/hww2l2v_13TeV_hpt_mm_pth200_300/events/datacard.txt
...
#cp ${outputDir}/Full2017_SF_ggH_HTXS_Stage1p2.txt  ${outputDir}/Full2017_SF_ggH_HTXS_Stage1p2_orig.txt

#python ${modDatacardDir}/RemoveSample.py ${outputDir}/Full2017_SF_ggH_HTXS_Stage1p2_orig.txt -o ${outputDir}/Full2017_SF_ggH_HTXS_Stage1p2.txt -i ${modDatacardDir}/inputRemoveAllSamplesBelowThreshold.py --threshold 0.01
