...
#    'expr': '((0.56960943547 + 0.00765274121374 * mth) * zeroJet + (0.781155261603 + 0.000268909273257 * mth + 1.32757759568e-05 * mth * mth) * oneJet + (0.839514849495 + 0.00173226337506  * mth) * 2jggH) * (Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11) + ((0.536588837954 + 0.00824591942529  * mth) * zeroJet + (0.759553897216 + 0.000258537189195 * mth + 1.24012212162e-05 * mth * mth) * oneJet + (0.787493526437 + 0.00158575548001  * mth) * 2jggH) * (Lepton_pdgId[0] * Lepton_pdgId[1] == -13*13)',
    'expr': '((0.692987880853 + 0.0106455977147 * ptll -3.85066443272e-05 * ptll * ptll) * zeroJet + (0.688460175969 + 0.00358696637618 * ptll -9.72611262958e-06 * ptll * ptll) * oneJet + (0.841579935848 + 0.00261359168296 * ptll -8.89172634272e-06 * ptll * ptll) * 2jggH + (0.987927478016 + 0.00127025192143 * ptll -6.00946065551e-06 * ptll * ptll) * 2jVBF + (0.638163935742 + 0.00456370094041 * ptll -1.32198724979e-05 * ptll * ptll) * 2jVH) * (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) + ((0.659604074841 + 0.0116794360503 * ptll -4.75851979474e-05 * ptll * ptll) * zeroJet + (0.667324367904 + 0.0034749161481 * ptll -9.56553354515e-06 * ptll * ptll) * oneJet + (0.764561251451 + 0.00272039608794 * ptll -8.56358921599e-06 * ptll * ptll) * 2jggH + (0.79972789884 + 0.00200991276124 * ptll -6.90377190566e-06 * ptll * ptll) * 2jVBF + (0.623147975708 + 0.00415560130975 * ptll -1.1182125075e-05 * ptll * ptll) * 2jVH) * (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) + (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
    'samples': ['DY']
}
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2lAlt', 'LepWPCut', 'LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'btagSF', 'Jet_PUIDSF']),
    'samples': mc
}
