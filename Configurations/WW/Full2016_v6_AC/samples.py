...
#
#
# ls -alrth /eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer16_102X_nAODv5_Full2016v6/MCl1loose2016v6__MCCorr2016v6__l2loose__l2tightOR2016v6 | grep WW
#
#
# WWTo2L2Nu_MWW-0To400_aTGC_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1
#
#
# https://cmsweb.cern.ch/das/request?view=list&limit=50&instance=prod%2Fglobal&input=%2FWWTo2L2Nu_MWW-*_aTGC_13TeV-amcatnloFXFX-madspin-pythia8%2F*NanoAODv6*%2FNANO*
#
#      
#      https://cmsweb.cern.ch/das/request?view=list&limit=50&instance=prod%2Fglobal&input=%2FWWTo2L2Nu_MWW-*_aTGC_13TeV-amcatnloFXFX-madspin-pythia8%2F*NanoAODv6*%2FNANO*
#      
#      Dataset: /WWTo2L2Nu_MWW-800ToInf_aTGC_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16NanoAODv6-PUMoriond17_Nano25Oct2019_102X_mcRun2_asymptotic_v7-v1/NANOAODSIM
#      Dataset: /WWTo2L2Nu_MWW-600To800_aTGC_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16NanoAODv6-PUMoriond17_Nano25Oct2019_102X_mcRun2_asymptotic_v7-v1/NANOAODSIM
#      Dataset: /WWTo2L2Nu_MWW-400To600_aTGC_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16NanoAODv6-PUMoriond17_Nano25Oct2019_102X_mcRun2_asymptotic_v7-v1/NANOAODSIM
#      Dataset: /WWTo2L2Nu_MWW-0To400_aTGC_13TeV-amcatnloFXFX-madspin-pythia8/RunIISummer16NanoAODv6-PUMoriond17_Nano25Oct2019_102X_mcRun2_asymptotic_v7-v1/NANOAODSIM
#    
...
samples['sm'] = {
    'name': nanoGetSampleFiles(mcDirectory, 'WWTo2L2Nu'),
    'weight': mcCommonWeight+embed_tautauveto , # temporary - nllW module not run on PS and UE variation samples
    #'weight': mcCommonWeight+embed_tautauveto + '*nllW', # temporary - nllW module not run on PS and UE variation samples
    #'weight': mcCommonWeight + '*nllWOTF', # temporary
    'FilesPerJob': 1
}
...
# WW_AC_cB_int --> 
# linear_cHB
samples['linear_cHB']  =  {'name'   : nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_0-400')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_400-600')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_600-800')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_800-Inf')
                                   ,
    ...
    #
    'weight': mcCommonWeight+embed_tautauveto + ' * (  (10*10 * LHEReweightingWeight[0] - 10*10 * LHEReweightingWeight[2])/10/10/(10+10) )',
    'FilesPerJob': 1
}



samples['quadratic_cHB']  =  {'name'   : nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_0-400')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_400-600')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_600-800')
                                      + nanoGetSampleFiles(mcDirectoryAC,'WWTo2L2Nu_aTGC_800-Inf')
                                      + nanoGetSampleFiles(mcDirectory, 'WWTo2L2Nu')
