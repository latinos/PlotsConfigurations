...
try:
    ...
    mc_noAC = [skey for skey in mc_emb if skey != 'Dyemb' and skey != 'WW_AC' and skey != 'linear_cHB' and skey != 'quadratic_cHB' and skey != 'sm']
except NameError:
    mc = []
    mc_noAC = []
    cuts = {}
...
#nuisances['electronpt'] = {
    ...
    #'mapUp' : 'ElepTup',
    #'mapDown': 'ElepTdo',
    #'samples': dict((skey, ['1', '1']) for skey in mc_noAC),
...
# 
# Never _CR_ in name??? ---> never applied??? --> subtituted maybe by the qcd scale uncertainty by envelope?
#
#
#nuisances['CRSR_accept_DY'] = {
    #'name': 'CMS_ww_CRSR_accept_DY',
    #'type': 'lnN',
    #'samples': {'DY': '1.02'},
