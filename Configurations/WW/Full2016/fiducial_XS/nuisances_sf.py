...
nuisances['WWresum']  = {
               ...
               'type'  : 'shape',
                'samples'  : {
                   'WW'   : ['(nllW_Rup/nllW)/1.011810*1.0352', '(nllW_Rdown/nllW)/0.953619*1.0352'],
...
nuisances['WWqscale']  = {
                ...
                'type'  : 'shape',
                'samples'  : {
                   'WW'   : ['(nllW_Qup/nllW)/0.996073*1.0352', '(nllW_Qdown/nllW)/1.000986*1.0352'],
                   },
               'cuts'  : [
                 'ww_0jet_sf',
                 'ww_top0jet_sf',
