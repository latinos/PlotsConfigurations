...
cuts['ww_BVetoIncl_em'] = 'njet == 0 || njet == 1'

cuts['ww_MetCut0j_em'] = 'njet == 0'
cuts['ww_MetCut1j_em'] = 'njet == 1'

cuts['ww_mpMetCut0j_em'] = 'njet == 0 && mpmet > 20'
cuts['ww_mpMetCut1j_em'] = 'njet == 1 && mpmet > 20'
...
cuts['ww_TopCR0j_plusminus_em'] = 'njet == 0 \
            && mpmet > 20 \
            && ptll > 30 \
            && mth > 40 \
            && (std_vector_lepton_flavour[0] == 11 || std_vector_lepton_flavour[0] == 13) \
            && (( std_vector_jet_pt[0] > 20 && std_vector_jet_cmvav2[0] > -0.715 )  \
            ||  ( std_vector_jet_pt[1] > 20 && std_vector_jet_cmvav2[1] > -0.715 )  \
            ||  ( std_vector_jet_pt[2] > 20 && std_vector_jet_cmvav2[2] > -0.715 )  \
            ||  ( std_vector_jet_pt[3] > 20 && std_vector_jet_cmvav2[3] > -0.715 )  \
...
cuts['ww_TopCR0j_minusplus_em'] = 'njet == 0 \
            && mpmet > 20 \
            && ptll > 30 \
            && mth > 40 \
            && (std_vector_lepton_flavour[0] == -11 || std_vector_lepton_flavour[0] == -13) \
...
cuts['ww_TopCR1j_plusminus_em'] = 'njet == 1 \
            && mpmet > 20 \
            && ptll > 30 \
            && mth > 40 \
            && (std_vector_lepton_flavour[0] == 11 || std_vector_lepton_flavour[0] == 13) \
...
cuts['ww_TopCR1j_minusplus_em'] = 'njet == 1 \
            && mpmet > 20 \
            && ptll > 30 \
            && mth > 40 \
            && (std_vector_lepton_flavour[0] == -11 || std_vector_lepton_flavour[0] == -13) \
