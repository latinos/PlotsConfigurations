...
samples['ttbar'] = {   'name': ['../../50ns/05Aug2015/latino_TTJets.root'],          
                       'weight' : 'baseW',                
                       'weights': ['GEN_weight_SM/abs(GEN_weight_SM) / 0.331907'],           
                       'weights': ['1']                   
                   }

samples['top'] = {   'name': ['../../50ns/05Aug2015/latino_ST_tW_top.root', '../../50ns/05Aug2015/latino_ST_tW_antitop.root', 'latino_ST_t-channel.root'],   
                       'weight' : 'baseW',                
