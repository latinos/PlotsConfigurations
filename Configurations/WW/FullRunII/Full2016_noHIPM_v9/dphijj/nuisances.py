...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/dphijj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/dphijj/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.124300, 'Alt$(LHEScaleWeight[1],1)' : 1.105130, 'Alt$(LHEScaleWeight[3],1)' : 1.023427, 'Alt$(LHEScaleWeight[5],1)' : 0.982114, 'Alt$(LHEScaleWeight[7],1)' : 0.902644, 'Alt$(LHEScaleWeight[8],1)' : 0.882201},
}
