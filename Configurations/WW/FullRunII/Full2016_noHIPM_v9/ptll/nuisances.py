...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/ptll/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/ptll/sampleFrac.json"%configurations))
