...
#### Reweighted EFT vs. NNLO inclusive WW
nuisances['sm_LO_0j'] = {
    'name': 'sm_LO_0j',
    'type': 'lnN',
    'samples': {
...
nuisances['electronpt'] = {
    ...
    'mapUp' : 'ElepTup',
    'mapDown': 'ElepTdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if skey not in signals or skey in ['ggWW']),
    'folderUp': 'root://eosuser.cern.ch/'+makeMCDirectory('ElepTup_suffix'),
    'folderDown': 'root://eosuser.cern.ch/'+makeMCDirectory('ElepTdo_suffix'),
    'AsLnN': '0'
}
...
nuisances['PU'] = {
    ...
    'type': 'shape',
    'samples': {
        'DY'      : ['1.000440*(puWeightUp/puWeight)', '0.998879*(puWeightDown/puWeight)'],
        #'WW': ['1.007517*(puWeightUp/puWeight)', '0.993099*(puWeightDown/puWeight)'],
        'ggWW'    : ['1.006411*(puWeightUp/puWeight)', '0.993709*(puWeightDown/puWeight)'],
        'Vg'      : ['1.004774*(puWeightUp/puWeight)', '0.998298*(puWeightDown/puWeight)'],
        'WZ'      : ['1.003131*(puWeightUp/puWeight)', '0.997771*(puWeightDown/puWeight)'],
        'ZZ'      : ['1.000722*(puWeightUp/puWeight)', '0.999262*(puWeightDown/puWeight)'],
        'VVV'     : ['0.995841*(puWeightUp/puWeight)', '1.005930*(puWeightDown/puWeight)'],
        'top'     : ['1.004330*(puWeightUp/puWeight)', '0.995728*(puWeightDown/puWeight)'],
        'Higgs'   : ['1.006376*(puWeightUp/puWeight)', '0.993642*(puWeightDown/puWeight)'],
	},
    'AsLnN': '0',
}
...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.075357, 'Alt$(LHEScaleWeight[1],1)' : 1.074864, 'Alt$(LHEScaleWeight[3],1)' : 1.002645, 'Alt$(LHEScaleWeight[5],1)' : 1.000488, 'Alt$(LHEScaleWeight[7],1)' : 0.924728, 'Alt$(LHEScaleWeight[8],1)' : 0.923016},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.084889, 'Alt$(LHEScaleWeight[1],1)' : 1.080582, 'Alt$(LHEScaleWeight[3],1)' : 1.008342, 'Alt$(LHEScaleWeight[5],1)' : 0.995452, 'Alt$(LHEScaleWeight[7],1)' : 0.919540, 'Alt$(LHEScaleWeight[8],1)' : 0.911993},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.123219, 'Alt$(LHEScaleWeight[1],1)' : 1.104467, 'Alt$(LHEScaleWeight[3],1)' : 1.023052, 'Alt$(LHEScaleWeight[5],1)' : 0.982445, 'Alt$(LHEScaleWeight[7],1)' : 0.903126, 'Alt$(LHEScaleWeight[8],1)' : 0.882982},
}
...
for ibin in cuts['ww2l2v_13TeV_top']['categories']:
    nuisances['Topnorm_'+ibin]  = {
        'name'  : 'CMS_hww_Topnorm_2016_noHIPM_'+ibin,
        'samples'  : {
            'top' : '1.00',
        },
        'type'  : 'rateParam',
