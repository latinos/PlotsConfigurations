...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/ptWW/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/ptWW/sampleFrac.json"%configurations))
