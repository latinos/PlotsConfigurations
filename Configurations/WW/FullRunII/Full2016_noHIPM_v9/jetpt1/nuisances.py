...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/jetpt1/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/jetpt1/sampleFrac.json"%configurations))
