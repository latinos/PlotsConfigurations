...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/leadinglepPT/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/leadinglepPT/sampleFrac.json"%configurations))
