...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/njets/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/njets/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.079381, 'Alt$(LHEScaleWeight[1],1)' : 1.078013, 'Alt$(LHEScaleWeight[3],1)' : 1.004099, 'Alt$(LHEScaleWeight[5],1)' : 0.999208, 'Alt$(LHEScaleWeight[7],1)' : 0.922603, 'Alt$(LHEScaleWeight[8],1)' : 0.919364},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.090761, 'Alt$(LHEScaleWeight[1],1)' : 1.084148, 'Alt$(LHEScaleWeight[3],1)' : 1.010817, 'Alt$(LHEScaleWeight[5],1)' : 0.993262, 'Alt$(LHEScaleWeight[7],1)' : 0.917111, 'Alt$(LHEScaleWeight[8],1)' : 0.907393},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.105839, 'Alt$(LHEScaleWeight[1],1)' : 1.093714, 'Alt$(LHEScaleWeight[3],1)' : 1.017976, 'Alt$(LHEScaleWeight[5],1)' : 0.986881, 'Alt$(LHEScaleWeight[7],1)' : 0.909413, 'Alt$(LHEScaleWeight[8],1)' : 0.892712},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.146619, 'Alt$(LHEScaleWeight[1],1)' : 1.118932, 'Alt$(LHEScaleWeight[3],1)' : 1.030016, 'Alt$(LHEScaleWeight[5],1)' : 0.976351, 'Alt$(LHEScaleWeight[7],1)' : 0.894461, 'Alt$(LHEScaleWeight[8],1)' : 0.869494},
}
