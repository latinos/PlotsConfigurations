...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/jetpt0/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/jetpt0/sampleFrac.json"%configurations))
