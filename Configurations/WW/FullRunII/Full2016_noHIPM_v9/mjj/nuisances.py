...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/mjj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_noHIPM_v9/mjj/sampleFrac.json"%configurations))
