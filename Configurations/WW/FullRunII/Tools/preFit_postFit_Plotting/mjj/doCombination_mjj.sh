...
text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                  ...
                  Full2016_HIPM_mjj.txt -o Full2016_HIPM_mjj.root
...
text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                  ...
                  --PO 'map=.*/.*WW_B9:r_9[1, -10, 10]' \
                  --PO 'map=.*/.*WW_B10:r_10[1, -10, 10]' \
                  Full2016_noHIPM_mjj.txt -o Full2016_noHIPM_mjj.root
...
text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                  ...
                  --PO 'map=.*/.*WW_B9:r_9[1, -10, 10]' \
                  --PO 'map=.*/.*WW_B10:r_10[1, -10, 10]' \
                  Full2017_mjj.txt -o Full2017_mjj.root
...
text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                  ...
                  --PO 'map=.*/.*WW_B9:r_9[1, -10, 10]' \
                  --PO 'map=.*/.*WW_B10:r_10[1, -10, 10]' \
                  Full2018_mjj.txt -o Full2018_mjj.root

combineCards.py WW2l2nu_2016_HIPM=Full2016_HIPM_mjj.txt \
                WW2l2nu_2016_noHIPM=Full2016_noHIPM_mjj.txt \
                WW2l2nu_2017=Full2017_mjj.txt \
                WW2l2nu_2018=Full2018_mjj.txt \
                > FullRunII_mjj.txt
...
text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                  ...
                  --PO 'map=.*/.*WW_B9:r_9[1, -10, 10]' \
                  --PO 'map=.*/.*WW_B10:r_10[1, -10, 10]' \
                  FullRunII_mjj.txt -o FullRunII_mjj.root
