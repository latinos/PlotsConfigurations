...
aliases['ptWW_Reweighing_pol4'] = {
    'expr': '(1.223926 -0.009992 * genptww + 0.000145 * genptww * genptww - 0.000001 * genptww * genptww * genptww + 0.00000001 * genptww * genptww * genptww * genptww)*(genptww>0 && genptww<180) + 1.0*(genptww>180 || genptww<=0)',
    'samples': ['WW']
}

aliases['ptWW_Reweighing_nuisance'] = {
    'expr': 'abs(ptWW_Reweighing_pol2 - ptWW_Reweighing_pol4) / abs(ptWW_Reweighing_pol2)',
    'samples': ['WW']
}
