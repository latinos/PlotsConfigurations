...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/ptll/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/ptll/sampleFrac.json"%configurations))
