...
class ww_dy_bdt_1j : public multidraw::TTreeFunction {
public:
  ww_dy_bdt_1j();

  char const* getName() const override { return "ww_dy_bdt_1j"; }
  TTreeFunction* clone() const override { return new ww_dy_bdt_1j(); }
...
ww_dy_bdt_1j::ww_dy_bdt_1j() : TTreeFunction() 
{
  ...
  reader->BookMVA("BDT","/eos/user/f/fernanpe/TrainingWW/1jet_ZVeto/TMVA_BDT_DY_v1/weights/TMVAClassification_BDTG4D3.weights.xml");
}

double
ww_dy_bdt_1j::evaluate(unsigned)
{
...
void
ww_dy_bdt_1j::bindTree_(multidraw::FunctionLibrary& _library)
{
