...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/jetpt1/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/jetpt1/sampleFrac.json"%configurations))
