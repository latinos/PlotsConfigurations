...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/jetpt0/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/jetpt0/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    ...
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.126090, 'Alt$(LHEScaleWeight[1],1)' : 1.106102, 'Alt$(LHEScaleWeight[3],1)' : 1.024134, 'Alt$(LHEScaleWeight[5],1)' : 0.981509, 'Alt$(LHEScaleWeight[7],1)' : 0.902071, 'Alt$(LHEScaleWeight[8],1)' : 0.881110},
}
