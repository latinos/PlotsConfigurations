...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/ptWW/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/ptWW/sampleFrac.json"%configurations))
