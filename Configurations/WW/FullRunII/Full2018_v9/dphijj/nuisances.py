...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/dphijj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/dphijj/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.125544, 'Alt$(LHEScaleWeight[1],1)' : 1.105747, 'Alt$(LHEScaleWeight[3],1)' : 1.023959, 'Alt$(LHEScaleWeight[5],1)' : 0.981663, 'Alt$(LHEScaleWeight[7],1)' : 0.902298, 'Alt$(LHEScaleWeight[8],1)' : 0.881474},
}
