...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/njets/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/njets/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.079853, 'Alt$(LHEScaleWeight[1],1)' : 1.078416, 'Alt$(LHEScaleWeight[3],1)' : 1.004374, 'Alt$(LHEScaleWeight[5],1)' : 0.998982, 'Alt$(LHEScaleWeight[7],1)' : 0.922262, 'Alt$(LHEScaleWeight[8],1)' : 0.918689},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.091138, 'Alt$(LHEScaleWeight[1],1)' : 1.084333, 'Alt$(LHEScaleWeight[3],1)' : 1.011075, 'Alt$(LHEScaleWeight[5],1)' : 0.993056, 'Alt$(LHEScaleWeight[7],1)' : 0.916963, 'Alt$(LHEScaleWeight[8],1)' : 0.907015},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.106798, 'Alt$(LHEScaleWeight[1],1)' : 1.094102, 'Alt$(LHEScaleWeight[3],1)' : 1.018479, 'Alt$(LHEScaleWeight[5],1)' : 0.986420, 'Alt$(LHEScaleWeight[7],1)' : 0.909200, 'Alt$(LHEScaleWeight[8],1)' : 0.892101},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.147843, 'Alt$(LHEScaleWeight[1],1)' : 1.119599, 'Alt$(LHEScaleWeight[3],1)' : 1.030477, 'Alt$(LHEScaleWeight[5],1)' : 0.976006, 'Alt$(LHEScaleWeight[7],1)' : 0.894087, 'Alt$(LHEScaleWeight[8],1)' : 0.868833},
}
