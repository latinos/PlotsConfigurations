...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/mjj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/mjj/sampleFrac.json"%configurations))
