...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/mll/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v9/mll/sampleFrac.json"%configurations))
