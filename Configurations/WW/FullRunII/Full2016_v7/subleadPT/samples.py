...
ptlowedge = ['20.', '25.', '30.', '35.', '40.', '50.', '60.', '70.', '80.', '90.', '100.', '120.', '150.','200.', '300.']
pthighedge = ['25.','30.', '35.', '40.', '50.', '60.', '70.', '80.', '90.', '100.', '120.', '150.', '200.', '300.', '9999.']
subleadlepPT = 'DressedLepton_pt[1]'
fiducial = 'fiducial'
nj = 0
nj1 = 0
...
for sname in signals:
  ...
  while nj < len(ptlowedge):
    ...
    cut = '%s && %s > %s && %s <= %s ' % (fiducial, subleadlepPT, ptlowedge[nj],subleadlepPT,pthighedge[nj])
    nj = nj+1
    sample['subsamples'][binName] = cut

  while nj1 < len(ptlowedge):
    binName = 'nonfid_Bin%s' % (nj1)
    cutnonfid = '%s && %s > %s && %s <= %s ' % ('!'+fiducial, subleadlepPT, ptlowedge[nj1],subleadlepPT,pthighedge[nj1])
    nj1 = nj1+1
