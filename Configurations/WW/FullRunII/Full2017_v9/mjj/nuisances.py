...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/mjj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/mjj/sampleFrac.json"%configurations))
