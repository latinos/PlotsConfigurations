...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/ptWW/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/ptWW/sampleFrac.json"%configurations))
