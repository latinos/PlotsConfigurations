...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/jetpt0/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/jetpt0/sampleFrac.json"%configurations))
