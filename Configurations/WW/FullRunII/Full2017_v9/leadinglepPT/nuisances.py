...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/leadinglepPT/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/leadinglepPT/sampleFrac.json"%configurations))
