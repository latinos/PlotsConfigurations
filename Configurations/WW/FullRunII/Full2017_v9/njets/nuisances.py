...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.069624, 'Alt$(LHEScaleWeight[1],1)' : 1.071843, 'Alt$(LHEScaleWeight[3],1)' : 0.999256, 'Alt$(LHEScaleWeight[5],1)' : 1.003642, 'Alt$(LHEScaleWeight[7],1)' : 0.928106, 'Alt$(LHEScaleWeight[8],1)' : 0.929747},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.083996, 'Alt$(LHEScaleWeight[1],1)' : 1.080081, 'Alt$(LHEScaleWeight[3],1)' : 1.007110, 'Alt$(LHEScaleWeight[5],1)' : 0.996746, 'Alt$(LHEScaleWeight[7],1)' : 0.920981, 'Alt$(LHEScaleWeight[8],1)' : 0.915103},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.103656, 'Alt$(LHEScaleWeight[1],1)' : 1.092197, 'Alt$(LHEScaleWeight[3],1)' : 1.016854, 'Alt$(LHEScaleWeight[5],1)' : 0.987910, 'Alt$(LHEScaleWeight[7],1)' : 0.910898, 'Alt$(LHEScaleWeight[8],1)' : 0.895419},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.144594, 'Alt$(LHEScaleWeight[1],1)' : 1.117682, 'Alt$(LHEScaleWeight[3],1)' : 1.029071, 'Alt$(LHEScaleWeight[5],1)' : 0.977221, 'Alt$(LHEScaleWeight[7],1)' : 0.895543, 'Alt$(LHEScaleWeight[8],1)' : 0.871496},
}
