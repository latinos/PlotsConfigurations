...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/subleadinglepPT/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/subleadinglepPT/sampleFrac.json"%configurations))
