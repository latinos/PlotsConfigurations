...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/mll/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/mll/sampleFrac.json"%configurations))
