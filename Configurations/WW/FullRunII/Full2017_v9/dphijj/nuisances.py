...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/dphijj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/dphijj/sampleFrac.json"%configurations))
...
nuisances['electronpt'] = {
    ...
    'mapUp' : 'ElepTup',
    'mapDown': 'ElepTdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if skey not in ['ggWW']), #TODO fix when samples are available
...
topScaleNormFactors = {
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.122609, 'Alt$(LHEScaleWeight[1],1)' : 1.104075, 'Alt$(LHEScaleWeight[3],1)' : 1.022463, 'Alt$(LHEScaleWeight[5],1)' : 0.983004, 'Alt$(LHEScaleWeight[7],1)' : 0.903722, 'Alt$(LHEScaleWeight[8],1)' : 0.884303},
}
