...
aliases['BDTOutput_0j'] = {
    'class': 'ww_top_bdt_0j',
    'linesToAdd' : ['.L %s/WW/FullRunII/Full2018_v7/leadlepPT/WW_BDT_0j.cc+' % configurations],
}

aliases['BDTOutput_1j'] = {
    'class': 'ww_top_bdt_1j',
    'linesToAdd' : ['.L %s/WW/FullRunII/Full2018_v7/leadlepPT/WW_BDT_1j.cc+' % configurations],
}

aliases['BDTOutput_2j'] = {
    'class': 'ww_top_bdt_2j',
    'linesToAdd' : ['.L %s/WW/FullRunII/Full2018_v7/leadlepPT/WW_BDT_2j.cc+' % configurations],
}
