...
nfdict = json.load(open("%s/WW/FullRunII/Full2018_v7/mll/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2018_v7/mll/sampleFrac.json"%configurations))
