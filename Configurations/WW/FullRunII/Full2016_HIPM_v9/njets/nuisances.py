...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/njets/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/njets/sampleFrac.json"%configurations))
...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.080031, 'Alt$(LHEScaleWeight[1],1)' : 1.077818, 'Alt$(LHEScaleWeight[3],1)' : 1.004808, 'Alt$(LHEScaleWeight[5],1)' : 0.998667, 'Alt$(LHEScaleWeight[7],1)' : 0.922776, 'Alt$(LHEScaleWeight[8],1)' : 0.919053},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.090753, 'Alt$(LHEScaleWeight[1],1)' : 1.084547, 'Alt$(LHEScaleWeight[3],1)' : 1.010483, 'Alt$(LHEScaleWeight[5],1)' : 0.993598, 'Alt$(LHEScaleWeight[7],1)' : 0.916893, 'Alt$(LHEScaleWeight[8],1)' : 0.907457},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.106082, 'Alt$(LHEScaleWeight[1],1)' : 1.093845, 'Alt$(LHEScaleWeight[3],1)' : 1.018116, 'Alt$(LHEScaleWeight[5],1)' : 0.986774, 'Alt$(LHEScaleWeight[7],1)' : 0.909302, 'Alt$(LHEScaleWeight[8],1)' : 0.892481},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.147189, 'Alt$(LHEScaleWeight[1],1)' : 1.119526, 'Alt$(LHEScaleWeight[3],1)' : 1.029960, 'Alt$(LHEScaleWeight[5],1)' : 0.976461, 'Alt$(LHEScaleWeight[7],1)' : 0.894109, 'Alt$(LHEScaleWeight[8],1)' : 0.869252},
}
