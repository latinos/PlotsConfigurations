...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/inclusive_Backup/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/inclusive_Backup/sampleFrac.json"%configurations))
