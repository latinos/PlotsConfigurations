...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/dphijj/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/dphijj/sampleFrac.json"%configurations))
