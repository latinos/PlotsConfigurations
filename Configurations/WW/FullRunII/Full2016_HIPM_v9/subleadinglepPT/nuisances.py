...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/subleadinglepPT/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/subleadinglepPT/sampleFrac.json"%configurations))
