...
nfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/jetpt0/WWnorm.json"%configurations))
sfdict = json.load(open("%s/WW/FullRunII/Full2016_HIPM_v9/jetpt0/sampleFrac.json"%configurations))
