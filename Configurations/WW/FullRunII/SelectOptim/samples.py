...
configurations = os.path.dirname(configurations) # SelectOptim
...
samples['WWewk'] = {
    ...
    'weight': mcCommonWeight + '*(Sum$(abs(GenPart_pdgId)==6 || GenPart_pdgId==25)==0) * 0.2571', #filter tops and Higgs + xsec fix
    'FilesPerJob': 2
}
