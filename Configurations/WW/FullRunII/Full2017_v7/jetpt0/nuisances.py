...
nfdict = json.load(open("%s/WW/FullRunII/Full2017_v7/jetpt0/WWnorm.json"%configurations))
...
topScaleNormFactors = {
    ...
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.125502, 'Alt$(LHEScaleWeight[1],1)' : 1.106017, 'Alt$(LHEScaleWeight[3],1)' : 1.023775, 'Alt$(LHEScaleWeight[5],1)' : 0.981817, 'Alt$(LHEScaleWeight[7],1)' : 0.902129, 'Alt$(LHEScaleWeight[8],1)' : 0.881389},
}
