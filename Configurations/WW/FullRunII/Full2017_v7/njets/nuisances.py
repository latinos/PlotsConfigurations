...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.077576, 'Alt$(LHEScaleWeight[8],1)' : 0.921477},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.090153, 'Alt$(LHEScaleWeight[8],1)' : 0.908104},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.106371, 'Alt$(LHEScaleWeight[8],1)' : 0.892378},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.145785, 'Alt$(LHEScaleWeight[8],1)' : 0.869801}
}
