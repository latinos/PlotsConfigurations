...
topScaleNormFactors = {
    '0j' : {'Alt$(LHEScaleWeight[0],1)' : 1.077933, 'Alt$(LHEScaleWeight[1],1)' : 1.077272, 'Alt$(LHEScaleWeight[3],1)' : 1.003296, 'Alt$(LHEScaleWeight[5],1)' : 1.000194, 'Alt$(LHEScaleWeight[7],1)' : 0.923396, 'Alt$(LHEScaleWeight[8],1)' : 0.921104},
    '1j' : {'Alt$(LHEScaleWeight[0],1)' : 1.090033, 'Alt$(LHEScaleWeight[1],1)' : 1.084009, 'Alt$(LHEScaleWeight[3],1)' : 1.010280, 'Alt$(LHEScaleWeight[5],1)' : 0.993960, 'Alt$(LHEScaleWeight[7],1)' : 0.917425, 'Alt$(LHEScaleWeight[8],1)' : 0.908310},
    '2j' : {'Alt$(LHEScaleWeight[0],1)' : 1.106278, 'Alt$(LHEScaleWeight[1],1)' : 1.093984, 'Alt$(LHEScaleWeight[3],1)' : 1.018148, 'Alt$(LHEScaleWeight[5],1)' : 0.986747, 'Alt$(LHEScaleWeight[7],1)' : 0.909286, 'Alt$(LHEScaleWeight[8],1)' : 0.892449},
    '3j' : {'Alt$(LHEScaleWeight[0],1)' : 1.145475, 'Alt$(LHEScaleWeight[1],1)' : 1.118725, 'Alt$(LHEScaleWeight[3],1)' : 1.029386, 'Alt$(LHEScaleWeight[5],1)' : 0.976891, 'Alt$(LHEScaleWeight[7],1)' : 0.894576, 'Alt$(LHEScaleWeight[8],1)' : 0.869973},
}
