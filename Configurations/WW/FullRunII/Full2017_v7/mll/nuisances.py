...
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v7/mll/sampleFrac.json"%configurations))
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'Vg'      : ['0.999988*(puWeightUp/puWeight)', '1.001711*(puWeightDown/puWeight)'],
        ...
        'Higgs'   : ['1.001572*(puWeightUp/puWeight)', '0.997913*(puWeightDown/puWeight)'],
    },
    'AsLnN': '1',
}
