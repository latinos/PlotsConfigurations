...
combineCards.py   of2jvh2j13=VH2j/datacards/hww2l2v_13TeV_of2j_vh2j/mll/datacard.txt.pruned.txt \
                  ...
                  >   Data2015.vh2j.pruned.txt

# results

combine -M MaxLikelihoodFit    --rMin=-9 --rMax=10   -t -1 --expectSignal 1   Data2015.vh2j.pruned.txt             >   result.MaxLikelihoodFit.Data2015.vh2j.pruned.txt

combine -M ProfileLikelihood --significance         -t -1 --expectSignal 1   Data2015.vh2j.pruned.txt             >   result.Significance.Data2015.vh2j.pruned.txt


combine -M MultiDimFit Data2015.vh2j.pruned.txt -m 125 -t -1 --expectSignal 1 --algo=grid --points 200 --setPhysicsModelParameterRanges r=-9,10 -n "LHScanHVH2j"     >   result.LikelihoodScan.Data2015.vh2j.pruned.txt


# data

combine -M MaxLikelihoodFit    --rMin=-9 --rMax=10      Data2015.vh2j.pruned.txt             >   result.data.MaxLikelihoodFit.Data2015.vh2j.pruned.txt

combine -M ProfileLikelihood --significance            Data2015.vh2j.pruned.txt             >   result.data.Significance.Data2015.vh2j.pruned.txt

combine -M MultiDimFit Data2015.vh2j.pruned.txt -m 125 --algo=grid --points 200 --setPhysicsModelParameterRanges r=-9,10 -n "LHScanHdataVH2j"     >   result.data.LikelihoodScan.Data2015.vh2j.pruned.txt
