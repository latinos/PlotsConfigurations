...
parser.add_option("-l", "--lumi",     dest="cmsLumi",  default="35.9")
...
combChannels = ['4-lepton ZH-tagged','3-lepton WH-tagged','2-jet DF VH-tagged','2-jet DF VBF-tagged high mjj','2-jet DF VBF-tagged low mjj','2-jet DF VBF-tagged','2-jet DF ggH-tagged','1-jet SF ggH-tagged','1-jet DF ggH-tagged','0-jet SF ggH-tagged','0-jet DF ggH-tagged']
...
for channel in DC.exp:
  ...
  if 'of0j' in channel: c='0-jet DF ggH-tagged'
...
stack = ROOT.THStack()
histos = {}
leg = ROOT.TLegend(0.83,0.45,1.0,0.8)
leg.SetTextFont(42)
...
for s in overallSignalRate['0-jet DF ggH-tagged']: #used just to preserve the order of the signals
  stack.Add(histos[s])
