...
list_datacards [ '2016_mll_VH_2j_topemu'   ] = [ '../Full2016_v6/datacards_nominal/VH_2j_topemu/mll/datacard.txt',   'False' ]  
list_datacards [ '2016_mll_VH_2j_emu'      ] = [ '../Full2016_v6/datacards_nominal/VH_2j_emu/mll/datacard.txt',      'False' ]  
list_datacards [ '2016_mll_VH_2j_DYtautau' ] = [ '../Full2016_v6/datacards_nominal/VH_2j_DYtautau/mll/datacard.txt', 'False' ]  
list_datacards [ '2017_mll_VH_2j_topemu'   ] = [ '../Full2017_v6/datacards_nominal/VH_2j_topemu/mll/datacard.txt',   'False' ]  
list_datacards [ '2017_mll_VH_2j_emu'      ] = [ '../Full2017_v6/datacards_nominal/VH_2j_emu/mll/datacard.txt',      'False' ]  
list_datacards [ '2017_mll_VH_2j_DYtautau' ] = [ '../Full2017_v6/datacards_nominal/VH_2j_DYtautau/mll/datacard.txt', 'False' ]  
list_datacards [ '2018_mll_VH_2j_topemu'   ] = [ '../Full2018_v6/datacards_nominal/VH_2j_topemu/mll/datacard.txt',   'False' ]  
list_datacards [ '2018_mll_VH_2j_emu'      ] = [ '../Full2018_v6/datacards_nominal/VH_2j_emu/mll/datacard.txt',      'False' ]  
list_datacards [ '2018_mll_VH_2j_DYtautau' ] = [ '../Full2018_v6/datacards_nominal/VH_2j_DYtautau/mll/datacard.txt', 'False' ]  
