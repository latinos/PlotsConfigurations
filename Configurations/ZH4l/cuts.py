...
# cuts['zh4l_XSF_jetVeto_13TeV']  = '(flagZ1SF_zh4l==1\
        # &&  z1Mass_zh4l < 65 && z1Mass_zh4l > 10 \
        # && metPfType1 > 35 \
        # && mllll_zh4l > 140\
        ...
        # && fabs(z0Mass_zh4l-91.1876)< 15)*bPogSF_CMVAL'

# cuts['zh4l_XDF_jetVeto_13TeV']  = '(flagZ1SF_zh4l==0\
        # && z1Mass_zh4l < 75 && z1Mass_zh4l >10 \
        # && std_vector_jet_pt[0] < 50  \
        # && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.715 ) \
        # && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.715 ) \
...
cuts['zh4l_XSF_mz0_met_mz1']  = 'flagZ1SF_zh4l==1\
        ...
        && mllll_zh4l > 140\
        && fabs(z0Mass_zh4l-91.1876)< 15'
cuts['zh4l_XSF_mz0_met_mz1_jet']  = 'flagZ1SF_zh4l==1\
        &&  z1Mass_zh4l < 65 && z1Mass_zh4l > 10 \
        && metPfType1 > 35 \
        && mllll_zh4l > 140\
        && std_vector_jet_pt[0] < 50  \
...
cuts['zh4l_XDF_mz0']  = 'flagZ1SF_zh4l==0\
        && fabs(z0Mass_zh4l-91.1876)< 15'
cuts['zh4l_XDF_mz0_mz1']  = 'flagZ1SF_zh4l==0\
        && z1Mass_zh4l < 75 && z1Mass_zh4l >10 \
        && fabs(z0Mass_zh4l-91.1876)< 15'
cuts['zh4l_XDF_mz0_mz1_jet']  = 'flagZ1SF_zh4l==0\
        && z1Mass_zh4l < 75 && z1Mass_zh4l >10 \
        && std_vector_jet_pt[0] < 50  \
        && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.715 ) \
        && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.715 ) \
