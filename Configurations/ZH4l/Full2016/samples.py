...
directory2 = treeBaseDir+'Summer16_102X_nAODv4_Full2016v4/MCl1loose2016__MCCorr2016__l2loose__l2tightOR2016'+skim
...
bVeto ='(Sum$(CleanJet_pt > 20. && abs(CleanJet_eta)<2.5 && Jet_btagDeepB[CleanJet_jetIdx] > 0.2217) == 0)'
...
#
#  else:
samples['DY'] = {    'name'   :   getSampleFiles(directory2,'DYJetsToLL_M-50_ext2',False,'nanoLatino_')
                                    + getSampleFiles(directory2,'DYJetsToLL_M-10to50-LO',False,'nanoLatino_'),
...
samples['WW'] = {    'name'   :   getSampleFiles(directory2,'WWTo2L2Nu',False,'nanoLatino_') 
                                + getSampleFiles(directory2,'GluGluWWTo2L2Nu_MCFM',False,'nanoLatino_'),
                     'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch2l+'*'+METFilter_MC ,
                 }
...
#samples['ggWW']  = {  'name'   :   getSampleFiles(directory2,'GluGluWWTo2L2Nu_MCFM',False,'nanoLatino_'),
...
samples['ggH_hzz']  = {    'name': getSampleFiles(directory2,'GluGluHToZZTo4L_M125',False,'nanoLatino_'),
                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC,
                     }
...
samples['ttZ']  = {    'name': getSampleFiles(directory2,'TTZjets',False,'nanoLatino_'),
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC,
...
samples['ZZ']  = {  'name'   :   getSampleFiles(directory2,'ZZTo4L',False,'nanoLatino_')
                              ...
                              +getSampleFiles(directory2,'ggZZ4t',False,'nanoLatino_')
                              +getSampleFiles(directory2,'ggZZ4e',False,'nanoLatino_')
...
samples['VVV']  = {  'name'   :   getSampleFiles(directory2,'ZZZ',False,'nanoLatino_')
                                + getSampleFiles(directory2,'WZZ',False,'nanoLatino_')
                                + getSampleFiles(directory2,'WWZ',False,'nanoLatino_')
                                + getSampleFiles(directory2,'WWW',False,'nanoLatino_'),
...
#samples['ggH_hww']  = {  'name'   :   getSampleFiles(directory2,'GluGluHToWWTo2L2NuPowheg_M125',False,'nanoLatino_'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                     }

############ VBF H->WW ############
#samples['qqH_hww']  = {  'name'   :   getSampleFiles(directory2,'VBFHToWWTo2L2NuPowheg_M125',False,'nanoLatino_'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                     }

############ ZH H->WW ############

samples['ZH_hww']  = {  'name'   :   getSampleFiles(directory2,'HZJ_HToWW_M125',False,'nanoLatino_'),
                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }

samples['ggZH_hww']  = {  'name'   :   getSampleFiles(directory2,'ggZH_HToWW_M125',False,'nanoLatino_'),
                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }

############ WH H->WW ############

#samples['WH_hww']  = {  'name'   :   getSampleFiles(directory2,'HWplusJ_HToWW_M125',False,'nanoLatino_')
#                                   + getSampleFiles(directory2,'HWminusJ_HToWW_M125',False,'nanoLatino_'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                     }
...
samples['H_htt'] = {  'name'   :   getSampleFiles(directory2,'GluGluHToTauTau_M125',False,'nanoLatino_')
                                   + getSampleFiles(directory2,'VBFHToTauTau_M125',False,'nanoLatino_')
                                   + getSampleFiles(directory2,'HZJ_HToTauTau_M125',False,'nanoLatino_')
                                   + getSampleFiles(directory2,'HWplusJ_HToTauTau_M125',False,'nanoLatino_')
                                   + getSampleFiles(directory2,'HWminusJ_HToTauTau_M125',False,'nanoLatino_'),
                         'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
#else:
#  
#  samples['ggH_htt']  = {  'name'   : getSampleFiles(directory2,'GluGluHToTauTau_M125',False,'nanoLatino_'),
#                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                        } 
#
#  samples['qqH_htt']  = {  'name'   : getSampleFiles(directory2,'VBFHToTauTau_M125',False,'nanoLatino_'),
#                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                        }
#
#  samples['ZH_htt']  = {  'name'   : getSampleFiles(directory2,'HZJ_HToTauTau_M125',False,'nanoLatino_'),
#                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                        }
#
#  samples['WH_htt']  = {  'name'   :  getSampleFiles(directory2,'HWplusJ_HToTauTau_M125',False,'nanoLatino_')
#                                    + getSampleFiles(directory2,'HWminusJ_HToTauTau_M125',False,'nanoLatino_'),
#                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                        }
#
