...
//        myreaderBDT->AddVariable("z1dPhi_lep2MET_zh4l", &loc_z1dPhi_lep2MET_zh4l); 
        ...
        myreaderBDT->BookMVA("BDT","/afs/cern.ch/work/k/kaura/NewLatino_v2/CMSSW_10_2_5/src/PlotsConfigurations/Configurations/ZH4l/nano_config/Full2016/BDT/new_weights/init_var/ZH4l__Tmva_ZH_2016_root_BDT.weights.xml"); 

}


float hww_ZH_newBDT(int entry, int nclass){
