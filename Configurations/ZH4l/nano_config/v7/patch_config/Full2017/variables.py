...
#     'name': 'BDT(Entry$,0)',
    'name': 'BDT_test[0]',
     ...
     'fold' : 3,
#     'linesToAdd' : ['.L /afs/cern.ch/work/k/kaura/Thesis/AnalysisWork/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ZH4l/nano_config/v7/Full2016/hww_ZH_BDT.C+']
...
variables['z0Mass_zh4l']  = {   'name': 'z0Mass_zh4l_test[0]',            #   variable name    
                        'range' : (30,50,140),    #   variable range
                        'xaxis' : 'z0Mass [GeV]',  #   x axis name
                       'fold' : 0
                     }

variables['z1Mass_zh4l']  = {   'name': 'z1Mass_zh4l_test[0]',            #   variable name    
                        'range' : (25,0,250),    #   variable range
                        'xaxis' : 'XMass [GeV]',  #   x axis name
                       'fold' : 0
                     }

variables['mllll_zh4l']  = {   'name': 'mllll_zh4l_test[0]',            #   variable name    
                        'range' : (60,0,600),    #   variable range
                        'xaxis' : 'mllll [GeV]',  #   x axis name
                       'fold' : 0
                     }

variables['z1Mt_zh4l']  = {   'name': 'z1Mt_zh4l_test[0]',            #   variable name    
...
variables['lep1Mt_zh4l']  = {   'name': 'lep1Mt_zh4l_test[0]',            #   variable name    
                        'range' : (30,0,550),    #   variable range
                        'xaxis' : 'lep1Mt [GeV]',  #   x axis name
                       'fold' : 0
                     }

variables['lep2Mt_zh4l']  = {   'name': 'lep2Mt_zh4l_test[0]',            #   variable name    
