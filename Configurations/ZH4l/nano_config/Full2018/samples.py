...
#directoryWG = treeBaseDir+'Fall2017_102X_nAODv4_Full2017v5/MCl1loose2017v5__MCCorr2017v5__l2loose__l2tightOR2017v5__redoWGammaStarV2'+skim
################################################
############ NUMBER OF LEPTONS #################
################################################
...
addSampleWeight(samples,'ZZ','ZZTo4L_ext1',"1.17") ## The NNLO/NLO k-factor, cited from https://arxiv.org/abs/1405.2219v1
...
#FIXME Add normalization k-factor
samples['ZZhad']  = {  'name'   :   getSampleFiles(directory,'ZZTo2L2Nu_ext1',False,'nanoLatino_')
