...
'''
#FIXME Add normalization k-factor
samples['ZZ']  = {  'name'   :   getSampleFiles(directory,'ZZTo4L_ext2',False,'nanoLatino_')
...
samples['ZH_hww']  = {  'name'   :   getSampleFiles(directory,'HZJ_HToWWTo2L2Nu_ZTo2L_M125',False,'nanoLatino_'),
                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
'''
