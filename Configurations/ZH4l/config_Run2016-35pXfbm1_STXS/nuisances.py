...
nuisances['PS_zh4l']  = {
        ...
        'samples'  : {
            ...
            'ggZH_hww'  : '1.037',
            'ZH_had_hww'       :'1.037',
            'ZH_had_fwd_hww'   :'1.037',
            'ZH_lep_hww'       :'1.037',
            'ZH_lep_fwd_hww'   :'1.037',
            'ggZH_lep_hww'     :'1.037',
            'ggZH_lep_fwd_hww' :'1.037',
            'ZH_had_htt'       :'1.037',
            'ZH_had_fwd_htt'   :'1.037',
            'ZH_lep_htt'       :'1.037',
            'ZH_lep_fwd_htt'   :'1.037',
...
nuisances['UE_zh4l']  = {
        ...
        'samples'  : {
            ...
            'ggZH_hww'  : '1.010',
            'ZH_had_hww'       :'1.010',
            'ZH_had_fwd_hww'   :'1.010',
            'ZH_lep_hww'       :'1.010',
            'ZH_lep_fwd_hww'   :'1.010',
            'ggZH_lep_hww'     :'1.010',
            'ggZH_lep_fwd_hww' :'1.010',
            'ZH_had_htt'       :'1.010',
            'ZH_had_fwd_htt'   :'1.010',
            'ZH_lep_htt'       :'1.010',
            'ZH_lep_fwd_htt'   :'1.010',
            },
        }
...
nuisances['btag_heavy']  = {
        ...
        'type'  : 'shape',
        'samples'  : {
            'ZH_had_hww'       : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_had_fwd_hww'   : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_lep_hww'       : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_lep_fwd_hww'   : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ggZH_lep_hww'     : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ggZH_lep_fwd_hww' : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_had_htt'       : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_had_fwd_htt'   : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_lep_htt'       : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
            'ZH_lep_fwd_htt'   : ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)'],
...
nuisances['btag_light']  = {
        ...
        'type'  : 'shape',
        'samples'  : {
            'ZH_had_hww'       : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_had_fwd_hww'   : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_lep_hww'       : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_lep_fwd_hww'   : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ggZH_lep_hww'     : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ggZH_lep_fwd_hww' : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_had_htt'       : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_had_fwd_htt'   : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_lep_htt'       : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
            'ZH_lep_fwd_htt'   : ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)'],
...
nuisances['hww_trigger']  = {
        ...
        'type'  : 'shape',
        'samples'  : {
            'ZH_had_hww'       : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_had_fwd_hww'   : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_lep_hww'       : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_lep_fwd_hww'   : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ggZH_lep_hww'     : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ggZH_lep_fwd_hww' : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_had_htt'       : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_had_fwd_htt'   : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_lep_htt'       : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
            'ZH_lep_fwd_htt'   : ['(effTrigW4l_Up)/(effTrigW4l)', '(effTrigW4l_Down)/(effTrigW4l)'],
