...
do
    ...
    #echo "mkDatacards.py --pycfg configuration.py --inputFile rootFiles_ZH4l_${YEAR}_v7_STXS/plots_ZH4l_${YEAR}_v7_STXS.root"
    #mkDatacards.py --pycfg configuration.py --inputFile rootFiles_ZH4l_${YEAR}_v7_STXS/plots_ZH4l_${YEAR}_v7_STXS.root
    ...
    find -L datacard_ZH4l_${YEAR}_v7_STXS -name 'datacard.txt' | while read line
    do 
