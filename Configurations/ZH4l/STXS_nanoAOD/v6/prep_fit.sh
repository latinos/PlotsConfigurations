...
do
    ...
    datacardDir=${PWD}/datacards_${ANALYSIS}_${YEAR}_nanov6_STXS

    # combine the datacards                    
    combineCards.py \
	zh4l_XSF_13TeV_ptw_lt150=$datacardDir/zh4l_XSF_13TeV_ptv_lt150/class0_XSF/datacard.txt.pruned.txt \
	zh4l_XSF_13TeV_ptw_gt150=$datacardDir/zh4l_XSF_13TeV_ptv_gt150/class0_XSF/datacard.txt.pruned.txt \
	zh4l_XDF_13TeV_ptw_lt150=$datacardDir/zh4l_XDF_13TeV_ptv_lt150/class1_XDF/datacard.txt.pruned.txt \
	zh4l_XDF_13TeV_ptw_gt150=$datacardDir/zh4l_XDF_13TeV_ptv_gt150/class1_XDF/datacard.txt.pruned.txt \
