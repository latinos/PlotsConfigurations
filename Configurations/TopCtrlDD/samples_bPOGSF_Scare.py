...
samples['DY'] =  { 'name': [
	...
	'eos/cms/store/caf/user/lenzip/ww2016/21Oct_25ns_MC/mcwghtcount__MC__l2sel__bPogSF__hadd/latino_DYJetsToLL_M-50.root',
        ...
        'weight' : 'GEN_weight_SM/abs(GEN_weight_SM)*bPogSF1Jet*baseW*puW*((0.724244/0.777343)**(std_vector_jet_HadronFlavour[0] == 5))*((0.9656)**(std_vector_jet_HadronFlavour[0] != 5))',
        'isData' : ['0']
        }
...
samples['FakeQCD'] = {   'name': [
	...
	'eos/cms/store/caf/user/lenzip/ww2016/21Oct_25ns_MC/mcwghtcount__MC__l2sel__bPogSF__hadd/latino_QCD_Pt-50to80_EMEnriched.root',
                       ...
                       'weight' : 'bPogSF1Jet*baseW*puW*((0.724244/0.777343)**(std_vector_jet_HadronFlavour[0] == 5))*((0.9656)**(std_vector_jet_HadronFlavour[0] != 5))',
                   }
...
#                      'weight' : 'GEN_weight_SM/abs(GEN_weight_SM)*bPogSF1Jet*baseW*puW',
#                  }
