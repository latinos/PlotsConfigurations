...
dymvaVBFee  = 'hww_DYmvaDNN_VBF(Entry$) > 0.975'
dymvaVBFmm  = 'hww_DYmvaDNN_VBF(Entry$) > 0.975'
...
cuts['hww2l2v_13TeV_2017_DYin_2jdf_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && bVeto \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
                             '
...
cuts['hww2l2v_13TeV_2017_DYin_btag_2jdf_vbf'] = '(Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) \
                             && topcr \
                             && '+dymvaVBFee+' \
                             && fabs(91.1876 - mll) < 7.5  \
                             '
