...
variables['nlepton'] = {     'name'  : 'nLepton',            #   variable name    
                             'range' : (1,0,6),    #   variable range
                             'xaxis' : 'nLepton',  #   x axis name
                             'fold'  : 0
                             }

variables['pt1'] = {     'name'  : 'Lepton_pt[0]',            #   variable name    
                         'range' : (50,0,500),    #   variable range
                         'xaxis' : 'Leading lepton p_T',  #   x axis name
                         'fold'  : 0
                         }

variables['pt2'] = {     'name'  : 'Lepton_pt[1]',            #   variable name    
                         'range' : (50,0,500),    #   variable range
                         'xaxis' : 'Trailing lepton p_T',  #   x axis name
                         'fold'  : 0
                         }

variables['eta1'] = {     'name'  : 'Lepton_eta[0]',            #   variable name    
                          'range' : (10,-2.5,2.5),    #   variable range
                          'xaxis' : 'Leading lepton eta',  #   x axis name
                          'fold'  : 0
                          }

variables['eta2'] = {     'name'  : 'Lepton_eta[1]',            #   variable name    
                          'range' : (10,-2.5,2.5),    #   variable range
                          'xaxis' : 'Trailing lepton eta',  #   x axis name
                          'fold'  : 0
                          }
