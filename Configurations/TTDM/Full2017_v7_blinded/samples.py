...
mcSteps = 'MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7{var}_weighted'

fakeSteps = 'DATAl1loose2017v7__l2loose__fakeW_weighted'

dataSteps = 'DATAl1loose2017v7__l2loose__l2tightOR2017v7_weighted'
...
"""
samples['ttV'] = {
    'name': nanoGetSampleFiles(mcDirectory, 'TTWjets') + nanoGetSampleFiles(mcDirectory, 'TTWJetsToLNu_PSweights') + nanoGetSampleFiles(mcDirectory, 'TTZjets') + nanoGetSampleFiles(mcDirectory, 'TTZToLLNuNu_M-10'),
    'weight': mcCommonWeight,
    'FilesPerJob': 1,
}
"""
...
samples['ttW'] = {
    'name': nanoGetSampleFiles(mcDirectory, 'TTWjets') + nanoGetSampleFiles(mcDirectory, 'TTWJetsToLNu_PSweights'),
    'weight': mcCommonWeight,
    'FilesPerJob': 1,
}
...
signals = []
#signalDir = '/eos/user/c/cprieels/work/TopPlusDMRunIILegacyRootfiles/Fall2017_102X_nAODv7_Full2017v7/MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7_weighted/'
