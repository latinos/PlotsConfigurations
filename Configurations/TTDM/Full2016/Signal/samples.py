...
samples['DMPseudo_100GeV']  = {  'name'  : getSampleFiles(directory,'DMPseudo_ttbar01j_Mchi1_Mphi100_Private2019',False,'nanoLatino_') ,
                                'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC,               
}

samples['DMScalar_100GeV']  = {  'name'  : getSampleFiles(directory,'DMScalar_ttbar01j_Mchi1_Mphi100_Private2019',False,'nanoLatino_') ,
                                'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC,               
}
...
samples['Fake']  = {   'name': [ ] ,
                         'weight' : METFilter_DATA+'*'+fakeW+'*(abs(Lepton_pdgId[0])==11 && abs(Lepton_pdgId[1])==13)'+'/4',              #   weight/cut 
                         'weights' : [ ] ,
                         'isData': ['all'],
                         'FilesPerJob' : 15 ,
                      }
