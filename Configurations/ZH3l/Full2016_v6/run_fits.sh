...
python ../../Template/scripts/correlationMatrix.py fitDiagnosticsZh3l_2016_v6_mTlmetjj.root
...
combineTool.py -M Impacts -d Zh3l_2016_v6_mTlmetjj.root -m 125.09 -n Zh3l_2016_v6_mTlmetjj --expectSignal=1 -t -1 --setParameterRanges r=-10,10:CMS_hww_WZ3l1jnorm=-5,5:CMS_hww_WZ3l2jnorm=-5,5 --X-rtd MINIMIZER_analytic --robustFit=1 --doFits --parallel 8 > output_impacts_mtlmetjj.txt
