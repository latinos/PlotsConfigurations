...
samples['DY'] = {    'name'   :    getSampleFilesNano(directory,'DYJetsToLL_M-10to50-LO')
				 ...
				 + getSampleFilesNano(directory, 'DYJetsToLL_M-50_ext2')
...
M10baseW   = getBaseWnAOD(directory,'Autumn18_102X_nAODv7_Full2018v7',['DYJetsToLL_M-10to50-LO','DYJetsToLL_M-10to50-LO_ext1'])
#HT400baseW = getBaseWnAOD(directory,'Autumn18_102X_nAODv7_Full2018v7',['DYJetsToLL_M-50_HT-400to600'])
...
addSampleWeight(samples,'DY','DYJetsToLL_M-50_ext2'            ,ptllDYW_LO)
