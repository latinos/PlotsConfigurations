...
do
    ...
    echo "nuisance edit drop WH_hww_FWDH eu_2j_PTV_LE150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_2j_PTV_GT150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
...
do
    ...
    echo "nuisance edit drop WH_hww_FWDH eu_2j_PTV_LE150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_2j_PTV_GT150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
