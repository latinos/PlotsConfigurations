...
do
    echo "nuisance edit drop Vg eu_2j_PTV_150_250_GE1J CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop WH_hww_FWDH eu_2j_PTV_0_75 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_2j_PTV_150_250_GE1J CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
...
do
    echo "nuisance edit drop Vg eu_2j_PTV_150_250_GE1J CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop WH_hww_FWDH eu_2j_PTV_0_75 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_2j_PTV_150_250_GE1J CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
