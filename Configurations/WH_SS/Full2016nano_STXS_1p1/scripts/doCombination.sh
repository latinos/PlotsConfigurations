...
do
    echo "nuisance edit drop Vg uu_1j_PTV_LE150 CMS_CMS_btag_$nu " >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_1j_PTV_LE150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg eu_2j_PTV_LE150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop ZH_hww eu_2j_PTV_LE150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg eu_2j_PTV_GT150 CMS_CMS_btag_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
done

#Eff
for nu in e_2016 m_2016 hwwtrigger_2016 prefiring_2016
do
    echo "nuisance edit drop Vg uu_1j_PTV_LE150 CMS_CMS_eff_$nu " >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg uu_1j_PTV_LE150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg eu_2j_PTV_LE150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop ZH_hww eu_2j_PTV_LE150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
    echo "nuisance edit drop Vg eu_2j_PTV_GT150 CMS_CMS_eff_$nu" >> ${outputDir}/${analysis}_HTXS_Stage1.txt
done
