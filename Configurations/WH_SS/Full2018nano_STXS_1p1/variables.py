...
#variables['maxdphilepjj'] = { 'name': 'maxdphilepjj',
#                             'range' : (20,0,3.14),
#                             'xaxis' : 'Max(#Delta#phi_{lepjj})',
#                             'fold': 0
#                         }

#variables['dphilep2jj'] = { 'name': 'dphilep2jj',
#                             'range' : (20,0,3.14),
#                             'xaxis' : '#Delta#phi_{lep2jj}',
#                             'fold': 0
#                         }

#variables['dphilep1jj'] = { 'name': 'dphilep1jj',
#                             'range' : (20,0,3.14),
#                             'xaxis' : '#Delta#phi_{lep1jj}',
#                             'fold': 0
#                       }
