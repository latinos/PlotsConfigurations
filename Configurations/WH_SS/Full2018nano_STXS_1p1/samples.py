...
def makeMCDirectory(var=''):
  if var:
    #nAODv5_SigOnly
    directory = treeBaseDir+'Autumn18_102X_XXXX_Full2018v5/MCl1loose2018v5__MCCorr2018v5__l2loose__l2tightOR2018v5/'+skim
...
#samples['DY'] = {    'name'   :   getSampleFiles(makeMCDirectory(),'DYJetsToLL_M-50_ext',False,'nanoLatino_')
#                                + getSampleFiles(makeMCDirectory(),'DYJetsToLL_M-10to50-LO',False,'nanoLatino_'),
# #                               + getSampleFiles(makeMCDirectory(),'DYJetsToTT_MuEle_M-50',False,'nanoLatino_'),
...
samples['top'] = {    'name'   :   getSampleFiles(makeMCDirectory(),'TTTo2L2Nu',False,'nanoLatino_')
                                 + getSampleFiles(makeMCDirectory(),'ST_s-channel_ext1',False,'nanoLatino_')
...
samples['VZ']  = {  'name'   :   getSampleFiles(makeMCDirectory(),'ZZTo2L2Nu_ext1',False,'nanoLatino_')
                               + getSampleFiles(makeMCDirectory(),'ZZTo2L2Q',False,'nanoLatino_')
                               + getSampleFiles(makeMCDirectory(),'ZZTo4L_ext1',False,'nanoLatino_')
...
#samples['ZH_hww']  = {  'name'   :   getSampleFiles(makeMCDirectory(),'HZJ_HToWW_M125',False,'nanoLatino_'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                     }

#samples['ggZH_hww']  = {  'name'   :   getSampleFiles(makeMCDirectory(),'GluGluZH_HToWWTo2L2Nu_M125',False,'nanoLatino_'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
#                     }
