...
if not MERGE:
  #No merging
  command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2018_WH_SS_HTXS_Stage1.root -t -1 --setParameters "
  poi =''
  ...
  #MERGE ALL BIN STXS
  command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2018_WH_SS_HTXS_Stage1_merged.root -t -1 --setParameters "
  poi = ''
  for sample in sampleNames:
