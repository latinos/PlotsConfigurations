...
eleWP_old = 'mva_90p_Iso2016'
muWP_old = 'cut_Tight80x'
...
#############################################
### Total SFs for charge flip             ###
#############################################

aliases['ttHMVA_SF_flip_2l'] = {'linesToAdd': ['.L %s/macros/flipper.cc+' % configurations],
                           'class': 'flipper',
                           'args' : ('2016', 2, 'total_SF'),
                           'samples': mc
                          }

aliases['ttHMVA_SF_err_flip_2l'] = {'linesToAdd': ['.L %s/macros/flipper.cc+' % configurations],
                           'class': 'flipper',
