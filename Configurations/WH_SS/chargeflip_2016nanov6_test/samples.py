...
samples['DY'] = {
    'name': files,
    'weight': mcCommonWeight + '*( !(Sum$(PhotonGen_isPrompt==1 && PhotonGen_pt>15 && abs(PhotonGen_eta)<2.6) > 0))*ttHMVA_SF_flip_2l',
    'FilesPerJob': 4,
}
...
samples['top'] = {
    'name': files,
    'weight': mcCommonWeight + "*ttHMVA_SF_flip_2l",
    'FilesPerJob': 1,
    #'EventsPerJob': 100000
}
...
samples['WW'] = {
    ...
    'weight': mcCommonWeight + '*nllW*ttHMVA_SF_flip_2l', # temporary - nllW module not run on PS and UE variation samples
