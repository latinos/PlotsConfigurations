...
samples['WZ']  = {    'name': ['eos/cms/store/caf/user/lenzip/ww2016/21Oct_25ns_MC/mcwghtcount__MC__l2sel__bPogSF__hadd/latino_WZTo3LNu.root'],
                      'weight' : 'baseW*puW',
                      'weights': ['1'] ,
                      'isData': ['0'],
                  }
...
samples['vbf']  = {    'name': ['eos/cms/store/caf/user/lenzip/ww2016/21Oct_25ns_MC/mcwghtcount__MC__l2sel__bPogSF__hadd/latino_VBFHToWWTo2L2Nu_M125.root'],
                     'weight' : 'baseW*puW',
                   'isData' : ['0']
