...
samples['TTV'] = {   'name'     : 
                     ...
                     + getSampleFiles(directory,'TTZToLLNuNu_M-10_ext2',False,'nanoLatino_'),
                     'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,  
                     'FilesPerJob' : 1 ,
                  }
...
# #### ggH -> MuMu (POWHEG, just for testing)
# samples['ggH_hmm_powheg']  = {  'name'  : 
#                                 getSampleFiles(directory,'GluGluHToMuMu_M125_powheg',False,'nanoLatino_') 
#                               + getSampleFiles(directory,'GluGluHToMuMu_M125_powheg_ext1',False,'nanoLatino_') 
#                               ,  
