...
# from high mass (fully leptonic) 2018 config
...
addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-100to200','(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-200to400','(gen_mll<10)*'+ptllDYW_LO)
...
addSampleWeight(samples,'top','ST_s-channel_ext1',    lepD_to_incD)
