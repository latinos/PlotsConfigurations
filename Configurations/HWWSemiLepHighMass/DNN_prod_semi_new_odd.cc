...
#ifndef DNNprodSemiNewOdd_HH
#define DNNprodSemiNewOdd_HH

//#include "NNEvaluation/DNNTensorflow/interface/DNNEvaluator.hh"
//using namespace NNEvaluation;

class DNNprodSemiNewOdd : public multidraw::TTreeFunction {
public:
  DNNprodSemiNewOdd(unsigned int var);

  char const* getName() const override { return "DNNprodSemiNewOdd"; }
  TTreeFunction* clone() const override { return new DNNprodSemiNewOdd(_var); }
...
DNNprodSemiNewOdd::DNNprodSemiNewOdd(unsigned int var) :
  TTreeFunction()
{
  _var = var;
...
double
DNNprodSemiNewOdd::evaluate(unsigned)
{
...
void
DNNprodSemiNewOdd::bindTree_(multidraw::FunctionLibrary& _library)
{
