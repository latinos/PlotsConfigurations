...
variables['mass_HIGGS_twojet_binned'] = {
   ...
   'range': ([0, 200, 250, 300, 350, 400, 450, 500, 550, 600,
              650, 700, 750, 800, 850, 900, 950, 1000, 1150, 1100, 1300, 1500, 3000],),
   'xaxis': 'Higgs Mass [GeV]',
   'fold' : 0,
   'cuts' : resolved, 
}
...
#   	'HvOverLEP_stud': 'HvOverLEP[0]',
#    	'CleanTau_21': 'CleanFatJet_tau21[0]',
#    	'CleanFatPt_stud': 'CleanFatJet_pt[0]',
#    	'FatPt_stud': 'FatJet_pt[0]',
#    	'CleanFatMass_stud': 'CleanFatJet_mass[0]',
#    	'FatMass_stud': 'FatJet_mass[0]',
#    	'Tau_21_decorrelated': 'tau21DDT[0]',
#    	'mass_HIGGS': 'mass_HIGGS_FAT[0]',
#    	'phi_WW': 'dPhi_WW_boosted[0]',
#	'FatJet_deepTag': 'FatJet_deepTag_WvsQCD[0]',
#	'FatJet_deepTag_taucut': 'Alt$(FatJet_deepTag_WvsQCD[CleanFatJet_jetIdx[HM_CleanFatJetPassMBoosted_CFatJetIdx[0]]], -1)',
#	'FatJet_deepTag_MD': 'FatJet_deepTagMD_WvsQCD[0]',
#	'FatJet_deepTag_taucut': 'Alt$(FatJet_deepTagMD_WvsQCD[CleanFatJet_jetIdx[HM_CleanFatJetPassMBoosted_CFatJetIdx[0]]], -1)',
#   }
#}
