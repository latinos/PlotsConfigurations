...
addSampleWeight(samples,'DY','DYJetsToLL_M-10to50_ext1',ptllDYW_NLO)
addSampleWeight(samples,'DY','DYJetsToLL_M-50_ext2'    ,ptllDYW_NLO)

addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-70to100'      ,'(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-100to200'     ,'(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-200to400'     ,'(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-400to600'     ,'(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-600toinf'     ,'(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-200to400_ext1','(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-400to600_ext1','(gen_mll<10)*'+ptllDYW_LO)
addSampleWeight(samples,'DY','DYJetsToLL_M-5to50_HT-600toinf_ext1','(gen_mll<10)*'+ptllDYW_LO)
...
addSampleWeight(samples,'top','TTTo2L2Nu_ext1'  ,'Top_pTrw')
addSampleWeight(samples,'top','TTTo2L2Nu_ext2'  ,'Top_pTrw')
...
files += nanoGetSampleFiles(mcDirectory, 'WZTo1L1Nu2Q')
