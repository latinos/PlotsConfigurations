...
#samples['qqWWqq'] = {
#    'name'   : files, 
#    'weight' : mcCommonWeightTagger + "*BtagSF_corr_nJets_qqWWqq*(mjjGen_max>150)*(GenLHE)", 
#    'FilesPerJob': 10
#}
...
####            ['WJetsToLNu_HT800_1200', 'WJetsToLNu_HT800_1200_ext1'])
###
addSampleWeight(samples,'Wjets_NLO','WJetsToLNu','(GenW_pt < 70)')
...
#samples['Vg'] = {
#    'name': files,
#    'weight': mcCommonWeight + '*(!(Gen_ZGstar_mass > 0))*BtagSF_corr_nJets_Vg',
#    'FilesPerJob': 8
#}
#
######## VgS ########
...
#samples['VgS'] = {
#    'name': files,
#    'weight': mcCommonWeight + ' * (gstarLow * 0.94 + gstarHigh * 1.14)*BtagSF_corr_nJets_Vg',
#    'FilesPerJob': 8,
#    'subsamples': {
#      'L': 'gstarLow',
#      'H': 'gstarHigh'
...
#samples['VZ'] = {
#    'name': files,
#    'weight': mcCommonWeight + '*1.11*BtagSF_corr_nJets_VZ',
#    'FilesPerJob': 15
#}
...
#samples['VVV'] = {
#    'name': files,
#    'weight': mcCommonWeight+'*BtagSF_corr_nJets_VVV',
#    'FilesPerJob': 15
#}
#
############## QCD ###########
...
#    'weight': mcCommonWeightTagger+'*BtagSF_corr_nJets_ggH_hww',
#    'FilesPerJob': 10,
#}
#
############## VBF H->WW ############
...
#    'weight': mcCommonWeightTagger+'*BtagSF_corr_nJets_qqH_hww',
#    'FilesPerJob': 10
#}
#
############### ZH H->WW ############
...
#    'weight': mcCommonWeightTagger+'*BtagSF_corr_nJets_ZH_hww',
#    'FilesPerJob': 10
#}
#
############# WH H->WW ############
...
#    'weight': mcCommonWeightTagger+'*BtagSF_corr_nJets_WH_hww',
#    'FilesPerJob': 10
#}
#
## ############ H->TauTau ############
...
#    'weight': mcCommonWeight+'*BtagSF_corr_nJets_ggH_htt',
#    'FilesPerJob': 10
#}
#
#samples['qqH_htt'] = {
#    'name': nanoGetSampleFiles(mcDirectory, 'VBFHToTauTau_M125'),
#    'weight': mcCommonWeight+'*BtagSF_corr_nJets_qqH_htt',
#    'FilesPerJob': 10
#}
#
#samples['ZH_htt'] = {
#   'name': nanoGetSampleFiles(mcDirectory, 'HZJ_HToTauTau_M125'),
#   'weight': mcCommonWeight+'*BtagSF_corr_nJets_ZH_htt',
#   'FilesPerJob': 10
#}
#
#samples['WH_htt'] = {
#   'name':  nanoGetSampleFiles(mcDirectory, 'HWplusJ_HToTauTau_M125') + nanoGetSampleFiles(mcDirectory, 'HWminusJ_HToTauTau_M125'),
#   'weight': mcCommonWeight+'*BtagSF_corr_nJets_WH_htt',
#   'FilesPerJob': 5
#}
#
#
...
#         'weight': mcCommonWeightTagger + '*(2*{0}*'+noSMxsec+'*(abs({0})<50) )'.format(model),
