...
void AddMSSMFullRun2Systematics(CombineHarvester & cb, bool highmass, bool DNNdiscrim, std::string model) {
  ...
  std::vector<std::string> backgrounds_semi_PS = {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "WW", "Wjets", "ggWW", "qqWWqq", "top"};//,"WWewk","VBF_V"}; // All backgrounds, but without Fakes
 ...
 // cb.cp().process(JoinStr({{"qqH_hww", "qqWWqq"}})).attr({"True"},"CR").AddSyst(cb, "QCDscale_qqH_ACCEPT", "lnN", SystMap<>::init(1.003));
  ...
  cb.cp().process(JoinStr({qqHSBI, {"qqWWqq"}})).AddSyst(cb, "pdf_qqbar", "shape", SystMap<>::init(1.00)); // TODO Add ggHSBI for Semilep
...
//      "CMS_rateparam_WW2J_"+y3+"_"+y2+"_"+y, "rateParam", SystMap<>::init(1.00));
  ...
  std::vector<std::string> LumiBkg_semi = {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "WW", "ggWW", "qqWWqq","VBF_V","WWewk"};
...
//    cb.cp().process({"Wjets"}).attr({y2},"whad").attr({y3},"categ").attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"False"},"CR").AddSyst(cb,
//      "CMS_hww_Wjets_Correction_"+y2fullname+"_201"+y, "shape", SystMap<>::init(1.00));
//}
//}
//for(auto y2 : std::vector<std::string> {"resolved"}){
//  for(auto y3 : std::vector<std::string> {"isGGH", "isVBF", "isBKG"}){
//  std::string y2fullname = y2=="resolved"?"incl_ResolvedSR_"+y3+"_":"incl_BoostedSR_"+y3+"_";
//  //if (highmass && y2=="boosted") y2fullname=y2fullname+"H";
//    cb.cp().process({"Wjets"}).attr({y2},"whad").attr({y3},"categ").attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"False"},"CR").AddSyst(cb,
//      "CMS_hww_Wjets_Correction_"+y2fullname+"_201"+y, "shape", SystMap<>::init(1.00));
//}
//}
////  cb.cp().process({"Wjets"}).bin_id({11}).attr({"semilep"},"analysis").attr({"resolved"},"whad").AddSyst(cb, "CMS_hww_Wjets_Correction_incl_ResolvedSB_201", "lnN", SystMap<>::init(1.009));

    cb.cp().process(JoinStr({signal,{"WWewk","VBF_V","WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,"CMS_wtag_eff_201"+y, "shape", SystMap<>::init(1.00));
    ...
    for(auto j : std::vector<std::string> {"1", "2", "3"}){//, "4", "5"}){
      cb.cp().process(JoinStr({signal, {"WWewk","VBF_V","WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
...
//
 ...
 // }
  ...
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_eff_e_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({{"WWewk","VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV",  "VZ", "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_eff_m_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({signal, {"WWewk","VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "WW", "qqWWqq", "VZ", "Vg", "VgS_H", "VgS_L", "ggWW", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  // Jets - Split up
  // -----------------------
  cb.cp().process(JoinStr({{"VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"semilep"},"analysis").AddSyst(cb,
  ...
  for(auto y : runyears){
    cb.cp().process(JoinStr({{"VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_scale_JESAbsolute_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({{"VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_scale_JESBBEC1_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({{"VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  // JER
  // -----------------------
  cb.cp().process(JoinStr({{"VBF_V","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "Vg", "VgS_H",  "VgS_L", "Wjets","top"}})).attr({"2k17"},"year").attr({"semilep"},"analysis").AddSyst(cb,
    "CMS_res_j_2017", "shape", SystMap<>::init(1.00));
  ...
  // -----------------------
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, {"VBF_V","WWewk","WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"WW", "ggWW","qqWWqq","DY", "VVV",  "Vg", "VgS_H", "VgS_L", "Wjets", "top"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  for(auto y : runyears){
    ...
    //cb.cp().process({"FAKE_el"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_syst_El_201"+y, "lnN", SystMap<>::init(1.30));
    //cb.cp().process({"FAKE_mu"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_syst_Mu_201"+y, "lnN", SystMap<>::init(1.30));

    //cb.cp().process({"FAKE_el"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_e_stat_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process({"FAKE_el"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_e_recoil_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process({"FAKE_mu"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_m_stat_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process({"FAKE_mu"}).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
    //  "CMS_fake_m_recoil_201"+y, "shape", SystMap<>::init(1.00));
  }
  ...
  cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi_PS})).attr({"semilep"},"analysis").AddSyst(cb,
    "PS_ISR", "shape", SystMap<>::init(1.00));
  //cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi})).attr({"semilep"},"analysis").AddSyst(cb,
  //  "PS_FSR", "shape", SystMap<>::init(1.00));
