...
resolvedSR  = set(x for x in cuts if 'ResolvedSR_all' in x)
...
##variables['mass_HIGGS_twojet_fit'] = {
##   'name' : 'mass_HIGGS_JJ[0]',
##   'range': ([0, 150, 200, 260, 300, 350, 400, 450, 500, 550, 600,
##              650, 700, 750, 800, 850, 900, 950, 1000, 1100, 1300, 1500, 3000, 5000],),
##   'xaxis': 'Higgs Mass [GeV]',
##   'fold' : 0,
##   'cuts' : resolved, 
##}
