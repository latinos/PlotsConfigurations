...
#        'isSignal': 2,
#        'color'   : counter+1,
#        'samples' : ['GGH_{}_RelW002'.format(MX), 'QQH_{}_RelW002'.format(MX)],#'GGHSBI_{}_RelW03'.format(MX), 'QQHSBI_{}_RelW03'.format(MX)] #'GGHINT_{}_RelW002'.format(MX), 'QQH_{}_RelW002'.format(MX),'QQHINT_{}_RelW002'.format(MX), 'QQHSBI_{}_RelW002'.format(MX), 'GGHSBI_{}_RelW002'.format(MX)]
#    }

#for counter, MX in enumerate(plotmasses):
#    groupPlot['Higgs_ggh{}'.format(MX)] = {
...
#        'scale'   : xs_ggf
#    }
#   # plot['GGHINT_{}_RelW03'.format(MX)] = {
#   #     'nameHR'  : 'ggH{}'.format(MX),
#   #     'color'   : 1,
#   #     'isSignal': 1,
#   #     'isData'  : 0,
...
#   # }
#
##    plot['GGHSBI_{}_RelW03'.format(MX)] = {
##        'nameHR'  : 'ggH{}'.format(MX),
##        'color'   : 1,
##        'isSignal': 1,
##        'isData'  : 0,
