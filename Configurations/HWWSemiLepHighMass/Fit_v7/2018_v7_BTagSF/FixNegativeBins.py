...
signameFormat5 = "histo_(top|qqWWqq|WW|ggH_hww|qqH_hww|ZH_hww|WH_hww|ggWW)_Top_massVsTagger_reweighting_bin_([0-9]+)_([0-9]+)(Up|Down)"
...
signameFormatTAP = "histo_(top|qqWWqq|WW|ggH_hww|qqH_hww|ZH_hww|WH_hww|ggWW|Wjets|DY|Vg|VgS_L|VgS_H|VZ|VVV|ggH_htt|qqH_htt|WH_htt|ZH_htt)_TagAndProbe_corr(Up|Down)"
...
newfile2 = ROOT.TFile(rootfile.replace(".root", "_Updated_conf_TEST.root"), 'recreate')
