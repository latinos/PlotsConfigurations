...
for counter, MX in enumerate(plotmasses):
    groupPlot['Higgs_ggh{}'.format(MX)] = {
        ...
        'isSignal': 2,
        'color'   : counter+1,
        'samples' : ['ggH_HWW', 'qqH_HWW'] #'GGHINT_{}_RelW002'.format(MX), 'QQH_{}_RelW002'.format(MX),'QQHINT_{}_RelW002'.format(MX), 'QQHSBI_{}_RelW002'.format(MX), 'GGHSBI_{}_RelW002'.format(MX)]
    }
...
#    }
    ...
    plot['ggH_HWWSBI'.format(MX)] = {
        'nameHR'  : 'ggH_SBI{}'.format(MX),
        'color'   : 1,
        'isSignal': 1,
        'isData'  : 0,
        'scale'   : xs_ggf
