...
try:
    ...
    sig_mc = [skey for skey in mc if ("GGH" in skey) or (skey in ["qqWWqq","WW","VZ"]) or ("QQH" in skey)] # ggWW is currently reweighted sig sample, while qqWWqq needs to be symlinked to the BWReweight!
