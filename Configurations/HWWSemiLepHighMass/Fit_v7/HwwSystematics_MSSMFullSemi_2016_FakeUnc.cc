...
void AddMSSMFullRun2Systematics(CombineHarvester & cb, bool highmass, bool DNNdiscrim, std::string model) {
  ...
  std::vector<std::string> backgrounds_semi = {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "WW", "Wjets", "ggWW", "qqWWqq", "top","VBF_V","WWewk"}; // All backgrounds, but without Fakes

  std::vector<std::string> backgrounds_semi_PS = {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "WW", "Wjets", "ggWW", "qqWWqq", "top"}; // All backgrounds, but without Fakes
  ...
  cb.cp().process(JoinStr({ggH,{"ggH_hww"}})).AddSyst(cb, "pdf_Higgs_gg_ACCEPT", "shape", SystMap<>::init(1.00));
  ...
  cb.cp().process(JoinStr({qqH, {"qqH_hww"}})).AddSyst(cb, "pdf_Higgs_qqbar_ACCEPT", "shape", SystMap<>::init(1.00));
...
//}
    ...
    cb.cp().process(JoinStr({signal,{"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww","VBF_V","WWewk"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    ...
    // Old uncertainties, not needed anymore: 
    //cb.cp().process(JoinStr({signal, {"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    //  "CMS_var_top_deep_0_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process(JoinStr({signal, {"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    //  "CMS_var_top_deep_1_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process(JoinStr({signal, {"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    //  "CMS_var_top_deep_2_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process(JoinStr({signal, {"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    //  "CMS_var_top_deep_3_201"+y, "shape", SystMap<>::init(1.00));
    //cb.cp().process(JoinStr({signal, {"WW", "ggWW", "qqWWqq", "top", "WH_hww", "ZH_hww", "ggH_hww", "qqH_hww"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").attr({"boosted"},"whad").AddSyst(cb,
    //  "CMS_Fat_rewei_unc_201"+y, "shape", SystMap<>::init(1.00));
  ...
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_eff_e_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({signal, {"WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "WW", "ggWW", "qqWWqq", "Wjets", "top","VBF_V","WWewk"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, SM_procs_semi, backgrounds_semi})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
      "CMS_eff_m_201"+y, "shape", SystMap<>::init(1.00));
    cb.cp().process(JoinStr({{"WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV", "VZ", "Vg", "VgS_H", "VgS_L", "Wjets", "top","VBF_V"}})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
  ...
  // -----------------------
  for(auto y : runyears){
    cb.cp().process(JoinStr({signal, {"WH_htt", "WH_hww", "ZH_htt", "ZH_hww", "ggH_htt", "qqH_htt"}, {"DY", "VVV",  "Vg", "VgS_H", "VgS_L", "Wjets", "top", "qqWWqq", "WW", "ggWW","VBF_V","WWewk" }})).attr({"2k1"+y},"year").attr({"semilep"},"analysis").AddSyst(cb,
