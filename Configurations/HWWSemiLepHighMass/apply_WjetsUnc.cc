...
#ifndef apply_WjetsUnc_HH
#define apply_WjetsUnc_HH

class apply_WjetsUnc : public multidraw::TTreeFunction {
public:
  //apply_WjetsUnc(string file, string ele_WP, string mu_WP, string fr_ele_path, string pr_ele_path, string fr_mu_path, string pr_mu_path);
  apply_WjetsUnc(TString file_name, TString file_name_boo);

  char const* getName() const override { 
      return "apply_WjetsUnc"; 
  }
  TTreeFunction* clone() const override { 
      //return new apply_WjetsUnc(inputfile_path, ele_WP, mu_WP, fr_ele_path, pr_ele_path, fr_mu_path, pr_mu_path); 
      return new apply_WjetsUnc(n_file, n_file_boo); 
  }
...
//apply_WjetsUnc::apply_WjetsUnc(string in_file, string ele_WP, string mu_WP, string in_fr_ele_path, string in_pr_ele_path, string in_fr_mu_path, string in_pr_mu_path) :
apply_WjetsUnc::apply_WjetsUnc(TString file_name, TString file_name_boo) :
    n_file(file_name),
...
double
apply_WjetsUnc::evaluate(unsigned)
{
...
void
apply_WjetsUnc::bindTree_(multidraw::FunctionLibrary& _library)
{   
