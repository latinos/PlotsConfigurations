...
#                        'fold'  : 3
#                        }
#variables['LHE_HT_low']  = {
#                        'name': 'LHE_HT',
#                        'range' : (100,0,100),
#                        'xaxis' : 'LHE HT [GeV]',
#                        'fold'  : 3
#                        }
#variables['LHE_HT_med']  = {
#                        'name': 'LHE_HT',
#                        'range' : (100,0,200),
#                        'xaxis' : 'LHE HT [GeV]',
#                        'fold'  : 3
#                        }
#variables['LHE_HT_high']  = {
#                        'name': 'LHE_HT',
#                        'range' : (50,0,800),
#                        'xaxis' : 'LHE HT [GeV]',
#                        'fold'  : 3
...
genW_pt_bin = [0, 10] + range(10, 200, 10) + range(200, 400, 25) + range(400, 900, 100) + range(900, 1500, 300)
variables['genW_pt2_true']  = {
    'name': 'genW_pt',     
    'range' : (genW_pt_bin,),   
    'xaxis' : 'gen W p_T',
...
genW_pt_bin = [0, 20] + range(20, 200, 20) + range(200, 400, 40) + range(400, 900, 100) + range(900, 1500, 300)
variables['genW_pt2_large']  = {
    'name': 'genW_pt',     
    'range' : (genW_pt_bin,),   
    'xaxis' : 'gen W p_T',
    'fold'  : 3                         
