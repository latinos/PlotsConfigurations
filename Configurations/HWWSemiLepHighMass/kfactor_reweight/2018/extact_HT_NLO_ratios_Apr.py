...
for year in run2:
    year_dict[year] = {}
    year_dict[year]['r_file'] = ROOT.TFile('Wjets_kfac_root_nano_stud_Mar/plots_Wjets_kfac_'+year+'v7_nano_stud_2.root')
...
# Store
file_name = 'HT_to_NLO_QCD_k_factors_boo_2018.root'
