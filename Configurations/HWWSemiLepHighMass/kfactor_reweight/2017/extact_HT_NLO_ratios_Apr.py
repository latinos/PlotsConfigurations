...
for year in run2:
    year_dict[year] = {}
    year_dict[year]['r_file'] = ROOT.TFile('Wjets_kfac_nano_root_Mar_2/plots_Wjets_kfac_'+year+'v7_nano_stud.root')
...
# Store
file_name = 'HT_to_NLO_QCD_k_factors_n_stud_boo_re.root'
