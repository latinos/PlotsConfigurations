...
for year in run2:
    year_dict[year] = {}
    if( year == '2017'):year_dict[year]['r_file'] = ROOT.TFile('Wjets_kfac_nano_root_Mar_2/plots_Wjets_kfac_'+year+'v7_nano_Test.root')
    else: year_dict[year]['r_file'] = ROOT.TFile('../2018/Wjets_kfac_root_nano_stud_Mag/plots_Wjets_kfac_2018v7_nano_Test.root')
    ...
    print(year_dict[year]['ratio'].GetBinContent(10))
...
for year in run2:
    if (year == '2017'): 
    	year_dict[year]['LO'].Add(year_dict['2018']['LO'],1)
   	year_dict[year]['NLO'].Add(year_dict['2018']['NLO'],1)
   	year_dict[year]['ratio'].Add(year_dict['2018']['ratio'],1)
    	print(year_dict[year]['ratio'].GetBinContent(10))
...
for year in run2:
   ...
   # year_dict[year]['ratio_ns'].SetLineColor(col_idx)
    ...
    if first:
        ...
        year_dict[year]['ratio_s'].GetYaxis().SetRangeUser(0.0, 1.8)
