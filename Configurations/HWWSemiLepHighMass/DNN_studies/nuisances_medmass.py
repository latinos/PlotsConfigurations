...
cutdict = {
    ...
    'resTOP_01J'   : 'incl_ResolvedTopCR_01jets', #set(x for x in cuts if 'ResolvedTopCR' in x),
    'booTOP_01J'   : 'incl_BoostedTopCR_01jets',  #set(x for x in cuts if 'BoostedTopCR' in x),
    'resSR_01J'   : 'incl_ResolvedSR_01jets',     #set(x for x in cuts if 'ResolvedSR' in x),
    'resSB_01J'   : 'incl_ResolvedSB_01jets',     #set(x for x in cuts if 'ResolvedSB' in x),
    'booSR_01J'   : 'incl_BoostedSR_01jets',      #set(x for x in cuts if 'BoostedSR' in x),
    'booSB_01J'   : 'incl_BoostedSB_01jets',      #set(x for x in cuts if 'BoostedSB' in x),
...
#        'kind': 'weight',
#        'type': 'shape',
#        'samples': dict((skey, ['DeepAK8_SF_up/DeepAK8_SF', 'DeepAK8_SF_down/DeepAK8_SF']) for skey in mc),
#        'cuts'  : [
#                cutdict['resTOP'],
#                cutdict['booTOP'],
#                cutdict['resSB'],
