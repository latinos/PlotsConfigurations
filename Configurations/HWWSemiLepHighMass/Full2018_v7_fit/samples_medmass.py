...
massesAndModelsFile = "{}/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/Full2018_v7_fit/massesAndModels.py".format(os.getenv("CMSSW_BASE"))
...
#addSampleWeight(samples,'ggWW','GluGluHToWWToLNuQQ_M126', "{0} * ({0} < 50)".format(model_B))
