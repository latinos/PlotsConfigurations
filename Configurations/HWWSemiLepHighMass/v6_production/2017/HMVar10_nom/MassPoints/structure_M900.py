...
#ggHWWlnuqq_M900_S_B_I
structure['ggHWWlnuqq_M900'] = {
    'isSignal' : 1,
    'isData'   : 0
}


structure['vbfHWWlnuqq_M900'] = {
    'isSignal' : 1,
    'isData'   : 0
}
...
#ggHWWlnuqq_M900_S_B_I
structure['ggHWWlnuqq_M900_S_B_I'] = {
    'isSignal' : 0,
    'isData'   : 0
}

structure['ggHWWlnuqq_M900_S'] = {
    'isSignal' : 1,
    'isData'   : 0
}

#ggHWWlnuqq_M900_S_B_I
structure['VBFHToWWToLNuQQ_M900_S_B_I'] = {
    'isSignal' : 0,
    'isData'   : 0
}

structure['VBFHToWWToLNuQQ_M900_S'] = {
    'isSignal' : 1,
    'isData'   : 0
}
