...
samples['ggHWWlnuqq_M500'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M500',False,'nanoLatino_'),
...
samples['vbfHWWlnuqq_M500'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M500',False,'nanoLatino_'),
                                                 'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC,
                                                 'FilesPerJob' : 10,
                                               }
