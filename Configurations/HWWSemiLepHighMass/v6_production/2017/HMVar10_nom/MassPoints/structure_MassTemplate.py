...
#ggHWWlnuqq_M__THIS_MASS___S_B_I
structure['ggHWWlnuqq_M__THIS_MASS__'] = {
    'isSignal' : 1,
    'isData'   : 0
}


structure['vbfHWWlnuqq_M__THIS_MASS__'] = {
    'isSignal' : 1,
    'isData'   : 0
}
...
#ggHWWlnuqq_M__THIS_MASS___S_B_I
structure['ggHWWlnuqq_M__THIS_MASS___S_B_I'] = {
    'isSignal' : 0,
    'isData'   : 0
}

structure['ggHWWlnuqq_M__THIS_MASS___S'] = {
    'isSignal' : 1,
    'isData'   : 0
}

#ggHWWlnuqq_M__THIS_MASS___S_B_I
structure['VBFHToWWToLNuQQ_M__THIS_MASS___S_B_I'] = {
    'isSignal' : 0,
    'isData'   : 0
}

structure['VBFHToWWToLNuQQ_M__THIS_MASS___S'] = {
    'isSignal' : 1,
    'isData'   : 0
}
