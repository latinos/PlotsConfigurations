...
mc = [skey for skey in samples if skey not in ('FAKE', 'DATA', 'FAKE_old')]
...
FR_dir = os.getenv('CMSSW_BASE') + "/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/FAKE_RW/FR/2016/"
