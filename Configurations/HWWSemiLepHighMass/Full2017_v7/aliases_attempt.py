...
aliases['boostedSignalWMass'] = {
    'expr': '(65 < Alt$(FatJet_mass[0], 0) \
            && Alt$(FatJet_mass[0], 999) < 105)'
}
...
aliases['mass_HIGGS_real'] = {
    'linesToAdd':['.L %s/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/getResBoo.cc+'  % os.getenv('CMSSW_BASE')],
    'class': 'getResBoo',
    'args': 5
}
aliases['HvOverFat_real'] = {
    'linesToAdd':['.L %s/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/getResBoo.cc+'  % os.getenv('CMSSW_BASE')],
    'class': 'getResBoo',
    'args': 6
}
#aliases['non_overlapping'] ={
#    'expr': 'nCleanJet - nCleanJetOverlap*Alt$(nCleanJetOverlap > 0, 0)',
#}
...
#bJetV_req_boo = '(boosted_nocut_res[0]  && CleanJet_pt[CleanJet_notOverlapping] > 20 && abs(CleanJet_eta[CleanJet_notOverlapping]) < 2.5  && isJetBoo[0])'
#bJetR_req_boo = '(boosted_nocut_res[0]  && CleanJet_pt[CleanJetNotFat_jetIdx] > 30 && abs(CleanJet_eta[CleanJetNotFat_jetIdx]) < 2.5 && isJetBoo[0])'
...
#aliases['deltaR'] = {
#    'expr' : 'TMath::Sqrt((Alt$(FatJet_phi[FatJet_idx_clean[0]],0) -Alt$(GenJetAK8_phi[FatJet_idx_clean[0]], 0) )*(Alt$(FatJet_phi[FatJet_idx_clean[0]],0) - Alt$(GenJetAK8_phi[FatJet_idx_clean[0]],0)) + (Alt$(GenJetAK8_eta[FatJet_idx_clean[0]],0) - Alt$(FatJet_eta[FatJet_idx_clean[0]],0))*(Alt$(GenJetAK8_eta[FatJet_idx_clean[0]],0) - Alt$(FatJet_eta[FatJet_idx_clean[0]],0))) ',
#    'samples': mc_deep
#}
#
#aliases['deltaR_ov'] = {
...
#    'samples':mc_deep,#['top',]
#}
corr_file = os.getenv('CMSSW_BASE') + "/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/corr_weights/"+ "puppiCorr_2017.root"
nom_hist = "puppiJECcorr_gen"
down_hist = "puppiJECcorr_reco_0eta1v3"
up_hist = "puppiJECcorr_reco_1v3eta2v5"


aliases['Fat_reweight'] = {# New Top PAG
    'linesToAdd': [
        'gSystem->AddIncludePath("-I%s/src");' % os.getenv('CMSSW_RELEASE_BASE'),
        '.L %s/src/PlotsConfigurations/Configurations/HWWSemiLepHighMass/Soft_Corr.cc+' % os.getenv('CMSSW_BASE')
    ],  
    'class': 'Softdrop_corr',
    'args': ('PlotsConfigurations/Configurations/HWWSemiLepHighMass/corr_weights/puppiCorr.root'), # nom_hist, down_hist,up_hist),
}
#aliases['Fat_apply'] = {# New Top PAG
#    'expr': '(Fat_reweight[0]*Alt$(CleanFatJet_mass[0], 0))',
#}
#aliases['Fat_gen'] = {# New Top PAG
#    'expr': '(Fat_reweight[0]*Alt$(GenJetAK8_mass[0], 0))',
#    'samples':mc,#['top']
#}
#aliases['Fat_rewei'] = {# New Top PAG
#    'expr': '(1 * !boosted_nocut_res[0] + (boosted_nocut_res[0]*(-1.58891 + 0.0290681*CleanFatJet_mass[0])))',
#    'samples':mc_deep,#['top']
#}
aliases['Fat_rewei'] = {# New Top PAG
