...
##=== Define categories ===###
LepCats={}
LepCats['incl_']='( (abs(Lepton_pdgId[0])==11) && Lepton_pt[0]>38 || (abs(Lepton_pdgId[0])==13) && Lepton_pt[0]>30)'
...
BoostCats['BoostedSR_']='(1 \
                       ...
                       && boostedSignalWMass[0] \
                       && bVeto_boo[0])'
##BoostCats['BoostedSB_R']='(1 \
##                       && boosted_nocut_res[0] \
##                       && HvOverFat_real[0] < 0.35 \
##                       && boostedSignalWMass[0] \
##                       && bVeto_boo[0])'
##BoostCats['BoostedTopCR_R']='(1 \
##                       && boosted_nocut_res[0] \
##                       && HvOverFat_real[0] > 0.4 \
##                       && boostedSignalWMass[0] \
##                       && bReq_boo[0])'
