...
#include <iostream>
#include <TMath.h>
#include "weights_dnn/generated_code_Boosted_High_even_alpha_Class.h"
#include "weights_dnn/generated_code_Boosted_odd_alpha_High_Class.h"
...
DNNprodSemiNewHigh::bindTree_(multidraw::FunctionLibrary& _library)
{
 ...
 // _library.bindBranch(HM_nCleanFatJetPassMBoosted,     "HM_idxWfat_noTau21Cut");
  ...
  _library.bindBranch(HM_CleanFatJetPassMBoosted_mass, "FatJet_mass");
