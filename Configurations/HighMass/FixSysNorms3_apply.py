...
with open('FixSysNorms_Factors3.json') as f:
  scaleby = json.load(f)
print scaleby

DecorrelateTheseFS = [] # List of nuisances to decorrelate by FS
ButNot = [] # Avoid changing these by accident
DecorrelateTheseCateg = [] # List of nuisances to decorrelate by category
...
for roo in rootdict:
  ...
  newfile2 = ROOT.TFile(rootdict[roo].replace(".root", "_new5.root"), 'recreate')
