...
directoryDY = treeBaseDir+'Fall2017_102X_nAODv7_Full2017v7/MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7__recoilDY'
directoryHM = treeBaseDir+'Fall2017_102X_nAODv7_Full2017v7/MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7__BWReweight'
...
def CombineBaseW(samples, proc, samplelist):
  newbaseW = getBaseWnAOD(directory, 'Fall2017_102X_nAODv7_Full2017v7', samplelist)
  for s in samplelist:
...
if useEmbeddedDY:
  ...
  for Run in DataRun :
          directoryEmb = '/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Embedding2017_102X_nAODv7_Full2017v7/DATAl1loose2017v7__l2loose__l2tightOR2017v7__Embedding'
  ...
  samples['DYveto']  = {   'name': getSampleFiles(directory,'TTTo2L2Nu',False,'nanoLatino_')
                                 ...
                                 + getSampleFiles(directory,'EWKZ2Jets_ZToLL_M-50_newpmx',False,'nanoLatino_'),
  ...
  veto_dict = {'TTTo2L2Nu'               : '(topGenPt * antitopGenPt > 0.) * (TMath::Sqrt((0.103*TMath::Exp(-0.0118*topGenPt) - 0.000134*topGenPt + 0.973) * (0.103*TMath::Exp(-0.0118*antitopGenPt) - 0.000134*antitopGenPt + 0.973))) + (topGenPt * antitopGenPt <= 0.)' ,
               ...
               'ZZTo4L_ext2'    : '1.11' ,
               'WZTo2L2Q'       : '1.11' ,
               'EWKZ2Jets_ZToLL_M-50_newpmx' : '(lhe_mjj[0] > 120)'
              }
...
if useDYtt :
  ...
  samples['DY'] = {    'name'   :   getSampleFiles(directoryDY,'DYJetsToLL_M-50',True,'nanoLatino_') # LO_ext1 is DYMVA Training!
                                  + getSampleFiles(directoryDY,'DYJetsToLL_M-50_ext1',True,'nanoLatino_')
                                  + getSampleFiles(directoryDY,'DYJetsToLL_M-10to50-LO_ext1',True,'nanoLatino_'), # LO_ext1 is DYMVA Training!
  ...
  if useDYHT:
    samples['DY']['name'] += getSampleFiles(directoryDY,'DYJetsToLL_M-50_HT-70to100',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-50_HT-100to200_newpmx',True,'nanoLatino_') \
                           ...
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-50_HT-400to600_newpmx',True,'nanoLatino_') \
                           ...
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-100to200_newpmx',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-100to200_ext1',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-200to400_newpmx',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-400to600',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-400to600_ext1',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-600toInf',True,'nanoLatino_') \
                           + getSampleFiles(directoryDY,'DYJetsToLL_M-4to50_HT-600toInf_ext1',True,'nanoLatino_')
    CombineBaseW(samples, 'DY', ['DYJetsToLL_M-50_HT-100to200_newpmx', 'DYJetsToLL_M-50_HT-100to200_ext1'])
    CombineBaseW(samples, 'DY', ['DYJetsToLL_M-50_HT-200to400', 'DYJetsToLL_M-50_HT-200to400_ext1'])
    CombineBaseW(samples, 'DY', ['DYJetsToLL_M-50_HT-400to600_newpmx', 'DYJetsToLL_M-50_HT-400to600_ext1'])
    CombineBaseW(samples, 'DY', ['DYJetsToLL_M-4to50_HT-100to200_newpmx', 'DYJetsToLL_M-4to50_HT-100to200_ext1'])
    ...
    addSampleWeight(samples,'DY','DYJetsToLL_M-50_HT-200to400_ext1',     '0.999')
    addSampleWeight(samples,'DY','DYJetsToLL_M-50_HT-400to600_newpmx',   '0.990')
    addSampleWeight(samples,'DY','DYJetsToLL_M-50_HT-400to600_ext1',     '0.990')
  ...
  addSampleWeight(samples,'DY','DYJetsToLL_M-50_ext1','DY_NLO_pTllrw')
  addSampleWeight(samples,'DY','DYJetsToLL_M-10to50-LO_ext1','DY_LO_pTllrw')
  addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-100to200_newpmx','DY_LO_pTllrw') # HT-binned are LO!
  addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-100to200_ext1',  'DY_LO_pTllrw')
  addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-200to400_newpmx','DY_LO_pTllrw')
  addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-400to600',       'DY_LO_pTllrw')
  addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-400to600_ext1',  'DY_LO_pTllrw')
...
samples['Zjj']  = {  'name'   :   getSampleFiles(directory,'EWKZ2Jets_ZToLL_M-50_newpmx',False,'nanoLatino_'),
  ...
  for mass in massggh:
    ...
    if INToverSBI:
      ...
      samples['GGHSBI_'+mass+model_name]  = {  'name'   :   getSampleFiles(directoryHM,'GluGluHToWWTo2L2Nu_M'+mass,True,'nanoLatino_')
                                                      ...
                                                      + getSampleFiles(directory,'GluGluToWWToTNMN',False,'nanoLatino_')
                                                      + getSampleFiles(directory,'GluGluToWWToTNTN',False,'nanoLatino_')
                                                      + getSampleFiles(directory,'GluGluHToWWTo2L2Nu_Powheg_M125',False,'nanoLatino_'),
                        'weight' : TotalMC ,
                        'FilesPerJob' : 10,
                        'EventsPerJob' : 250000,
                        'suppressNegative' :['all'],
      ...
      addSampleWeight(samples, 'GGHSBI_'+mass+model_name, 'GluGluHToWWTo2L2Nu_Powheg_M125', 'MINLO')
...
samples['ggH_hww']  = {  'name'   :   getSampleFiles(directory,'GluGluHToWWTo2L2Nu_Powheg_M125',False,'nanoLatino_'),
                        'weight' : TotalMC,
                        'FilesPerJob' : 10,
                        'EventsPerJob' : 500000,
                        'suppressNegative' :['all'],
...
addSampleWeight(samples, 'ggH_hww', 'GluGluHToWWTo2L2Nu_Powheg_M125', 'MINLO')
...
samples['ggH_htt']  = {  'name'   : getSampleFiles(directory,'GluGluHToTauTau_M125',False,'nanoLatino_')
                                  + getSampleFiles(directory,'GluGluHToTauTau_M125_ext1',False,'nanoLatino_'),
                         'weight' : TotalMC ,
                         'suppressNegative' :['all'],
                         'suppressNegativeNuisances' :['all'],
                      }
CombineBaseW(samples, 'ggH_htt', ['GluGluHToTauTau_M125', 'GluGluHToTauTau_M125_ext1'])
