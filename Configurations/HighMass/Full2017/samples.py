...
directoryHM = treeBaseDirHM+'Fall2017_102X_nAODv4_Full2017v4/MCl1loose2017__MCCorr2017__l2loose__l2tightOR2017v4__HighMass__hadd/'
...
if useEmbeddedDY:
  ...
  for Run in DataRun :
          directoryEmb = '/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Embedding2017_102X_nAODv4_Full2017v5/DATAl1loose2017v5__l2loose__l2tightOR2017v5__Embedding2017__hadd/'
  ...
  veto_dict = {'TTTo2L2Nu'     : '(TMath::Sqrt( TMath::Exp(0.0615-0.0005*topGenPt) * TMath::Exp(0.0615-0.0005*antitopGenPt) ) )' ,
               ...
               'ZGToLLG'           : '((!(Gen_ZGstar_mass > 0 && Gen_ZGstar_MomId == 22 )) || (Gen_ZGstar_mass >0))' ,
