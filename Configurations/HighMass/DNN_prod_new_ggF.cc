...
class DNNprod_new_ggF : public multidraw::TTreeFunction {
public:
  DNNprod_new_ggF();

  char const* getName() const override { return "DNNprod_new_ggF"; }
  TTreeFunction* clone() const override { return new DNNprod_new_ggF(); }
...
DNNprod_new_ggF::DNNprod_new_ggF() :
  TTreeFunction()
{
  std::string cmsswbase(gSystem->Getenv("CMSSW_BASE"));
  dnn_tensorflow0 = new DNNEvaluator(cmsswbase + "/src/PlotsConfigurations/Configurations/HighMass/DNNs/ProdNew_0/", false, 0);
  dnn_tensorflow1 = new DNNEvaluator(cmsswbase + "/src/PlotsConfigurations/Configurations/HighMass/DNNs/ProdNew_1/", false, 0);
}

double
DNNprod_new_ggF::evaluate(unsigned)
{
...
void
DNNprod_new_ggF::bindTree_(multidraw::FunctionLibrary& _library)
{
