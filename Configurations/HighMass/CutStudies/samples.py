...
if    'iihe' in SITE :
  ...
  treeBaseDir2 = '/eos/cms/store/cmst3/group/hww/HWWNano/'
...
if useEmbeddedDY: #Setup
  ...
  directory2 = treeBaseDir2+'Fall2017_nAOD_v1_Full2017v2/MCl1loose2017v2__MCCorr2017__btagPerEvent__l2loose__l2tightOR2017__EmbeddingVeto'+skim
...
mjjGen='mjjGen(Alt$(GenJet_pt[Jet_genJetIdx[CleanJet_jetIdx[0]]],-1), Alt$(GenJet_eta[Jet_genJetIdx[CleanJet_jetIdx[0]]],-1), Alt$(GenJet_phi[Jet_genJetIdx[CleanJet_jetIdx[0]]],-1), Alt$(GenJet_pt[Jet_genJetIdx[CleanJet_jetIdx[1]]],-1), Alt$(GenJet_eta[Jet_genJetIdx[CleanJet_jetIdx[1]]],-1), Alt$(GenJet_phi[Jet_genJetIdx[CleanJet_jetIdx[1]]],-1))'
