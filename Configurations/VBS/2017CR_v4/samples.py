...
DataTrig = {
            ...
            'SingleMuon'     : '!Trigger_ElMu && !Trigger_dblMu &&  Trigger_sngEl' ,
            'DoubleEG'       : '!Trigger_ElMu && !Trigger_dblMu && !Trigger_sngEl &&  Trigger_dblEl' ,
            'SingleElectron' : '!Trigger_ElMu && !Trigger_dblMu && !Trigger_sngEl && !Trigger_dblEl &&  Trigger_sngEl' ,
           }
'''
DataTrig = {
            'MuonEG'         : 'Trigger_ElMu' ,
