...
Repeat, but with data-blind signal region. Put to 1 the 'isBlind' flag in plot.py and:
    ...
    mkPlot.py --onlyCut=hww2l2v_13TeV_2j_2j_mjjGT700_pthLT200_ee --inputFile=rootFile/plots_STXS_qqH_SF_2016_DYEstimDATA.root --linearOnly --fileFormats=png --onlyPlot=cratio
    mkPlot.py --onlyCut=hww2l2v_13TeV_2j_2j_mjjGT350_pthGT200_ee --inputFile=rootFile/plots_STXS_qqH_SF_2016_DYEstimDATA.root --linearOnly --fileFormats=png --onlyPlot=cratio
    ...
    mkPlot.py --onlyCut=hww2l2v_13TeV_2j_2j_mjjGT700_pthLT200_mm --inputFile=rootFile/plots_STXS_qqH_SF_2016_DYEstimDATA.root --linearOnly --fileFormats=png --onlyPlot=cratio
    mkPlot.py --onlyCut=hww2l2v_13TeV_2j_2j_mjjGT350_pthGT200_mm --inputFile=rootFile/plots_STXS_qqH_SF_2016_DYEstimDATA.root --linearOnly --fileFormats=png --onlyPlot=cratio
