...
#No merging
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2016_SF_qqH_HTXS_Stage1p2.root -t -1 --setParameters "
...
# Merge some bins
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2016_SF_qqH_HTXS_Stage1p2.root -t -1 --freezeParameters 'rgx{.*}' --setParameters "
