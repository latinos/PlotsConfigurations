...
# Datacard directory
datacardDir=$CMSSW_BASE/src/PlotsConfigurations/Configurations/qqH_SF/Full2018_HTXS_Stage1p2_v7/datacards
echo "Datacard directory:"
echo ${datacardDir}

# Output directory
outputDir=$CMSSW_BASE/src/PlotsConfigurations/Configurations/qqH_SF/Full2018_HTXS_Stage1p2_v7/Combination
mkdir -p ${outputDir}
