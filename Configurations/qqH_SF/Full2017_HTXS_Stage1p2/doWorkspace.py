...
#No merging
command="text2workspace.py datacards/Full2017_SF_qqH_HTXS_Stage1p2/comb/datacard.txt -o Combination/Full2016_ggH_HTXS_Stage1p2.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
...
'''
#Merge some bins
command="text2workspace.py Full2016_ggH_HTXS_Stage1p2.txt -o Full2016_ggH_HTXS_Stage1p2_merged.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
poi=''
for sample in sampleNames:
...
#Merge all bins
command="text2workspace.py Full2016_ggH_HTXS_Stage1p2.txt -o Full2016_ggH_HTXS_Stage1p2_onePOI.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
poi=''
for sample in sampleNames:
  if 'FWDH' in sample: continue
  else: poi ='r_ggH_hww'
