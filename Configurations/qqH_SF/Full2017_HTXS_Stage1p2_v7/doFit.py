...
#No merging
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2017_SF_qqH_HTXS_Stage1p2_v7.root -t -1 --setParameters "
...
# Merge some bins
command="combine -M MultiDimFit --algo=singles --X-rtd MINIMIZER_analytic Full2017_SF_qqH_HTXS_Stage1p2_v7.root -t -1 --freezeParameters 'rgx{.*}' --setParameters "
