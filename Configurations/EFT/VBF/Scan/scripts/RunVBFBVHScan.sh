...
text2workspace.py cards/$1_HVBFBVH.txt -o cards/$1_HVBFBVH.root -P HiggsAnalysis.CombinedLimit.HWWCouplings:HWWCouplings --PO $1 > cards/scale.txt

combine -d cards/$1_HVBFBVH.root -n $1_HVBFBVH -M MultiDimFit -t -1 -m 125 --algo grid --points 1000 --setParameters muV=1.0,Fai=0.0 --redefineSignalPOIs=Fai
...
mv higgsCombine$1_HVBFBVH.MultiDimFit.mH125*.root hists/higgsCombine$1_HVBFBVH.MultiDimFit.mH125.root
