...
cuts['hww2l2v_13TeV_of2j_vbf_hpip']  = '(mth>=60 && mth<125) && mll<76.2 && (abs(CleanJet_eta[0])<4.7) && (abs(CleanJet_eta[1])<4.7) && bVeto && mtw2>30 && mjj>120 && kd_vbf_mixhp>0.4 && Sum$(CleanJet_pt>30)==2 && nCleanFatJet==0'

cuts['hww2l2v_13TeV_of2j_vbf_hpin']  = '(mth>=60 && mth<125) && mll<76.2 && (abs(CleanJet_eta[0])<4.7) && (abs(CleanJet_eta[1])<4.7) && bVeto && mtw2>30 && mjj>120 && kd_vbf_mixhp<0.4 && Sum$(CleanJet_pt>30)==2 && nCleanFatJet==0'
