...
supercut = 'Lepton_pt[0]>25 && Lepton_pt[1]>13 && mll>12 && Lepton_pdgId[0]*Lepton_pdgId[1]==-11*13 && Alt$(Lepton_pt[2],0)<10 && ptll>30 && PuppiMET_pt>20 && hm > 0'
...
cuts['hww2l2v_13TeV_of2j_ggh_thmip']  = 'mth>=60 && mth<125 && ((mll>12 && mll<76.2) || mll>106.2) && abs(CleanJet_eta[0])<4.7 && abs(CleanJet_eta[1])<4.7 && bVeto && mtw2>30 && mjj>200 && kd_ggh_mixhm>0 && Sum$(CleanJet_pt>30)==2 && nCleanFatJet==0'

cuts['hww2l2v_13TeV_of2j_ggh_thmin']  = 'mth>=60 && mth<125 && ((mll>12 && mll<76.2) || mll>106.2) && abs(CleanJet_eta[0])<4.7 && abs(CleanJet_eta[1])<4.7 && bVeto && mtw2>30 && mjj>200 && kd_ggh_mixhm<0 && Sum$(CleanJet_pt>30)==2 && nCleanFatJet==0'
