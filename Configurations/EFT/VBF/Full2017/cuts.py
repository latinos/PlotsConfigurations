...
cuts['hww2l2v_13TeV_of2j_ggh_thmip']  = 'mth>=60 && mth<125 && mll<76.2 && abs(CleanJet_eta[0])<4.7 && abs(CleanJet_eta[1])<4.7 && bVeto && mtw2>30 && mjj>200 && kd_ggh_mixhm>0 && Sum$(CleanJet_pt>30)==2'

cuts['hww2l2v_13TeV_of2j_ggh_thmin']  = 'mth>=60 && mth<125 && mll<76.2 && abs(CleanJet_eta[0])<4.7 && abs(CleanJet_eta[1])<4.7 && bVeto && mtw2>30 && mjj>200 && kd_ggh_mixhm<0 && Sum$(CleanJet_pt>30)==2'

cuts['hww2l2v_13TeV_of2j_ggh_untagged'] = '(mth>=60 && mth<125) && bVeto && mtw2>30 && mjj<200 && nCleanJet<=2'
