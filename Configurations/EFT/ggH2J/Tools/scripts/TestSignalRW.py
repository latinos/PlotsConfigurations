...
src = path.realpath("rootFileJJH18Test-XS/plots_JJH18Test.root")
...
def CompareHGGRW(Cat, Var, Prod, Hyp):
 ...
 H1.SetMinimum(0)#-2*Sum.GetMaximum())
 H1.SetMaximum(1.2*Sum.GetMaximum())
 H1.GetXaxis().SetTitle(""+Var+"")
...
GGHJJConfig = [ ("of2j_ggh_thmip", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0PM"),
                ("of2j_ggh_thmip", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0M"),
                ("of2j_ggh_thmip", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0Mf05"),  
                ("of2j_ggh_thmin", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0PM"),
                ("of2j_ggh_thmin", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0M"),
                ("of2j_ggh_thmin", "kd2d_ggh_hm3", "GGHjj_minlo_", "H0Mf05"),  
]  
