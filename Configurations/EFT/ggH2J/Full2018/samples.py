...
# GGHjj MINLO MC samples 

samples['GGHjj_minlo_H0PM'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0PM_minloHJJ_ToWWTo2L2Nu'), 
   'weight': mcCommonWeight+ '*GGHjj_H0PM_minlo_W',   'FilesPerJob': 15, } 
 
samples['GGHjj_minlo_H0M'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0M_minloHJJ_ToWWTo2L2Nu'), 
   'weight': mcCommonWeight+ '*GGHjj_H0M_minlo_W',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0Mf05'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0Mf05_minloHJJ_ToWWTo2L2Nu'), 
   'weight': mcCommonWeight+ '*GGHjj_H0Mf05_minlo_W',   'FilesPerJob': 15, } 

# Reweighted MINLO samples 

samples['GGHjj_minlo_H0PM_H0M'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0PM_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0M_minlo_W*(LHEReweightingWeight[1]/LHEReweightingWeight[0])',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0PM_H0Mf05'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0PM_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0Mf05_minlo_W*(LHEReweightingWeight[2]/LHEReweightingWeight[0])',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0M_H0PM'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0M_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0PM_minlo_W*(LHEReweightingWeight[0]/LHEReweightingWeight[1])',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0M_H0Mf05'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0M_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0Mf05_minlo_W*(LHEReweightingWeight[2]/LHEReweightingWeight[1])',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0Mf05_H0PM'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0Mf05_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0PM_minlo_W*(LHEReweightingWeight[0]/LHEReweightingWeight[2])',   'FilesPerJob': 15, } 

samples['GGHjj_minlo_H0Mf05_H0M'] = { 
   'name':   nanoGetSampleFiles(mcDirectory, 'GGHjj_H0Mf05_minloHJJ_ToWWTo2L2Nu'), 
    'weight': mcCommonWeight+ '*GGHjj_H0M_minlo_W*(LHEReweightingWeight[1]/LHEReweightingWeight[2])',   'FilesPerJob': 15, } 
