...
try:
    ...
    gghAC = [skey for skey in samples if (skey.startswith('H0') or skey.startswith('GGHjj_H0') or skey.startswith('GGHjj_minlo_H0'))]
...
key_dic = {
	...
	'hww2l2v_13TeV_of2j_ggh_thmip':gghtdic,
        'hww2l2v_13TeV_of2j_ggh_thmin':gghtdic,	
