...
'''
#cats = ['hww2l2v_13TeV_of2j_A']

#DeclareKD3D('ggh_hmA','D_ggH', 'mll',[10,25,45,60], 'deta_jj',[0,1,2,3,8], 'dphi_jj',[-3.2,-2.8,-2.2,-1.8,-1.2,-0.8,-0.4,0,0.4,0.8,1.2,1.8,2.2,2.8,3.2], cats)
