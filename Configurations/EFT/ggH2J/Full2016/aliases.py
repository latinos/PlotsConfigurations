...
mc_ggh = [skey for skey in samples if (skey.startswith('H0') or skey.startswith('GGHjj_H0') or skey.startswith('GGHjj_minlo_H0'))]
...
aliases['GGHjj_H0PM_minlo_W']    = { 'expr': '1'}  
aliases['GGHjj_H0M_minlo_W']     = { 'expr': '(JHUXSGGHjja3/JHUXSGGHjja2)'}
aliases['GGHjj_H0Mf05_minlo_W']  = { 'expr': '(JHUXSGGHjja2a3/JHUXSGGHjja2)'}


# Prepare gen MEs for jhugen signal reweighting
...
for me in mes:
    aliases[me] = {
    'linesToAdd': ['.L %s/EFT/ggH2J/Tools/getme.cc+' % configurations ],
...
for con in cons:
    aliases[con] = {
    'linesToAdd': ['.L %s/EFT/ggH2J/Tools/getconstant.cc+' % configurations ],
    'class': 'GetConstant',
    'args': (con,),
}


mes_add = ['dr_jj','dphi_jj','deta_jj','me_qcd_hsm2','me_qcd_hm2','me_qcd_mixhm2'] # Given "hm2" as me is in a small number of new signal files 
...
for me in mes_add:
    ...
    '.L %s/EFT/ggH2J/Tools/addrecome.cc+' % configurations],
    'class': 'AddRecoME',
    'args': (me,)
    }
...
aliases['kd_smvbf']     = { 'expr': '1/(1+((me_qcd_hsm2*CVBF)/me_vbf_hsm))' }
aliases['kd_ggh_hm']    = { 'expr': '1/(1+(me_qcd_hsm2/(me_qcd_hm2*G4_GGHjj**2)))' }
aliases['kd_ggh_mixhm'] = { 'expr': '(me_qcd_mixhm2 - me_qcd_hsm2 - me_qcd_hm2)/(2*sqrt(me_qcd_hsm2*me_qcd_hm2))' }
