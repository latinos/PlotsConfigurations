...
factorLabelBSM = { 'H0PH' : " 0^{+}", 'H0M' : " 0^{-}", 'H0L1' : " 0^{#Lambda1}", 'H0LZg' : " 0^{#Lambda1}_{Z#gamma}" }
...
groupPlot['BSM']  = {
                      'nameHR' : _sm+factor['BSM'],
                      'color' : 2,
                      'isSignal' : 2,
                      'isData'   : 0,
                      'scale'    : 1.,
                      'samples'  : [process+'_'+tplLabelBSM[process] for process in processes if (process != 'ggH' and process != 'WH')]
                    }
'''
groupPlot['T2']  = {
