...
variablesFile = 'variables_combined_label_aLZg_VH.py'
...
# file with list of samples
plotFile = 'plot_ggH2016_LambdaZg_allSignals_forSRs_ana_unblinded.py' 
...
nuisancesFile = 'nuisances16_ana.py' 
