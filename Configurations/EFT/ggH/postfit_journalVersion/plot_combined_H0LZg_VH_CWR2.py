...
tplLabelBSM = {'ggH' : "", 'VBF' : "T3", 'WH' : "", 'ZH' : "T3"}
powerLabelBSM = {
...
groupPlot['TotalSig'] = {
                  ...
                  'samples'  : [process+'_T1' for process in processes]+\
                               [process+'_T2' for process in processes if (process != "ggH" and process != "WH")]+\
                               [process+'_T3' for process in processes if (process != "ggH" and process != "WH")]
              }
groupPlot['SigSM'] = {
                  'nameHR' : '#splitline{H #rightarrow WW f_{#Lambda1}^{Z#gamma}= 0}{(n=n_{SM} #times '+str(int(globScale))+')}',
                  'isSignal' : 2,
                  'color': 2,
                  'style': 1, 
                  'scale': 1.,
...
groupPlot['SigBSM'] = {
                  'nameHR' : '#splitline{H #rightarrow WW f_{#Lambda1}^{Z#gamma}= 0.99}{(n=n_{SM} #times '+str(int(globScale))+')}',
                  'isSignal' : 2,
                  'color': 4,
                  'style': 1,
                  'scale': 1.,
                  'samples'  : [process+'_T3_prefit' for process in processes if (process != 'ggH' and process != 'WH')]+\
                               [process+'_T2_prefit' for process in processes if (process != 'ggH' and process != 'WH')]
              }
'''
groupPlot['T2']  = {
