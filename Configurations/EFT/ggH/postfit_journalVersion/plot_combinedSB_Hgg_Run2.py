...
groupPlot['TotalSigGGH']  = {
                  ...
                  'color': 2,
                  'scale': 1.,
                  'samples'  : [process+'_T1' for process in processes if process in ["ggH","ggHjj"]]+\
                               [process+'_T2' for process in processes if process in ["ggH","ggHjj"]]+\
                               [process+'_T3' for process in processes if process in ["ggH","ggHjj"]]
              }
groupPlot['SigSM'] = {
                  'nameHR' : '#splitline{ggH f_{a3}^{ggH}= 0}{(n=n_{SM})}',
                  'isSignal' : 2,
                  'color': 2,
                  'style': 1,
                  'scale': 1.,
                  'samples'  : ['ggHjj_T1_prefit']
              }
groupPlot['SigBSM'] = {
                  'nameHR' : '#splitline{ggH f_{a3}^{ggH}= 1}{(n=n_{SM})}',
                  'isSignal' : 2,
                  'color': 4,
                  'style': 1,
                  'scale': 1.,
                  'samples'  : ['ggHjj_T3_prefit']
              }
'''
groupPlot['T2']  = {
