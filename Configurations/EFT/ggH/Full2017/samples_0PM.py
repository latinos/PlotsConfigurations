...
samples['ggH_hww_0PM']  = {  'name'   :   getSampleFiles(directory,'H0PM_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight ,
                         #+'*'+SFweight ,
...
samples['qqH_hww_0PM']  = {  'name'   :   getSampleFiles(directory,'VBF_H0PM_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight , 
                         #+'*'+SFweight ,
                         #+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
