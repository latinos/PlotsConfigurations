...
nuisances['trigg_emb'] = {
    'name': 'CMS_eff_hwwtrigger_embedded_2017',
    'kind': 'weight',
    'type': 'shape',
...
nuisances['electronpt'] = {
    ...
    'mapUp': 'ElepTup',
    'mapDown': 'ElepTdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if not skey in ['DY']),
...
if useEmbeddedDY: 
  if runDYveto:
    ...
    unc_dict = {}
    unc_dict['hww2l2v_13TeV_mth125_mllCut_0j_dphill0to14']  = '1.05670'
    unc_dict['hww2l2v_13TeV_mth125_mllCut_1j_dphill0to14']  = '1.01093'
    unc_dict['hww2l2v_13TeV_mth125_mllCut_0j_dphill14to32']  = '1.01533'
    unc_dict['hww2l2v_13TeV_mth125_mllCut_1j_dphill14to32']  = '1.00883'
    unc_dict['hww2l2v_13TeV_orig_mth125_mllCut_0j']  = '1.02020'
    unc_dict['hww2l2v_13TeV_orig_mth125_mllCut_1j']  = '1.00953'
    unc_dict['hww2l2v_13TeV_orig_mth125_0j']  = '1.01908'
    unc_dict['hww2l2v_13TeV_orig_mth125_1j']  = '1.00956'
    unc_dict['hww2l2v_13TeV_orig_mllCut_0j']  = '1.02311'
    unc_dict['hww2l2v_13TeV_orig_mllCut_1j']  = '1.01211'
    unc_dict['hww2l2v_13TeV_orig_0j']  = '1.02196'
    unc_dict['hww2l2v_13TeV_orig_1j']  = '1.01232'
    unc_dict['hww2l2v_13TeV_top_0j'] = '1.01564'
    unc_dict['hww2l2v_13TeV_top_1j'] = '1.02312'
    unc_dict['hww2l2v_13TeV_dytt_0j'] = '1.00330'
    unc_dict['hww2l2v_13TeV_dytt_1j'] = '1.00167'
...
for i in range(1,33):
  ...
  upScale = "LHEPdfWeight[%d]/LHEPdfWeight[0]" %i
  doScale = "2. - LHEPdfWeight[%d]/LHEPdfWeight[0]" %i
  pdf_variations_WW = [upScale, doScale]

  #this is hardcoded to fix the single event with big weight causing super high syst. error
  if i == 3 or i == 12:
      upScale = "(LHEPdfWeight[%d]/LHEPdfWeight[0])*(LHEPdfWeight[%d]/LHEPdfWeight[0] < 4.)+1.*((LHEPdfWeight[%d]/LHEPdfWeight[0]) >= 4)" %(i,i,i)
      doScale = "2. - (LHEPdfWeight[%d]/LHEPdfWeight[0])*(LHEPdfWeight[%d]/LHEPdfWeight[0] < 4.) - 1.*((LHEPdfWeight[%d]/LHEPdfWeight[0]) >= 4)" %(i,i,i)
  pdf_variations_top = [upScale, doScale]
...
topScaleNormFactors0j = {'LHEScaleWeight[3]': 1.0008829637654995, 'LHEScaleWeight[0]': 1.070761703863844, 'LHEScaleWeight[1]': 1.0721982065714528, 'LHEScaleWeight[8]': 0.9270717138194097, 'LHEScaleWeight[Length$(LHEScaleWeight)-4]': 1.002515087891841, 'LHEScaleWeight[Length$(LHEScaleWeight)-2]': 0.9270080603942781}
topScaleNormFactors1j = {'LHEScaleWeight[3]': 1.0079221754798773, 'LHEScaleWeight[0]': 1.0846741444664376, 'LHEScaleWeight[1]': 1.0806432359691847, 'LHEScaleWeight[8]': 0.9129672863490275, 'LHEScaleWeight[Length$(LHEScaleWeight)-4]': 0.9960603215169435, 'LHEScaleWeight[Length$(LHEScaleWeight)-2]': 0.9198946095840594}
topScaleNormFactors2j = {'LHEScaleWeight[3]': 1.0224795274718796, 'LHEScaleWeight[0]': 1.1209941307567444, 'LHEScaleWeight[1]': 1.103222357530683, 'LHEScaleWeight[8]': 0.8840173265167147, 'LHEScaleWeight[Length$(LHEScaleWeight)-4]': 0.9829374807746288, 'LHEScaleWeight[Length$(LHEScaleWeight)-2]': 0.9038880068177306}
...
#print ' '.join(nuis['name'] for nname, nuis in nuisances.iteritems() if ((nuis['type'] == 'shape' or 'folderUp' in nuis.keys()) and ("VBF_H0PM" in nuis['samples'].keys() or "H0PM" in nuis['samples'].keys() or "WH_H0PM" in nuis['samples'].keys() or "ZH_H0PM" in nuis['samples'].keys() )))
print ' '.join(nuis['name'] for nname, nuis in nuisances.iteritems() if ((nuis['type'] == 'shape' or 'folderUp' in nuis.keys()) and ( "VBF_H0PM" in nuis['samples'].keys() or "H0PM" in nuis['samples'].keys() or "WH_H0PM" in nuis['samples'].keys() or "ZH_H0PM" in nuis['samples'].keys() or len(nuis['samples'].keys()) == 0 )))
