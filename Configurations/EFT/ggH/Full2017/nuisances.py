...
nuisances['electronpt'] = {
    ...
    'kind': 'tree',
    'type': 'shape',
    'samples': dict((skey, ['1', '1']) for skey in mc if ('DY' not in skey)), #FIXME Add DY Add ggH_hww_ALT Add qqH_hww_ALT
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'ggH_hww_ALT': ['1.0036768006*(puWeightUp/puWeight)', '0.995996570285*(puWeightDown/puWeight)'],
        'qqH_hww_ALT': ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],
    },
    'AsLnN': '1',
}
...
nuisances['PS']  = {
    ...
    'AsLnN': '1',
    'samplespost': lambda self, samples: dict([('WW', ['1.', '1.'])] + [(sname, ['1.', '1.']) for sname in samples if 'ggH_hww' in sname or 'ggH_hww_ALT' in sname or 'qqH_hww' in sname or 'qqH_hww_ALT' in sname])
}
