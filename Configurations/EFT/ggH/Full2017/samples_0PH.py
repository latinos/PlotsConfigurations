...
############ ggH H->WW in SM ############
samples['ggH_hww']  = {  'name'   :   getSampleFiles(directory,'GluGluHToWWTo2L2Nu_M125',False,'nanoLatino_'),
                        'weight' : XSWeight ,                       
                         #+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
...
############ ggH H->WW in 0PH model ############
samples['ggH_hww_0PH']  = {  'name'   :   getSampleFiles(directory,'H0PH_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight ,
                         #+'*'+SFweight ,
                         #+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }

############ VBF H->WW in 0PH model ############
samples['qqH_hww_0PH']  = {  'name'   :   getSampleFiles(directory,'VBF_H0PH_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight , 
                         #+'*'+SFweight ,
                         #+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
