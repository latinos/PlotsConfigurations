...
samples['ggH_hww_0L1']  = {  'name'   :   getSampleFiles(directory,'H0L1_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight ,
                         #+'*'+SFweight ,
...
samples['qqH_hww_0L1']  = {  'name'   :   getSampleFiles(directory,'VBF_H0L1_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight , 
                         #+'*'+SFweight ,
                         #+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
