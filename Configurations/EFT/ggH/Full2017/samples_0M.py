...
samples['ggH_hww_0M']  = {  'name'   :   getSampleFiles(directory,'H0M_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight ,
                         #+'*'+SFweight ,
...
samples['qqH_hww_0M']  = {  'name'   :   getSampleFiles(directory,'VBF_H0M_ToWWTo2L2Nu',False,'nanoLatino_'),
                        'weight' : XSWeight , 
                         #+'*'+SFweight ,
                         #+'*'+GenLepMatch+'*'+METFilter_MC ,
                     }
