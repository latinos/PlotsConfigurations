...
groupPlot['TotalSig'] = {
                  ...
                  'samples'  : [process+'_T1' for process in processes]+\
                               [process+'_T2' for process in processes if process not in ["ggH","VBF"]]+\
                               [process+'_T3' for process in processes if process not in ["ggH","VBF"]]+\
                               [process+'_T4' for process in processes if process not in ["ggH","VBF"]]+\
                               [process+'_T5' for process in processes if process not in ["ggH","VBF"]]
              }
'''
groupPlot['T2']  = {
