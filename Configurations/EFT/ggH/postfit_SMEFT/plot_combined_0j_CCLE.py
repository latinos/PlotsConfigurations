...
#SMEFT but only H0PH is considered 
groupPlot['TotalSig'] = {
                  'nameHR' : 'Higgs boson',
                  'isSignal' : 1,
                  'color': 2,
                  ...
                  'samples'  : [process+'_T1' for process in processes]+\
                               [process+'_T2' for process in processes if process not in ["VBF","WH","ZH"]]+\
                               [process+'_T3' for process in processes if process not in ["VBF","WH","ZH"]]+\
                               [process+'_T4' for process in processes if process not in ["ggH","VBF","WH","ZH"]]+\
                               [process+'_T5' for process in processes if process not in ["ggH","VBF","WH","ZH"]]
              }
'''
groupPlot['T2']  = {
