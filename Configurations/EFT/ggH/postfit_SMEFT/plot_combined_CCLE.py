...
groupPlot['TotalSig'] = {
                  ...
                  'samples'  : [process+'_T1' for process in processes]+\
                               [process+'_T2' for process in processes if process not in ["ZH","WH"]]+\
                               [process+'_T3' for process in processes if process not in ["ZH","WH"]]+\
                               [process+'_T4' for process in processes if process not in ["ggH","ZH","WH"]]+\
                               [process+'_T5' for process in processes if process not in ["ggH","ZH","WH"]]
              }
'''
groupPlot['T2']  = {
