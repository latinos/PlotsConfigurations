...
configurations = os.path.dirname(configurations) # nAODv7_Full2017v7
...
#FIXME: apply for jets cleared from leptons only!
aliases['Jet_PUIDSF'] = { 
...
for thu in thusQQ:
    aliases[thu+'_2'] = {
        ...
        'args': (thu,),
        'samples': ['VBF_T1','VBF_T2','VBF_T3','VBF_T4','VBF_T5'],
        'nominalOnly': True
    }
