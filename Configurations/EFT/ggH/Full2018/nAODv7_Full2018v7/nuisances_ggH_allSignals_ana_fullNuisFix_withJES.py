...
for js in jes_systs:
  notFor = ""
  if js == "JESHF": notFor = "VBF" #added for negative yield
  if 'Absolute' in js: 
  ...
  nuisances[js] = {
      ...
      'mapUp': js+'up',
      'mapDown': js+'do',
      'samples': dict((skey, ['1', '1']) for skey in mc if (skey not in ['VZ', 'Vg', 'VgS'] and notFor not in skey)), #FIXME
      'folderUp': folderup,
      'folderDown': folderdo,
      'AsLnN': '1'
  }
...
nuisances['JER'] = {
    ...
    'mapUp': 'JERup',
    'mapDown': 'JERdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if (skey not in ['VZ', 'Vg', 'VgS'] and "VBF" not in skey)), #FIXME #added VBF on top
...
nuisances['met'] = {
    ...
    'mapUp': 'METup',
    'mapDown': 'METdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if "VBF" not in skey), #added VBF for negative yield
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'VBF_T1' : ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],
        'VBF_T2' : ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],
        'VBF_T3' : ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],
        'VBF_T4' : ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],
        'VBF_T5' : ['1.00374694528*(puWeightUp/puWeight)', '0.995878596852*(puWeightDown/puWeight)'],

	'ggH_T1' :['1.0036768006*(puWeightUp/puWeight)', '0.995996570285*(puWeightDown/puWeight)'],
        'ggH_T2' :['1.0036768006*(puWeightUp/puWeight)', '0.995996570285*(puWeightDown/puWeight)'],
        'ggH_T3' :['1.0036768006*(puWeightUp/puWeight)', '0.995996570285*(puWeightDown/puWeight)'],
