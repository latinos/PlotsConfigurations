...
def makeMCDirectory(var=''):
    if var:
        ...
        #return '/afs/cern.ch/user/t/tkello/public/HWW_EFT/Summer2016/l2tightOR__{var}'.format(var=var)
    else:
        return os.path.join(treeBaseDir, mcProduction, mcSteps.format(var=''))
        #return '/afs/cern.ch/user/t/tkello/public/HWW_EFT/Summer2016/l2tightOR'
