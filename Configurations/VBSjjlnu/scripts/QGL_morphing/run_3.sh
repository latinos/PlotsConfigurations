...
BASEDIR=`pwd`/Remorphing_v3

#No correction
../../scripts/QGL_morphing/rdf_analyzer_morph_ptorder.o ../rootFile_test_qgl_tree/plots_test_qgl_tree.root res_wjetcr \
...
#                  --outputdir $BASEDIR/output_wjets_iter2b --outputfile morphing_gluon_iter2.root --jet-type gluon

# python ../../scripts/QGL_morphing/extract_morphing.py --input $BASEDIR/output_histos_topcr_iter2.root \
#                  --outputdir $BASEDIR/output_top_iter2b --outputfile morphing_quark_iter2.root --jet-type quark
