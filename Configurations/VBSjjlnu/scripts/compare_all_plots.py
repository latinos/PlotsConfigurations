...
parser.add_argument("--conf", help="config", type=str)
...
for var in variables:
    ...
    hA = fA.Get(args.cut +"/"+ var +"/histo_"+ args.sample)
    hB = fB.Get(args.cut +"/"+ var +"/histo_"+ args.sample)
    ...
    leg.Draw()
    c.Draw()
    c.SaveAs(args.output+"/" + args.cut + '_' + var + ".png")
