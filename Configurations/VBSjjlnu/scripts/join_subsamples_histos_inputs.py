    ...
    for variable in args.variables:
        ...
        for sample_name, sample in samples.items():
            ...
            if "subsamples" in sample:
                join_histos(R.gDirectory,keys, sample_name, sample["subsamples"])

                # Now for each nuisance
                for nuis in nuisances_name:
                    print("Nuisance: ", nuis)
                    join_histos(R.gDirectory, keys, sample_name, sample["subsamples"], suffix=nuis+"Up")
                    join_histos(R.gDirectory, keys, sample_name, sample["subsamples"], suffix=nuis+"Down")
