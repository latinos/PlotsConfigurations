  ...
  for var in vars:
    if "DNN" in var: 
      output_joint.append( {
        ...
        "folders": [
          {
            "basedir": "Full2016v7/datacards_fit_v4.5_2016_Dipole_v2", 
            "name": 2016
          },
          {
            "basedir": "Full2017v7/datacards_fit_v4.5_2017_Dipole_v2.1", 
            "name": 2017
          },
          {
            "basedir": "Full2018v7/datacards_fit_v4.5_2018_Dipole_v2", 
            "name": 2018
          }
        ], 
        "phase_spaces": [
      ...
      for y,d in zip([2016,2017,2018],["Full2016v7/datacards_fit_v4.5_2016_Dipole_v2",
                                      "Full2017v7/datacards_fit_v4.5_2017_Dipole_v2.1", 
                                      "Full2018v7/datacards_fit_v4.5_2018_Dipole_v2"] ):
        for fl in ["ele","mu"]:
          output_split.append( {
...
json.dump(output_split, open("datacard_config_fullrun2_v4.5.2_allvars_split.json","w"), indent=2)
json.dump(output_joint, open("datacard_config_fullrun2_v4.5.2_allvars_joint.json","w"), indent=2)
