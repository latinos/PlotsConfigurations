...
for cat, vars in variables.items():
  for var in vars:
    output_joint.append( {
      ...
      "folders": [
        {
          "basedir": "Full2016v7/datacards_fit_v4.3_2016_signalplots_v4SignalPlots", 
          "name": 2016
        },
        {
          "basedir": "Full2017v7/datacards_fit_v4.3_2017_signalplots_v4SignalPlots", 
          "name": 2017
        },
        {
          "basedir": "Full2018v7/datacards_fit_v4.3_2018_signalplots_v5SignalPlots", 
          "name": 2018
        }
      ], 
      "phase_spaces": [
    ...
    for y,d in zip([2016,2017,2018],["Full2016v7/datacards_fit_v4.3_2016_signalplots_v4SignalPlots",
                                    "Full2017v7/datacards_fit_v4.3_2017_signalplots_v4SignalPlots", 
                                    "Full2018v7/datacards_fit_v4.3_2018_signalplots_v5SignalPlots"] ):
      for fl in ["ele","mu"]:
        output_split.append( {
...
json.dump(output_split, open("datacard_config_fullrun2_v4.3.5_allvars_split.json","w"), indent=2)
json.dump(output_joint, open("datacard_config_fullrun2_v4.3.5_allvars_joint.json","w"), indent=2)