...
colors = [ R.TColor.GetColor(0, 149, 226),  R.TColor.GetColor(242, 108, 13), R.TColor.GetColor(0, 179, 133)] #R.TColor.GetColor(72, 145, 234) 158, 218, 255
...
for cut in args.cuts:
    for var in args.vars:
        ...
        for sample in args.samples:
            h = iF.Get("{}/{}_{}".format(cut, sample, var))
            hs.append(h)
