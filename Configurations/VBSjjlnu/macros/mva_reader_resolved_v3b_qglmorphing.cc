...
#ifndef MVAREADERResolved
#define MVAREADERResolved
...
public:
  ...
  MVAReaderResolved(const char* model_path,  const char* transform_path, bool verbose, int category);

  char const* getName() const override { return "MVAReaderResolved"; }
  TTreeFunction* clone() const override { return new MVAReaderResolved(model_path_.c_str(), 
...
MVAReaderResolved::MVAReaderResolved(const char* model_path, const char* transform_path, bool verbose, int category):
...
{  
  ...
  _library.bindBranch(vbs_0_qgl_res, "vbs_0_qglmorphed_res");
  _library.bindBranch(vjet_0_qgl_res, "vjet_0_qglmorphed_res");
  _library.bindBranch(vjet_1_qgl_res, "vjet_1_qglmorphed_res");
