...
#ifndef MVAREADERBoosted_mVauto
#define MVAREADERBoosted_mVauto

typedef TTreeReaderValue<Double_t> DoubleValueReader;

class MVAReaderBoosted_mVauto : public multidraw::TTreeFunction {
public:
  
  MVAReaderBoosted_mVauto(const char* model_path,  const char* transform_path, bool verbose, int category);

  char const* getName() const override { return "MVAReaderBoosted_mVauto"; }
  TTreeFunction* clone() const override { return new MVAReaderBoosted_mVauto(model_path_.c_str(), 
...
MVAReaderBoosted_mVauto::MVAReaderBoosted_mVauto(const char* model_path, const char* transform_path, bool verbose, int category):
...
double
MVAReaderBoosted_mVauto::evaluate(unsigned)
{
  // Run only if 
...
void
MVAReaderBoosted_mVauto::bindTree_(multidraw::FunctionLibrary& _library)
{  
...
MVAReaderBoosted_mVauto::~MVAReaderBoosted_mVauto(){  
