...
#ifndef MVAREADERResolved_mVauto_v25e
#define MVAREADERResolved_mVauto_v25e

typedef TTreeReaderValue<Double_t> DoubleValueReader;

class MVAReaderResolved_mVauto_v25e : public multidraw::TTreeFunction {
public:
  
  MVAReaderResolved_mVauto_v25e(const char* model_path,  const char* transform_path, bool verbose, int category);

  char const* getName() const override { return "MVAReaderResolved_mVauto_v25e"; }
  TTreeFunction* clone() const override { return new MVAReaderResolved_mVauto_v25e(model_path_.c_str(), 
...
MVAReaderResolved_mVauto_v25e::MVAReaderResolved_mVauto_v25e(const char* model_path, const char* transform_path, bool verbose, int category):
...
double
MVAReaderResolved_mVauto_v25e::evaluate(unsigned)
{
  // Run only if 
...
void
MVAReaderResolved_mVauto_v25e::bindTree_(multidraw::FunctionLibrary& _library)
{  
...
MVAReaderResolved_mVauto_v25e::~MVAReaderResolved_mVauto_v25e(){
