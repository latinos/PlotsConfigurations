...
class Wtagging_SF_ptExtrap_2017 : public multidraw::TTreeFunction {
public:
  Wtagging_SF_ptExtrap_2017(  const char* year);
  ~Wtagging_SF_ptExtrap_2017();

  char const* getName() const override { return "Wtagging_SF_ptExtrap_2017"; }
  TTreeFunction* clone() const override { return new Wtagging_SF_ptExtrap_2017(year_.c_str() ); }
...
Wtagging_SF_ptExtrap_2017::Wtagging_SF_ptExtrap_2017(const char* year):
   TTreeFunction(), year_(year){}



void
Wtagging_SF_ptExtrap_2017::beginEvent(long long _iEntry)
{
  setValues();
}
...
double
Wtagging_SF_ptExtrap_2017::evaluate(unsigned iJ)
{
  // Up - down
...
void
Wtagging_SF_ptExtrap_2017::setValues()
{
...
void
Wtagging_SF_ptExtrap_2017::bindTree_(multidraw::FunctionLibrary& _library)
{   
...
Wtagging_SF_ptExtrap_2017::~Wtagging_SF_ptExtrap_2017(){
