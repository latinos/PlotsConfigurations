...
variables["deta_jetpt_resCR"] = {
            'name': 'detavbs_jetpt_bin',
            'range': (8, 3.5, 11.5),
            'axis': '#Delta#eta VBS jets : VBS trailing jet Pt bins (res region)',
            'fold': 0
}

variables["deta_jetpt_boostCR"] = {
            'name': 'detavbs_jetpt_bin',
            'range': (2, 0.5, 3.5),
            'axis': '#Delta#eta VBS jets : VBS trailing jet Pt bins (boost region)',
            'fold': 0
}
