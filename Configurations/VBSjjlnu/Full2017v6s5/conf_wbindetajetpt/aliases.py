...
aliases['detavbs_jetpt_bin'] = {
    'expr':'(VBS_category==0)*( 1* (mjj_vbs<1000) + 2*(mjj_vbs>=1000) ) + \
            (VBS_category==1) * \
                (   3* ((deltaeta_vbs < 3.5)  && vbs_1_pt < 75) + \
                    4* ((deltaeta_vbs >= 3.5 && deltaeta_vbs < 5.5)  && vbs_1_pt < 75) + \
                    5* ((deltaeta_vbs >= 5.5)  && vbs_1_pt < 75) + \
                    \
