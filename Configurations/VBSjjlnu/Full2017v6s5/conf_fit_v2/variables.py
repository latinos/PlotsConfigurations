...
'''
[0.3,0.35,0.4,0.45,0.5,0.55,0.6, 0.66, 0.69, 0.72, 
 0.765, 0.795, 0.835, 0.88, 
 0.925, 0.975,1.0]
...
variables['DNNoutput_high_res_ele'] = {
    ...
    'range': ([0.3,0.35,0.4,0.45,0.5,0.55,0.6, 0.66, 0.69, 0.72, 
            0.765, 0.795, 0.835, 0.88, 0.925, 0.975,1.0],
            ),
    'xaxis': 'DNN',
    'fold': 0 ,
    #'divideByBinWidth' : 1,
...
'''
[0.3,0.35,0.4,0.45,0.5,0.55,0.6, 0.645, 
0.67, 0.715, 0.74, 0.78, 0.83, 
0.865, 0.93, 0.96]

'''
variables['DNNoutput_high_res_mu'] = {
    'name': 'DNNoutput_resolved',
    'range': ([0.3,0.35,0.4,0.45,0.5,0.55,0.6, 0.645, 
                0.67, 0.715, 0.74, 0.78, 0.83, 
                0.865, 0.93, 0.96, 1.],
             ),
    'xaxis': 'DNN',
...
'''
[0.305, 0.43, 0.53, 0.635, 0.735, 0.895
'''
...
'''
[0.3, 0.36, 0.425, 0.495, 0.595, 0.665, 0.735, 0.83, 0.92]
'''
