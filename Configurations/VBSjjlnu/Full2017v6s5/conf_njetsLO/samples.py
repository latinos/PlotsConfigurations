...
samples['top'] = {    
            ...
            'weight' :  XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'*Top_pTrw * btagSF',
            'FilesPerJob' : 3,
                 }
...
samples['Wjets_HT'] = { 'name' :   
        ...
        'FilesPerJob' : 4, # must be divisor of 32
        # 'subsamples': {
...
#
# Fix Wjets binned + LO 
addSampleWeight(samples,'Wjets_HT', 'WJetsToLNu-LO_ext1', '(LHE_HT < 100)') # to be add ewknloW here!
...
addSampleWeight(samples,'Wjets_LO','WJetsToLNu-LO_ext1',   "LHE_Njets == 0")
...
#samples = {   key:v for key,v in samples.items() if key  in ["Wjets_njetsLO", "Wjets_LO"]}