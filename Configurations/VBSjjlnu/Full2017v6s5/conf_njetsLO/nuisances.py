...
mc =["DY", "top", "VV", "VVV", "VBF-V", "top", "VBS", "Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO"]


phase_spaces_boost = []
phase_spaces_res = []

for d in ["all","high","low", "all_loweta", "all_higheta"]:
...
nuisances['lumi_Uncorrelated'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.02') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}

nuisances['lumi_XYFact'] = {
    'name': 'lumi_13TeV_XYFact',
    'type': 'lnN',
    'samples': dict((skey, '1.008') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}

nuisances['lumi_LScale'] = {
    'name': 'lumi_13TeV_LSCale',
    'type': 'lnN',
    'samples': dict((skey, '1.003') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}

nuisances['lumi_BBDefl'] = {
    'name': 'lumi_13TeV_BBDefl',
    'type': 'lnN',
    'samples': dict((skey, '1.004') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}

nuisances['lumi_DynBeta'] = {
    'name': 'lumi_13TeV_DynBeta',
    'type': 'lnN',
    'samples': dict((skey, '1.005') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}
...
nuisances['lumi_Ghosts'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.001') for skey in mc if skey not in ["Wjets", "Wjets_HT", "Wjets_njetsLO", "Wjets_LO", 'top'])
}
...
nuisances['muonpt']  = {
                ...
                'kind'  : 'tree',
                'type'  : 'shape',
                'samples'  : dict((skey, ['1', '1']) for skey in mc if skey not in ["Wjets_njetsLO"]), # Files not available at the moment
...
nuisances['jes_others']  = {
                ...
                'kind'  : 'tree',
                'type'  : 'shape',
                'samples'  : dict((skey, ['1', '1']) for skey in mc if skey not in ["Wjets","Wjets_njetsLO","Wjets_LO","WJets_HT", "top", "VBS", "DY", "VV", "VBF-V"]),
