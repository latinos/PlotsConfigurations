...
aliases["sip3d_cut"]= {
    'linesToAdd': [
        ...
        '.L {}/VBSjjlnu/Full2017v6s5/macros/sip3d_cut.cc+'.format(configurations)
    ],
    'class': 'Sip3dcut',
    'args': ()
}
...
aliases['bVetoSF'] = {
    ...
    'samples': [m for m in mc if m != "Wjets_njetsLO"]
}
...
aliases['btagSF_new'] = {
    'expr': 'bVeto*bVetoSF_new + bReqTight *bReqSF_new',
    'samples': ["Wjets_njetsLO"]
}
...
for s in systs:
  aliases['btagSF'+s+'up'] = { 'expr': '(bVeto*'+aliases['bVetoSF']['expr'].replace('shape','shape_up_'+s)+'+bReqTight*'+aliases['bReqSF']['expr'].replace('shape','shape_up_'+s)+'+ ( (!bVeto) && (!bReqTight) ))', 'samples':[m for m in mc if m != "Wjets_njetsLO"]  }
...
aliases['deltaphi_lep_alljets'] = {
            'class': 'DeltaPhiVars',
            'args': ("deltaphi_lep_alljets"),
            'linesToAdd' : [
                'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
...
aliases['deltaeta_lep_alljets'] = {
            'class': 'DeltaPhiVars',
            'args': ("deltaeta_lep_alljets"),
            'linesToAdd' : [
                'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
                '.L {}/VBSjjlnu/Full2017v6s5/macros/deltaphivars_class.cc+'.format(configurations)
                ]  
...
aliases['deltaR_lep_alljets'] = {
            'class': 'DeltaPhiVars',
            'args': ("deltaR_lep_alljets"),
            'linesToAdd' : [
                'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
                '.L {}/VBSjjlnu/Full2017v6s5/macros/deltaphivars_class.cc+'.format(configurations)
                ]  
