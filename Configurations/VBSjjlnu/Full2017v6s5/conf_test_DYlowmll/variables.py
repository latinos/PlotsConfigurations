...
variables['Lepton_eta_abs_lessbins'] = {   'name': 'abs(Lepton_eta[0])',      
                        'range' : (20,0,2.5),  
                        'xaxis' : 'Lepton #eta', 
                        'fold' : 3
                        }

variables['Lepton_eta_lessbins'] = {   'name': 'Lepton_eta[0]',      
                        'range' : (30,-2.5,2.5),  
                        'xaxis' : 'Lepton #eta', 
                        'fold' : 3
                        }
...
variables['PuppiMET_zoom'] = {   'name': 'PuppiMET_pt',      
                        'range' : (30,0,200),  
                        'xaxis' : 'PuppiMET_pt', 
                        'fold' : 3
                        }
...
variables['jet_0_pt'] = {   'name': 'CleanJet_pt[0]',      
                        'range' : (30,0,300),  
                        'xaxis' : 'Jet 1 Pt', 
                        'fold' : 3
                        }

variables['jet_1_pt'] = {   'name': 'CleanJet_pt[1]',      
                        'range' : (30,0,300),  
                        'xaxis' : 'Jet 1 Pt', 
                        'fold' : 3
                        }

variables['jet_2_pt'] = {   'name': 'CleanJet_pt[2]',      
                        'range' : (30,0,200),  
                        'xaxis' : 'Jet 1 Pt', 
                        'fold' : 3
                        }

variables['jet_3_pt'] = {   'name': 'CleanJet_pt[3]',      
                        'range' : (30,0,200),  
                        'xaxis' : 'Jet 1 Pt', 
                        'fold' : 3
                        }

variables['jet_4_pt'] = {   'name': 'Alt$(CleanJet_pt[0],-1)',      
                        'range' : (30,0,200),  
                        'xaxis' : 'Jet 1 Pt', 
                        'fold' : 0
                        }
...
variables['vjet_1_eta'] = {   'name': 'abs(vjet_1_eta)',      
                        'range' : (30,0,5),  
...
variables['lep2_pt'] = {   'name': 'Alt$(Lepton_pt[1],-1)',      
                        'range' : (20,0,10),  
                        'xaxis' : '2nd lepton pT', 
                        'fold' : 0
                        }

variables['lep2_pt_lessbins'] = {   'name': 'Alt$(Lepton_pt[1],-1)',      
                        'range' : (5,0,10),  
                        'xaxis' : '2nd lepton pT', 
                        'fold' : 0
                        }

variables['lep2_eta'] = {   'name': 'Alt$(abs(Lepton_eta[1]),-1)',      
                        'range' : (20,0,2.5),  
                        'xaxis' : '2nd lepton #eta', 
                        'fold' : 0
                        }

variables['lep2_eta_lessbins'] = {   'name': 'Alt$(abs(Lepton_eta[1]),-1)',      
                        'range' : (5,0,2.5),  
                        'xaxis' : '2nd lepton #eta', 
                        'fold' : 0
                        }
...
variables['deltaphi_lep_alljets'] = {
            'name': "deltaphi_lep_alljets",
            'range': (30, 0, 3.5),
            'xaxis': '#Delta#phi (lepton, leading jet)',
            'fold': 3      
}

variables['deltaeta_lep_alljets'] = {
            'name': "deltaphi_lep_alljets",
            'range': (30, 0, 3),
            'xaxis': '#Delta#phi (lepton, leading jet)',
            'fold': 3      
