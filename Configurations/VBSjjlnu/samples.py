...
elif 'hercules' in SITE : 
  #xrootdPath  = 'root://'
  treeBaseDir = '/gwteray/users/govoni/OneLeptonSkims/'


directory = treeBaseDir+'Apr2017_summer16_SingleLepton_hercules/lepSel__MCWeights__bSFLpTEffMulti__cleanTauMC__l1tightChain__LepTrgFix'+skim+'/'
...
samples['ttbar'] = 	{ 	'name'  :getSampleFiles(directory,'TTTo2L2Nu',True)
...
signalDirectory =  treeBaseDir + 'VBS_semileptonic_signal_summer16/lepSel__MCWeights__bSFLpTEffMulti__cleanTauMC__l1tightChain__LepTrgFix__dorochester__formulasMC'

samples['VBS']  = { 'name' :   getSampleFiles(signalDirectory,'WmTo2J_ZTo2L') +
								getSampleFiles(signalDirectory,'WmToLNu_WmTo2J') +
								getSampleFiles(signalDirectory,'WmToLNu_ZTo2J') +
								getSampleFiles(signalDirectory,'WpTo2J_WmToLNu') +
								getSampleFiles(signalDirectory,'WpTo2J_ZTo2L') +
								getSampleFiles(signalDirectory,'WpToLNu_WmTo2J') +
								getSampleFiles(signalDirectory,'WpToLNu_WpTo2J') +
								getSampleFiles(signalDirectory,'WpToLNu_ZTo2J') +
								getSampleFiles(signalDirectory,'ZTo2L_ZTo2J') ,
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
                        }
