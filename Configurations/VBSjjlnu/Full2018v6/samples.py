...
# Steps
mcSteps   = 'MCl1loose2018v6__MCCorr2018v6__VBSjjlnuSkim2018v4' 
dataSteps = 'DATAl1loose2018v6__VBSjjlnuSkim2018v4_data'
...
SFweight      = SFweight1l+'*'+LepWPWeight_1l+'*'+LepWPCut_1l+'* btagSF * PUJetIdSF'
...
samples['DY'] = {    'name'   :   nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-10to50-LO')
                                 #+ nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-4to50_HT-100to200')  ######## Missing!!!!
                                ...
                                + nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-50_HT-400to600_ext2')
...
#addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-100to200',ptllDYW_LO) ## TO BE ADDED AGAIN
