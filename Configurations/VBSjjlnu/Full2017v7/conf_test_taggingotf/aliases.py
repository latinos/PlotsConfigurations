...
####################
# On the fly VBS variables 

aliases['VBSvars'] = {
    'class': 'VBSJetsSelection',
    'args': (False),
    'linesToAdd':[
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L {}/VBSjjlnu/macros/VBS_jets_selection.cc+'.format(configurations)
    ],
}

vbs_vars = [ 'VBS_category', 'VBS_jets_index_0', 'VBS_jets_index_1', 
...
for iv, var in enumerate(vbs_vars):
    aliases[var+'_OTF'] = { 'expr': 'Alt$(VBSvars[{}], -999)'.format(iv)}
...
aliases['veto_fatjet_180'] = {
            'class': 'VetoFatJetResolved_2017',
            'args': (180.),
            'linesToAdd' : [
                'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
                '.L {}/VBSjjlnu/macros/veto_fatjet_resolved_2017.cc+'.format(configurations)
            ]           
}
...
aliases['vbs_0_qglmorphed_res'] = {
   'expr': 'Alt$(CleanJet_qgl_morphed[VBS_jets_index_0_OTF],-1)'
} 

aliases['vbs_1_qglmorphed_res'] = {
   'expr': 'Alt$(CleanJet_qgl_morphed[VBS_jets_index_1_OTF],-1)'
} 

aliases['vjet_0_qglmorphed_res'] = {
    'expr': 'Alt$(CleanJet_qgl_morphed[V_jets_index_0_OTF],-1)'
} 

aliases['vjet_1_qglmorphed_res'] = {
    'expr': 'Alt$(CleanJet_qgl_morphed[V_jets_index_1_OTF],-1)'
} 
...
#     'class': 'Wtagging_SF_ptExtrap_2017',
#     'args': ('2017'),
#     'linesToAdd' : [
#         'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
#         '.L {}/VBSjjlnu/macros/Wtagging_SF_ptExtrap_2017.cc+'.format(configurations)
#     ]   
# }
...
aliases['angular_vars'] = {
    'class': 'VBSAngularVars_2017',
    'args': (False),
    'linesToAdd':[
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L {}/VBSjjlnu/macros/VBSAngularVars_2017.cc+'.format(configurations)
    ],
}
#   0) deltaphi_WVplanes
#   1) theta Vhad
