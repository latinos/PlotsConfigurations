...
# cuts["res_sig_mu"] = 'VBS_category_OTF>0 \
...
# cuts["res_wjetcr_ele"] = 'VBS_category_OTF>0 \
#                                 && abs(Lepton_pdgId[0])==11 \
#                                 && vjet_0_pt_OTF > 30 && vjet_1_pt_OTF > 30 \
...
# cuts["res_wjetcr_mu"] = 'VBS_category_OTF>0 \
#                                 && abs(Lepton_pdgId[0])==13 \
#                                 && vjet_0_pt_OTF > 30 && vjet_1_pt_OTF > 30 \
#                                 && mjj_vjet_OTF > 40 && (mjj_vjet_OTF <= 65 || mjj_vjet_OTF >= 105) \
#                                 && bVeto \
...
# cuts["res_topcr_ele"] = 'VBS_category_OTF>0 \
#                                 && abs(Lepton_pdgId[0])==11 \
#                                 && vjet_0_pt_OTF > 30 && vjet_1_pt_OTF > 30 \
#                                 && mjj_vjet_OTF > 65 && mjj_vjet_OTF < 105 \
#                                 && bReqTight \
...
# cuts["res_topcr_mu"] = 'VBS_category_OTF>0 \
#                                 && abs(Lepton_pdgId[0])==13 \
#                                 && vjet_0_pt_OTF > 30 && vjet_1_pt_OTF > 30 \
#                                 && mjj_vjet_OTF > 65 && mjj_vjet_OTF < 105 \
#                                 && bReqTight \
