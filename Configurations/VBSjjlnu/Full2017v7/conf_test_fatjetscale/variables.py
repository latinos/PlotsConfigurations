...
res_cuts= [cut for cut in cuts if 'res' in cut]
boost_cuts= [cut for cut in cuts if 'boost' in cut]
...
variables['mjj_vbs_morebins'] = {   'name': 'mjj_vbs',      
                        ...
                        'xaxis' : 'M_{jj} VBS', 
                        'fold' : 3,
                        'blind': { c:[1000,4000] for c in cuts if 'sig' in cut}
}
...
variables['tau21_boost'] = {   'name': 'Alt$(CleanFatJet_tau21[0],-1)',      
                        'range' : (40,0,1),  
                        'xaxis' : 'Tau21', 
                        'fold' : 0,
                        'cuts':  boost_cuts
...
variables['tau21_res'] = {   'name': 'Alt$(FatJet_tau2[0]/FatJet_tau1[0],-1)',      
                        'range' : (40,0,1),  
                        'xaxis' : 'Tau21', 
                        'fold' : 0,
                        'cuts':  res_cuts
...
variables['mjj_vjet08'] = {   'name': 'mjj_vjet08',      
                        'range' : (80,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3,
                        'cuts': boost_cuts
...
variables['mjj_vjet085'] = {   'name': 'mjj_vjet085',      
                        'range' : (80,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3,
                        'cuts': boost_cuts
...
variables['mjj_vjet083'] = {   'name': 'mjj_vjet083',      
                        'range' : (80,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3,
                        'cuts': boost_cuts
...
variables['mjj_vjet082'] = {   'name': 'mjj_vjet082',      
                        'range' : (80,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3,
                        'cuts': boost_cuts
...
variables['mjj_vjet087'] = {   'name': 'mjj_vjet087',      
                        'range' : (80,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3,
                        'cuts': boost_cuts
...
variables['fatjet_pt_boost'] = {   'name': 'Alt$(CleanFatJet_pt[0],-1)',      
                        'range' : (60,100,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 2
                        }

variables['fatjet_ptzoom'] = {   'name': 'Alt$(FatJet_pt_nom[0],0)',      
                        'range' : (40,100,300),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 0,
                        'cuts':  res_cuts
...
# variables['fatjet_pt09'] = {   'name': 'fatjetpt09',      
#                         'range' : (60,150,800),  
#                         'xaxis' : 'Fatjet pt', 
#                         'fold' : 3,
#                         'cuts':  boost_cuts
...
variables['fatjet_pt08'] = {   'name': 'fatjetpt08',      
                        'range' : (60,150,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 3,
                        'cuts':  boost_cuts
...
variables['fatjet_pt082'] = {   'name': 'fatjetpt082',      
                        'range' : (60,150,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 3,
                        'cuts':  boost_cuts
...
# variables['fatjet_pt095'] = {   'name': 'fatjetpt095',      
#                         'range' : (60,150,800),  
#                         'xaxis' : 'Fatjet pt', 
#                         'fold' : 3,
#                         'cuts':  boost_cuts
...
variables['fatjet_pt085'] = {   'name': 'fatjetpt085',      
                        'range' : (60,150,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 3,
                        'cuts':  boost_cuts
...
variables['fatjet_pt083'] = {   'name': 'fatjetpt083',      
                        'range' : (60,150,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 3,
                        'cuts':  boost_cuts
...
variables['fatjet_pt087'] = {   'name': 'fatjetpt087',      
                        'range' : (60,150,800),  
                        'xaxis' : 'Fatjet pt', 
                        'fold' : 3,
                        'cuts':  boost_cuts
