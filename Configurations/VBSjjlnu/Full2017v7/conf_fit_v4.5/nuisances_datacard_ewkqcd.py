...
mc =["DY", "top", "VV", "VVV", "VBF-V_dipole", "Vg", "VgS","VBS_dipoleRecoil","ggWW", "Wjets_boost"] + wjets_res_bins
# "VBS", "VBF-V",
...
nuisances['pdf_weight'] = {
    ...
    'type'  : 'shape',
    'samples' :  { s: [' Alt$(LHEPdfWeight['+str(i)+'], 1.)' for i in range(0,103)] for s in mc if s not in ["VBS", "VBS_dipoleRecoil","top","Wjets_boost","VV"]+wjets_res_bins},
    'AsLnN':  '1'
}
