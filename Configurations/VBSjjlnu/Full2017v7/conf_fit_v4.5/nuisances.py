...
nuisances['PU']  = {
                ...
                'samples'  : {
                    s : ['(puWeightUp/puWeight) * {}'.format(nuis_factors[s]["CMS_PU_2017"][0]),
                         '(puWeightDown/puWeight) * {}'.format(nuis_factors[s]["CMS_PU_2017"][1])] for s in mc if s not in wjets_res_bins },
                'AsLnN'      : '1',
}
...
nuisances['PU_wjets']  = {
                ...
                'type'  : 'shape',
                'samples'  : {
                    s : ['(puWeightUp/puWeight) * {}'.format(nuis_factors["Wjets_res"]["CMS_PU_2017"][0]),
                         '(puWeightDown/puWeight) * {}'.format(nuis_factors["Wjets_res"]["CMS_PU_2017"][1])] for s in wjets_res_bins },
                'AsLnN'      : '1',
}
...
nuisances = {k:v for k,v in nuisances.items() if k =='dipole' } #if 'PS' in k or 'QCD' in k
