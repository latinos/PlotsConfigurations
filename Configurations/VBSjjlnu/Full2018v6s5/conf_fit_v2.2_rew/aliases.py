...
aliases['detavbs_jetpt_weight'] = {
    'expr':'(abs(Lepton_pdgId[0])==11)*(\
                    (VBS_category==0)* \
                        (   0.64402*( deltaeta_vbs < 5) + \
                            0.50038*(deltaeta_vbs >= 5) \
                        )+\
                    (VBS_category==1) * \
                        (   1.01516* ((deltaeta_vbs < 5)  && vbs_1_pt < 75) + \
                            1.29124* ((deltaeta_vbs >= 5)  && vbs_1_pt < 75) + \
                            \
                            0.88576* ((deltaeta_vbs < 4)  &&  ( vbs_1_pt >= 75 && vbs_1_pt <150) ) + \
                            1.13063* ((deltaeta_vbs >= 4) &&  ( vbs_1_pt >= 75 && vbs_1_pt <150) ) + \
                            0.72970* ( vbs_1_pt >= 150 ) \
                        )\
            )+ (abs(Lepton_pdgId[0])==13)*(\
                    (VBS_category==0)* \
                        (   0.43365*( deltaeta_vbs < 5) + \
                            0.47277*(deltaeta_vbs >= 5) \
                        )+\
                    (VBS_category==1) * \
                        (   0.97166* ((deltaeta_vbs < 5)  && vbs_1_pt < 75) + \
                            1.14509* ((deltaeta_vbs >= 5)  && vbs_1_pt < 75) + \
                            \
                            0.79567* ((deltaeta_vbs < 4)  &&  ( vbs_1_pt >= 75 && vbs_1_pt <150) ) + \
                            0.91422* ((deltaeta_vbs >= 4) &&  ( vbs_1_pt >= 75 && vbs_1_pt <150) ) + \
                            0.53602* ( vbs_1_pt >= 150 ) \
                        )\
            )'
}
