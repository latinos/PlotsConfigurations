...
class WhadPt : public multidraw::TTreeFunction {
public:
  WhadPt():TTreeFunction(){};

  char const* getName() const override { return "WhadPt"; }
  TTreeFunction* clone() const override { return new WhadPt(); }
...
void
WhadPt::bindTree_(multidraw::FunctionLibrary& _library)
{   
