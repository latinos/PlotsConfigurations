...
# VBS vars
variables['mjj_vbs_morebins'] = {   'name': 'mjj_vbs_jer',      
                        'range' : (20,200,4000) , 
                        'xaxis' : 'M_{jj} VBS', 
                        'fold' : 3,
...
variables['vbs_0_pt'] = {   'name': 'vbs_0_pt_jer',      
                        'range' : (30,0,400),  
...
variables['vbs_1_pt'] = {   'name': 'vbs_1_pt_jer',      
                        'range' : (30,0,400),  
...
variables['mjj_vjet'] = {   'name': 'mjj_vjet_jer',      
                        'range' : (42,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3
                        }

variables['mjj_vjet_morebins'] = {   'name': 'mjj_vjet_jer',      
                        'range' : (70,40,250),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3
                        }
...
variables['vjet_0_pt'] = {   'name': 'vjet_0_pt_jer',      
                        'range' : (30,30,400),  
                        'xaxis' : 'leading V-jet pt', 
                        'fold' : 3
                        }

variables['vjet_1_pt'] = {   'name': 'vjet_1_pt_jer',      
                        'range' : (30,30,200),  
