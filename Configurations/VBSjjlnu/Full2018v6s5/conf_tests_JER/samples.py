...
samples['Wjets'] = { 'name' :   
        ...
        'subsamples': {
          ...
          "deta1_jpt1": "(VBS_category==1) && (deltaeta_vbs < 5 ) && vbs_1_pt_jer < 75",
          "deta2_jpt1": "(VBS_category==1) && (deltaeta_vbs >= 5) && vbs_1_pt_jer < 75",
          
          "deta1_jpt2": "(VBS_category==1) && (deltaeta_vbs < 4 ) &&  ( vbs_1_pt_jer >= 75 && vbs_1_pt_jer <150)",
          "deta2_jpt2": "(VBS_category==1) && (deltaeta_vbs >= 4) &&  ( vbs_1_pt_jer >= 75 && vbs_1_pt_jer <150)",

          "jpt3": "(VBS_category==1) && ( vbs_1_pt_jer >= 150)",
