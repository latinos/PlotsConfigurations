...
cuts["res_wjetcr_mjjincl_mjjvjetlow_ele"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==11 \
                                && Lepton_pt[0] >= 40 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && (mjj_vjet <= 65) \
...
cuts["res_wjetcr_mjjincl_mjjvjethigh_ele"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==11 \
                                && Lepton_pt[0] >= 40 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && (mjj_vjet >= 105) \
...
cuts["res_wjetcr_mjjincl_mjjvjetlow_mu"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==13 \
                                && Lepton_pt[0] >= 30 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && (mjj_vjet <= 65) \
...
cuts["res_wjetcr_mjjincl_mjjvjethigh_mu"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==13 \
                                && Lepton_pt[0] >= 30 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && (mjj_vjet >= 105) \
...
cuts["boost_wjetcr_mjjincl_mjjvjetlow_ele"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==11 \
                                && Lepton_pt[0] >= 40 \
                                && vjet_0_pt > 200 \
                                && ( mjj_vjet <= 65 ) \
...
cuts["boost_wjetcr_mjjincl_mjjvjethigh_ele"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==11 \
                                && Lepton_pt[0] >= 40 \
                                && vjet_0_pt > 200 \
                                && ( mjj_vjet >= 105) \
...
cuts["boost_wjetcr_mjjincl_mjjvjetlow_mu"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==13 \
                                && Lepton_pt[0] >= 30 \
                                && vjet_0_pt > 200 \
                                && ( mjj_vjet <= 65 ) \
...
cuts["boost_wjetcr_mjjincl_mjjvjethigh_mu"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==13 \
                                && Lepton_pt[0] >= 30 \
                                && vjet_0_pt > 200 \
                                && ( mjj_vjet >= 105) \
