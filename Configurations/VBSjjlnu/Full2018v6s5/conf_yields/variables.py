...
# for d in ["dnnall", "dnnhigh", "fnal"]:
#     for cat in ["sig", "wjetcr", "topcr"]:
#         phase_spaces_boost.append("boost_{}_{}".format(cat, d))
#         phase_spaces_res.append("res_{}_{}".format(cat, d))

# phase_spaces_tot = phase_spaces_res+phase_spaces_boost
...
#     'blind': {  c :[0.6,1] for c in phase_spaces_res if "sig" in c }
# }
...
#     'blind': {  c :[0.6,1] for c in phase_spaces_boost if "sig" in c }
# }
...
# #     #'divideByBinWidth' : 1,
# #     'blind': {
# #         "res_sig_dnnhigh": [0.6,1], 
# #         "res_sig_dnnall": [0.6,1],
# #         "res_sig_fnal": [0.6,1],
# #         "boost_sig_dnnhigh": [0.6,1], 
# #         "boost_sig_dnnall": [0.6,1],
# #     }
# # }
...
#                         'xaxis' : 'M_{jj} VBS', 
#                         'fold' : 3,
#                         'blind': {  c :[1500,4000] for c in phase_spaces_tot if "sig" in c }
#             }
...
#                         'fold' : 3,
#                         'blind' : {
#                             "res_sig_dnnhigh" :(1000,2000),
#                             "res_sig_dnnhigh" : (1000,2000),
#                             "boost_sig_dnnhigh" :(1000,2000),
#                             "boost_sig_dnnhigh" : (1000,2000),
#                             "res_sig_dnnall" :(1000,2000),
#                             "res_sig_dnnall" : (1000,2000),
#                             "boost_sig_dnnall" :(1000,2000),
#                             "boost_sig_dnnall" : (1000,2000),
#                             "res_sig_fnal" :(1000,2000),
#                             "res_sig_fnal" : (1000,2000),
#                             "boost_sig_fnal" :(1000,2000),
#                             "boost_sig_fnal" : (1000,2000),
#                             }
#                         }
