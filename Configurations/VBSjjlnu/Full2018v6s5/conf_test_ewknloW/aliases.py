...
aliases["W_EWK_correction"] = {
    'class': 'V_EWKcorrection',
    'args': (os.getenv('CMSSW_BASE') +"/src/LatinoAnalysis/Gardener/python/data/ewk/kewk_w_for_python.txt", 1),
    'linesToAdd' : [
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L {}/VBSjjlnu/Full2018v6s5/corrections/V_EWK_NLO_weights.cc+'.format(configurations)
    ],
    'samples': ["Wjets"]
}

aliases["Z_EWK_correction"] = {
    'class': 'V_EWKcorrection',
    'args': (os.getenv('CMSSW_BASE') +"/src/LatinoAnalysis/Gardener/python/data/ewk/kewk_z_for_python.txt", 1),
    'linesToAdd' : [
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L {}/VBSjjlnu/Full2018v6s5/corrections/V_EWK_NLO_weights.cc+'.format(configurations)
    ],
