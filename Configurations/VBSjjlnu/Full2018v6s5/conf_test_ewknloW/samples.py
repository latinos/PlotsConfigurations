...
samples['DY'] = {    
  'name':   nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-4to50_HT-100to200') 
          ...
          ,
    'weight' : XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'*Z_EWK_correction', # '*' + DY_photon_filter , ###### ADD ewkNLO!!!
    'FilesPerJob' : 3,
}
...
samples['Wjets'] = { 'name' :   
          ...
          ,
				'weight': XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'*W_EWK_correction',
				'FilesPerJob' : 2,
        # 'subsamples': {
