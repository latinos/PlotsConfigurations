...
aliases["detavbs_jetpt_genbin_resolved"] = {
    'class': 'GenJetBin_resolved',
    'args': ( ),
    'linesToAdd':[
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L %s/conf_test_genbins/genjetbin_resolved.cc+' % conf_folder, 
    ],
    'samples': mc
}

aliases["detavbs_genbin_boost"] = {
    'class': 'GenJetBin_boost',
    'args': ( ),
    'linesToAdd':[
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        '.L %s/conf_test_genbins/genjetbin_boost.cc+' % conf_folder, 
    ],
    'samples': mc
}
