...
samples['top'] = {    
            ...
            'weight' :  XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'* btagSF * Top_pTrw' , # New top pt reweighting
            'FilesPerJob' : 3,
}
...
samples["Wjets_LO"] = { 'name' :   
      ...
      'FilesPerJob' : 4, 
      'subsamples': {
          "boost1": "(VBS_category==0) && detavbs_genbin_boost == 1",
          "boost2": "(VBS_category==0) && detavbs_genbin_boost == 2",
          "deta1_jpt1": "(VBS_category==1) && detavbs_jetpt_genbin_resolved==1",
          "deta2_jpt1": "(VBS_category==1) && detavbs_jetpt_genbin_resolved==2",
          "deta1_jpt2": "(VBS_category==1) && detavbs_jetpt_genbin_resolved==3",
          "deta2_jpt2": "(VBS_category==1) && detavbs_jetpt_genbin_resolved==4",
          "jpt3": "(VBS_category==1) && detavbs_jetpt_genbin_resolved==5"
...
#samples = {   key:v for key,v in samples.items() if key in ["Wjets_LO", "Wjets_njetsLO"]}