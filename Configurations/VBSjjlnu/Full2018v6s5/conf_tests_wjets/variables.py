...
variables['Vpt_LHE']  = {   'name': 'LHE_Vpt',      
                                'range' : (6,0,6),  
                                'xaxis' : 'Njets', 
                                'fold' : 3
                        }
...
#                         'range' : (40,50,150),  
#                         'xaxis' : 'W had FatJet soft-drop Puppi mass', 
#                         'fold' : 3
#                         }

# variables['mjj_vjet_lessbins'] = {   'name': 'mjj_vjet',      
#                         'range' : (25,50,250),  
#                         'xaxis' : 'Whad reco mass', 
#                         'fold' : 3
#                         }

# variables['mjj_vjet_boost_lessbins'] = {   'name': 'mjj_vjet',      
#                         'range' : (25,50,150),  
#                         'xaxis' : 'W had FatJet soft-drop Puppi mass', 
#                         'fold' : 3
#                         }
