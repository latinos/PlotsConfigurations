...
# Steps
mcSteps   = 'MCl1loose2018v6__VBSjjlnuSkim2018v5' 
...
directory_bkg    = treeBaseDirNLO + 'Autumn18_102X_nAODv6_Full2018v6/'+mcSteps
...
#             'weight' :  XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +"* btagSF" , #no Top pt reweighting
#             'FilesPerJob' : 2,
# }
...
samples = {   key:v for key,v in samples.items() if key in ["Wjets_NLO"]}