...
palette = {
    ...
    "Wjets_lpt1": (247, 135, 7),#
    "Wjets_lpt2": (247, 155, 7),#f79b07
    "Wjets_lpt3": (247, 175, 7), #f7af07
    "Wjets_lpt4": (247, 195, 7), #f7c307
    "Wjets_lpt5": (247, 215, 7), #f7d707
    "Wjets_lpt6": (247, 235, 7), #f7eb07
}
...
for ibin, lptbin in enumerate(Wjets_lptbins): 
    groupPlot[lptbin]  = {  
                    'nameHR' : 'W+Jets_{}'.format(ibin),
                    'isSignal' : 0,
                    'color':   palette[lptbin],
                    'samples'  : [lptbin],
                    'fill': 1001
                }
