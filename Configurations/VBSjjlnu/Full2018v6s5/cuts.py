...
cuts["res_sig_mjjincl_ele_cuteta"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && mjj_vjet > 65 && mjj_vjet < 105 \
...
cuts["res_topcr_mjjincl_ele_cuteta"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && mjj_vjet > 65 && mjj_vjet < 105 \
...
cuts["res_wjetcr_mjjincl_ele_cuteta"] = 'VBS_category==1 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 30 && vjet_1_pt > 30 \
                                && (mjj_vjet <= 65 || mjj_vjet >= 105) \
...
cuts["boost_sig_mjjincl_ele_cuteta"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 200 \
                                && mjj_vjet > 65 && mjj_vjet < 105 \
...
cuts["boost_wjetcr_mjjincl_ele_cuteta"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 200 \
                                && (mjj_vjet <= 65 || mjj_vjet >= 105) \
...
cuts["boost_topcr_mjjincl_ele_cuteta"] = 'VBS_category==0 \
                                && abs(Lepton_pdgId[0])==11 \
                                && abs(Lepton_eta[0])<=2 \
                                && vjet_0_pt > 200 \
                                && mjj_vjet > 65 && mjj_vjet < 105 \
