...
mc =["DY", "top", "VV", "VVV", "VBF-V", "top", "VBS", "Wjets_HT", "Wjets_LO", "Wjets_njetsLO", "Wjets"]
...
nuisances['jes_others']  = {
                ...
                'kind'  : 'tree',
                'type'  : 'shape',
                'samples'  : dict((skey, ['1', '1']) for skey in mc if skey not in ["Wjets_NLO", "Wjets", "Wjets_HT","Wjets_LO","Wjets_njetsLO","DY", "top", "VBS", "DY_NLO", "VV", "VBF-V"]),
