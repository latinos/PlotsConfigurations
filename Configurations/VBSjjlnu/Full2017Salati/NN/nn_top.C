...
void nn_top(  ) {
 ...
 TString outfileName;
 outfileName = "nn_top.root"; //nome del file root di output
 TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

 TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile,
                                              "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );

TMVA::DataLoader* dataloader = new TMVA::DataLoader("dataset_top") ;
...
//Wjets
 ...
 background2->Add("/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_102X_nAODv4_Full2017v5/MCl1loose2017v5__MCCorr2017v5__VBSjjlnuSkim2017v3__VBSjjlnuSkim2017v3_fatjet/nanoLatino_TTTo2L2Nu__part*");
 background2->Add("/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_102X_nAODv4_Full2017v5/MCl1loose2017v5__MCCorr2017v5__VBSjjlnuSkim2017v3__VBSjjlnuSkim2017v3_fatjet/nanoLatino_TTWjets__part*");
...
//si possono definire dei pesi, ma è opzionale (puoi lasciare a 1)
 ...
 dataloader->SetSignalWeightExpression    ("XSWeight*puWeight*METFilter_MC*\
                   TriggerEffWeight_1l*\
                   Lepton_RecoSF[0]*\
                   EMTFbug_veto*\
                   (Lepton_isTightElectron_mvaFall17V2Iso_WP90[0]>0.5 || Lepton_isTightMuon_cut_Tight_HWWW[0]>0.5)*\
                   Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF[0]*\
                   Lepton_tightMuon_cut_Tight_HWWW_IdIsoSF[0]*\
                   PrefireWeight");
 dataloader->SetBackgroundWeightExpression ("XSWeight*puWeight*METFilter_MC*\
                   TriggerEffWeight_1l*\
                   Lepton_RecoSF[0]*\
                   EMTFbug_veto*\
                   (Lepton_isTightElectron_mvaFall17V2Iso_WP90[0]>0.5 || Lepton_isTightMuon_cut_Tight_HWWW[0]>0.5)*\
...
//si possono defire dei tagli (analoghi a quelli che applichi alle tue NTuple), ma anche questo è opzionale e puoi lasciare a 1
 TCut mycuts = "(Sum$(CleanJet_pt > 20. && abs(CleanJet_eta)<2.5 && Jet_btagDeepB[CleanJet_jetIdx] > 0.1522) == 0) \
                 && nLepton==1 && Lepton_pt[0]>30  \
                 &&  (  Lepton_isTightElectron_mvaFall17V2Iso_WP90[0] > 0.5  || Lepton_isTightMuon_cut_Tight_HWWW[0] > 0.5) \
                 && vbs_pt_low >= 30  \
                 && mjj_vbs >=300  && deltaeta_vbs >= 2  "; 
TCut mycutb = mycuts;
//&& VBS_category == 0  
