...
void nn_W_BGFS(  ) {
 ...
 TString outfileName;
 outfileName = "nn_W_BGFS.root"; //nome del file root di output
 TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

 TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile,
                                              "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );

TMVA::DataLoader* dataloader = new TMVA::DataLoader("datasetW_BGFS") ;
...
//spectators
 dataloader->AddSpectator( "vbs_eta_high" ); 
 dataloader->AddSpectator( "deltaeta_lep_vbs_high" );
 dataloader->AddSpectator( "deltaeta_lep_vbs_low" );
 dataloader->AddSpectator( "CleanFatJet_pt[0]" );
 dataloader->AddSpectator( "vbs_pt_high" );
 dataloader->AddSpectator( "mjj_vbs" );
 dataloader->AddSpectator( "Ht" );
 dataloader->AddSpectator( "R_mw" );
 dataloader->AddSpectator( "Asym_vbs" );
 dataloader->AddSpectator( "Zlep" );
