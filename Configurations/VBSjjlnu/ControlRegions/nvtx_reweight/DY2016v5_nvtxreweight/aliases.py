...
nvtx_reweight_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/VBSjjlnu/ControlRegions/nvtx_reweight/DY2016v5_nvtxreweight/nvtx_reweight/'
