...
python -i reweight_variable_closure.py --file ../../Full2018v5/rootFile/plots_DY2018v5.root --file_weight reweighting_Zmm_fit.txt \
...
python -i reweight_variable_closure.py --file ../../Full2018v5/rootFile/plots_DY2018v5.root --file_weight reweighting_Zee_fit.txt \
...
# some checks
python -i nvtx_zmm_zee.py --file ../../Full2018v5/rootFile/plots_DY2018v5.root --var nvtx --samples ggWW Vg top WW VVV DY VgS VZ
