...
cuts['Zee_jpt30']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 30) \
               '
...
cuts['Zee_jpt40']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 40) \
               '
...
cuts['Zee_jpt50']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 50) \
               '
...
cuts['Zee_jpt60']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 60) \
               '
...
cuts['Zee_jpt80']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 80) \
               '
...
cuts['Zee_jpt100']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                 ...
                 && mll>60 && mll<120 \
                 && nCleanJet>=1 \
                 && (abs(CleanJet_eta[0]) < 2.5 || abs(CleanJet_eta[1]) > 3.2 || CleanJet_pt[0] > 100) \
               '
