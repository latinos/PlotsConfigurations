...
mcSteps = 'MCl1loose2016v6__MCCorr2016v6__l2loose__l2tightOR2016v6'
...
DataRun_muonEG =  [
    'MuonEG_Run2016B-Nano1June2019_ver2-v1',
    'MuonEG_Run2016C-Nano1June2019-v1',
    'MuonEG_Run2016D-Nano1June2019-v1',
    'MuonEG_Run2016E-Nano1June2019-v3', # <<--- v3
    'MuonEG_Run2016F-Nano1June2019-v1',
    'MuonEG_Run2016G-Nano1June2019-v1',
    'MuonEG_Run2016H-Nano1June2019-v1'
]

# Muon EG is different
...
for sd in DataRun_muonEG:
    files = nanoGetSampleFiles(fakeDirectory, sd)
    samples['Fake']['name'].extend(files)
    samples['Fake']['weights'].extend([DataTrig["MuonEG"]] * len(files))
...
for sd in DataRun_muonEG:
    files = nanoGetSampleFiles(dataDirectory, sd)
    samples['DATA']['name'].extend(files)
    samples['DATA']['weights'].extend([DataTrig["MuonEG"]] * len(files))