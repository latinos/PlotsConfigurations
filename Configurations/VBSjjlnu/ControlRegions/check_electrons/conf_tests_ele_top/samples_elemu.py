...
DataSets = ['MuonEG'] # FIXME (dario): different dataset in 2018? 
...
samples['DY'] = {    
  'name':   nanoGetSampleFiles(directory,'DYJetsToLL_M-4to50_HT-100to200') 
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-4to50_HT-200to400')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-4to50_HT-400to600')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-4to50_HT-600toInf')
          # + nanoGetSampleFiles(directory,'DYJetsToLL_M-5to50-LO')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-10to50-LO_ext1') # covered by: DYJetsToLL_M-5to50-LO
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_ext2')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-70to100')  
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-100to200')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-200to400')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-400to600')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-600to800')
          + nanoGetSampleFiles(directory,'DYJetsToLL_M-50_HT-800to1200')
