...
aliases['vbs_0_qgl_res'] = {
   'expr': 'Alt$(Jet_qgl[CleanJet_jetIdx[VBS_jets_maxmjj_massWZ[0]]],-1)'
} 


aliases['vjet_0_qgl_res'] = {
    'expr': 'Alt$(Jet_qgl[CleanJet_jetIdx[V_jets_maxmjj_massWZ[0]]],-1)'
} 

aliases['vjet_1_qgl_res'] = {
    'expr': 'Alt$(Jet_qgl[CleanJet_jetIdx[V_jets_maxmjj_massWZ[1]]],-1)'
} 

aliases['vbs_0_qgl_boost'] = {
    'expr': 'Alt$(Jet_qgl[CleanJet_jetIdx[VBS_jets_maxmjj[0]]],-1)'
} 

aliases['vbs_1_qgl_boost'] = {
    'expr': 'Alt$(Jet_qgl[CleanJet_jetIdx[VBS_jets_maxmjj[1]]],-1)'
} 

###########
# ## morphUP

aliases['vbs_0_qgl_res_morphed'] = {
   'expr': 'Alt$(CleanJet_qgl_morphed[VBS_jets_maxmjj_massWZ[0]],-1)'
} 


aliases['vjet_0_qgl_res_morphed'] = {
    'expr': 'Alt$(CleanJet_qgl_morphed[V_jets_maxmjj_massWZ[0]],-1)'
} 

aliases['vjet_1_qgl_res_morphed'] = {
    'expr': 'Alt$(CleanJet_qgl_morphed[V_jets_maxmjj_massWZ[1]],-1)'
} 

aliases['vbs_0_qgl_boost_morphed'] = {
    'expr': 'Alt$(CleanJet_qgl_morphed[VBS_jets_maxmjj[0]],-1)'
} 

aliases['vbs_1_qgl_boost_morphed'] = {
...
aliases['QGL_weight'] = {
    'expr': '(VBS_category==0)*(Alt$(CleanJet_qgl_weights[VBS_jets_maxmjj[0]],1.)) + \
             (VBS_category==1)*(Alt$(CleanJet_qgl_weights[VBS_jets_maxmjj_massWZ[0]],1.)*Alt$(CleanJet_qgl_weights[V_jets_maxmjj_massWZ[0]],1.)*Alt$(CleanJet_qgl_weights[V_jets_maxmjj_massWZ[1]],1.))\
             +(VBS_category<0)*1',
    'samples':mc
}
