...
aliases['gen_analysis'] = {
    ...
    'linesToAdd': [
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
            '.L {}/VBSjjlnu/macros/reweight_genlevel_3d.cc+'.format(configurations)
    ],
...
btagSF_corr_samples_groups = {
    'VBS': ['VBS','VBS_noZLL'],
    'VBS_dipoleRecoil': ['VBS_dipoleRecoil','VBS_noZLL_dipoleRecoil'],
    'Wjets_HT': ['Wjets_HT'],
...
aliases['QCDscale_normalized'] = {
            ...
            'samples':['VBS','VBS_dipoleRecoil','VBS_noZLL']          
}
