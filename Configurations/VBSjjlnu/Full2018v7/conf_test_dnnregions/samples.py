...
samples['DY'] = {    'name'   :   nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-50') #Don't use LO(_ext0)! DYMVA Training!
                       ...
                       'EventsPerJob' : 70000,
                       'subsamples': {
                         "boost_1": "DNNoutput_boosted <= 0.1",
                         "boost_2": "DNNoutput_boosted > 0.1 && DNNoutput_boosted <= 0.2",
                         "boost_3": "DNNoutput_boosted > 0.2 && DNNoutput_boosted <= 0.4",
                         "boost_4": "DNNoutput_boosted > 0.4 && DNNoutput_boosted <= 0.65",
                         "boost_5": "DNNoutput_boosted > 0.65",
                         "res_1": "DNNoutput_resolved_v1 <= 0.2",
                         "res_2": "DNNoutput_resolved_v1 > 0.2 && DNNoutput_resolved_v1 <= 0.4",
                         "res_3": "DNNoutput_resolved_v1 > 0.4 && DNNoutput_resolved_v1 <= 0.6",
                         "res_4": "DNNoutput_resolved_v1 > 0.6 && DNNoutput_resolved_v1 <= 0.8",
                         "res_5": "DNNoutput_resolved_v1 > 0.8",
                       }
