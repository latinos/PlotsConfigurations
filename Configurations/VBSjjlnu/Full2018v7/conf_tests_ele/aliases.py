...
aliases['otherPV_dz0'] = {
    'expr' : 'Alt$(OtherPV_z[0],999) - (PV_z + Electron_dz[Lepton_electronIdx[0]])'
}

aliases['otherPV_dz1']= {
    'expr' : 'Alt$(OtherPV_z[1],999) - (PV_z + Electron_dz[Lepton_electronIdx[0]])'
}

aliases['otherPV_dz2']= {
    'expr' : 'Alt$(OtherPV_z[2],999) - (PV_z + Electron_dz[Lepton_electronIdx[0]])'
}

aliases['otherPV_dz3']= {
    'expr' : 'Alt$(OtherPV_z[3],999) - (PV_z + Electron_dz[Lepton_electronIdx[0]])'
}