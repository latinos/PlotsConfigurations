...
aliases['DNNoutput_resolved'] = {
    'class': 'MVAReaderResolved_mVscan',
    'args': ( models_path+ 'res_sig/models/v4_d/',models_path+ 'res_sig/models/v4_d/cumulative_signal_2018.root', 
            False, 1, 55, 115, 10),
    'linesToAdd':[
        'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
        'gSystem->Load("libDNNEvaluator.so")',
        '.L ' + mva_reader_path + 'mva_reader_resolved_v4d_mVscan.cc+', 
    ],
}
