...
variablesFile = direc+'/variables_signalregion.py'

# file with list of cuts
cutsFile = direc +'/cuts_signalonly.py' 
...
outputDirDatacard = 'datacards_'+tag +"_v5SignalPlots"
