...
variables['deltaeta_vbs'] = {   'name': 'deltaeta_vbs_alt',      
                        'range' : (16,2,8),  
...
# VBS vars
variables['mjj_vbs_morebins'] = {   'name': 'mjj_vbs_alt',      
                        'range' : (20,200,4000) , 
                        'xaxis' : 'M_{jj} VBS', 
                        'fold' : 3,
...
variables['vbs_0_pt'] = {   'name': 'vbs_0_pt_alt',      
                        'range' : (30,0,400),  
...
variables['vbs_1_pt'] = {   'name': 'vbs_1_pt_alt',      
                        'range' : (30,0,400),  
...
variables['deltaphi_vbs'] = {   'name': 'deltaphi_vbs_alt',      
                        'range' : (30,0,3.5),  
...
variables['mjj_vjet_morebins'] = {   'name': 'mjj_vjet_alt',      
                        'range' : (50,40,200),  
                        'xaxis' : 'Whad reco mass', 
                        'fold' : 3
                        }
...
variables['vjet_0_pt'] = {   'name': 'vjet_0_pt_alt',      
                        'range' : (30,30,400),  
                        'xaxis' : 'leading V-jet pt', 
                        'fold' : 3
                        }

variables['vjet_1_pt'] = {   'name': 'vjet_1_pt_alt',      
                        'range' : (30,30,200),  
                        'xaxis' : 'trailing V-jet pt', 
                        'fold' : 3
                        }

variables['vjet_0_eta'] = {   'name': 'vjet_0_eta_alt',      
                        'range' : (40,-5,5),  
                        'xaxis' : 'leading Vjet #eta', 
                        'fold' : 3
                        }

variables['vjet_1_eta'] = {   'name': 'vjet_1_eta_alt',      
                        'range' : (40,-5,5),  
                        'xaxis' : 'trailing Vjet #eta', 
                        'fold' : 3
                        }

variables['vjet_0_eta_abs'] = {   'name': 'abs(vjet_0_eta_alt)',      
                        'range' : (30,0,5),  
                        'xaxis' : 'leading Vjet #eta', 
                        'fold' : 3
                        }

variables['vjet_1_eta_abs'] = {   'name': 'abs(vjet_1_eta_alt)',      
                        'range' : (30,0,5),  
                        'xaxis' : 'trailing Vjet #eta', 
                        'fold' : 3
                        }
...
# # #
variables['vbs_0_eta'] = {   'name': 'vbs_0_eta_alt',      
                        'range' : (40,-5,5),  
                        'xaxis' : 'leading VBS jet #eta', 
                        'fold' : 3
                        }

variables['vbs_1_eta'] = {   'name': 'vbs_1_eta_alt',      
                        'range' : (40,-5,5),  
                        'xaxis' : 'trailing VBS jet #eta', 
                        'fold' : 3
                        }

variables['vbs_0_eta_abs'] = {   'name': 'abs(vbs_0_eta_alt)',      
                        'range' : (30,0,5),  
                        'xaxis' : 'leading VBS jet #eta', 
                        'fold' : 3
                        }

variables['vbs_1_eta_abs'] = {   'name': 'abs(vbs_1_eta_alt)',      
                        'range' : (30,0,5),  
                        'xaxis' : 'trailing VBS jet #eta', 
                        'fold' : 3
                        }
...
variables['vbs_etaprod'] = {   'name': 'vbs_0_eta_alt*vbs_1_eta_alt',      
                        'range' : (30,-10,10),  
...
variables["vbs_index_0"] = {   'name': 'VBS_jets_maxPt_massWZ[0]',      
                        'range' : (10,0,10),  
                        'xaxis' : 'Index leading VBS jet', 
                        'fold' : 3
                        }

variables["vbs_index_1"] = {   'name': 'VBS_jets_maxPt_massWZ[1]',      
                        'range' : (10,0,10),  
                        'xaxis' : 'Index trailing VBS jet', 
                        'fold' : 3
                        }

variables["vjet_index_0"] = {   'name': 'V_jets_maxPt_massWZ[0]',      
                        'range' : (10,0,10),  
                        'xaxis' : 'Index leading V-jet', 
                        'fold' : 3
                        }

variables["vjet_index_1"] = {   'name': 'V_jets_maxPt_massWZ[1]',      
                        'range' : (10,0,10),  
