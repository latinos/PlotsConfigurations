...
# Tight top
# cuts["boost_sig_incl"] = 'VBS_category==0 \
#                             && w_had_pt >= 200 \
#                             && mjj_vjet > 70 && mjj_vjet < 115 \
#                             && bVeto \
#                             '
...
cuts["boost_wjetcr_offshell_ele"] = 'VBS_category==0 \
...
cuts["boost_wjetcr_offshell_mu"] = 'VBS_category==0 \
...
cuts["boost_wjetcr_offshell_dnnhigh_ele"] = 'VBS_category==0 \
                            && abs(Lepton_pdgId[0])==11 \
                            && w_had_pt >= 200 \
                            && mjj_vjet > 40 && (mjj_vjet <= 70 || mjj_vjet >= 115) \
                            && bVeto \
                            && DNNoutput_boosted[0] >= 0.55 \
                            '

cuts["boost_wjetcr_offshell_dnnhigh_mu"] = 'VBS_category==0 \
                            && abs(Lepton_pdgId[0])==13 \
                            && w_had_pt >= 200 \
                            && mjj_vjet > 40 && (mjj_vjet <= 70 || mjj_vjet >= 115) \
                            && bVeto \
