...
int main(int argc, char** argv){
    ...
    for (auto & sample : samples_mc){
        ...
        std::map<string, RResultPtr<TH1D>> histos = {
            ...
            {"vjet0_higheta_gluon", df_vjet0_gluon.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vjet0_higheta_gluon").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet0_higheta_quark", df_vjet0_quark.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vjet0_higheta_quark").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet1_higheta_gluon", df_vjet1_gluon.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vjet1_higheta_gluon").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vjet1_higheta_quark", df_vjet1_quark.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vjet1_higheta_quark").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vbs0_higheta_gluon", df_vbs0_gluon.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vbs0_higheta_gluon").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs0_higheta_quark", df_vbs0_quark.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vbs0_higheta_quark").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs1_higheta_gluon", df_vbs1_gluon.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vbs1_higheta_gluon").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},
            {"vbs1_higheta_quark", df_vbs1_quark.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vbs1_higheta_quark").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},

            {"vjet0_loweta_gluon", df_vjet0_gluon.Filter("vjet_0_aeta <= 2.5").Histo1D({(sample+ "_vjet0_loweta_gluon").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet0_loweta_quark", df_vjet0_quark.Filter("vjet_0_aeta <= 2.5").Histo1D({(sample+ "_vjet0_loweta_quark").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet1_loweta_gluon", df_vjet1_gluon.Filter("vjet_1_aeta <= 2.5").Histo1D({(sample+ "_vjet1_loweta_gluon").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vjet1_loweta_quark", df_vjet1_quark.Filter("vjet_1_aeta <= 2.5").Histo1D({(sample+ "_vjet1_loweta_quark").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vbs0_loweta_gluon", df_vbs0_gluon.Filter("vbs_0_aeta <= 2.5").Histo1D({(sample+ "_vbs0_loweta_gluon").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs0_loweta_quark", df_vbs0_quark.Filter("vbs_0_aeta <= 2.5").Histo1D({(sample+ "_vbs0_loweta_quark").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs1_loweta_gluon", df_vbs1_gluon.Filter("vbs_1_aeta <= 2.5").Histo1D({(sample+ "_vbs1_loweta_gluon").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},
            {"vbs1_loweta_quark", df_vbs1_quark.Filter("vbs_1_aeta <= 2.5").Histo1D({(sample+ "_vbs1_loweta_quark").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},
            ...
            {"vjet0_gluon_pt_loweta", df_vjet0_gluon.Filter("vjet_0_aeta <= 2.5").Histo1D({(sample+ "_vjet0_gluon_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet0_quark_pt_loweta", df_vjet0_quark.Filter("vjet_1_aeta <= 2.5").Histo1D({(sample+ "_vjet0_quark_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet1_gluon_pt_loweta", df_vjet1_gluon.Filter("vbs_0_aeta <= 2.5").Histo1D({(sample+ "_vjet1_gluon_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            {"vjet1_quark_pt_loweta", df_vjet1_quark.Filter("vbs_1_aeta <= 2.5").Histo1D({(sample+ "_vjet1_quark_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            
            {"vbs0_gluon_pt_loweta", df_vbs0_gluon.Filter("vjet_0_aeta <= 2.5").Histo1D({(sample+ "_vbs0_gluon_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs0_quark_pt_loweta", df_vbs0_quark.Filter("vjet_1_aeta <= 2.5").Histo1D({(sample+ "_vbs0_quark_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs1_gluon_pt_loweta", df_vbs1_gluon.Filter("vbs_0_aeta <= 2.5").Histo1D({(sample+ "_vbs1_gluon_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},
            {"vbs1_quark_pt_loweta", df_vbs1_quark.Filter("vbs_1_aeta <= 2.5").Histo1D({(sample+ "_vbs1_quark_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},

            {"vjet0_gluon_pt_higheta", df_vjet0_gluon.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vjet0_gluon_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet0_quark_pt_higheta", df_vjet0_quark.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vjet0_quark_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet1_gluon_pt_higheta", df_vjet1_gluon.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vjet1_gluon_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            {"vjet1_quark_pt_higheta", df_vjet1_quark.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vjet1_quark_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            
            {"vbs0_gluon_pt_higheta", df_vbs0_gluon.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vbs0_gluon_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs0_quark_pt_higheta", df_vbs0_quark.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vbs0_quark_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs1_gluon_pt_higheta", df_vbs1_gluon.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vbs1_gluon_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},
            {"vbs1_quark_pt_higheta", df_vbs1_quark.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vbs1_quark_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},
    ...
    for (auto & sample : samples_data){
        ...
        std::map<string, RResultPtr<TH1D>> histos = {
            ...
            {"vjet0_higheta", rdfb.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vjet0_higheta").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet1_higheta", rdfb.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vjet1_higheta").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vbs0_higheta", rdfb.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vbs0_higheta").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs1_higheta", rdfb.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vbs1_higheta").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},

            {"vjet0_loweta", rdfb.Filter("vjet_0_aeta <= 2.5").Histo1D({(sample+ "_vjet0_loweta").c_str(), "QGL", 100,0,1}, "vjet_0_qgl_res", "weight")},
            {"vjet1_loweta", rdfb.Filter("vjet_1_aeta <= 2.5").Histo1D({(sample+ "_vjet1_loweta").c_str(), "QGL", 100,0,1}, "vjet_1_qgl_res", "weight")},
            {"vbs0_loweta", rdfb.Filter("vbs_0_aeta <= 2.5").Histo1D({(sample+ "_vbs0_loweta").c_str(), "QGL", 100,0,1}, "vbs_0_qgl_res", "weight")},
            {"vbs1_loweta", rdfb.Filter("vbs_1_aeta <= 2.5").Histo1D({(sample+ "_vbs1_loweta").c_str(), "QGL", 100,0,1}, "vbs_1_qgl_res", "weight")},
            ...
            {"vjet0_pt_loweta", rdfb.Filter("vjet_0_aeta  2.5").Histo1D({(sample+ "_vjet0_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet1_pt_loweta", rdfb.Filter("vjet_1_aeta  2.5").Histo1D({(sample+ "_vjet1_pt_loweta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            {"vbs0_pt_loweta", rdfb.Filter("vbs_0_aeta  2.5").Histo1D({(sample+ "_vbs0_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs1_pt_loweta", rdfb.Filter("vbs_1_aeta  2.5").Histo1D({(sample+ "_vbs1_pt_loweta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},

            {"vjet0_pt_higheta", rdfb.Filter("vjet_0_aeta > 2.5").Histo1D({(sample+ "_vjet0_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_0_pt", "weight")},
            {"vjet1_pt_higheta", rdfb.Filter("vjet_1_aeta > 2.5").Histo1D({(sample+ "_vjet1_pt_higheta").c_str(), "QGL", 50,30,300}, "vjet_1_pt", "weight")},
            {"vbs0_pt_higheta", rdfb.Filter("vbs_0_aeta > 2.5").Histo1D({(sample+ "_vbs0_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_0_pt", "weight")},
            {"vbs1_pt_higheta", rdfb.Filter("vbs_1_aeta > 2.5").Histo1D({(sample+ "_vbs1_pt_higheta").c_str(), "QGL", 50,30,300}, "vbs_1_pt", "weight")},
