...
XSWeight   = 'XSWeight'
SFweight1l = 'puWeight*\
              SingleLepton_trigEff_corrected*\
              Lepton_RecoSF[0]'
...
samples['DY'] = {    'name'   :   nanoGetSampleFiles(directory_bkg,'DYJetsToLL_M-50') #Don't use LO(_ext0)! DYMVA Training!
                       ...
                       'subsamples': {
                          ...
                          "vjet0_gluon" : "vjet_0_partfl_res == 21 ",
                          "vjet0_quark" : "vjet_0_partfl_res != 21 ",
                        },
                       'EventsPerJob' : 70000,
...
addSampleWeight(samples,'DY','DYJetsToLL_M-4to50_HT-100to200','DY_LO_pTllrw') # removed for multidraw bug
...
#samples = {   key:v for key,v in samples.items() if key  in ["DATA"]}