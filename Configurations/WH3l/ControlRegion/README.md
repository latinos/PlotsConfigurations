...
Running the confiuguration.
        ...
        mkShapes.py --pycfg=configuration.py --inputDir=/tmp/arun/arun/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWTightMu/07Jun2016_spring16_mAODv2_4p0fbm1/MCl2loose__hadd__bSFL2pTEff__l2tight__vh3lSel

        mkDatacards.py --pycfg=configuration.py --inputFile=rootFiles_WH_CR/plots_WH3l.root

        mkPlot.py --pycfg=configuration.py --inputFile=rootFiles_WH_CR/plots_WH3l.root
