...
myreaderBDTGOSSF->BookMVA("BDTG4D3","/afs/cern.ch/user/p/pyu/public/HWWAnalysis/FullRunII_WH3l/BDT_xmlfile/21Nov2019/TMVAClassification_2017OSSF.weights.xml");
...
float hww_WH3l_OSSF_mvaBDTG(int entry, int nclass){
    ...
    float classifier = myreaderBDTGOSSF->EvaluateMVA("BDTG4D3");
