...
do
    ...
    python ${CMSSW_BASE}/src/PlotsConfigurations/Configurations/Template/STXS_VHlep/suppressNegativeBins.py rootFiles_WH3l_${YEAR}_v6_STXS/plots_WH3l_${YEAR}_v6_STXS.root
    
    echo "mkDatacards.py --pycfg configuration.py --inputFile rootFiles_WH3l_${YEAR}_v6_STXS/plots_WH3l_${YEAR}_v6_STXS.root"
