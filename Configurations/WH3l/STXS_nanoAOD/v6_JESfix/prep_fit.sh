...
do
    ...
    combineCards.py \
	wh3l_13TeV_sssf_ptv_lt150=${datacardDir}/wh3l_13TeV_sssf_ptv_lt150/BDTG_SSSF_bin2/datacard.txt.pruned.txt \
	wh3l_13TeV_ossf_ptv_lt150=${datacardDir}/wh3l_13TeV_ossf_ptv_lt150/BDTG_OSSF_bin2/datacard.txt.pruned.txt \
	wh3l_13TeV_merged_ptv_gt150=${datacardDir}/wh3l_13TeV_merged/BDTG_OSSF_bin2/datacard.txt.pruned.txt \
	wh3l_zg=${datacardDir}/wh3l_zg_13TeV/events/datacard.txt.pruned.txt \
	wh3l_wz=${datacardDir}/wh3l_wz_13TeV/events/datacard.txt.pruned.txt \
