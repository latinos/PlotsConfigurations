...
//=========  (Sun Jul  3 01:21:53 2016) by ROOT version6.02/13
   ...
   ccwh3l_MET_13TeV_flagOSSF->Range(-0.4,-8.522051,2.1,57.03219);
   ...
   thsBackground_grouped_wh3l_MET_13TeV_flagOSSF_stack_29->SetMinimum(-0.02343283);
   thsBackground_grouped_wh3l_MET_13TeV_flagOSSF_stack_29->SetMaximum(23.26253);
   ...
   new_histo_group_Fake_wh3l_MET_13TeV_flagOSSF142->SetBinContent(1,19.17259);
   new_histo_group_Fake_wh3l_MET_13TeV_flagOSSF142->SetBinError(1,2.982204);
   new_histo_group_Fake_wh3l_MET_13TeV_flagOSSF142->SetEntries(161);
   ...
   new_histo_group_WW_wh3l_MET_13TeV_flagOSSF143->SetBinContent(1,0.1110794);
   new_histo_group_WW_wh3l_MET_13TeV_flagOSSF143->SetBinError(1,0.04090878);
   new_histo_group_WW_wh3l_MET_13TeV_flagOSSF143->SetEntries(8);
   ...
   new_histo_group_VVV_wh3l_MET_13TeV_flagOSSF144->SetBinContent(1,0.313563);
   new_histo_group_VVV_wh3l_MET_13TeV_flagOSSF144->SetBinError(1,0.02940779);
   new_histo_group_VVV_wh3l_MET_13TeV_flagOSSF144->SetEntries(198);
   ...
   new_histo_group_Vg_wh3l_MET_13TeV_flagOSSF145->SetBinContent(1,0.1801005);
   new_histo_group_Vg_wh3l_MET_13TeV_flagOSSF145->SetBinError(1,0.2035333);
   new_histo_group_Vg_wh3l_MET_13TeV_flagOSSF145->SetEntries(4);
   ...
   new_histo_group_ZZ_wh3l_MET_13TeV_flagOSSF146->SetBinContent(1,0.1255383);
   new_histo_group_ZZ_wh3l_MET_13TeV_flagOSSF146->SetBinError(1,0.07302862);
   new_histo_group_ZZ_wh3l_MET_13TeV_flagOSSF146->SetEntries(3);
   ...
   new_histo_group_WZ_wh3l_MET_13TeV_flagOSSF147->SetBinContent(1,1.186873);
   new_histo_group_WZ_wh3l_MET_13TeV_flagOSSF147->SetBinError(1,0.08037284);
   new_histo_group_WZ_wh3l_MET_13TeV_flagOSSF147->SetEntries(244);
   ...
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF148->SetBinContent(1,0.4120507);
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF148->SetBinError(1,0.02099632);
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF148->SetEntries(741);
   ...
   thsSignal_grouped_wh3l_MET_13TeV_flagOSSF_stack_30->SetMaximum(0.4546993);
   ...
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF149->SetBinContent(1,0.4120507);
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF149->SetBinError(1,0.02099632);
   new_histo_group_Higgs_wh3l_MET_13TeV_flagOSSF149->SetEntries(741);
   ...
   Graph_Graph3029->SetMaximum(31.48541);
   ...
   Graph_Graph3030->SetMaximum(18.2159);
...
tex->SetNDC();
   ...
   hframe_copy150->SetMaximum(53.75448);
