...
//=========  (Sun Jul  3 01:22:18 2016) by ROOT version6.02/13
   ...
   ccwh3l_MET_JetV_ZVeto_13TeV_events->Range(-0.4,-2.867954,2.1,19.19323);
   ...
   thsBackground_grouped_wh3l_MET_JetV_ZVeto_13TeV_events_stack_101->SetMaximum(4.45845);
   ...
   new_histo_group_Fake_wh3l_MET_JetV_ZVeto_13TeV_events502->SetBinContent(1,2.887924);
   new_histo_group_Fake_wh3l_MET_JetV_ZVeto_13TeV_events502->SetBinError(1,1.358219);
   new_histo_group_Fake_wh3l_MET_JetV_ZVeto_13TeV_events502->SetEntries(34);
   ...
   new_histo_group_WW_wh3l_MET_JetV_ZVeto_13TeV_events503->SetBinContent(1,0.04360057);
   new_histo_group_WW_wh3l_MET_JetV_ZVeto_13TeV_events503->SetBinError(1,0.02568789);
   new_histo_group_WW_wh3l_MET_JetV_ZVeto_13TeV_events503->SetEntries(3);
   ...
   new_histo_group_VVV_wh3l_MET_JetV_ZVeto_13TeV_events504->SetBinContent(1,0.1299423);
   new_histo_group_VVV_wh3l_MET_JetV_ZVeto_13TeV_events504->SetBinError(1,0.01921394);
   new_histo_group_VVV_wh3l_MET_JetV_ZVeto_13TeV_events504->SetEntries(80);
   ...
   new_histo_group_Vg_wh3l_MET_JetV_ZVeto_13TeV_events505->SetBinContent(1,0.0522728);
   new_histo_group_Vg_wh3l_MET_JetV_ZVeto_13TeV_events505->SetBinError(1,0.0522728);
   new_histo_group_Vg_wh3l_MET_JetV_ZVeto_13TeV_events505->SetEntries(1);
   ...
   new_histo_group_ZZ_wh3l_MET_JetV_ZVeto_13TeV_events506->SetBinContent(1,0.07785033);
   new_histo_group_ZZ_wh3l_MET_JetV_ZVeto_13TeV_events506->SetBinError(1,0.05530859);
   new_histo_group_ZZ_wh3l_MET_JetV_ZVeto_13TeV_events506->SetEntries(2);
   ...
   new_histo_group_WZ_wh3l_MET_JetV_ZVeto_13TeV_events507->SetBinContent(1,0.6645087);
   new_histo_group_WZ_wh3l_MET_JetV_ZVeto_13TeV_events507->SetBinError(1,0.05966337);
   new_histo_group_WZ_wh3l_MET_JetV_ZVeto_13TeV_events507->SetEntries(136);
   ...
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events508->SetBinContent(1,0.2835517);
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events508->SetBinError(1,0.01760248);
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events508->SetEntries(512);
   ...
   thsSignal_grouped_wh3l_MET_JetV_ZVeto_13TeV_events_stack_102->SetMaximum(0.3162119);
   ...
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events509->SetBinContent(1,0.2835517);
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events509->SetBinError(1,0.01760248);
   new_histo_group_Higgs_wh3l_MET_JetV_ZVeto_13TeV_events509->SetEntries(512);
   ...
   Graph_Graph3101->SetMinimum(1.609333);
   Graph_Graph3101->SetMaximum(6.102808);
   ...
   Graph_Graph3102->SetMinimum(2.286049);
   Graph_Graph3102->SetMaximum(8.936766);
...
tex->SetNDC();
   ...
   hframe_copy510->SetMaximum(18.09017);
