...
//=========  (Sun Jul  3 01:21:51 2016) by ROOT version6.02/13
   ...
   ccwh3l_MET_JetV_13TeV_events->Range(-0.4,-2.867954,2.1,19.19323);
   ...
   thsBackground_grouped_wh3l_MET_JetV_13TeV_events_stack_23->SetMaximum(4.45845);
   ...
   new_histo_group_Fake_wh3l_MET_JetV_13TeV_events112->SetBinContent(1,2.887924);
   new_histo_group_Fake_wh3l_MET_JetV_13TeV_events112->SetBinError(1,1.358219);
   new_histo_group_Fake_wh3l_MET_JetV_13TeV_events112->SetEntries(34);
   ...
   new_histo_group_WW_wh3l_MET_JetV_13TeV_events113->SetBinContent(1,0.04360057);
   new_histo_group_WW_wh3l_MET_JetV_13TeV_events113->SetBinError(1,0.02568789);
   new_histo_group_WW_wh3l_MET_JetV_13TeV_events113->SetEntries(3);
   ...
   new_histo_group_VVV_wh3l_MET_JetV_13TeV_events114->SetBinContent(1,0.1299423);
   new_histo_group_VVV_wh3l_MET_JetV_13TeV_events114->SetBinError(1,0.01921394);
   new_histo_group_VVV_wh3l_MET_JetV_13TeV_events114->SetEntries(80);
   ...
   new_histo_group_Vg_wh3l_MET_JetV_13TeV_events115->SetBinContent(1,0.0522728);
   new_histo_group_Vg_wh3l_MET_JetV_13TeV_events115->SetBinError(1,0.0522728);
   new_histo_group_Vg_wh3l_MET_JetV_13TeV_events115->SetEntries(1);
   ...
   new_histo_group_ZZ_wh3l_MET_JetV_13TeV_events116->SetBinContent(1,0.07785033);
   new_histo_group_ZZ_wh3l_MET_JetV_13TeV_events116->SetBinError(1,0.05530859);
   new_histo_group_ZZ_wh3l_MET_JetV_13TeV_events116->SetEntries(2);
   ...
   new_histo_group_WZ_wh3l_MET_JetV_13TeV_events117->SetBinContent(1,0.6645087);
   new_histo_group_WZ_wh3l_MET_JetV_13TeV_events117->SetBinError(1,0.05966337);
   new_histo_group_WZ_wh3l_MET_JetV_13TeV_events117->SetEntries(136);
   ...
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events118->SetBinContent(1,0.2835517);
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events118->SetBinError(1,0.01760248);
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events118->SetEntries(512);
   ...
   thsSignal_grouped_wh3l_MET_JetV_13TeV_events_stack_24->SetMaximum(0.3162119);
   ...
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events119->SetBinContent(1,0.2835517);
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events119->SetBinError(1,0.01760248);
   new_histo_group_Higgs_wh3l_MET_JetV_13TeV_events119->SetEntries(512);
   ...
   Graph_Graph3023->SetMinimum(1.609333);
   Graph_Graph3023->SetMaximum(6.102808);
   ...
   Graph_Graph3024->SetMinimum(2.286049);
   Graph_Graph3024->SetMaximum(8.936766);
...
tex->SetNDC();
   ...
   hframe_copy120->SetMaximum(18.09017);
