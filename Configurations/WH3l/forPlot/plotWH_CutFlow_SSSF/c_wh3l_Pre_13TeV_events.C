...
//=========  (Sun Jul  3 01:22:08 2016) by ROOT version6.02/13
   ...
   ccwh3l_Pre_13TeV_events->Range(-0.4,-9.941746,2.1,66.53323);
   ...
   thsBackground_grouped_wh3l_Pre_13TeV_events_stack_75->SetMinimum(-0.102791);
   thsBackground_grouped_wh3l_Pre_13TeV_events_stack_75->SetMaximum(26.61798);
   ...
   new_histo_group_Fake_wh3l_Pre_13TeV_events372->SetBinContent(1,22.1599);
   new_histo_group_Fake_wh3l_Pre_13TeV_events372->SetBinError(1,3.190554);
   new_histo_group_Fake_wh3l_Pre_13TeV_events372->SetEntries(191);
   ...
   new_histo_group_WW_wh3l_Pre_13TeV_events373->SetBinContent(1,0.1954926);
   new_histo_group_WW_wh3l_Pre_13TeV_events373->SetBinError(1,0.05489521);
   new_histo_group_WW_wh3l_Pre_13TeV_events373->SetEntries(14);
   ...
   new_histo_group_VVV_wh3l_Pre_13TeV_events374->SetBinContent(1,0.3680759);
   new_histo_group_VVV_wh3l_Pre_13TeV_events374->SetBinError(1,0.03145783);
   new_histo_group_VVV_wh3l_Pre_13TeV_events374->SetEntries(227);
   ...
   new_histo_group_Vg_wh3l_Pre_13TeV_events375->SetBinContent(1,0.1998786);
   new_histo_group_Vg_wh3l_Pre_13TeV_events375->SetBinError(1,0.3026696);
   new_histo_group_Vg_wh3l_Pre_13TeV_events375->SetEntries(10);
   ...
   new_histo_group_ZZ_wh3l_Pre_13TeV_events376->SetBinContent(1,0.1653816);
   new_histo_group_ZZ_wh3l_Pre_13TeV_events376->SetBinError(1,0.08319056);
   new_histo_group_ZZ_wh3l_Pre_13TeV_events376->SetEntries(4);
   ...
   new_histo_group_WZ_wh3l_Pre_13TeV_events377->SetBinContent(1,1.495022);
   new_histo_group_WZ_wh3l_Pre_13TeV_events377->SetBinError(1,0.09046657);
   new_histo_group_WZ_wh3l_Pre_13TeV_events377->SetEntries(305);
   ...
   new_histo_group_Higgs_wh3l_Pre_13TeV_events378->SetBinContent(1,0.5000402);
   new_histo_group_Higgs_wh3l_Pre_13TeV_events378->SetBinError(1,0.02307393);
   new_histo_group_Higgs_wh3l_Pre_13TeV_events378->SetEntries(916);
   ...
   thsSignal_grouped_wh3l_Pre_13TeV_events_stack_76->SetMaximum(0.5492699);
   ...
   new_histo_group_Higgs_wh3l_Pre_13TeV_events379->SetBinContent(1,0.5000402);
   new_histo_group_Higgs_wh3l_Pre_13TeV_events379->SetBinError(1,0.02307393);
   new_histo_group_Higgs_wh3l_Pre_13TeV_events379->SetEntries(916);
   ...
   Graph_Graph3075->SetMinimum(14.28329);
   Graph_Graph3075->SetMaximum(34.92836);
   ...
   Graph_Graph3076->SetMinimum(9.450729);
   Graph_Graph3076->SetMaximum(19.68318);
...
tex->SetNDC();
   ...
   hframe_copy380->SetMaximum(62.70948);
