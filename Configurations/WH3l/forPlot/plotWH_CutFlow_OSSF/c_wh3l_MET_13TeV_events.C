...
//=========  (Sat Jul  2 21:43:39 2016) by ROOT version6.02/13
   ...
   ccwh3l_MET_13TeV_events->Range(-0.4,-0.1585366,2.1,1.060976);
   ...
   thsBackground_grouped_wh3l_MET_13TeV_events_stack_49->SetMinimum(0);
   thsBackground_grouped_wh3l_MET_13TeV_events_stack_49->SetMaximum(0);
   ...
   thsSignal_grouped_wh3l_MET_13TeV_events_stack_50->SetMaximum(0);
   ...
   Graph_Graph3049->SetMaximum(1.1);
