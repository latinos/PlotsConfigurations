...
//=========  (Sat Jul  2 21:43:41 2016) by ROOT version6.02/13
   ...
   ccwh3l_Pre_13TeV_flagOSSF->Range(-0.4,-430.6113,2.1,2881.783);
   ...
   thsBackground_grouped_wh3l_Pre_13TeV_flagOSSF_stack_55->SetMinimum(0);
   thsBackground_grouped_wh3l_Pre_13TeV_flagOSSF_stack_55->SetMaximum(995.6246);
   ...
   new_histo_group_Fake_wh3l_Pre_13TeV_flagOSSF272->SetBinContent(2,288.8572);
   new_histo_group_Fake_wh3l_Pre_13TeV_flagOSSF272->SetBinError(2,13.45654);
   new_histo_group_Fake_wh3l_Pre_13TeV_flagOSSF272->SetEntries(3851);
   ...
   new_histo_group_WW_wh3l_Pre_13TeV_flagOSSF273->SetBinContent(2,0.4344971);
   new_histo_group_WW_wh3l_Pre_13TeV_flagOSSF273->SetBinError(2,0.08206113);
   new_histo_group_WW_wh3l_Pre_13TeV_flagOSSF273->SetEntries(30);
   ...
   new_histo_group_VVV_wh3l_Pre_13TeV_flagOSSF274->SetBinContent(2,5.209865);
   new_histo_group_VVV_wh3l_Pre_13TeV_flagOSSF274->SetBinError(2,0.09912109);
   new_histo_group_VVV_wh3l_Pre_13TeV_flagOSSF274->SetEntries(4991);
   ...
   new_histo_group_Vg_wh3l_Pre_13TeV_flagOSSF275->SetBinContent(2,226.538);
   new_histo_group_Vg_wh3l_Pre_13TeV_flagOSSF275->SetBinError(2,5.978531);
   new_histo_group_Vg_wh3l_Pre_13TeV_flagOSSF275->SetEntries(3337);
   ...
   new_histo_group_ZZ_wh3l_Pre_13TeV_flagOSSF276->SetBinContent(2,53.51771);
   new_histo_group_ZZ_wh3l_Pre_13TeV_flagOSSF276->SetBinError(2,1.483803);
   new_histo_group_ZZ_wh3l_Pre_13TeV_flagOSSF276->SetEntries(1447);
   ...
   new_histo_group_WZ_wh3l_Pre_13TeV_flagOSSF277->SetBinContent(2,368.6494);
   new_histo_group_WZ_wh3l_Pre_13TeV_flagOSSF277->SetBinError(2,1.417335);
   new_histo_group_WZ_wh3l_Pre_13TeV_flagOSSF277->SetEntries(74706);
   ...
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF278->SetBinContent(2,5.007154);
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF278->SetBinError(2,0.07306387);
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF278->SetEntries(8009);
   ...
   thsSignal_grouped_wh3l_Pre_13TeV_flagOSSF_stack_56->SetMaximum(5.334229);
   ...
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF279->SetBinContent(2,5.007154);
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF279->SetBinError(2,0.07306387);
   new_histo_group_Higgs_wh3l_Pre_13TeV_flagOSSF279->SetEntries(8009);
   ...
   Graph_Graph3055->SetMaximum(1153.378);
   ...
   Graph_Graph3056->SetMaximum(1196.224);
...
tex->SetNDC();
   ...
   hframe_copy280->SetMaximum(2716.163);
