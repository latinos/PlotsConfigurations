...
//=========  (Sat Jul  2 21:43:37 2016) by ROOT version6.02/13
   ...
   ccwh3l_MET_13TeV_nbjet_3l->Range(-1,-0.1585366,5.25,1.060976);
   ...
   thsBackground_grouped_wh3l_MET_13TeV_nbjet_3l_stack_43->SetMinimum(0);
   thsBackground_grouped_wh3l_MET_13TeV_nbjet_3l_stack_43->SetMaximum(0);
   ...
   thsSignal_grouped_wh3l_MET_13TeV_nbjet_3l_stack_44->SetMaximum(0);
   ...
   Graph_Graph3043->SetMaximum(1.1);
