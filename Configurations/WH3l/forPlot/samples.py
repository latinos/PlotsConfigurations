...
#                            'latino_DYJetsToLL_M-10to50.root',
 #                           'latino_DYJetsToLL_M-10to50ext3.root',
  ...
  #                          ],    
  #                    'weight' : 'metFilter*(0.95 - 0.1*TMath::Erf((gen_ptll-14)/8.8))*puW*bPogSF_CMVAT*effTrigW3l*std_vector_lepton_idisoW[0]*std_vector_lepton_idisoW[1]*std_vector_lepton_idisoW[2]*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]*GEN_weight_SM/abs(GEN_weight_SM)',              #   weight/cut 
                      #'isData': ['0', '0'],      
   #                   'weights': [  '0.238112'
   #                               , '0.238112'
    #                              , '0.317273040011'
