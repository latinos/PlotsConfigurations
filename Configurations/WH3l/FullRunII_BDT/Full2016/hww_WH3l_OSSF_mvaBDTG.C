...
myreaderBDTGOSSF->BookMVA("BDTG4F07","/afs/cern.ch/user/p/pyu/public/HWWAnalysis/FullRunII_WH3l/BDT_xmlfile/04Feb2020/TMVAClassification_2016OSSF.weights.xml");
