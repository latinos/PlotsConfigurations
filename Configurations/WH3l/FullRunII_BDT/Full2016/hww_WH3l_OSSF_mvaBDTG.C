...
myreaderBDTGOSSF->BookMVA("BDTG4F07","/afs/cern.ch/user/p/pyu/public/HWWAnalysis/FullRunII_WH3l/BDT_xmlfile/21Nov2019/TMVAClassification_2016SSSF.weights.xml");
