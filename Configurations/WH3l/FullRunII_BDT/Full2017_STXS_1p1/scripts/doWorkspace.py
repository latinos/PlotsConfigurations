...
#Merge some bins
command="text2workspace.py Full2017_WH_3l_HTXS_Stage1.txt -o Full2017_WH_3l_HTXS_Stage1_merged.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
poi=''
for sample in sampleNames:
  if 'WH_hww' not in sample: continue
  if 'FWDH' in sample: continue
