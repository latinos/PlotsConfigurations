...
myreaderBDTGSSSF->BookMVA("BDTG4SK01","/afs/cern.ch/user/p/pyu/public/HWWAnalysis/FullRunII_WH3l/BDT_xmlfile/04Feb2020/TMVAClassification_2017SSSF.weights.xml");
...
float hww_WH3l_SSSF_mvaBDTG(int entry, int nclass){
    ...
    float classifier = myreaderBDTGSSSF->EvaluateMVA("BDTG4SK01");//v5
