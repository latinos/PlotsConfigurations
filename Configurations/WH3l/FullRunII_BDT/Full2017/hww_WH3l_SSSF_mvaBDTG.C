...
myreaderBDTGSSSF->BookMVA("BDTG0","/afs/cern.ch/user/p/pyu/public/HWWAnalysis/FullRunII_WH3l/BDT_xmlfile/21Nov2019/TMVAClassification_2017SSSF.weights.xml");
...
float hww_WH3l_SSSF_mvaBDTG(int entry, int nclass){
    ...
    float classifier = myreaderBDTGSSSF->EvaluateMVA("BDTG0");
