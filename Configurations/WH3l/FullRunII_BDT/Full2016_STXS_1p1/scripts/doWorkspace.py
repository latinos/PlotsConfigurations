...
#No merging
command="text2workspace.py Full2016_WH_3l_HTXS_Stage1.txt -o Full2016_WH_3l_HTXS_Stage1.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
