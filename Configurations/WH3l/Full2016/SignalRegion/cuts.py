...
#cuts['wh3l_13TeV_sssf_2m']  = 'njet_3l == 0 \
#                       && std_vector_jet_pt[0] < 30 \
#                       && ( abs(std_vector_lepton_flavour[0]) + abs(std_vector_lepton_flavour[1]) +  abs(std_vector_lepton_flavour[2])) == 37 \
...
#cuts['wh3l_13TeV_sssf_m']  = 'njet_3l == 0 \
#                       && (( abs(std_vector_lepton_flavour[0]) + abs(std_vector_lepton_flavour[1]) +  abs(std_vector_lepton_flavour[2])) == 35) \
#                       && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
#                       && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
#                       && ( std_vector_jet_pt[2] < 20 || std_vector_jet_cmvav2[2] < -0.5884 ) \
#                       && ( std_vector_jet_pt[3] < 20 || std_vector_jet_cmvav2[3] < -0.5884 ) \
