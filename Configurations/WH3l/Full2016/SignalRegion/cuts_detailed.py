...
cuts['wh3l_MET_JetV_dPhi_ossf_13TeV'] = 'njet_3l == 0\
                              && std_vector_jet_pt[0] < 30 \
                              && metPfType1 > 50\
                              && flagOSSF == 1\
                              && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
                              ...
                              && dphilllmet > 2.2 \
                              '
cuts['wh3l_MET_JetV_dPhi_ZVeto_ossf_13TeV'] = 'njet_3l == 0 \
                                  && std_vector_jet_pt[0] < 30 \
                                  && metPfType1 > 50 \
                                  && flagOSSF == 1\
                                  && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
                                  ...
                                  && zveto_3l > 25 \
                                  '
cuts['wh3l_MET_JetV_dPhi_ZVeto_mll_ossf_13TeV'] = 'njet_3l == 0 \
                                        && std_vector_jet_pt[0] < 30 \
                                        && metPfType1 > 50 \
                                        && flagOSSF == 1\
                                        && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
...
cuts['wh3l_JetV_sssf_13TeV'] = 'njet_3l == 0\
                              && std_vector_jet_pt[0] < 30 \
                              && flagOSSF == 0\
                              && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
                              && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
                              ...
                              && ( std_vector_jet_pt[9] < 20 || std_vector_jet_cmvav2[9] < -0.5884 ) \
                              '
cuts['wh3l_JetV_dPhi_sssf_13TeV'] = 'njet_3l == 0 \
                                  && std_vector_jet_pt[0] < 30 \
                                  && flagOSSF == 0\
                                  && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
                                  && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
                                  ...
                                  && dphilllmet > 2.5 \
                                  '
cuts['wh3l_JetV_dPhi_mll_sssf_13TeV'] = 'njet_3l == 0 \
                                        && std_vector_jet_pt[0] < 30 \
                                        && flagOSSF == 0\
                                        && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
                                        && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
