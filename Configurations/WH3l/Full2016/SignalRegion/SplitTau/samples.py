...
samples['ZH_had_hww']  = { 'name' :  getSampleFiles(directory,'HZJ_HToWW_M125') ,
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==23)' ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
                         }

samples['ZH_had_fwd_hww'] = { 'name' :  getSampleFiles(directory,'HZJ_HToWW_M125') ,
                              'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==22)' ,
                              'suppressNegative' :['all'],
                              'suppressNegativeNuisances' :['all'],
                             }
...
samples['ZH_lep_hww']  = {  'name' :  getSampleFiles(directory,'HZJ_HToWW_M125') ,
                            'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==41)' ,  
                            'suppressNegative' :['all'],
                            'suppressNegativeNuisances' :['all'],
                         }

samples['ZH_lep_fwd_hww']  = {  'name' :  getSampleFiles(directory,'HZJ_HToWW_M125') ,
                                'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==40)' ,  
                                'suppressNegative' :['all'],
                                'suppressNegativeNuisances' :['all'],
                             }
...
samples['ggZH_lep_hww'] = {  'name' : getSampleFiles(directory,'ggZH_HToWW_M125') ,
                             'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==51)' ,  
                             'suppressNegative' :['all'],
                             'suppressNegativeNuisances' :['all'],
                          }

samples['ggZH_lep_fwd_hww'] = {  'name' : getSampleFiles(directory,'ggZH_HToWW_M125') ,
                                 'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==50)' ,  
                                 'suppressNegative' :['all'],
                                 'suppressNegativeNuisances' :['all'],
                              }
...
samples['WH_lep_hww']   = {  'name' :   getSampleFiles(directory,'HWminusJ_HToWW_M125')
                                        + getSampleFiles(directory,'HWplusJ_HToWW_M125') , 
                             'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==31)' ,  
                             'suppressNegative' :['all'],
                             'suppressNegativeNuisances' :['all'],
                          }
...
samples['WH_lep_fwd_hww']   = {  'name' :   getSampleFiles(directory,'HWminusJ_HToWW_M125')
                                          + getSampleFiles(directory,'HWplusJ_HToWW_M125') , 
                                 'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC+'*(HTXS_stage0==30)' ,  
                                 'suppressNegative' :['all'],
                                 'suppressNegativeNuisances' :['all'],
                              }
...
#                                 +getSampleFiles(directory,'HZJ_HToWW_M125'),
#                        'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch3L+'*'+METFilter_MC,
#                        'suppressNegativeNuisances' :['all'],
#                     }
#
