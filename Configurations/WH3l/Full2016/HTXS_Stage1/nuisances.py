...
for name in sampleNames:
  if 'ggZH' in name:
    nuisances['QCDscale_ggZH_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','ggZH','125.09','scale','sm')})
...
for name in sampleNames:
  if 'ggH' in name:
    ...
    nuisances['QCDscale_gg_ACCEPT']['samples'].update({name : '1.003'})
...
for name in sampleNames:
  if 'ggH' in name:
    nuisances['pdf_Higgs_gg_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','ggH' ,'125.09','pdf','sm')})
  elif 'ggZH' in name:
    nuisances['pdf_Higgs_gg_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','ggZH' ,'125.09','pdf','sm')})
  elif 'bbH' in name:
    nuisances['pdf_Higgs_gg_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','bbH' ,'125.09','pdf','sm')})
...
nuisances['pdf_Higgs_qqbar_wh3l']  = {
               ...
               'samples'  : {
                   ...
                   'WH_htt'   : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','ggH' ,'125.09','pdf','sm'),
...
for name in sampleNames:
  if 'qqH' in name:
    nuisances['pdf_Higgs_qqbar_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','vbfH' ,'125.09','pdf','sm')})
  elif 'WH' in name:
    nuisances['pdf_Higgs_qqbar_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','WH' ,'125.09','pdf','sm')})
  elif 'ZH' in name:
    nuisances['pdf_Higgs_qqbar_wh3l']['samples'].update({name : HiggsXS.GetHiggsProdXSNP('YR4','13TeV','ZH' ,'125.09','pdf','sm')})
...
for name in sampleNames:
  if 'ggH' in name:
    nuisances['pdf_Higgs_gg_ACCEPT_wh3l']['samples'].update({name : '1.005'})
  elif 'ggZH' in name:
    nuisances['pdf_Higgs_gg_ACCEPT_wh3l']['samples'].update({name : '1.005'})
...
for name in sampleNames:
  if 'qqH' in name:
    nuisances['pdf_Higgs_qqbar_ACCEPT_wh3l']['samples'].update({name : '1.011'})
  elif 'WH' in name:
    nuisances['pdf_Higgs_qqbar_ACCEPT_wh3l']['samples'].update({name : '1.007'})
  elif 'ZH' in name:
    nuisances['pdf_Higgs_qqbar_ACCEPT_wh3l']['samples'].update({name : '1.012'})
...
for name in sampleNames:
  if 'WH' in name:
    nuisances['PS_wh3l']['samples'].update({name : '1.037'})
  elif 'ZH_hww' in name:
    nuisances['PS_wh3l']['samples'].update({name : '1.037'})
  elif 'ggZH_hww' in name:
    nuisances['PS_wh3l']['samples'].update({name : '1.037'})
...
for name in sampleNames:
  if 'WH' in name:
    nuisances['UE_wh3l']['samples'].update({name : '1.010'})
  elif 'ZH_hww' in name:
    nuisances['UE_wh3l']['samples'].update({name : '1.010'})
  elif 'ggZH_hww' in name:
    nuisances['UE_wh3l']['samples'].update({name : '1.010'})
...
for name in sampleNames:
  nuisances['trigg_wh3l']['samples'].update({name : trig_syst})
...
for name in sampleNames:
  nuisances['eff_e_wh3l']['samples'].update({name : id_syst_ele})
...
for name in sampleNames:
  nuisances['electronpt_wh3l']['samples'].update({name : ['1', '1']})
...
for name in sampleNames:
  nuisances['elePtCor']['samples'].update({name : elePtCor_Syst_wh3l})
...
for name in sampleNames:
  nuisances['eleEtaCor']['samples'].update({name : eleEtaCor_Syst_wh3l})
...
for name in sampleNames:
  nuisances['eff_m_wh3l']['samples'].update({name : id_syst_mu})
...
for name in sampleNames:
  nuisances['muonpt_wh3l']['samples'].update({name : ['1', '1']})
...
for name in sampleNames:
  nuisances['jes_wh3l']['samples'].update({name : ['1', '1']})
...
for name in sampleNames:
  nuisances['met_wh3l']['samples'].update({name : ['1', '1']})
