...
cuts['hwwhighmass_13TeV_em']  = '(abs(std_vector_lepton_flavour[0]) == 11) * (abs(std_vector_lepton_flavour[1]) == 13)     \
            '  

cuts['hwwhighmass_13TeV_me']  = '(abs(std_vector_lepton_flavour[0]) == 13) * (abs(std_vector_lepton_flavour[1]) == 11)     \
            '  
