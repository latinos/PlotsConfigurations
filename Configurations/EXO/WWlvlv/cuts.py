...
cuts['hwwhighmass_13TeV_em_0j']  = '(abs(std_vector_lepton_flavour[0]) == 11) * (abs(std_vector_lepton_flavour[1]) == 13)     \
...
cuts['hwwhighmass_13TeV_me_0j']  = '(abs(std_vector_lepton_flavour[0]) == 13) * (abs(std_vector_lepton_flavour[1]) == 11)     \
                && ( std_vector_jet_pt[0] < 30 ) \
                && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.715 ) \
                && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.715 ) \
                && ( std_vector_jet_pt[2] < 20 || std_vector_jet_cmvav2[2] < -0.715 ) \
...
cuts['hwwhighmass_13TeV_em_1j']  = '(abs(std_vector_lepton_flavour[0]) == 11) * (abs(std_vector_lepton_flavour[1]) == 13)     \
                && ( std_vector_jet_pt[0] >= 30 ) \
                && ( std_vector_jet_pt[1] < 30 ) \
            '  

cuts['hwwhighmass_13TeV_me_1j']  = '(abs(std_vector_lepton_flavour[0]) == 13) * (abs(std_vector_lepton_flavour[1]) == 11)     \
                && ( std_vector_jet_pt[0] >= 30 ) \
                && ( std_vector_jet_pt[1] < 30 ) \
            '  
