...
for m in masses:
  for model in models:
    samples['ggH_hww_'+m+'_'+model] = { 'name': [
                                          ...
                                          'weight' : 'metFilter*puW*baseW*bPogSF*effTrigW*std_vector_lepton_idisoW[0]*std_vector_lepton_idisoW[1]*'+model,
                                        }
    print samples['ggH_hww_'+m+'_'+model]      
...
samples['DY']  = {    'name': [
                      ...
                      'weight' : '(njet<2)*metFilter*(0.95 - 0.1*TMath::Erf((gen_ptll-14)/8.8))*puW*bPogSF*effTrigW*std_vector_lepton_idisoW[0]*std_vector_lepton_idisoW[1]*GEN_weight_SM/abs(GEN_weight_SM)',              #   weight/cut 
                      #'isData': ['0', '0'],      
                      'weights': [  '0.238112'
                                  , '0.238112'
                                  , '0.317273040011'
