...
cuts['hwwhighmass_13TeV_em_0j'] = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*13)    \
...
cuts['hwwhighmass_13TeV_me_0j']  = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*13)    \
                && (abs(std_vector_lepton_flavour[1]) == 13 || std_vector_lepton_pt[1]>13) \
...
cuts['hwwhighmass_13TeV_em_1j']  = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*13)    \
                && (abs(std_vector_lepton_flavour[1]) == 13 || std_vector_lepton_pt[1]>13) \
                && (abs(std_vector_lepton_flavour[0]) == 11) \
                && ( mth>=60) \
                && ( std_vector_jet_pt[0] >= 30 ) \
...
cuts['hwwhighmass_13TeV_me_1j']  = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*13)    \
                && (abs(std_vector_lepton_flavour[1]) == 13 || std_vector_lepton_pt[1]>13) \
                && (abs(std_vector_lepton_flavour[0]) == 13) \
                && ( mth>=60) \
                && ( std_vector_jet_pt[0] >= 30 ) \
