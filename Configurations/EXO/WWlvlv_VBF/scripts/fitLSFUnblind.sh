...
### 2016
#          text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO 'map=.*/ggH_hww*:1' --PO 'map=.*/qqH_hww*:1' --PO 'map=.*/ggH_hww_:0' --PO 'map=.*/qqH_hww_:0' --PO 'map=.*/ggH_hww_'${massmodel}':r[1,-10,10]' --PO 'map=.*/qqH_hww_'${massmodel}':r'  --PO 'map=.*/ggH_hww_750_NWA:0' --PO 'map=.*/qqH_hww_750_NWA:0' --PO 'map=.*/ggH_hww_INT'${massmodel}':sqrt_scaling=expr::sqrt_scaling("TMath::Sqrt(@0)",r)' --PO 'map=.*Top*/ggH_hww_INT'${massmodel}':0' --PO 'map=.*DYtt*/ggH_hww_INT'${massmodel}':0' --PO 'map=of0jDYtt/qqH_hww_300_c10brn00:0' --PO 'map=of1jDYtt/Fake:0'  --PO 'map=of0jDYtt/qqH_hww_500_c10brn00:0' ICHEP2016.txt -o ICHEP2016.workspace.mH${massmodel}.root -m ${m} -v 1 &> log.workspace.mH${massmodel}.root
        else
### 2015 r: 0-10
...
### 2015
          text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO 'map=.*/ggH_hww*:1' --PO 'map=.*/qqH_hww*:1' --PO 'map=.*/ggH_hww_:0' --PO 'map=.*/qqH_hww_:0' --PO 'map=.*/ggH_hww_'${massmodel}':r[1,-10,10]' --PO 'map=.*/qqH_hww_'${massmodel}':r' --PO 'map=.*/ggH_hww_750_NWA:0' --PO 'map=.*/qqH_hww_750_NWA:0' --PO 'map=.*/ggH_hww_INT'${massmodel}':sqrt_scaling=expr::sqrt_scaling("TMath::Sqrt(@0)",r)' --PO 'map=.*Top*/ggH_hww_INT'${massmodel}':0' --PO 'map=.*DYtt*/ggH_hww_INT'${massmodel}':0' ICHEP2016.${cat}.txt -o ICHEP2016.workspace.${cat}.mH${massmodel}.root -m ${m} -v 1 &> log.workspace.${cat}.mH${massmodel}.root
### 2016
#          text2workspace.py -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO 'map=.*/ggH_hww*:1' --PO 'map=.*/qqH_hww*:1' --PO 'map=.*/ggH_hww_:0' --PO 'map=.*/qqH_hww_:0' --PO 'map=.*/ggH_hww_'${massmodel}':r[1,-10,10]' --PO 'map=.*/qqH_hww_'${massmodel}':r' --PO 'map=.*/ggH_hww_750_NWA:0' --PO 'map=.*/qqH_hww_750_NWA:0' --PO 'map=.*/ggH_hww_INT'${massmodel}':sqrt_scaling=expr::sqrt_scaling("TMath::Sqrt(@0)",r)' --PO 'map=.*Top*/ggH_hww_INT'${massmodel}':0' --PO 'map=.*DYtt*/ggH_hww_INT'${massmodel}':0' --PO 'map=of0jDYtt/qqH_hww_300_c10brn00:0' --PO 'map=of1jDYtt/Fake:0'  --PO 'map=of0jDYtt/qqH_hww_500_c10brn00:0' ICHEP2016.${cat}.txt -o ICHEP2016.workspace.${cat}.mH${massmodel}.root -m ${m} -v 1 &> log.workspace.${cat}.mH${massmodel}.root
        fi
...
if [ "${what}" == "sig" ]; then
	if [ "${cat}" == "all" ]; then
  	  combine -M ProfileLikelihood --significance -t -1 --expectSignal 1 ICHEP2016.workspace.mH${massmodel}.root       &> Significance.ICHEP2016.mH${massmodel}.txt
          combine -M ProfileLikelihood --significance ICHEP2016.workspace.mH${massmodel}.root       &> Significance.ICHEP2016.unblind.mH${massmodel}.txt
        else
          ...
          combine -M ProfileLikelihood --significance ICHEP2016.workspace.${cat}.mH${massmodel}.root       &> Significance.${cat}.ICHEP2016.unblind.mH${massmodel}.txt
        fi
        cp Significance* ${workdir}

else
        if [ "${cat}" == "all" ]; then
          combine -M Asymptotic --run both ICHEP2016.workspace.mH${massmodel}.root      &> Limit.ICHEP2016.unblind.mH${massmodel}.txt
        else
          combine -M Asymptotic --run both ICHEP2016.workspace.${cat}.mH${massmodel}.root      &> Limit.${cat}.ICHEP2016.unblind.mH${massmodel}.txt
        fi
        cp Limit* ${workdir}
