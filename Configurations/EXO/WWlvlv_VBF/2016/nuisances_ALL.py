...
nuisances['TopPtRew']  = {
                ...
                'type'  : 'shape',
                'samples' : {
                 #    'top'  : ['1/(TMath::Sqrt(TMath::Exp(0.0615-0.0005*LHEquark_top_pt) *TMath::Exp(0.0615-0.0005*LHEquark_antitop_pt ) ) )','1']
...
nuisances['QCDscale_ggH_INCL']  = {
               'name'  : 'QCDscale_ggH_INCL', 
               'samples'  : {
               ...
               'hww2l2v_13TeV_top_of_2bjet',
               'hww2l2v_13TeV_dytt_of_INCL',
               'hwwhm_13TeV_of_INCL',
...
for m in masses:
  for model in models:
    model_name = model.replace("cprime","c").replace(".","").replace("BRnew","brn")
    nuisances['QCDscale_ggH_INCL']['samples'].update({'ggH_hww_'+m+'_'+model_name:HiggsXS.GetHiggsProdXSNP('YR4prel','13TeV','ggH',m,'scale','bsm')})
...
#                 
                 'hwwhm_13TeV_of_VBF',
                 'hww2l2v_13TeV_top_of_2bjet_VBF',       #ctrl
                ]
                }
...
#               
                 'hwwhm_13TeV_of_VBF',
                 'hww2l2v_13TeV_top_of_2bjet_VBF',
#                   
                ]
                }
...
nuisances['PS']  = {
                ...
                'folderDown' : 'eosBig/cms/store/group/phys_higgs/cmshww/amassiro/HWW12fb_repro/07Jun2016_spring16_mAODv2_12pXfbm1_repro//MCl2loose__hadd__bSFL2pTEff__l2tight__wwSel__PS' 
...
#AGGIUNTO
nuisances['DYttnormINCL']  = {
               'name'  : 'ICHEP_DYttnormINCL',
               'samples'  : {
                   'DY' : '1.00',
                   },
               'type'  : 'rateParam',
...
#AGGIUNTO
nuisances['WWnormINCL']  = {
               'name'  : 'ICHEP_WWnormINCL',
               'samples'  : {
                   'WW' : '1.00',
                   },
               'type'  : 'rateParam',
