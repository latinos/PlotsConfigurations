...
aliases['LepWPCut'] = {
    'expr': 'LepCut3l__ele_'+eleWP+'__mu_'+muWP+'*\
     ( ((abs(Lepton_pdgId[0])==13 && Muon_mvaTTH[Lepton_muonIdx[0]]>0.82) || (abs(Lepton_pdgId[0])==11 && Lepton_mvaTTH_UL[0]>0.90 && (abs(Lepton_eta[0]) > 1.556 || abs(Lepton_eta[0]) < 1.4442))) \
    && ((abs(Lepton_pdgId[1])==13 && Muon_mvaTTH[Lepton_muonIdx[1]]>0.82) || (abs(Lepton_pdgId[1])==11 && Lepton_mvaTTH_UL[1]>0.90 && (abs(Lepton_eta[1]) > 1.556 || abs(Lepton_eta[1]) < 1.4442))) \
    && ((abs(Lepton_pdgId[2])==13 && Muon_mvaTTH[Lepton_muonIdx[2]]>0.82) || (abs(Lepton_pdgId[2])==11 && Lepton_mvaTTH_UL[2]>0.90 && (abs(Lepton_eta[2]) > 1.556 || abs(Lepton_eta[2]) < 1.4442))) )'
}
...
aliases['transition_veto'] = {
    'expr': '( (abs(Lepton_pdgId[0])==13  || (abs(Lepton_pdgId[0])==11 && (abs(Lepton_eta[0]) > 1.556 || abs(Lepton_eta[0]) < 1.4442))) \
            && (abs(Lepton_pdgId[1])==13  || (abs(Lepton_pdgId[1])==11 && (abs(Lepton_eta[1]) > 1.556 || abs(Lepton_eta[1]) < 1.4442))) \
            && (abs(Lepton_pdgId[2])==13  || (abs(Lepton_pdgId[2])==11 && (abs(Lepton_eta[2]) > 1.556 || abs(Lepton_eta[2]) < 1.4442))) )'
}
####################################################################################
...
aliases['fakeW'] = {
    'linesToAdd' : ['.L %s/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/fake_rate_reader.C+' % os.getenv('CMSSW_BASE')],
