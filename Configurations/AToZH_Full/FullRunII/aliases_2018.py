...
aliases['ellipse_mA_1000_mH_330'] = {
    'linesToAdd' : ['.L %s/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/elliptical_bin_FullRunII.cc+' % os.getenv('CMSSW_BASE')],
    'class' : 'elliptical_bin_FullRunII',
    'args'  : (1000,330,False),
