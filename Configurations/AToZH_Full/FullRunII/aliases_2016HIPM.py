...
btagSFSource = '%s/src/LatinoAnalysis/NanoGardener/python/data/btagSF/wp_deepJet_106XUL16postVFP_v3.csv' % os.getenv('CMSSW_BASE')
...
aliases['AZH_Amass_patch'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_Amass"),
}

aliases['AZH_Amass_patch_onebjet'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_Amass_onebjet"),
}

aliases['AZH_Hmass_patch'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_Hmass"),
}

aliases['AZH_Hmass_patch_onebjet'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_Hmass_onebjet"),
}
aliases['AZH_ChiSquare_patch'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_ChiSquare"),
}

aliases['AZH_ChiSquare_onebjet_patch'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_ChiSquare_onebjet"),
}

aliases['AZH_Tophadronic_patch'] = {
    'class': 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_Tophadronic")
}

aliases['AZH_mA_minus_mH_onebjet_patch'] = {
    'class' : 'AZH_patch_FullRunII',
    'args'  : ("2016HIPM","AZH_mA_minus_mH_onebjet")
}
