...
HEMveto_MC = 'HEMveto_MC'
HEMveto_DATA = 'HEMveto_DATA'
...
samples['Zg']  =  {     'name'   :    getSampleFilesNano(directory,'ZGToLLG'),
                        'weight' : XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+HEMveto_MC + '*(Gen_ZGstar_mass <= 0)',
                        'FilesPerJob' : 2 ,
                 }

samples['ZgS']  = {    'name'   :   getSampleFilesNano(directory,'ZGToLLG'),
                       'weight' : XSWeight+'*'+SFweight+'*'+PromptGenLepMatch3l+'*'+METFilter_MC+'*'+HEMveto_MC+'*(Gen_ZGstar_mass > 0)',
                       'FilesPerJob' : 2 ,
                 }
samples['WZ']  = {    'name':   getSampleFilesNano(directory,'WZTo3LNu_mllmin4p0')
                              + getSampleFilesNano(directory,'WZTo2Q2L_mllmin4p0'),
                       'weight' : XSWeight+'*'+SFweight+'*'+PromptGenLepMatch3l+'*'+METFilter_MC+'*'+HEMveto_MC+'*'+WZWeight,
                       'FilesPerJob' : 2 ,
             }


samples['ttZ'] = {    'name'   :   getSampleFilesNano(directory,'TTZToLLNuNu_M-10'), 
                     'weight' : XSWeight+'*'+SFweight+'*'+PromptGenLepMatch+'*'+METFilter_MC+'*'+HEMveto_MC+'*'+TTZWeight,
                     'FilesPerJob' : 1,
                 }
################## ttH ###############
...
samples['ZZ']  = {  'name'   :   getSampleFilesNano(directory,'ZZTo2L2Nu')
                    ...
                    'weight' : XSWeight+'*'+SFweight+'*'+PromptGenLepMatch+'*'+METFilter_MC+'*'+HEMveto_MC+'*'+ZZWeight,
                    'FilesPerJob' : 1,
             }
...
samples['AZH_1000_330'] = { 'name': getSampleFilesNano(directory, 'AToZHToLLTTbar_MA-1000_MH-330'),
                             'weight' : XSWeight+'*'+SFweight+'*'+PromptGenLepMatch3l+'*'+METFilter_MC+'*'+HEMveto_MC+'*hasGenA'
                            }
...
samples['Fake']  = {   'name': [ ] ,
                       'weight' : 'fakeW*'+ METFilter_DATA+'*'+HEMveto_DATA,
                       'weights' : [ ] ,
                       'isData': ['all'],
                       'FilesPerJob' : 500 ,
...
samples['DATA']  = {   'name': [ ] ,
                       'weight' : METFilter_DATA+'*'+HEMveto_DATA+'*LepWPCut',
                       'weights' : [ ],
                       'isData': ['all'],
                       'FilesPerJob' : 500 ,
                    }
