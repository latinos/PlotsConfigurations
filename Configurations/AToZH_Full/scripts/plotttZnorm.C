...
for (int i = 1; i < 100; i++) {
     TFile* _fileh1 = new TFile(((std::string("multidimfitresult_1000_600_NoSyst0signal1.5ttZ")+std::to_string(i)+std::string(".root")).c_str()));
     TFile* _fileh2 = new TFile(((std::string("multidimfitresult_1000_600_NoSyst0.01signal1.5ttZ")+std::to_string(i)+std::string(".root")).c_str()));
    //_file0->cd();
