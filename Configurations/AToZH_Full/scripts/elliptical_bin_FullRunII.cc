...
class elliptical_bin_FullRunII : public multidraw::TTreeFunction {
public:
  elliptical_bin_FullRunII(const float mA_, const float mH_, const bool isonebjet_);
  char const* getName() const override { return "elliptical_bin_FullRunII"; }
  TTreeFunction* clone() const override { return new elliptical_bin_FullRunII(mA, mH, isonebjet); }
...
elliptical_bin_FullRunII::elliptical_bin_FullRunII(const float mA_, const float mH_, const bool isonebjet_) :
  TTreeFunction(), mA{mA_}, mH{mH_}, isonebjet{isonebjet_}
{
  ...
  std::string filename;
  if (isonebjet) filename = cmssw_base + "/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/ellipse_onebjet_FullRunII.txt"; //TEMP update with correct filename
  else           filename = cmssw_base + "/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/ellipse_breq_FullRunII.txt";
...
double elliptical_bin_FullRunII::evaluate(unsigned){
  double dM;
...
void elliptical_bin_FullRunII::bindTree_(multidraw::FunctionLibrary& _library)
{
