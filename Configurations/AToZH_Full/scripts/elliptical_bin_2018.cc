...
class elliptical_bin_2018 : public multidraw::TTreeFunction {
public:
  elliptical_bin_2018(const float mA_, const float mH_, const bool isonebjet_);
  char const* getName() const override { return "elliptical_bin_2018"; }
  TTreeFunction* clone() const override { return new elliptical_bin_2018(mA, mH, isonebjet); }
...
elliptical_bin_2018::elliptical_bin_2018(const float mA_, const float mH_, const bool isonebjet_) :
  TTreeFunction(), mA{mA_}, mH{mH_}, isonebjet{isonebjet_}
{
  ...
  std::string filename;
  if (isonebjet) filename = cmssw_base + "/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/ellipse_onebjet_18.txt"; //TEMP update with correct filename
  else           filename = cmssw_base + "/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/ellipse_breq_18.txt";
...
double elliptical_bin_2018::evaluate(unsigned){
  double dM;
...
void elliptical_bin_2018::bindTree_(multidraw::FunctionLibrary& _library)
{
