...
xsec_mA_mH=$(cat /afs/cern.ch/work/s/srudrabh/AZH/postprocessing/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/AToZH_Full/scripts/total_xsec_results.json | jq ".[\"${mA},${mH}\"]")
