...
echo "class0:" "">> significance_class0_03_03_multicut.txt
combine -M Significance class0_03_02_multicut.root -t -1 --setParameters r_vbf=1 --redefineSignalPOIs=r_vbf >> significance_class0_03_02_multicut.txt
