...
echo "class013_6bin:" "">> significance.txt
combine -M Significance vbf_class013_6bin_14Feb.root -t -1 --setParameters r_vbf=1 --redefineSignalPOIs=r_vbf >> significance.txt
