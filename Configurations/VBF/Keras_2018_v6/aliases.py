...
'''
aliases['vbfdnn'] = {
        'linesToAdd': ['.L /afs/cern.ch/work/r/rceccare/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBF/Keras_2018_v6/dnn_tris/evaluate_multiclass_tris_2j.cc+'],
...
'''
aliases['vbfdnn'] = {
        'linesToAdd': ['.L /afs/cern.ch/work/r/rceccare/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBF/Keras_2018_v6/dnn_quad/evaluate_multiclass_quad.cc+'],
        'class': 'evaluate_multiclass',
        'args': 0,
}
...
aliases['olv'] = {
    'expr': "Lepton_eta[0] > min(CleanJet_eta[0], CleanJet_eta[1]) && Lepton_eta[0] < max(CleanJet_eta[0], CleanJet_eta[1]) && Lepton_eta[1] > min(CleanJet_eta[0], CleanJet_eta[1]) && Lepton_eta[1] < max(CleanJet_eta[0], CleanJet_eta[1])",
}
