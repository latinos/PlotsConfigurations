...
#model.add(Dense(400, activation='relu', input_dim=NDIM))
...
with open('generated_code_new_ext.h', 'w') as f:
...
f = ROOT.TFile("dnn_plots_ext.root","RECREATE")
c1.Write()
c2.Write()
c_vbf.Write()
c_top.Write()
