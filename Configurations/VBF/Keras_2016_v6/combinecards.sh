...
modDatacardDir=ModificationDatacards
...
combineCards.py   vbf_cut1=${workdir}/${datacardDir}/hww2l2v_13TeV_of2j_DNN_vbf/classvbf/datacard.txt \
                  ...
                  DY=${workdir}/${datacardDir}/hww2l2v_13TeV_dytt_of2j/events/datacard.txt \
                  top=${workdir}/${datacardDir}/hww2l2v_13TeV_top_of2j/events/datacard.txt \
> class0_15_11_quad_multicut.txt


cp class0_15_11_quad_multicut.txt class0_15_11_quad_multicut_orig.txt 
python RemoveSample.py  class0_15_11_quad_multicut.txt -o  class0_15_11_quad_multicut.txt -i inputRemoveAllSamplesBelowThreshold.py --threshold 0.01
...
text2workspace.py class0_15_11_quad_multicut.txt -o class0_15_11_quad_multicut.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO 'map=.*/qqH_hww:r_vbf[1,-10,10]' --PO 'map=.*/ggH_hww:r_ggH[1,-10,10]'
