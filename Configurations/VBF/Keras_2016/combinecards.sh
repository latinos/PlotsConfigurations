...
combineCards.py   vbf_cut1=${workdir}/${datacardDir}/hww2l2v_13TeV_of2j_DNN_vbf/class0/datacard.txt \
                  ...
                  DY=${workdir}/${datacardDir}/hww2l2v_13TeV_dytt_of2j/events/datacard.txt \
                  top=${workdir}/${datacardDir}/hww2l2v_13TeV_top_of2j/events/datacard.txt \
> class0_04_02_multicut.txt

#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_cferr1" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_cferr2" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_hf" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_lf" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_hfstats1_2016" >> class0_12_12_multicut.txt 
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_hfstats2_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_lfstats1_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_lfstats2_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_btag_jes" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_eff_e_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_eff_m_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_eff_hwwtrigger_2016" >> class0_12_12_multicut.txt
#echo "nuisance edit drop ttH_hww vbf_cut3 CMS_eff_prefiring_2016" >> class0_12_12_multicut.txt




text2workspace.py class0_04_02_multicut.txt -o class0_04_02_multicut.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO 'map=.*/qqH_hww:r_vbf[1,-10,10]' --PO 'map=.*/ggH_hww:r_ggH[1,-10,10]'
