...
echo "class0:" "">> significance_class0_14_11_quad_multicut.txt
combine -M Significance class0_14_11_quad_multicut.root -t -1 --setParameters r_vbf=1 --redefineSignalPOIs=r_vbf >> significance_class0_14_11_quad_multicut.txt
