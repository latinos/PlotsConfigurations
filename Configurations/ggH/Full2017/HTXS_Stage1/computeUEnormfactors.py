...
directoryNom='/afs/cern.ch/user/y/yiiyama/public/hwwvirtual/Fall17/l2tightOR/'
directoryUp='/afs/cern.ch/user/y/yiiyama/public/hwwvirtual/Fall17/l2tightOR__UEup/'
directoryDown='/afs/cern.ch/user/y/yiiyama/public/hwwvirtual/Fall17/l2tightOR__UEdo/'
...
chainggHNom.Add(directoryNom+"nanoLatino_GluGluHToWWTo2L2NuPowheg_M125__part4.root")
chainggHNom.Add(directoryNom+"nanoLatino_GluGluHToWWTo2L2NuPowheg_M125__part5.root")
