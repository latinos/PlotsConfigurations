...
#include <iostream>
#include <TMath.h>
#include "generated_code_mjjlow.h"

class evaluate_multiclass_mjjlow : public multidraw::TTreeFunction {
public:
  evaluate_multiclass_mjjlow(int const nclass);

  char const* getName() const override { return "evaluate_multiclass_mjjlow"; }
  TTreeFunction* clone() const override { return new evaluate_multiclass_mjjlow(nclass_); }
...
evaluate_multiclass_mjjlow::evaluate_multiclass_mjjlow(int const nclass) :
  TTreeFunction()
{
  nclass_ = nclass;
}
...
double
evaluate_multiclass_mjjlow::evaluate(unsigned)
{
...
void
evaluate_multiclass_mjjlow::bindTree_(multidraw::FunctionLibrary& _library)
{
