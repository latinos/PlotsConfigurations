...
#No merging
command="text2workspace.py Full2016_ggH_HTXS_Stage1p2.txt -o Full2016_ggH_HTXS_Stage1p2.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
