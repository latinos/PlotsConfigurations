...
# Make plots:
    ...
    mkPlot.py --pycfg=configuration.py --inputFile rootFile/plots_ggH2016_v6.root --onlyPlot=cratio --linearOnly --showIntegralLegend=1

# Make datacards:

    mkDatacards.py --pycfg configuration.py --inputFile rootFile/plots_ggH2016_v6.root
