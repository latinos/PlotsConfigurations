...
samples['WW']  = {    'name': ['latino_WWTo2L2Nu.root', 'latino_WWTo2L2NuHerwigPS.root'],      
...
samples['ggH_hww']  = {    'name': [
                               'latino_GluGluHToWWTo2L2NuPowheg_M125.root', 'latino_GluGluHToWWTo2L2NuHerwigPS_M125.root'
