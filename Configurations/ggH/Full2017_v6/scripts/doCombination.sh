...
## work directory
outputDir=/afs/cern.ch/work/l/lviliani/LatinosFramework13TeV_FullRun2_branchmaps/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2017_v6/Combination/

datacardDir=/afs/cern.ch/work/l/lviliani/LatinosFramework13TeV_FullRun2_branchmaps/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2017_v6/datacards/
...
cp ${outputDir}/Full2017_0jet_ggH.txt ${outputDir}/Full2017_0jet_ggH_orig.txt
python ${modDatacardDir}/RemoveSample.py ${outputDir}/Full2017_0jet_ggH_orig.txt -o ${outputDir}/Full2017_0jet_ggH.txt -i ${modDatacardDir}/inputRemoveAllSamplesBelowThreshold.py --threshold 0.01
#echo "nuisance edit drop qqH_hww em_mp_0j_pt2lt20 PS_FSR" >> ${outputDir}/Full2017_0jet_ggH.txt
#echo "nuisance edit drop qqH_hww em_mp_0j_pt2lt20 PS_ISR" >> ${outputDir}/Full2017_0jet_ggH.txt
...
cp ${outputDir}/Full2017_1jet_ggH.txt ${outputDir}/Full2017_1jet_ggH_orig.txt
python ${modDatacardDir}/RemoveSample.py ${outputDir}/Full2017_1jet_ggH_orig.txt -o ${outputDir}/Full2017_1jet_ggH.txt -i ${modDatacardDir}/inputRemoveAllSamplesBelowThreshold.py --threshold 0.01

combineCards.py   of2j_2017=${datacardDir}/hww2l2v_13TeV_2j/${variable_ggh2j}/datacard.txt \
                  of2j_Top_2017=${datacardDir}/hww2l2v_13TeV_top_2j/events/datacard.txt \
                  of2j_DYtt_2017=${datacardDir}/hww2l2v_13TeV_dytt_2j/events/datacard.txt \
                  >   ${outputDir}/Full2017_2jet_ggH.txt

cp ${outputDir}/Full2017_2jet_ggH.txt ${outputDir}/Full2017_2jet_ggH_orig.txt
python ${modDatacardDir}/RemoveSample.py ${outputDir}/Full2017_2jet_ggH_orig.txt -o ${outputDir}/Full2017_2jet_ggH.txt -i ${modDatacardDir}/inputRemoveAllSamplesBelowThreshold.py --threshold 0.01
...
#text2workspace.py Full2017_ggH.txt -o Full2017.muVmuF.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose  \
