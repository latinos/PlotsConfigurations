...
## work directory
outputDir=/afs/cern.ch/work/r/rceccare/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2017_v6/HTXS_Stage1p2_ggHVBFVH/Combination_20_11_quad

if [ ! -d $outputDir ]; then
  mkdir $outputDir
fi

datacardDir=/afs/cern.ch/work/r/rceccare/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2017_v6/HTXS_Stage1p2_ggHVBFVH/datacards_ggH_vbf_VH_2017v6_STXS_20_11_quad
...
combineCards.py   of2j_vbflike_mjj350_700_pthLT200=${datacardDir}/hww2l2v_13TeV_of2j_vbflike_mjj350_700_pthLT200/classvbf_1/datacard.txt \
                  ...
                  >   ${outputDir}/Full2017_ggH_HTXS_Stage1p2_2j.txt
