...
#command="combine -M Significance Full2018_ggH_HTXS_Stage1p2_2j_onePOI.root -t -1 --setParameters r_ggh=1,r_qqh=1 --redefineSignalPOIs=r_ggh >> significance_onePOI_gg$\mathrm{t\bar{t}}$h.txt "
