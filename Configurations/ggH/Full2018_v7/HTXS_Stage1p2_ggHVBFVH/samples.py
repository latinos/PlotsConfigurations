...
for cat,num in HTXSStage1_1Categories.iteritems():
    ...
    if 'GG2H_' in cat:
        ...
        if 'PTH_GT200' not in cat:
            ...
            addSampleWeight(samples, 'ggH_hww_'+cat.replace('GG2H_',''), 'GluGluHToWWTo2L2Nu_M125', '(HTXS_stage1_1_cat_pTjet30GeV<107)*Weight2MINLO*1093.8199/1073.9094')
            ...
            print('HTXS_stage1_1_cat_pTjet30GeV=='+str(num))
    ...
    ## qqZH lep.
      ...
      samples['ZH_lep_hww_'+cat.replace('QQ2HLL_','')]  = { 'name' :  nanoGetSampleFiles(mcDirectory,'HZJ_HToWWTo2L2Nu_M125') ,
                                                            'weight': mcCommonWeight+'*(HTXS_stage1_1_cat_pTjet30GeV=='+str(num)+')' ,
                                                            'suppressNegative' :['all'],
                                                            'suppressNegativeNuisances' :['all'],
                                                          }
...
addSampleWeight(samples, 'ggH_hww_PTH_200_300', 'GluGluHToWWTo2L2Nu_M125', '(HTXS_stage1_1_cat_pTjet30GeV<107)*Weight2MINLO*1093.8199/1073.9094')
addSampleWeight(samples, 'ggH_hww_PTH_200_300', 'GGHjjToWWTo2L2Nu_minloHJJ_M125', '(HTXS_stage1_1_cat_pTjet30GeV>106)*1093.8199/1073.9094')
...
addSampleWeight(samples, 'ggH_hww_PTH_300_450', 'GluGluHToWWTo2L2Nu_M125', '(HTXS_stage1_1_cat_pTjet30GeV<107)*Weight2MINLO*1093.8199/1073.9094')
addSampleWeight(samples, 'ggH_hww_PTH_300_450', 'GGHjjToWWTo2L2Nu_minloHJJ_M125', '(HTXS_stage1_1_cat_pTjet30GeV>106)*1093.8199/1073.9094')
...
addSampleWeight(samples, 'ggH_hww_PTH_450_650', 'GluGluHToWWTo2L2Nu_M125', '(HTXS_stage1_1_cat_pTjet30GeV<107)*Weight2MINLO*1093.8199/1073.9094')
addSampleWeight(samples, 'ggH_hww_PTH_450_650', 'GGHjjToWWTo2L2Nu_minloHJJ_M125', '(HTXS_stage1_1_cat_pTjet30GeV>106)*1093.8199/1073.9094')
...
addSampleWeight(samples, 'ggH_hww_PTH_GT650', 'GluGluHToWWTo2L2Nu_M125', '(HTXS_stage1_1_cat_pTjet30GeV<107)*Weight2MINLO*1093.8199/1073.9094')
addSampleWeight(samples, 'ggH_hww_PTH_GT650', 'GGHjjToWWTo2L2Nu_minloHJJ_M125', '(HTXS_stage1_1_cat_pTjet30GeV>106)*1093.8199/1073.9094')
