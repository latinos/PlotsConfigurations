...
#                  >   superCombination.Total.only2015signal.txt.pruned.txt
#  
#  
#  
# 
# text2workspace.py superCombination.Total.only2015signal.txt.pruned.txt   -o    superCombination.Total.only2015signal.txt.pruned.txt.workspace.root


# 
# combineTool.py -d superCombination.Total.only2015signal.txt.pruned.txt.workspace.root -M MultiDimFit    \
#                --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEPTotal2015sigOnlycombinedLXBATCHNominal"   \
#                --points 100    --job-mode lxbatch --task-name lxbatch-superCombinationTotal-Nominal-2015sigOnly --sub-opts='-q 1nd' --split-points 1  
#                
# 
# 
# combineTool.py -d superCombination.Total.only2015signal.txt.pruned.txt.workspace.root -M MultiDimFit    \
#                --algo=grid    -t -1 --expectSignal 1    --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanHICHEPTotal2015sigOnlycombinedLXBATCHNominal"   \
#                --points 100    --job-mode lxbatch --task-name lxbatch-MC-superCombinationTotal-Nominal-2015sigOnly --sub-opts='-q 1nd' --split-points 1  
  
  
  
# hadd higgsCombineLHScanHICHEPTotal2015sigOnlycombinedLXBATCHNominal.root         higgsCombineLHScanHICHEPTotal2015sigOnlycombinedLXBATCHNominal.POINTS.*.MultiDimFit.mH120.root
# hadd higgsCombineLHScanDATAHICHEPTotal2015sigOnlycombinedLXBATCHNominal.root     higgsCombineLHScanDATAHICHEPTotal2015sigOnlycombinedLXBATCHNominal.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanHICHEPTotal2015sigOnlycombinedLXBATCHNominal.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
#  ls -alrth higgsCombineLHScanDATAHICHEPTotal2015sigOnlycombinedLXBATCHNominal.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
# 
# combine -M MultiDimFit --saveWorkspace -n teststep1.superCombination.2016.txt.pruned.txt.workspace superCombination.2016.txt.pruned.txt.workspace.root
# 
# 
# combineTool.py -d higgsCombineteststep1.superCombination.2016.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.2016.txt.pruned.txt.workspace  \
#           -M MultiDimFit    \
#           --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEP2016combinedLXBATCHTheoryFrozenPostFit"   \
#           --points 100    --job-mode lxbatch --task-name lxbatch-superCombinationTotal-TheoryFrozen --sub-opts='-q 1nd' --split-points 1    \
#           --freezeNuisances CMS_tttwTh,\
# PS_ICHEP,\
# PS_wh3l,\
...
# hadd higgsCombineLHScanDATAHICHEP2016combinedLXBATCHTheoryFrozenPostFit.root         higgsCombineLHScanDATAHICHEP2016combinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEP2016combinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
# combineTool.py -d higgsCombineteststep1.superCombination.2016.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.2016.txt.pruned.txt.workspace  \
#           -M MultiDimFit    \
#           --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEP2016combinedLXBATCHExpNuisFrozenPostFit"   \
...
# hadd higgsCombineLHScanDATAHICHEP2016combinedLXBATCHExpNuisFrozenPostFit.root         higgsCombineLHScanDATAHICHEP2016combinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEP2016combinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
# combine -M MultiDimFit --saveWorkspace -n teststep1.superCombination.2015.txt.pruned.txt.workspace superCombination.2015.txt.pruned.txt.workspace.root

# 
# combine -M MultiDimFit --saveWorkspace -n teststep1.superCombination.Total.txt.pruned.txt.workspace superCombination.Total.txt.pruned.txt.workspace.root
...
combineTool.py -d higgsCombineteststep1.superCombination.Total.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.Total.txt.pruned.txt.workspace  \
          -M MultiDimFit    \
          --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEPTotalcombinedLXBATCHTheoryFrozenPostFit"   \
          --points 100    --job-mode lxbatch --task-name lxbatch-superCombinationTotal-TheoryFrozen --sub-opts='-q 1nd' --split-points 1    \
          --freezeNuisances CMS_tttwTh,\
PS_ICHEP,\
PS_wh3l,\
...
# hadd higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHTheoryFrozenPostFit.root         higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
combineTool.py -d higgsCombineteststep1.superCombination.Total.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.Total.txt.pruned.txt.workspace  \
          -M MultiDimFit    \
          --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEPTotalcombinedLXBATCHExpNuisFrozenPostFit"   \
          --points 100    --job-mode lxbatch --task-name lxbatch-superCombinationTotal-ExpNuisFrozen --sub-opts='-q 1nd' --split-points 1    \
          --freezeNuisances \
CMS_hww2l2v_13TeV_dytt_of0j_DY_ibin_1_stat,\
CMS_hww2l2v_13TeV_dytt_of0j_Fake_ibin_1_stat,\
...
# hadd higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHExpNuisFrozenPostFit.root         higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEPTotalcombinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
combineTool.py -d higgsCombineteststep1.superCombination.2015.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.2015.txt.pruned.txt.workspace  \
          -M MultiDimFit    \
          --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEP2015combinedLXBATCHTheoryFrozenPostFit"   \
...
# hadd higgsCombineLHScanDATAHICHEP2015combinedLXBATCHTheoryFrozenPostFit.root         higgsCombineLHScanDATAHICHEP2015combinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEP2015combinedLXBATCHTheoryFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
...
combineTool.py -d higgsCombineteststep1.superCombination.2015.txt.pruned.txt.workspace.MultiDimFit.mH120.root   -w w  --snapshotName "MultiDimFit" -n teststep2.superCombination.2015.txt.pruned.txt.workspace  \
          -M MultiDimFit    \
          --algo=grid  --setPhysicsModelParameterRanges  r=0,2.5    -n "LHScanDATAHICHEP2015combinedLXBATCHExpNuisFrozenPostFit"   \
...
# hadd higgsCombineLHScanDATAHICHEP2015combinedLXBATCHExpNuisFrozenPostFit.root         higgsCombineLHScanDATAHICHEP2015combinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root

#  ls -alrth higgsCombineLHScanDATAHICHEP2015combinedLXBATCHExpNuisFrozenPostFit.POINTS.*.MultiDimFit.mH120.root  | grep -v 6.6K | grep -v 6.7K | awk '{print "rm "$9}' | /bin/sh
