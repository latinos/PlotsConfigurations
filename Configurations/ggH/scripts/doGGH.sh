...
combine -M MultiDimFit ICHEP2016.v1.txt.pruned.txt -m 125 --algo=grid --points 200 --setPhysicsModelParameterRanges r=-2,4 -n "LHScanHdata"     >   result.data.LikelihoodScan.ICHEP2016.v1.txt.pruned.txt
