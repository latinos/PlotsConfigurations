...
GenLepMatch   = '1' #'PromptGenLepMatch'+Nlep+'l' #FIXME correct when we use real fakes
...
samples['VZ']  = {  'name'   :   getSampleFiles(directory,'ZZTo2L2Nu_ext1',False,'nanoLatino_')
                               ...
                               #+ getSampleFiles(directory,'ZZTo4L_ext2',False,'nanoLatino_') # not yet available Aug 5
