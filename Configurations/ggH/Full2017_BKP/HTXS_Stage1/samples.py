...
directory = treeBaseDir+'Fall2017_nAOD_v1_Full2017v2LP19/MCl1loose2017__MCCorr2017LP19__l2loose__l2tightOR2017__PUFIXLP19'+skim
...
for cat,num in HTXSStage1Categories.iteritems():
  ## ggH
  if 'GG2H_' in cat:
    samples['ggH_hww_'+cat.replace('GG2H_','')]  = {  'name'  : getSampleFiles(directory,'GluGluHToWWTo2L2NuPowheg_M125_PrivateNano',False,'nanoLatino_') ,
                                                      'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')',#+'*weight2MINLO' ,
...
#                                                   }
  ## VBF and VH had.
    ...
    samples['qqH_hww_'+cat.replace('QQ2HQQ_','')]  = {  'name' : getSampleFiles(directory,'VBFHToWWTo2L2NuPowheg_M125_PrivateNano',False,'nanoLatino_') ,
                                                        'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
                                                        'suppressNegative' :['all'],
                                                        'suppressNegativeNuisances' :['all'],
                                                     }
#    samples['qqH_htt_'+cat.replace('QQ2HQQ_','')]  = {  'name' :   getSampleFiles(directory,'VBFHToTauTau_M125',False,'nanoLatino_') ,
#                                                        'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                        'suppressNegative' :['all'],
#                                                        'suppressNegativeNuisances' :['all'],
#                                                     }
...
#                                                            'suppressNegativeNuisances' :['all'],
#                                                         }
#    samples['WH_had_htt_'+cat.replace('QQ2HQQ_','')]  = { 'name' :   getSampleFiles(directory,'HWplusJ_HToTauTau_M125',False,'nanoLatino_')
#                                                                    + getSampleFiles(directory,'HWminusJ_HToTauTau_M125',False,'nanoLatino_') ,
#                                                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                           'suppressNegative' :['all'],
#                                                           'suppressNegativeNuisances' :['all'],
#                                                         }
#    samples['ZH_had_hww_'+cat.replace('QQ2HQQ_','')]  = { 'name' :  getSampleFiles(directory,'HZJ_HToWW_M125',False,'nanoLatino_') ,
#                                                          'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                          'suppressNegative' :['all'],
#                                                          'suppressNegativeNuisances' :['all'],
#                                                        }
#    samples['ZH_had_htt_'+cat.replace('QQ2HQQ_','')]  = { 'name' :   getSampleFiles(directory,'HZJ_HToTauTau_M125',False,'nanoLatino_') ,
#                                                          'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                          'suppressNegative' :['all'],
#                                                          'suppressNegativeNuisances' :['all'],
#                                                        }
...
#    samples['WH_lep_hww_'+cat.replace('QQ2HLNU_','')]   = {  'name' :   getSampleFiles(directory,'HWminusJ_HToWW_M125',False,'nanoLatino_')
#                                                                      + getSampleFiles(directory,'HWplusJ_HToWW_M125',False,'nanoLatino_')  ,
#                                                            'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                            'suppressNegative' :['all'],
#                                                            'suppressNegativeNuisances' :['all'],
#                                                         }
#    samples['WH_lep_htt_'+cat.replace('QQ2HLNU_','')]  = { 'name' :   getSampleFiles(directory,'HWplusJ_HToTauTau_M125',False,'nanoLatino_')
#                                                                    + getSampleFiles(directory,'HWminusJ_HToTauTau_M125',False,'nanoLatino_') ,
#                                                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                           'suppressNegative' :['all'],
#                                                           'suppressNegativeNuisances' :['all'],
...
#  ## qqZH lep.
#  elif 'QQ2HLL_' in cat:
#    samples['ZH_lep_hww_'+cat.replace('QQ2HLL_','')]  = { 'name' :  getSampleFiles(directory,'HZJ_HToWW_M125',False,'nanoLatino_') ,
#                                                          'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                          'suppressNegative' :['all'],
#                                                          'suppressNegativeNuisances' :['all'],
#                                                        }
#    samples['ZH_lep_htt_'+cat.replace('QQ2HLL_','')]  = { 'name' :   getSampleFiles(directory,'HZJ_HToTauTau_M125',False,'nanoLatino_') ,
#                                                          'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                          'suppressNegative' :['all'],
#                                                          'suppressNegativeNuisances' :['all'],
#                                                        }
#  ## ggZH lep
#  elif 'GG2HLL_' in cat:
#    samples['ggZH_lep_hww_'+cat.replace('GG2HLL_','')] = {  'name' : getSampleFiles(directory,'ggZH_HToWW_M125',False,'nanoLatino_') ,
#                                                            'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                            'suppressNegative' :['all'],
#                                                            'suppressNegativeNuisances' :['all'],
#                                                         }
#  ## ttH
#  elif 'TTH' in cat:
#    samples['ttH_hww'+cat.replace('TTH','')]  = {  'name' :   getSampleFiles(directory,'ttHToNonbb_M125',False,'nanoLatino_'),
#                                                     'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage_1_pTjet30=='+str(num)+')' ,
#                                                     'suppressNegative' :['all'],
#                                                     'suppressNegativeNuisances' :['all'],
#                                                   }
#  ## bbH
#  elif 'BBH' in cat:
#    samples['bbH_hww'+cat.replace('BBH','')]  = {  'name' :   getSampleFiles(directory,'bbHToWWTo2L2Nu_M125_yb2',False,'nanoLatino_')
...
for Run in DataRun :
        directory = treeBaseDir+'Run2017_nAOD_v1_Full2017v2LP19/DATAl1loose2017LP19__l2loose__fakeWPUFIXLP19'+skim
...
for Run in DataRun :
        directory = treeBaseDir+'Run2017_nAOD_v1_Full2017v2LP19//DATAl1loose2017LP19__l2loose__l2tightOR2017'+skim
        for DataSet in DataSets :
                FileTarget = getSampleFiles(directory,DataSet+'_'+Run[1],True,'nanoLatino_')
                for iFile in FileTarget:
                        print(iFile)
