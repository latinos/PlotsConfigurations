...
for s in signals_orig:
  ...
  elif 'WH' in s or 'ZH' in s or 'VH' in s: signals_VH.append(s)
...
#  if overallTotalSignal[c] == 0: continue
  ...
  for num,s in enumerate(overallSignalRate[c]):
    ...
    elif 'WH' in s or 'ZH' in s or 'VH' in s: setPalette(signals_VH,'g')
...
canvas.SaveAs("signalfraction2017_1p2.png")
