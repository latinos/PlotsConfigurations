...
#!!!!!!!!!!!!!!!!!! FIXME Using the 2017 (!!) privateNano signal samples until the 2016 ones are available FIXME !!!!!!!!!!!!!!!!!!!!!!!#
directoryTMP = treeBaseDir+'Fall2017_nAOD_v1_Full2017v2LP19/MCl1loose2017__MCCorr2017LP19__l2loose__l2tightOR2017__PUFIXLP19'+skim
...
for cat,num in HTXSStage1Categories.iteritems():
  ## ggH
  if 'GG2H_' in cat:
    samples['ggH_hww_'+cat.replace('GG2H_','')]  = {  'name'  : getSampleFiles(directoryTMP,'GluGluHToWWTo2L2NuPowheg_M125_PrivateNano',False,'nanoLatino_') ,
...
#                                                   }
  ## VBF and VH had.
    ...
    samples['qqH_hww_'+cat.replace('QQ2HQQ_','')]  = {  'name' : getSampleFiles(directoryTMP,'VBFHToWWTo2L2NuPowheg_M125_PrivateNano',False,'nanoLatino_') ,
                                                        'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*(HTXS_stage1_pTjet30GeV=='+str(num)+')' ,
                                                        'suppressNegative' :['all'],
                                                        'suppressNegativeNuisances' :['all'],
                                                     }
