...
#FIXME Add when 2016 private nano are available
#for name in sampleNames:
...
#  elif 'qqH_hww' in name:
#    nuisances['PS']['samples'].update({name: ['1.0137', '0.9781']})
...
#QCD scale acceptance uncertainties within each STXS bin
#The up/down variations are renormalized such that they don't change the normalization
#FIXME Check if this works as expected!
#*............................................................................*
#*Br    5 :LHEScaleSumw :                                                     *
#*         | Double_t Sum of genEventWeight * LHEScaleWeight[i], divided by genEventSumw*
#*Entries :        1 : Total  Size=        833 bytes  File Size  =        163 *
#*Baskets :        1 : Basket Size=      32000 bytes  Compression=   1.00     *
#*............................................................................*
#***********************************
#*    Row   * Instance * LHEScaleSumw *
#***********************************
#*        0 *        0 * 1.1724862 *
#*        0 *        1 * 1.2011815 *
#*        0 *        2 * 1.2248701 *
...
#FIXME Do we need this for ggH STXS? Should be already part of QCDscale_ggH_STXS_ACCEPT
