...
supercut = 'mll>10  \
            ...
            && pfType1Met > 20 \
            && ptll > 30 \
            && ( std_vector_jet_pt[0] < 15 || std_vector_jet_csvv2ivf[0] < 0.89 ) \
            && ( std_vector_jet_pt[1] < 15 || std_vector_jet_csvv2ivf[1] < 0.89 ) \
            && ( std_vector_jet_pt[2] < 15 || std_vector_jet_csvv2ivf[2] < 0.89 ) \
            && ( std_vector_jet_pt[3] < 15 || std_vector_jet_csvv2ivf[3] < 0.89 ) \
            && ( std_vector_jet_pt[4] < 15 || std_vector_jet_csvv2ivf[4] < 0.89 ) \
            && ( std_vector_jet_pt[5] < 15 || std_vector_jet_csvv2ivf[5] < 0.89 ) \
'
