...
#precommand+='echo "nuisance edit drop VgS_L of2j_toplike_mjj350_700_pthLT200 QCDscale_VV" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
#precommand+='echo "nuisance edit drop ggH_htt of2j_wwlike_mjj350_700_pthLT200 CMS_scale_JESAbsolute" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
#precommand+='echo "nuisance edit drop ggH_htt of2j_wwlike_mjj350_700_pthLT200 CMS_scale_JESHF" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
#precommand+='echo "nuisance edit drop ggH_htt of2j_wwlike_mjj350_700_pthLT200 CMS_scale_JESFlavorQCD" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
#precommand+='echo "nuisance edit drop ggH_htt of2j_wwlike_mjj350_700_pthLT200 CMS_scale_JESRelativeBal" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
...
#
#precommand+='echo "nuisance edit drop DY of2j_pth60_120 CMS_PU_2016" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
...
#
#
#precommand+='echo "nuisance edit drop VgS_L of2j_vh_top QCDscale_VV" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;' 
...
precommand+='echo "nuisance edit drop DY of2j_vh_top CMS_PU_2016" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;'
precommand+='echo "nuisance edit drop DY of2j_vh_top QCDscale_V" >> Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt;'


command="text2workspace.py Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt -o Full2016_ggH_HTXS_Stage1p2_2j_merged.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose "
...
#Merge all bins
command="text2workspace.py Full2016_ggH_HTXS_Stage1p2_2j_EDIT.txt -o Full2016_ggH_HTXS_Stage1p2_2j_onePOI.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO 'map=.*/.*ggH_hww.*:r_ggh[1,-10,10]' --PO 'map=.*/.*qqH_hww.*:r_qqh[1,-10,10]' --PO verbose"
#--PO 'map=.*mjjGT700.*/Vg:0' --PO 'map=.*pth450.*/Fake.*:0' --PO 'map=.*pthGT650.*/Fake.*:0' --PO 'map=.*pthGT200.*/Fake.*:0' --PO 'map=.*pthLT200.*/VVV.*:0' "
