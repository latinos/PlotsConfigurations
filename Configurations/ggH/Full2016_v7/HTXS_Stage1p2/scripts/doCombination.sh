...
## work directory
outputDir=/afs/cern.ch/work/l/lviliani/LatinosFramework13TeV_FullRun2/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2016_v7/HTXS_Stage2/Combination/
#outputDir=/eos/user/l/lviliani/HWWRun2LegacyCombinationSTXS/ggH_DF/2016/

datacardDir=/afs/cern.ch/work/l/lviliani/LatinosFramework13TeV_FullRun2/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/ggH/Full2016_v7/HTXS_Stage2/datacards/
#datacardDir=/eos/user/l/lviliani/HWWRun2LegacyCombinationSTXS/ggH_DF/2016/datacards_ggH2016v6_STXS/
...
combineCards.py   of_0j_pth0_10=${datacardDir}/hww2l2v_13TeV_of0j_pth0_10/${variable_pt2lt20}/datacard.txt \
                  ...
                  >   ${outputDir}/Full2016_ggH_HTXS_Stage2.txt

cp ${outputDir}/Full2016_ggH_HTXS_Stage2.txt ${outputDir}/Full2016_ggH_HTXS_Stage2_orig.txt
python ${modDatacardDir}/RemoveSample.py ${outputDir}/Full2016_ggH_HTXS_Stage2_orig.txt -o ${outputDir}/Full2016_ggH_HTXS_Stage2.txt -i ${modDatacardDir}/inputRemoveAllSamplesBelowThreshold.py --threshold 0.01
