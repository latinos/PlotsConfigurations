...
command4.append('combineTool.py -M Impacts -d %s.root -m 125.09 -n %s -t -1 --X-rtd MINIMIZER_analytic --approx robust --doFits --parallel 8 %s' %(comfile,comfile,setPOI))
command4.append('combineTool.py -M Impacts -d %s.root -m 125.09 -n %s -t -1 --X-rtd MINIMIZER_analytic --approx robust -o impacts.json %s' %(comfile,comfile,setPOI))
