...
samples['qqH_sonly_on'] = {
	...
	'weight': mcCommonWeight + '* (LHE_mWW <= 160) * btagnorm_qqH_sonly_on',
	'FilesPerJob': 4,
	'suppressNegative':['all'],
	'suppressNegativeNuisances' :['all']
}
...
samples['qqH_bonly_on'] = {
	'name': nanoGetSampleFiles(mcDirectory, 'WpWmJJ_EWK_noTop'),
	'weight': mcCommonWeight + '*(Sum$(abs(GenPart_pdgId)==6 || GenPart_pdgId==25)==0) * (LHE_mWW <= 160) * btagnorm_qqH_bonly_on', #filter tops and Higgs
	'FilesPerJob': 4,
	'suppressNegative':['all'],
	'suppressNegativeNuisances' :['all']
}
...
samples['ggH_sonly_on'] = {
	...
	'weight': mcCommonWeight+'* (LHE_mWW <= 160) * btagnorm_ggH_sonly_on',
	'FilesPerJob': 3,
	'suppressNegative':['all'],
	'suppressNegativeNuisances' :['all']
