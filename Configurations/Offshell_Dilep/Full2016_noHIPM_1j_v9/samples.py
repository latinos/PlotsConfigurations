...
m_mcDirectory = '/eos/user/c/carbour/postProcessing/Summer20UL16_106x_nAODv9_noHIPM_Full2016v9/MCl1loose2016v9__MCCorr2016v9NoJERInHorn__l2tightOR2016v9__MCZlrm'
fakeDirectory = os.path.join(treeBaseDir, dataReco, fakeSteps)
dataDirectory = os.path.join(treeBaseDir, dataReco, dataSteps)
signalDirectory = '/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL16_106x_nAODv9_noHIPM_Full2016v9/AddLHE_MEs__AddMC_baseW__AddHWW_Offshell_Wgts__MCl1loose2016v9__MCCorr2016v9NoJERInHorn__l2tightOR2016v9'
...
#     'weight': mcCommonWeight+'*1.53/1.4 * 1.33 * norm_njet * 1.33 * norm_njet', # updating k-factor - split ggWW divide mass of WW
#     'FilesPerJob': 4,
#     'suppressNegative' :['all'],
#     'suppressNegativeNuisances' :['all']
# }
...
samples['ggH_sonly_off'] = {
    'name': files,
    'weight': mcCommonWeight+'* 1.68 * 1.645 * norm_njet * 1.645 * norm_njet * (LHE_mWW > 160)',
    'FilesPerJob': 3,
    'suppressNegative':['all'],
    'suppressNegativeNuisances' :['all']
}
...
samples['ggH_bonly_off'] = {
    'name': files,
    'weight': mcCommonWeight+'*1.53/1.4 * 1.33 * norm_njet * 1.33 * norm_njet  * (LHE_mWW > 160)',
    'FilesPerJob': 3,
    'suppressNegative':['all'],
    'suppressNegativeNuisances' :['all']
}
...
samples['ggH_sand_off'] = {
    'name': files,
    'weight': mcCommonWeight+'*1.60 * 1.52 * norm_njet * 1.52 * norm_njet * (LHE_mWW > 160)', ##TC 2024 SBI scaled by 151.6/95.0 {https://www.arxiv.org/pdf/1605.04610#page=18}
    'FilesPerJob': 3,
    'suppressNegative':['all'],
    'suppressNegativeNuisances' :['all']
}
samples['ggH_sand_on'] = {
    'name': files,
    'weight': mcCommonWeight+'*1.60 * 1.52 * norm_njet * 1.52 * norm_njet * (LHE_mWW <= 160)', ##TC 2024 SBI scaled
    'FilesPerJob': 3,
    'suppressNegative':['all'],
    'suppressNegativeNuisances' :['all']
}
