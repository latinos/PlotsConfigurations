...
##central prod MCFM May 2024
signalDirectory = '/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/AddLHE_MEs__AddMC_baseW__AddHWW_Offshell_Wgts__MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9'#reweightdir

#signalDirectory = '/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9/' #centralprod #'/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/AddLHE_MEs__AddMC_baseW__AddHWW_Offshell_Wgts__MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9'#reweightdir #'/eos/cms/store/group/phys_higgs/cmshww/fernanpe/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9'#private prod dir
...
##TC May 2024 not using sample - get rid of electroweak
...
##TC May 2024 - comment out bc new region here--
...
samples['ggH_sonly_off'] = {
    ...
    'weight': mcCommonWeight+'* norm_njet * (LHE_mWW > 160) * btagnorm_ggH_sonly_off * ggH_NNLO_kFactor * 0.49721373',
...
samples['ggH_sonly_on'] = {
    ...
    'weight': mcCommonWeight+'* norm_njet * (LHE_mWW <= 160) * btagnorm_ggH_sonly_on * ggH_NNLO_kFactor * 0.49721373',
...
samples['ggH_bonly_off'] = {
    ...
    'weight': mcCommonWeight+'*1.0/1.4 * norm_njet  * (LHE_mWW > 160) * btagnorm_ggH_bonly_off * ggH_NNLO_kFactor * 0.49721373',
...
samples['ggH_sand_off'] = {
    ...
    'weight': mcCommonWeight+'* norm_njet * (LHE_mWW > 160) * btagnorm_ggH_sand_off * ggH_NNLO_kFactor * 0.49721373',
