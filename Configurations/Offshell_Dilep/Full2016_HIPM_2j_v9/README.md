...
mkPlot.py  --pycfg=configuration.py  --inputFile=rootFile/plots_hww_offshell_UL_2016_HIPM.root --minLogC=0.01 --minLogCratio=0.01 --maxLogC=1000 --maxLogCratio=1000 --fileFormats=png,pdf --showIntegralLegend=
```
