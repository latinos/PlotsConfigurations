...
samples['WW_pt1']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]<40)',  
                 }
samples['WW_pt2']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]<50)*(std_vector_dressedLeptonGen_pt[0]>=40)',  
                 }
samples['WW_pt3']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]<60)*(std_vector_dressedLeptonGen_pt[0]>=50)',  
                 }
samples['WW_pt4']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]<80)*(std_vector_dressedLeptonGen_pt[0]>=60)',  
                 }
samples['WW_pt5']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]<100)*(std_vector_dressedLeptonGen_pt[0]>=80)',  
                 }
samples['WW_pt6']  = {    'name'   : getSampleFiles(directory,'WWTo2L2Nu') ,
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*nllW' + '*(std_vector_dressedLeptonGen_pt[0]>=100)',  
                 }
