...
for out_bin, in_bins in binning.bin_mapping['ptH'].iteritems():
...
for cut in cuts:
    ...
    if matches:
        ...
        ibin = binning.bins['ptH'].index(out_bin)
        ncat = binning.category_scheme['ptH'][ibin]
