...
nuisances['btag_shape_jes']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFjesup/btagSF)', '(btagSFjesdown/btagSF)'],
                   #
...
nuisances['btag_shape_lf']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   #
                   'ZH_hww_0j_fid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_1j_fid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_2j_fid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_3j_fid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_4j_fid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_0j_nonfid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_1j_nonfid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_2j_nonfid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_3j_nonfid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   'ZH_hww_4j_nonfid'  : ['(btagSFlfup/btagSF)', '(btagSFlfdown/btagSF)'],
                   #
...
nuisances['btag_shape_hf']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFhfup/btagSF)', '(btagSFhfdown/btagSF)'],
                   #
...
nuisances['btag_shape_hfstats1']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFhfstats1up/btagSF)', '(btagSFhfstats1down/btagSF)'],
                   #
...
nuisances['btag_shape_hfstats2']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFhfstats2up/btagSF)', '(btagSFhfstats2down/btagSF)'],
                   #
...
nuisances['btag_shape_lfstats1']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFlfstats1up/btagSF)', '(btagSFlfstats1down/btagSF)'],
                   #
...
nuisances['btag_shape_lfstats2']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFlfstats2up/btagSF)', '(btagSFlfstats2down/btagSF)'],
                   #
...
nuisances['btag_shape_cferr1']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFcferr1up/btagSF)', '(btagSFcferr1down/btagSF)'],
                   #
...
nuisances['btag_shape_cferr2']  = {
                ...
                'samples'  : {
                   ...
                   'ggH_hww_0j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_1j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_2j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_3j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_4j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_0j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_1j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_2j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_3j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'ggH_hww_4j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_0j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_1j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_2j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_3j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_4j_fid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_0j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_1j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_2j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_3j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   'qqH_hww_4j_nonfid' : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   #
#                   'XH_hww_0j_fid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_1j_fid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_2j_fid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_3j_fid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_4j_fid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_0j_nonfid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_1j_nonfid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_2j_nonfid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_3j_nonfid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
#                   'XH_hww_4j_nonfid'  : ['(btagSFcferr2up/btagSF)', '(btagSFcferr2down/btagSF)'],
                   #
