...
# /afs/cern.ch/user/n/ntrevisa/work/latinos/UL_production/CMSSW_10_6_27/src/PlotsConfigurations/Configurations/ControlRegions/SS/Full2018_v9
...
aliases['BDT_WHSS_v9'] = {
    ...
    'class': 'BDT_WHSS_v9',
    'args' : ('BDTG_6', '%s/WH_chargeAsymmetry/UL/data/BDT/2018/WHSS/weights_old_no_TT/TMVAClassification_BDTG_6.weights.xml' % configurations),
}
