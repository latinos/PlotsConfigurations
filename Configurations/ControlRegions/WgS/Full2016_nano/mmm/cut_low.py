...
supercut = '  (Lepton_eta[0])<2.4 &&  (Lepton_eta[1])<2.4 &&  (Lepton_eta[2])<2.4 && njet<1 \
              '
#cuts['ZToeeWTom_mpmet_Zpeak']  = '  mpmet > 30  \
#                          && abs(Lepton_eta[0])<2.4 && abs(Lepton_eta[1])<2.1 && abs(Lepton_eta[2])<2.1 \
#                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*11*11)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0) && fabs(mllTwoThree - 91.2) < 10. && (Lepton_isTightMuon_cut_Tight80x[0]>0.5 ) && Lepton_isWgs[1]==1 && Lepton_isWgs[2]==1 '
...
#                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*13)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0) && fabs(mllTwoThree - 91.2) < 10. && Lepton_isTightMuon_cut_Tight80x[0]>0.5 && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 '
...
#                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*13)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && Lepton_isTightMuon_cut_Tight80x[0]>0.5 && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 '


cuts['ZTommWTompuppimet']  = ' Lepton_pt[0] > 30 && Lepton_pt[1] > 10 && Lepton_pt[2] > 10 &&  PuppiMET_pt > 30\
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*13)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && Lepton_isTightMuon_cut_Tight80x[0]>0.5  && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 && fabs(mllTwoThree - 3.1) > 0.1 '
