...
directory = treeBaseDir+'Autumn18_102X_nAODv5_Full2018v5/MCWgStar201Xv5__MCWgStarCorr2018v5'
...
Top_pTrw = '(TMath::Sqrt(TMath::Exp(0.0615 - 0.0005 * topGenPtOTF) * TMath::Exp(0.0615 - 0.0005 * antitopGenPtOTF)))'
...
##                              + getSampleFiles(directory,'Wg_AMCNLOFXFX', False),
                       'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*1.2'  ,  
                       'FilesPerJob' : 1 ,
                  }
...
samples['VZ'] = {    'name'   : getSampleFiles(directory,'ZZTo2L2Nu_ext2',False,'nanoLatino_')
...
#  if DATaMetCor is not '':
    directory = treeBaseDir+'Run2018_102X_nAODv5_Full2018v5/DATAWgStar2018v5'
#  else:
