...
# 1.DY, 2.Wjets, 3,4.Fake, 5. , 8.Wg,WgS, 9.WZ3L, WZ3Lmllmin01,
...
#for Idx in 12 13; do
  ...
  #echo "mkShapes.py      --pycfg=configuration${Idx}.py  --inputDir=/u/user/sangilpark/Latino_CernBox/80Xv2/HWW12fb_v2/07Jun2016_spring16_mAODv2_12pXfbm1/MCl2loose__hadd__bSFL2pTEff__l2tight/" >> run_torqueBatch_${Idx}.sh
