...
if    'iihe' in SITE :
  ...
  treeBaseDir = '/gpfs/ddn/srm/cms/store/user/lviliani/Full2016/'
...
SFweight      = 'puW*bPogSF_CSVL*effTrigW*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*veto_EMTFBug'
