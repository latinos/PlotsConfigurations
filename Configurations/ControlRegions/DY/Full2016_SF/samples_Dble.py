...
samples['DY']  = {    'name': [ ],    
                      'weight' : 'puW*baseW*(1.08683 * (0.95 - 0.0657370*TMath::Erf((gen_ptll-12.5151)/5.51582)))*bPogSF*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_recoW[0]*std_vector_lepton_recoW[1]*GEN_weight_SM/abs(GEN_weight_SM)*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]',  
                 }
...
samples['DY-trigW']  = {    'name': [ ],
                      'weight' : 'puW*baseW*(1.08683 * (0.95 - 0.0657370*TMath::Erf((gen_ptll-12.5151)/5.51582)))*bPogSF*GEN_weight_SM/abs(GEN_weight_SM)*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)',
                 }
...
samples['DY-trigW-SF']  = {    'name': [ ],
                      'weight' : 'puW*baseW*(1.08683 * (0.95 - 0.0657370*TMath::Erf((gen_ptll-12.5151)/5.51582)))*bPogSF*GEN_weight_SM/abs(GEN_weight_SM)*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]',
                 }
...
samples['top'] = {   'name': [ ],          
                       ...
                       'weight' : 'puW*baseW*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*bPogSF*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_recoW[0]*std_vector_lepton_recoW[1]*GEN_weight_SM/abs(GEN_weight_SM)*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]',    #   weight/cut 
                      }
...
samples['WW']  = {    'name': [
                      ...
                      'weight' : 'nllW*baseW*puW*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*bPogSF*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_recoW[0]*std_vector_lepton_recoW[1]*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]',          
                  }



#samples['ggWW']  = {    'name': ['latino_GluGluWWTo2L2Nu_MCFM.root'],      
                      #'weight' : 'puW63mb*baseW*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*bPogSF*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]',          
                      ##'weights': ['abs(nllW)'] ,           
                      ##'weights': ['1.000'] ,           
                      #'isData': ['0'],                            
                  #}
...
#samples['Vg']  = {    'name': ['latino_Wg_MADGRAPHMLM.root'],      
                      #'weight' : 'puW63mb*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*bPogSF*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*GEN_weight_SM/abs(GEN_weight_SM)\
...
#samples['VgS']  = {    'name': [
                             ...
                             #],      
                      #'weight' : '1.4*puW63mb*baseW*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*bPogSF*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]*GEN_weight_SM/abs(GEN_weight_SM)',
                      #'weights': ['1','1'] ,           
                  #}
...
#samples['VZ']  = {    'name': [
                          ...
                          ##'latino_ZZTo4L.root'
                         #], 
                      #'weight' : 'puW63mb*bPogSF*((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)*effTrigW_DbleEle+(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)*effTrigW_DbleMu)*std_vector_lepton_idisoWcut_WP_Tight80X[0]*std_vector_lepton_idisoWcut_WP_Tight80X[1]*std_vector_lepton_genmatched[0]*std_vector_lepton_genmatched[1]*GEN_weight_SM/abs(GEN_weight_SM)',          
                      #'weights': [
                          #'0.002214825',
                          ##
                          #'6.28902765388e-05',
...
MyWeights={
           'DoubleMuon'     : 'trig_DbleMu' ,
           'DoubleEG'       : 'trig_DbleEle' ,
          }
