...
cuts['hww2l2v_13TeV_top_sf0j_NODYMVA']  = '((std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11) || (std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13))  \
                && (abs(std_vector_lepton_flavour[0]) == 13 || std_vector_lepton_pt[1]>25) \
                && (abs(std_vector_lepton_flavour[1]) == 13 || std_vector_lepton_pt[1]>13) \
                && fabs(91.1876 - mll) > 15  \
                && metTtrk > 20  \
...
cuts['hww2l2v_13TeV_top_uu0j_NODYMVA']  = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -13*13)    \
                && fabs(91.1876 - mll) > 15  \
                && metTtrk > 20  \
                && PfMetDivSumMet > 2 \
                && metPuppi > 35 \
...
cuts['hww2l2v_13TeV_top_ee0j_NODYMVA']  = '(std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == -11*11)    \
                && std_vector_lepton_pt[0] > 25 && std_vector_lepton_pt[1]>13 \
                && fabs(91.1876 - mll) > 15  \
                && metTtrk > 20  \
                && PfMetDivSumMet > 2 \
