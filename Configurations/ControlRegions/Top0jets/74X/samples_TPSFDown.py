...
samples['DY'] =  { 'name': [
	...
	'eosuser/user/x/xjanssen/HWW2015/21Oct_25ns_MC/mcwghtcount__MC__l2selFix__hadd__bSFL2Eff/latino_DYJetsToLL_M-50.root',
        ...
        'weight' : 'GEN_weight_SM/abs(GEN_weight_SM)*bPogSFDown*bTPSFDown*baseW*puW*effTrigW*std_vector_lepton_idisoW[0]*std_vector_lepton_idisoW[1]*std_vector_lepton_idisoW[2]',
        }
...
#	'eosuser/user/x/xjanssen/HWW2015/21Oct_25ns_MC/mcwghtcount__MC__l2selFix__hadd__bSFL2Eff/latino_QCD_Pt-50to80_EMEnriched.root',
                       ...
                       'weight' : 'bPogSFDown*bTPSFDown*baseW*puW*effTrigW*std_vector_lepton_idisoW[0]*std_vector_lepton_idisoW[1]*std_vector_lepton_idisoW[2]',
                   }
