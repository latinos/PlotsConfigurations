...
cuts['ee_eloose']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      && Lepton_isTightElectron_mvaFall17V1Iso_WP90[0]==1 && Lepton_isTightElectron_mvaFall17V1Iso_WP90[1]==1 \
...
cuts['ee_etight_noiso']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      && Lepton_isTightElectron_mvaFall17V1Iso_WP90[0]==1 && Lepton_isTightElectron_mvaFall17V1Iso_WP90[1]==1 \
                      && fabs(Lepton_pdgId[2])==11  \
                      && Lepton_isTightElectron_mvaFall17V1Iso_WP90[2]>0.5\
                     '
...
cuts['ee_etight_iso']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      ...
                      && fabs(Lepton_pdgId[2])==11  \
                      && Lepton_isTightElectron_mvaFall17V1Iso_WP90[2]>0.5  && Electron_pfRelIso03_all[Lepton_electronIdx[2]]<0.06 \
                     '
