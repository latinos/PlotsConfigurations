...
variables['eta3']  = {  'name': 'fabs(Lepton_eta[2])',     
                        'range' : (5,0,2.5),   
                        'xaxis' : '|#eta| 3rd lep',
                        'fold'  : 3                         
                        }

variables['flavourjet']= {'name': 'fabs(Alt$(Jet_partonFlavour[Alt$(Electron_jetIdx[Lepton_electronIdx[2]],999)],0))' ,
...
variables['associatedjetpt']= {'name': 'fabs(Alt$(Jet_pt[Alt$(Electron_jetIdx[Lepton_electronIdx[2]],999)],0))' ,
...
variables['isolation']  = {  'name': 'Electron_pfRelIso03_all[Lepton_electronIdx[2]]',     
                        'range' : (10,0,0.4),   
                        'xaxis' : 'pfRelIso 3rd lep',
                        'fold'  : 3                         
                        }
