...
##Loose
'''
cuts['ee_eloose']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      && Lepton_isTightElectron_cut_WP_Tight80X[0]==1 && Lepton_isTightElectron_cut_WP_Tight80X[1]==1 \
                      && Electron_pfRelIso03_all[Lepton_electronIdx[0]]<0.057 && Electron_pfRelIso03_all[Lepton_electronIdx[1]]<0.057 \
                      && fabs(Lepton_pdgId[2])==11  \
                     '

cuts['mm_eloose']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -13*13)   \
                      && Lepton_isTightMuon_cut_Tight80x[0]==1 && Lepton_isTightMuon_cut_Tight80x[1]==1 \
                      && fabs(Lepton_pdgId[2])==11  \
                     '
'''
##Tight
...
cuts['ee_etight_noiso']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      && Lepton_isTightElectron_cut_WP_Tight80X[0]==1 && Lepton_isTightElectron_cut_WP_Tight80X[1]==1 \
                      && fabs(Lepton_pdgId[2])==11  \
                      && Lepton_isTightElectron_cut_WP_Tight80X[2]>0.5\
                     '
...
cuts['ee_etight_iso']  = '(Lepton_pdgId[0] * Lepton_pdgId[1] == -11*11)   \
                      ...
                      && fabs(Lepton_pdgId[2])==11  \
                      && Lepton_isTightElectron_cut_WP_Tight80X[2]>0.5  && Electron_pfRelIso03_all[Lepton_electronIdx[2]]<0.06 \
                     '
