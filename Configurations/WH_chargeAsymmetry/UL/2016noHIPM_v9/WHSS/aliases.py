...
# /afs/cern.ch/user/n/ntrevisa/work/latinos/unblinding/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/WH_chargeAsymmetry/UL/2016noHIPM_v9/WHSS

configurations = os.path.realpath(inspect.getfile(inspect.currentframe())) # this file
configurations = os.path.dirname(configurations) # WHSS
configurations = os.path.dirname(configurations) # Full2016noHIPM_v9
...
aliases['fakeW'] = {
    ...
    'args'       : ('2016_noHIPM', '95', '85', 0.95, 0.85, 'nominal', 2),
    'samples'    : ['Fake']
}
# aliases['fakeW'] = {
...
# aliases['fakeWEleUp'] = {
#     'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/WHSS/macros/fake_rate_reader.C+' % configurations],
#     'class'      : 'fake_rate_reader',
#     'args'       : ('2016', '95', '85', 0.95, 0.85, 'EleUp', 2),
#     'samples'    : ['Fake']
# }
...
# # data/MC scale factors - THIS IS FROM 2018!
# aliases['SFweight'] = {
