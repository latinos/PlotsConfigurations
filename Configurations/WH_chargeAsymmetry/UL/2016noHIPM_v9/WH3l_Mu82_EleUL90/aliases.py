...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight3l', 'LepWPCut', 'LepWPSF','Jet_PUIDSF_loose', 'btagSF']),
    'samples': mc
}
...
aliases['BDT_WH3l_OSSF_v9'] = {
    ...
    'args'  : ('BDTG4F07', '%s/WH_chargeAsymmetry/UL/2016noHIPM_v9/BDTconfig_WH3l/dataset_OSSF/weights/TMVAClassification_BDTG4F07.weights.xml' % configurations),
}
...
aliases['BDT_WH3l_SSSF_v9'] = {
    ...
    'args'  : ('BDTG4SK01_1000Trees_02baggingfraction', '%s/WH_chargeAsymmetry/UL/2016noHIPM_v9/BDTconfig_WH3l/dataset_SSSF_no_btag/weights/TMVAClassification_BDTG4SK01_1000Trees_02baggingfraction.weights.xml' % configurations),
}
