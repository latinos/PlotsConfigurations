...
# /afs/cern.ch/user/n/ntrevisa/work/latinos/unblinding/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/WH_chargeAsymmetry/UL/2016noHIPM_v9/WH3l_Mu82_EleUL90
...
aliases['BDT_WH3l_OSSF_v9'] = {
    ...
    'args'  : ('BDTG4F07', '%s/WH_chargeAsymmetry/UL/data/BDT/2016noHIPM/WH3l/OSSF/weights_old/TMVAClassification_BDTG4F07.weights.xml' % configurations),
}
...
aliases['BDT_WH3l_SSSF_v9'] = {
    ...
    'args'  : ('BDTG4SK01_1000Trees_02baggingfraction', '%s/WH_chargeAsymmetry/UL/data/BDT/2016noHIPM/WH3l/SSSF/weights_old/TMVAClassification_BDTG4SK01_1000Trees_02baggingfraction.weights.xml' % configurations),
}
...
aliases['BDT_WH3l_OSSF_new_v9'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/BDT_WH3l_OSSF_v9.C+' % configurations],
    'class' : 'BDT_WH3l_OSSF_v9',
    'args'  : ('BDTG4C3', '%s/WH_chargeAsymmetry/UL/data/BDT/2016noHIPM/WH3l/OSSF/weights/TMVAClassification_BDTG4C3.weights.xml' % configurations),
}
