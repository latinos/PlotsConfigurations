...
variables = ['BDT_WH3l_OSSF_new_v9_100_bins','BDT_WH3l_OSSF_weight_v9_100_bins']
...
for var in variables:
    for scale in scaling:
        ...
        tmp_command = "combineCards.py WH_3l_sssf_plus=datacards{4}_opt/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                                       ...
                                       > Combination/WH_chargeAsymmetry_WH_3l_2016HIPM_v9{4}{5}_opt.txt".format(
                                           var_SSSF_plus,
                                           var_SSSF_minus,
                                           var_OSSF_plus,
                                           var_OSSF_minus,
        ...
        tmp_command = "combineCards.py WH_3l_sssf_plus=datacards_opt/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                                       ...
                                       > Combination/WH_chargeAsymmetry_WH_3l_2016HIPM_v9_alsoLowPt{8}_opt.txt".format(
                                           var_SSSF_plus,
                                           var_SSSF_minus,
                                           var_OSSF_plus,
                                           var_OSSF_minus,
