...
for var in variables:
    for suff in suffix:
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{2}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
		                       ...
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}{2}.txt".format(var,var_2j,suff)
        print(tmp_command)
        print()
        print()
        ...
        tmp_command = "combineCards.py WH_SS_ee_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_minus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_ee{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_ee_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_minus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_ee_alsoLowPt{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_mm_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_minus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_mm{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_mm_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_minus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_mm_alsoLowPt{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_ee_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_minus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_eeFinalState{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
                  		       ...
                  		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                  		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_allFinalStates{0}.txt".format(suff,var_2j,var)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
                     		       ...
                     		       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_alsoLowPt{0}.txt".format(suff,var_2j,var)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
                     		       ...
                     		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_allFinalStates_alsoLowPt{0}.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{2}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus=datacards{2}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}{2}_noZveto.txt".format(var,var_2j,suff)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{2}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus=datacards{2}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{1}/datacard.txt \
                  		       ...
                  		       WH_SS_ee_1j_plus=datacards{2}/hww2l2v_13TeV_WH_SS_ee_1j_plus_pt2ge20/{0}/datacard.txt \
                                       WH_SS_WZ_CR_1j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}_allFinalStates{2}_noZveto.txt".format(var,var_2j,suff)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
                     		       ...
                     		       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_alsoLowPt{0}_noZveto.txt".format(suff,var_2j,var)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{1}/datacard.txt \
                     		       ...
                     		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{1}/datacard.txt \
                                       ...
                                       WH_SS_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_allFinalStates_alsoLowPt{0}_noZveto.txt".format(suff,var_2j,var)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
	...
	# 	                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}_incl.txt".format(var,var_2j)
        # print(tmp_command)
        # print()
        # print()
        # os.system(tmp_command)
        ...
        #                                WH_SS_WZ_CR_1j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
        #                                WH_SS_WZ_CR_2j=datacards{2}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
        #           		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{2}_allFinalStates_incl{0}.txt".format(suff,var_2j,var)
