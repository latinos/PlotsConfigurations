...
for var in variables:
    for suff in suffix:
        ...
        tmp_command = "combineCards.py WH_SS_ee_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_ee{0}.txt".format(suff,var,var_2j_ee_highpt,var_1j_ee_highpt)
        print(tmp_command)
        print()
        print()
        ...
        tmp_command = "combineCards.py WH_SS_ee_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       WH_SS_ee_2j_plus_low_pt=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2lt20/{4}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_ee_alsoLowPt{0}.txt".format(suff,var,var_2j_ee_highpt,var_1j_ee_highpt,var_2j_ee_lowpt,var_1j_ee_lowpt)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_mm_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_minus_pt2ge20/{2}/datacard.txt \
		                       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_plus_pt2ge20/{2}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_mm{0}.txt".format(suff,var,var_2j_mm_highpt,var_1j_mm_highpt)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_mm_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus_low_pt=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_plus_pt2lt20/{4}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_mm_alsoLowPt{0}.txt".format(suff,var,var_2j_mm_highpt,var_1j_mm_highpt,var_2j_mm_lowpt,var_1j_mm_lowpt)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_plus_pt2ge20/{3}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_1j_em_highpt,var_1j_mm_highpt)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                  		       ...
                  		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{4}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                  		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_allFinalStates{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                     		       ...
                     		       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_mm_2j_plus_pt2ge20/{3}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_alsoLowPt{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_1j_em_highpt,var_1j_mm_highpt,
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                     		       ...
                     		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{4}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_allFinalStates_alsoLowPt{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,
                                                                                                                                               var_1j_em_highpt,var_1j_mm_highpt,var_1j_ee_highpt,
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{1}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}{1}_noZveto.txt".format(var,suff,var_2j_em_highpt,var_2j_mm_highpt,var_1j_em_highpt,var_1j_mm_highpt)
        print(tmp_command)
        print()
        print()
        os.system(tmp_command)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{1}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus=datacards{1}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{3}/datacard.txt \
                  		       ...
                  		       WH_SS_ee_1j_plus=datacards{1}/hww2l2v_13TeV_WH_SS_ee_1j_plus_pt2ge20/{7}/datacard.txt \
                                       WH_SS_WZ_1j=datacards{1}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{1}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
		                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}_allFinalStates{1}_noZveto.txt".format(var,suff,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,
                                                                                                                                             var_1j_em_highpt,var_1j_mm_highpt,var_1j_ee_highpt)
        print(tmp_command)
        print()
        print()
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                     		       ...
                     		       WH_SS_mm_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{3}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_alsoLowPt{0}_noZveto.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                     		       ...
                     		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{4}/datacard.txt \
                                       ...
                                       WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
                                       WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
                     		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_allFinalStates_alsoLowPt{0}_noZveto.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,
                                                                                                                                                       var_1j_em_highpt,var_1j_mm_highpt,var_1j_ee_highpt,
                                                                                                                                                       var_2j_em_lowpt,var_2j_mm_lowpt,var_2j_ee_lowpt,
                                                                                                                                                       var_1j_em_lowpt,var_1j_mm_lowpt,var_1j_ee_lowpt)
        print(tmp_command)
	...
	# 	                       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{0}_incl.txt".format(var,var_2j_em_highpt,var_2j_mm_highpt,var_1j_em_highpt,var_1j_mm_highpt)
        # print(tmp_command)
        # print()
        # print()
        # os.system(tmp_command)
        ...
        #                                WH_SS_WZ_1j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_1j/events/datacard.txt \
        #                                WH_SS_WZ_2j=datacards{0}/hww2l2v_13TeV_WH_SS_WZ_2j/events/datacard.txt \
        #           		       > Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_{1}_allFinalStates_incl{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,
        #                                                                                                                                   var_1j_em_highpt,var_1j_mm_highpt,var_1j_ee_highpt)
