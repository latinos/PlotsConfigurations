...
aliases['BDT_WH3l_SSSF_v9'] = {
    ...
    'args' : ('BDTG4SK01_1000Trees_02baggingfraction', '%s/WH_chargeAsymmetry/UL/Full2018_v9/BDTconfig_WH3l/datasetSSSF/weights/TMVAClassification_BDTG4SK01_1000Trees_02baggingfraction.weights.xml' % configurations),
}
