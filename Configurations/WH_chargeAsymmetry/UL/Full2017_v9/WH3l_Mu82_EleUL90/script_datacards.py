...
tmp_command = "combineCards.py WH_3l_sssf_plus=datacards/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                               ...
                               > Combination/WH_chargeAsymmetry_WH_3l_Full2017_v9.txt".format(var_SSSF,var_OSSF)
...
tmp_command = "combineCards.py WH_3l_sssf_plus=datacards/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                               ...
                               WH_3l_WZ_CR_0j=datacards/wh3l_wz_13TeV/events/datacard.txt \
                               > Combination/WH_chargeAsymmetry_WH_3l_Full2017_v9_alsoLowPt.txt".format(var_SSSF,var_OSSF)
