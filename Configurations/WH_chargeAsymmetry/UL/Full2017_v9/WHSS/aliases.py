...
aliases['fakeW'] = {
    ...
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'nominal', 2),
    'samples'    : ['Fake']
}
# aliases['fakeW'] = {
...
aliases['fakeWEleUp'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'EleUp', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWEleDown'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'EleDown', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWMuUp'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'MuUp', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWMuDown'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'MuDown', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWStatEleUp'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'StatEleUp', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWStatEleDown'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'StatEleDown', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWStatMuUp'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'StatMuUp', 2),
    'samples'    : ['Fake']
}
...
aliases['fakeWStatMuDown'] = {
    'linesToAdd' : ['.L %s/WH_chargeAsymmetry/UL/macros/fake_rate_reader.C+' % configurations],
    'class'      : 'fake_rate_reader',
    'args'       : ('2017', '95', '85', 0.95, 0.85, 'StatMuDown', 2),
    'samples'    : ['Fake']
}
