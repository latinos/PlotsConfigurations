...
### Extract charge-flip probabilities
    ...
    mkChargeFlip.py --input_file=rootFile/plots_WHSS_2018_v9_chargeFlip_Mu82_EleUL90.root --output_dir=charge_flip_2018_LegacyID_EleUL90 --era=2018
...
Validate the efficiency approach:
    ...
    mkDYee_chargeFlip_OS_SS.py --os_ss_cutsFile=dict_os_ss_cuts.py --inputFileSS=rootFile/plots_WHSS_2018_v9_chargeFlip_eff_validation_Mu82_EleUL90.root --inputFileOS=rootFile/plots_WHSS_2018_v9_chargeFlip_eff_validation_Mu82_EleUL90.root --outputDir=rootFile/ --outputFile=plots_WHSS_2018_v9_chargeFlip_eff_validation_DYflip.root --year=2018
