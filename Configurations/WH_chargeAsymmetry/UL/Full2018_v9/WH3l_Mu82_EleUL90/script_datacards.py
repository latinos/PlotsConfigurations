...
var_SSSF_plus  = 'BDT_WH3l_SSSF_v9_OptimizedBinning'
var_SSSF_minus = 'BDT_WH3l_SSSF_v9_OptimizedBinning'
var_OSSF_plus  = 'BDT_WH3l_OSSF_v9_LegacyBinning'
var_OSSF_minus = 'BDT_WH3l_OSSF_v9_LegacyBinning'
...
tmp_command = "combineCards.py WH_3l_sssf_plus=datacards/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                               ...
                               > Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_optimizedSSSF.txt".format(
                                   var_SSSF_plus,
                                   var_SSSF_minus,
                                   var_OSSF_plus,
                                   var_OSSF_minus
...
tmp_command = "combineCards.py WH_3l_sssf_plus=datacards/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                               ...
                               WH_3l_WZ_CR_0j=datacards/wh3l_wz_13TeV/events/datacard.txt \
                               > Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9.txt".format(
                                   'BDT_WH3l_SSSF_v9_LegacyBinning',
                                   'BDT_WH3l_SSSF_v9_LegacyBinning',
                                   'BDT_WH3l_OSSF_v9_LegacyBinning',
                                   'BDT_WH3l_OSSF_v9_LegacyBinning'
                               )
...
tmp_command = "combineCards.py WH_3l_sssf_plus=datacards/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                               ...
                               WH_3l_WZ_CR_0j=datacards/wh3l_wz_13TeV/events/datacard.txt \
                               > Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_alsoLowPt.txt".format(
                                   var_SSSF_plus,
                                   var_OSSF_plus
                               )
