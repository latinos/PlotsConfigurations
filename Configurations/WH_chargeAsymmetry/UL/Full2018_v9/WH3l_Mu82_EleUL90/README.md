...
Run combine using the FitDiagnostic option:
    ...
    python script_workspace_and_fit.py --datacard_name Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_binning_opt --output_name Combination/FitResults_binning_opt.txt --freeze_nuisances r_higgs --sanity_check FD
...
Using datacards with enhanced signal scaling:
    ...
    python script_workspace_and_fit.py --datacard_name Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_binning --output_name=Combination/FitResults_binning.txt --freeze_nuisances=r_higgs
...
Using datacards with correct signal scaling:
    ...
    python script_workspace_and_fit.py --datacard_name Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_original_signal_scale_binning_opt --output_name=Combination/FitResults_binning_original_signal_scale.txt --freeze_nuisances=r_higgs
...
Using new training with top and Z+jets as fakes
    ...
    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_binning.root -m 125 --doInitialFit -t -1 --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A --freezeParameters r_higgs

    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_binning.root -m 125 --doFits -t -1 --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A --job-mode condor --freezeParameters r_higgs --sub-opts='+JobFlavour="workday"'

    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_3l_Full2018_v9_binning.root -m 125 -t -1 -o impacts_WH3l_2018_binning.json --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A

    plotImpacts.py -i impacts_WH3l_2018_binning.json -o Impact_WH3l_2018_binning
