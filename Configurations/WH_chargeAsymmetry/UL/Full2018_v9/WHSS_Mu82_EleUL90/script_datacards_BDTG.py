    ...
    for suff in suffix:
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{0}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
                  		       ...
                  		       WH_SS_ee_2j_plus=datacards{0}/hww2l2v_13TeV_WH_SS_ee_2j_plus_pt2ge20/{4}/datacard.txt \
                                       ...
                                       ZH3l_WZ_CR_1j=datacards{0}/hww2l2v_13TeV_ZH3l_WZ_CR_1j/events/datacard.txt \
                                       ZH3l_WZ_CR_2j=datacards{0}/hww2l2v_13TeV_ZH3l_WZ_CR_2j/events/datacard.txt \
                  		       > Combination/WH_chargeAsymmetry_WH_SS_Full2018_v9_{1}_allFinalStates{0}.txt".format(suff,var,var_2j_em_highpt,var_2j_mm_highpt,var_2j_ee_highpt,var_1j_em_highpt,var_1j_mm_highpt,var_1j_ee_highpt)
        ...
        tmp_command = "combineCards.py WH_SS_em_2j_minus=datacards{1}/hww2l2v_13TeV_WH_SS_em_2j_minus_pt2ge20/{2}/datacard.txt \
		                       ...
		                       WH_SS_mm_2j_plus=datacards{1}/hww2l2v_13TeV_WH_SS_noZveto_mm_2j_plus_pt2ge20/{3}/datacard.txt \
                                       ...
                                       ZH3l_WZ_CR_1j=datacards{1}/hww2l2v_13TeV_ZH3l_WZ_CR_1j/events/datacard.txt \
                                       ZH3l_WZ_CR_2j=datacards{1}/hww2l2v_13TeV_ZH3l_WZ_CR_2j/events/datacard.txt \
