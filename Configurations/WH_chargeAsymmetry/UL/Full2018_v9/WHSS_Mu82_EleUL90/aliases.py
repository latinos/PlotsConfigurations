...
aliases['ttHMVA_SF_flip_2l'] = {
    'linesToAdd': ['.L %s/WH_chargeAsymmetry/UL/Full2018_v9/WHSS_Mu85_EleUL95/DY_OS_CR/macros/flipper.C+' % configurations],
    'class': 'flipper',
...
aliases['ttHMVA_eff_flip_2l'] = {
    'linesToAdd': ['.L %s/WH_chargeAsymmetry/UL/Full2018_v9/WHSS_Mu85_EleUL95/DY_OS_CR/macros/flipper_eff.C+' % configurations],
    'class': 'flipper_eff',
    'args' : ('UL_2018', 2, 'Total_SF', 'false'),
    'samples': ['DY']
}
