...
workspace_command_WH_plus_minus = "text2workspace.py \
                                   {0}.txt \
                                   -o {0}_WH_plus_minus.root \
                                   -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel \
                                   -m 125 \
                                   --PO verbose \
                                   --PO 'map=.*/ggH_hww:r_higgs[1,0.99,1.01]' \
                                   ...
                                   --PO 'map=.*/qqH_htt:r_higgs[1,0.99,1.01]' \
                                   --PO 'map=.*/ZH_htt:r_higgs[1,0.99,1.01]' \
                                   --PO 'map=.*/WH_h.*_plus:r_WH_plus[1,0.01,10.0]' \
                                   --PO 'map=.*/WH_h.*_minus:r_WH_minus[1,0.01,10.0]' \
                                   ".format(datacard_name)
...
combine_command_WH_plus_minus = "combine \
                                 -M MultiDimFit \
                                 --algo=singles \
