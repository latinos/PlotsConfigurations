...
with open('cuts_to_merge_WHSS.py', 'w') as f:
    ...
    f.write("    'rootFile': './plots_2016HIPM/cratio_weight_X_{}_BDTG6.root',\n".format(cut_name))
    f.write("    'cutUsed' : '{}'\n".format(cut_name))
    f.write("}\n")
    f.write("\n")
    f.write("# 2016noHIPM\n")
    f.write("cutsToMerge['{}_2016noHIPM'] = {{\n".format(cut_name))
    f.write("    'rootFile': './plots_2016noHIPM/cratio_weight_X_{}_BDTG6.root',\n".format(cut_name))
    f.write("    'cutUsed' : '{}'\n".format(cut_name))
    f.write("}\n")
    f.write("\n")
    f.write("# Full2017\n")
    f.write("cutsToMerge['{}_Full2017'] = {{\n".format(cut_name))
    f.write("    'rootFile': './plots_Full2017/cratio_weight_X_{}_BDTG6.root',\n".format(cut_name))
    f.write("    'cutUsed' : '{}'\n".format(cut_name))
    f.write("}\n")
    f.write("\n")
    f.write("# Full2018\n")
    f.write("cutsToMerge['{}_Full2018'] = {{\n".format(cut_name))
    f.write("    'rootFile': './plots_Full2018/cratio_weight_X_{}_BDTG6.root',\n".format(cut_name))
    f.write("    'cutUsed' : '{}'\n".format(cut_name))
    f.write("}\n")
