...
nuisances['chargeFlip'] = {
    ...
    'samples': dict((skey, ['ttHMVA_eff_flip_2l[0]/(ttHMVA_eff_flip_2l[0]+ttHMVA_eff_err_flip_2l[0])', '(ttHMVA_eff_flip_2l[0]+ttHMVA_eff_err_flip_2l[0])/ttHMVA_eff_flip_2l[0]']) for skey in ['DY','WW','top']),
} # IS THIS CORRECT????
