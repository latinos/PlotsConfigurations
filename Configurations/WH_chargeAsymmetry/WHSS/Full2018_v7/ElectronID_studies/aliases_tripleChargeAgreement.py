...
configurations = os.path.dirname(configurations) # ElectronID_studies
...
aliases['nCleanGenJet'] = {
    'linesToAdd': ['.L /afs/cern.ch/work/n/ntrevisa/latinos/unblinding/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/Differential/ngenjet.cc'],
    'class': 'CountGenJet',
    'samples': mc
}
