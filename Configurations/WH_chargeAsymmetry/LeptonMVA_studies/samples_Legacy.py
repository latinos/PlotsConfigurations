...
wh_2l_legacy_files = nanoGetSampleFiles('/ceph/ntrevisa/Samples_ttHMVA_selection/Legacy/HWminusJ_HToWWTo2L2Nu_M125/', 'HWminusJ_HToWWTo2L2Nu_M125') + \
                     nanoGetSampleFiles('/ceph/ntrevisa/Samples_ttHMVA_selection/Legacy/HWplusJ_HToWWTo2L2Nu_M125/',  'HWplusJ_HToWWTo2L2Nu_M125')

samples['WH_hww_2l_legacy'] = {
    'name': wh_2l_legacy_files,
    'weight': '1',
    'FilesPerJob': 1,
}

addSampleWeight(samples, 'WH_hww_2l_legacy', 'HWplusJ_HToWWTo2L2Nu_M125',  '0.8380/1000000')
addSampleWeight(samples, 'WH_hww_2l_legacy', 'HWminusJ_HToWWTo2L2Nu_M125', '0.5313/1000000')
