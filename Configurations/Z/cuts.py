...
cuts['Zjets'] = 'abs(std_vector_lepton_flavour[0]) == abs(std_vector_lepton_flavour[1]) &&  std_vector_lepton_pt[0]>20 && std_vector_lepton_pt[1]>15 && std_vector_lepton_pt[2]<10 && mll>80 && mll < 110 && njet > 0'
cuts['Z0jet'] = 'abs(std_vector_lepton_flavour[0]) == abs(std_vector_lepton_flavour[1]) &&  std_vector_lepton_pt[0]>20 && std_vector_lepton_pt[1]>15 && std_vector_lepton_pt[2]<10 && mll>80 && mll < 110 && njet == 0 && std_vector_jet_pt[0]>15 && std_vector_jet_pt[0]<30'
