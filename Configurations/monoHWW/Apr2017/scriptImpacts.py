...
print ""
print "combineTool.py -M Impacts -d datacards/monoH_" + cut + "_" + channel + "/" + variable + "/datacard_" + mZp + "_" + mA0 + "_combined.root -m 125 -o pulls_" + channel + "_" + cut + "/impact_" + mZp + "_" + mA0 + "_" + variable + ".json -n " + mZp + "_" + mA0 + "_" + variable
