...
#include "TF1.h"
using std::string;
void Macro_pfMet_step10_paperFinal(){
  ...
  //
  //==============================================================
  TFile* f1 = new TFile("PFMET-Data-MCs-ZZto4l-AfterSignalSelection.root","READ");
  //==============================================================
  //
  ...
  TPad *pad1 = new TPad("pad1", "pad1", 0, 1 - 0.72, 1.0, 1.0);
  pad1->SetBottomMargin(0.0); // Upper and lower plot are joined
  pad1->SetTopMargin(0.098);  // Upper and lower plot are joined
  // pad1->SetTickx(1);
  // pad1->SetTicky(1);
  pad1->SetLogx(1);
  pad1->SetLogy(1);
  ...
  TPad *pad2 = new TPad("pad2", "pad2", 0, 0.0, 1, 1-0.72);
  ...
  line->Draw();
  //==========================================================
  c1->Print("fig6_DM_pfmet_HtoZZ_paper.png","png");
  c1->Print("fig6_DM_pfmet_HtoZZ_paper.pdf","pdf");
  c1->Print("fig6_DM_pfmet_HtoZZ_paper.eps","eps");
}
