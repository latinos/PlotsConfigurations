/*
Launch these:
root -l -b -q 'macroExclusionTable.C("mthBin","em","MVA","2HDM",false)'
root -l -b -q 'macroExclusionTable.C("mthBin","em","MVA","Zbar",false)'
root -l -b -q 'macroExclusionTable.C("muccamva2HDMadaptFull","em","MVA","2HDM",false)'
root -l -b -q 'macroExclusionTable.C("muccamvaZbaradaptFull","em","MVA","Zbar",false)'
root -l -b -q 'macroExclusionTable.C("muccamva2HDMgradFull","em","MVA","2HDM",false)'
root -l -b -q 'macroExclusionTable.C("muccamvaZbargradFull","em","MVA","Zbar",false)'

root -l -b -q 'macroExclusionTable.C("mthBin","em","MVA","2HDM",true)'
root -l -b -q 'macroExclusionTable.C("mthBin","em","MVA","Zbar",true)'
root -l -b -q 'macroExclusionTable.C("muccamva2HDMadaptFull","em","MVA","2HDM",true)'
root -l -b -q 'macroExclusionTable.C("muccamvaZbaradaptFull","em","MVA","Zbar",true)'
root -l -b -q 'macroExclusionTable.C("muccamva2HDMgradFull","em","MVA","2HDM",true)'
root -l -b -q 'macroExclusionTable.C("muccamvaZbargradFull","em","MVA","Zbar",true)'
*/
...
//     if (model == "Zbar")
//       sprintf(limitfilename,"combine_" + channel + "_" + cut + "/higgsCombineTest.Asymptotic.mHZB_%d_1__" + variable + ".root",Xmass[n]);
//     else if (model == "2HDM")
//       sprintf(limitfilename,"combine_" + channel + "_" + cut + "/higgsCombineTest.Asymptotic.mH%d_300_"+ variable + ".root",Xmass[n]);
