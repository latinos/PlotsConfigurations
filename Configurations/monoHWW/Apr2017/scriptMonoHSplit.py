...
if (doPulls=="True") :
    ...
    os.system('combine -M MaxLikelihoodFit -t -1 --expectSignal 0 --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_B --saveShapes --saveWithUncertainties -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_SR --saveShapes --saveWithUncertainties --setPhysicsModelParameters mask_signal=0 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_CR --saveShapes --saveWithUncertainties --setPhysicsModelParameters mask_signal=1 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_BSR --saveShapes --saveWithUncertainties --setPhysicsModelParameters mask_signal=0 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_blind.root')
    ...
    os.system('combine -M GoodnessOfFit -n _' + mZp + '_' + mA0 + '_' + variable + '_AD datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root --algo=AD --setPhysicsModelParameters mask_signal=0 > goodnessOfFit_' + channel + '_' + cut + '/monoH_' + mZp + '_' + mA0 + '_' + variable + '_AD.txt')
    os.system('mv higgsCombine_' + mZp + '_' + mA0 + '_' + variable + '_AD.GoodnessOfFit.mH120.root goodnessOfFit_' + channel +'_' + cut + '/')
    
    os.system('combine -M GoodnessOfFit -n _' + mZp + '_' + mA0 + '_' + variable + '_KS datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root --algo=KS --setPhysicsModelParameters mask_signal=0 >> goodnessOfFit_' + channel + '_' + cut + '/monoH_' + mZp + '_' + mA0 + '_' + variable + '_KS.txt')
    os.system('mv higgsCombine_' + mZp + '_' + mA0 + '_' + variable + '_KS.GoodnessOfFit.mH120.root goodnessOfFit_' + channel +'_' + cut + '/')
    
    os.system('combine -M GoodnessOfFit -n _' + mZp + '_' + mA0 + '_' + variable + '_SAT datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root --algo=saturated --setPhysicsModelParameters mask_signal=0 >> goodnessOfFit_' + channel + '_' + cut + '/monoH_' + mZp + '_' + mA0 + '_' + variable + '_saturated.txt')
