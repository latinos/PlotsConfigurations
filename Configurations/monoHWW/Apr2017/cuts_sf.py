...
#cuts['monoH_nvtx_mm'] = 'mll < 91 + 15 && mll > 91 - 15'
...
'
# DY Control Region
cuts['monoH_MVA_DYtt_sf_Tight'] = 'njet >= 0 \
            && mll > 91 - 15 \
            && mll < 91 + 15 \
            && drll < 2.5 \
            && dymvaggh > 0.9 \
...
'
# WW Control Region
cuts['monoH_MVA_WW_sf_Tight'] = 'njet >= 0 \
            && mll > 91 + 15 \
            && drll < 2.5 \
            && dymvaggh > 0.9 \
            && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
...
'
# Top Control Region
cuts['monoH_MVA_Top_sf_Tight'] = 'njet >= 0 \
            && mll < 91 -15 \
            && drll < 2.5 \
            && dymvaggh > 0.9 \
            && ( std_vector_jet_pt[0] > 20 && std_vector_jet_cmvav2[0] > -0.5884 ) \
...
#######################################
# 0-Jets Bin Analysis: sf = ee + mm
#######################################

# # Signal Region
# cuts['monoH_0Jet_sf'] = 'std_vector_jet_pt[0] < 30 \
#             && mll < 91 - 15 \
#             && drll < 2.5 \
#             && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
#             && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
...
# '
# # DY Control Region
# cuts['monoH_0Jet_DY_sf'] = 'std_vector_jet_pt[0] < 30 \
#             && mll > 91 - 15 \
#             && mll < 91 + 15 \
#             && drll < 2.5 \
#             && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
...
# '
# # WW Control Region
# cuts['monoH_0Jet_WW_sf'] = 'std_vector_jet_pt[0] < 30 \
#             && mll > 91 + 15 \
#             && drll < 2.5 \
#             && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
#             && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
...
# '
# # Top Control Region
# cuts['monoH_0Jet_Top_sf'] = 'std_vector_jet_pt[0] < 30 \
#             && mll < 91 -15 \
#             && drll < 2.5 \
#             && ( std_vector_jet_pt[0] > 20 && std_vector_jet_cmvav2[0] > -0.5884 ) \
# '
