...
if len(sys.argv) < 6 :
    ...
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_600 MVA 600 300 False"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_100 MVA ZB 100_1_ False"
    print ""
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_600 MVA 600 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_1000 MVA 1000 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_2000 MVA 2000 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_2500 MVA 2500 300 True"
    print ""
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_10 MVA ZB 10_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_100 MVA ZB 100_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_1000 MVA ZB 1000_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_2000 MVA ZB 2000_1_ True"
    print ""
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_All_Bin600 MVA 600 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_All_Bin1000 MVA 1000 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_All_Bin2000 MVA 2000 300 True"
    print "python scriptMonoHSplit80.py em muccamva2HDMadaptFull_All_Bin2500 MVA 2500 300 True"
    print ""
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_All_Bin10 MVA ZB 10_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_All_Bin100 MVA ZB 100_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_All_Bin1000 MVA ZB 1000_1_ True"
    print "python scriptMonoHSplit80.py em muccamvaZbaradaptFull_All_Bin2000 MVA ZB 2000_1_ True"
    print ""
    sys.exit()
...
os.system('combine -M Asymptotic -n ' + mZp + '_' + mA0 + '_' + variable + ' -t -1 --expectSignal=1 --run expected datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root &> limits_' + channel + '_' + cut + '/monoH_' + mZp + '_' + mA0 + '_' + variable + '.txt')
...
if (doPulls=="True") :
    ...
    os.system('combine -M MaxLikelihoodFit -t -1 --expectSignal=1 --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_SB --saveShapes --saveWithUncertainties -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    os.system('mv fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_SB.root combine_' + channel + '_' + cut + '/')
    os.system('python ~/work/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py combine_' + channel + '_' + cut + '/fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_SB.root -a -f latex --histogram pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_SB.root > pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_SB.tex')
    ...
    os.system('combine -M MaxLikelihoodFit -t -1 --expectSignal=0  --rMin -0.1 --rMax 2 --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_B --saveShapes --saveWithUncertainties -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    os.system('mv fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_B.root combine_' + channel + '_' + cut + '/')
    os.system('python ~/work/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py combine_' + channel + '_' + cut + '/fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_B.root -a -f latex --histogram pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_B.root > pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_B.tex')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_SR --saveShapes --saveWithUncertainties --setParameters mask_signal=0 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    os.system('mv fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_SR.root combine_' + channel + '_' + cut + '/')
    os.system('python ~/work/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py combine_' + channel + '_' + cut + '/fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_SR.root -a -f latex --histogram pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_SR.root > pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_SR.tex')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_CR --saveShapes --saveWithUncertainties --setParameters mask_signal=1 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_combined.root')
    os.system('mv fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_CR.root combine_' + channel + '_' + cut + '/')
    os.system('python ~/work/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py combine_' + channel + '_' + cut + '/fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_CR.root -a -f latex --histogram pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_CR.root > pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_CR.tex')
    ...
    os.system('combine -M MaxLikelihoodFit --robustFit 1 -n _' + mZp + '_' + mA0 + '_' + variable + '_BSR --saveShapes --saveWithUncertainties --setParameters mask_signal=0 -d datacards/monoH_' + cut + '_' + channel + '/' + variable + '/datacard_' + mZp + '_' + mA0 + '_blind.root')
    os.system('mv fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_BSR.root combine_' + channel + '_' + cut + '/')
    os.system('python ~/work/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py combine_' + channel + '_' + cut + '/fitDiagnostics_' + mZp + '_' + mA0 + '_' + variable + '_BSR.root -a -f latex --histogram pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_BSR.root > pulls_' + channel + '_' + cut + '/pulls_' + mZp + '_' + mA0 + '_' + variable + '_BSR.tex')
