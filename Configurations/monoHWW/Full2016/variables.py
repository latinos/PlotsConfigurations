...
# variables['muccamva2HDMgradFull6'] = {'name': 'muccamva2HDMgradFull',          #  variable name    
#                         'range' : (6,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }
...
# variables['muccamva2HDMgrad5'] = {'name': 'muccamva2HDMgrad',          #  variable name    
#                         'range' : (5,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMgradFull5'] = {'name': 'muccamva2HDMgradFull',          #  variable name    
#                         'range' : (5,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMadapt5'] = {'name': 'muccamva2HDMadapt',          #  variable name    
#                         'range' : (5,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMadaptFull5'] = {'name': 'muccamva2HDMadaptFull',          #  variable name    
#                         'range' : (5,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }
...
# variables['muccamva2HDMgrad4'] = {'name': 'muccamva2HDMgrad',          #  variable name    
#                         'range' : (4,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMgradFull4'] = {'name': 'muccamva2HDMgradFull',          #  variable name    
#                         'range' : (4,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMadapt4'] = {'name': 'muccamva2HDMadapt',          #  variable name    
#                         'range' : (4,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMadaptFull4'] = {'name': 'muccamva2HDMadaptFull',          #  variable name    
#                         'range' : (4,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }
...
# variables['muccamva2HDMgrad_control'] = {'name': 'muccamva2HDMgrad',          #  variable name    
#                         'range' : (40,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }

# variables['muccamva2HDMgradFull_control'] = {'name': 'muccamva2HDMgradFull',          #  variable name    
#                         'range' : (40,-1,1),           #  variable range
#                         'xaxis' : 'MVA discriminant',  #  x axis name
#                         'fold' : 3
#                         }
