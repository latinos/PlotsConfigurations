...
# Signal Region
cuts['monoH_MVA_em'] = 'std_vector_jet_pt[0] < 30 \
            && mth > 40 \
            && mll < 76 \
            && drll < 2.5 \
            && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
...
'
# DY->tt Control Region
cuts['monoH_MVA_DYtt_em'] = 'std_vector_jet_pt[0] < 30 \
            && mth < 40 \
            && mll < 76 \
            && drll < 2.5 \
            && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
...
'
# WW Control Region
cuts['monoH_MVA_WW_em'] = 'std_vector_jet_pt[0] < 30 \
            && mth > 40 \
            && mll > 76 \
            && ( std_vector_jet_pt[0] < 20 || std_vector_jet_cmvav2[0] < -0.5884 ) \
            && ( std_vector_jet_pt[1] < 20 || std_vector_jet_cmvav2[1] < -0.5884 ) \
...
'
# Top Control Region
cuts['monoH_MVA_Top_em'] = 'std_vector_jet_pt[0] < 30 \
            && mth > 40 \
            && mll < 76 \
            && drll < 2.5 \
            && ( std_vector_jet_pt[0] > 20 && std_vector_jet_cmvav2[0] > -0.5884 ) \
