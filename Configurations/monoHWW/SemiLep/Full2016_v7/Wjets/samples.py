...
addSampleWeight(samples, 'Wjets_NLOptM', 'WJetsToLNu_ext2', '(LHE_Vpt < 100)')


# Pt split
for pt in ['100To250', '250To400', '400To600', '600ToInf']:
    samples['Wjets_NLOpt'+pt] = {
        'name'   : nanoGetSampleFiles(mcDirectory,'WJetsToLNu_Wpt'+pt),
        'weight' : mcCommonWeight +'*EWKnloW[0]', # ewk nlo correction https://arxiv.org/pdf/1705.04664v2.pdf 
        'FilesPerJob' : 4,
    }
...
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250'     , newbW100w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250_ext1', newbW100w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400'     , newbW250w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400_ext1', newbW250w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600'     , newbW400w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600_ext1', newbW400w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf'     , newbW600w)
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf_ext1', newbW600w)

#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_ext2', '((LHE_Vpt < 100) + (LHE_Vpt > 100 && LHE_Vpt < 250)*0.35 + (LHE_Vpt > 250 && LHE_Vpt < 400)*0.15 + (LHE_Vpt > 400)*0.05)')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250'     , '0.65')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250_ext1', '0.65')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400'     , '0.85')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400_ext1', '0.85')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600'     , '0.95')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600_ext1', '0.95')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf'     , '0.95')
#addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf_ext1', '0.95')

addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_ext2', '(LHE_Vpt < 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250'     , '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt100To250_ext1', '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400'     , '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt250To400_ext1', '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600'     , '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt400To600_ext1', '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf'     , '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOstatM', 'WJetsToLNu_Wpt600ToInf_ext1', '(LHE_Vpt > 120)')
