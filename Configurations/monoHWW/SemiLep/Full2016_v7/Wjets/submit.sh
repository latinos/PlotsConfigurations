...
#mkPlot.py --pycfg=conf_HT_vs_NLO.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 
#mkPlot.py --pycfg=conf_HT_vs_NLOpt.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 
#mkPlot.py --pycfg=conf_HTsf_vs_NLOpt.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 
#mkPlot.py --pycfg=conf_HTsf_vs_NLO.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 
#mkPlot.py --pycfg=conf_LO_vs_NLOpt.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 
#mkPlot.py --pycfg=conf_NLOpt_vs_NLO.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 

#mkPlot.py --pycfg=conf.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=3000. --logOnly
##mkPlot.py --pycfg=conf.py --inputFile=Wjets_root/plots_Wjets_2016v7.root --showIntegralLegend=1 --scaleToPlot=2 --plotNormalizedDistributions --onlyPlot=cSigVsBkg
