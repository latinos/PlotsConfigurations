...
plot['top'] = {
    ...
    'isData'   : 0,
    'scale'    : 1.,
    #'scale'    : 1.076, #run2 fit W+jets norm as POI
    #'scale'    : 1.073, #run2 fit W+jets norm as POI, freeze Wjets_QCD_NLO_sf_mjj_2016 to 1
}
...
plot['WjetsMjj']  = {
    ...
    'isData'   : 0,
    'scale'    : 1.0
    #'scale'    : 1.043 #run2 fit W+jets norm as POI
    #'scale'    : 1.048 #run2 fit W+jets norm as POI, freeze Wjets_QCD_NLO_sf_mjj_2016 to 1
}
...
##}
#sf_dict = {
#    'Wjets_2j_dRjj_low': 1.09919743423852,
#    'Wjets_2j_dRjj_hig': 1.0492409888651488,
#    'Wjets_3j_dRjj_low': 0.9891614448772287,
#    'Wjets_3j_dRjj_hig': 0.8838030820314716,
#    'Wjets_4j_dRjj_low': 0.9695432781223284,
#    'Wjets_4j_dRjj_hig': 1.287275432384344,
#}
#for samp in wjets_samples:
#    plot[samp]  = {
#        'color': 856, # kAzure -4
