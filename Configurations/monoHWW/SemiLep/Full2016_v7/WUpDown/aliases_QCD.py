...
#}
aliases['SFweight'] = {
    'expr': ' * '.join(['puWeight', 'TriggerEffWeight_1l_fixed[0]', 'Lepton_RecoSF[0]', 'EMTFbug_veto','LepSF1l__ele_wp__mu_wp[0]', 'PrefireWeight']),
    'samples': mc
}
#aliases['SFweightUp'] = {
#    'expr': ' * '.join(['puWeightUp', 'TriggerEffWeight_1l_fixed[0]', 'Lepton_RecoSF[0]', 'EMTFbug_veto','LepSF1l__ele_wp__mu_wp[0]', 'PrefireWeight']),
#    'samples': mc
#}
#aliases['SFweightDo'] = {
#    'expr': ' * '.join(['puWeightDown', 'TriggerEffWeight_1l_fixed[0]', 'Lepton_RecoSF[0]', 'EMTFbug_veto','LepSF1l__ele_wp__mu_wp[0]', 'PrefireWeight']),
#    'samples': mc
#}
...
aliases['gstarLow'] = {
    ...
    'samples': [skey for skey in mc if 'VgS' in skey]
}
...
aliases['isTTbar'] = {
    ...
    'samples': [skey for skey in mc if 'top' in skey]
}
...
aliases['getGenZpt_OTF'] = {
    ...
    'class': 'getGenZpt',
    'samples': [skey for skey in mc if 'DY' in skey]
}
...
aliases['EWKnloW'] = {
    ...
    'class': 'EWKnloW',
    'samples': [skey for skey in mc if 'Wjets' in skey]
