...
nuisances['lumi'] = {
   ...
   'type': 'lnN',
   'samples': dict((skey, '1.012') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
}

#nuisances['lumi_Uncorrelated'] = {
#    'name': 'lumi_13TeV_2016',
#    'type': 'lnN',
#    'samples': dict((skey, '1.022') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#    #'samples': dict((skey, '1.022') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'Wjets_HTsf', 'top'])
#}
#
#nuisances['lumi_XYFact'] = {
#    'name': 'lumi_13TeV_XYFact',
#    'type': 'lnN',
#    'samples': dict((skey, '1.009') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#    #'samples': dict((skey, '1.009') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'Wjets_HTsf', 'top'])
#}
#
#nuisances['lumi_BBDefl'] = {
#    'name': 'lumi_13TeV_BBDefl',
#    'type': 'lnN',
#    'samples': dict((skey, '1.004') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#    #'samples': dict((skey, '1.004') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'Wjets_HTsf', 'top'])
#}
#
#nuisances['lumi_DynBeta'] = {
#    'name': 'lumi_13TeV_DynBeta',
#    'type': 'lnN',
#    'samples': dict((skey, '1.005') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#    #'samples': dict((skey, '1.005') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'Wjets_HTsf', 'top'])
#}
#
...
nuisances['CMS_res_j_2016'] = {
   'name': 'CMS_res_j_2016',
   'type': 'lnN',
   'samples': dict((skey, '1.03') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
}
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'Wjets_hWpt': ['0.998208002462*(puWeightUp/puWeight)',  '1.0018013089*(puWeightDown/puWeight)'],
        'Wjets_lWpt': ['0.998208002462*(puWeightUp/puWeight)',  '1.0018013089*(puWeightDown/puWeight)'],
...
nuisances['QCDscale_Wjets']  = {
    ...
    'samples'  : {
        ...
        'Wjets_hWpt' : variations_wjets,
        'Wjets_lWpt' : variations_wjets,
    }
}
