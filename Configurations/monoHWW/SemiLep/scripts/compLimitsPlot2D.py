...
def plot_limits(output_file, mx, contours_dict, show_int=False):
    set_style()
    ...
    #for idx,key in enumerate(contours_dict):
    #
    #    exp_c[key].SetLineColor(colors[idx])
    #    s1up_c[key].SetLineColor(colors[idx])
    #    s1do_c[key].SetLineColor(colors[idx])

    #    exp_c[key] .SetLineWidth(4)
    #    s1up_c[key].SetLineWidth(1)
    #    s1do_c[key].SetLineWidth(1)

    #    if idx == 0:
    #        exp_c[key]
    #        exp_c[key].GetXaxis().SetTitle('m_{Z\'} [GeV]')
    #        exp_c[key].GetYaxis().SetTitle('m_{s} [GeV]')
    #        exp_c[key].GetXaxis().SetRangeUser(200, 2500)
    #        exp_c[key].GetYaxis().SetRangeUser(160, 400)
    #        exp_c[key].GetYaxis().SetRangeUser(160, 300)
    #        exp_c[key].SetTitle('')
...
for mx in [100, 150, 200, 300]:
    ...
    plot_limits(output_file, mx, mx_obj_dict[mx], show_int=options.points)
