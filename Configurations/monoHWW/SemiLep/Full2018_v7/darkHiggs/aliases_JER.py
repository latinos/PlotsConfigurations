...
### JER to MET
aliases['PuppiMET_JER'] = {
    'linesToAdd': [
        'gSystem->AddIncludePath("-I%s/src");' % os.getenv('CMSSW_BASE'),
        '.L %s/src/PlotsConfigurations/Configurations/monoHWW/SemiLep/scripts/JERtoMET_OTF.cc+' % os.getenv('CMSSW_BASE')
    ],
    'class': 'JERtoMETOTF',
    'args': (),
    'samples': mc
...
aliases['PuppiMET_UNC'] = {
    'linesToAdd': [
        'gSystem->AddIncludePath("-I%s/src");' % os.getenv('CMSSW_BASE'),
        '.L %s/src/PlotsConfigurations/Configurations/monoHWW/SemiLep/scripts/METunc_OTF.cc+' % os.getenv('CMSSW_BASE')
    ],
    'class': 'METuncOTF',
    'args': (),
    'samples': mc
...
aliases['JERvsj1pt'] = {
  'expr' : '(3.03153e+00/MHlnjj_pt_j1) + 1.00022e+00',
  'samples': mc
}
