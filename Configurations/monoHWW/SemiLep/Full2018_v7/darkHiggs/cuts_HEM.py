...
SRhem    = combinecut([super_cut, mt_lmet  , met_hem  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj  , veto_b  , veto_1l  ])
SBhem    = combinecut([super_cut, mt_lmet  , met_hem  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj_I, veto_b  , veto_1l  ])
TCRhem   = combinecut([super_cut, mt_lmet  , met_hem  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj  , veto_b_I, veto_1l  ])
...
addcut('InCh_SR_hem'  , combinecut([SRhem  ]))
addcut('InCh_SB_hem'  , combinecut([SBhem  ]))
addcut('InCh_TCR_hem'  , combinecut([TCRhem  ]))
