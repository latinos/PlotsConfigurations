...
### HEM issue
aliases['PuppiMET_HEM'] = {
    'linesToAdd': [
        'gSystem->AddIncludePath("-I%s/src");' % os.getenv('CMSSW_BASE'),
        '.L %s/src/PlotsConfigurations/Configurations/monoHWW/SemiLep/scripts/HEMtoMET_OTF.cc+' % os.getenv('CMSSW_BASE')
    ],
    'class': 'HEMtoMETOTF',
    'args': (),
}

aliases['WcandJet_HEM'] = {
    'linesToAdd': [
        'gSystem->AddIncludePath("-I%s/src");' % os.getenv('CMSSW_BASE'),
        '.L %s/src/PlotsConfigurations/Configurations/monoHWW/SemiLep/scripts/HEMtoJET_OTF.cc+' % os.getenv('CMSSW_BASE')
    ],
    'class': 'HEMtoJETOTF',
    'args': (),
}
