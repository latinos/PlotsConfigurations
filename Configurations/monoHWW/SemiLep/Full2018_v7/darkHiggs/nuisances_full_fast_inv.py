...
nuisances['lumi'] = {
   ...
   'type': 'lnN',
   'samples': dict((skey, '1.025') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
}

#nuisances['lumi_Uncorrelated'] = {
#    'name': 'lumi_13TeV_2018',
#    'type': 'lnN',
#    'samples': dict((skey, '1.015') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#}
#
#nuisances['lumi_XYFact'] = {
#    'name': 'lumi_13TeV_XYFact',
#    'type': 'lnN',
#    'samples': dict((skey, '1.02') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#}
#
#nuisances['lumi_LScale'] = {
#    'name': 'lumi_13TeV_LSCale',
#    'type': 'lnN',
#    'samples': dict((skey, '1.002') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top'])
#}
#
...
# Unified
#mc_forJES = [skey for skey in mc_noVBS if not skey in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt']]
...
mc_forJER = [skey for skey in mc_noVBS if not skey in ['top', 'Wjets', 'Wjets_hWpt', 'Wjets_lWpt']]
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'Wjets_hWpt': ['0.99670042989*(puWeightUp/puWeight)', '1.00338845139*(puWeightDown/puWeight)'],
        'Wjets_lWpt': ['0.99670042989*(puWeightUp/puWeight)', '1.00338845139*(puWeightDown/puWeight)'],
...
#    #'type': 'lnN',
#    #'samples': dict((skey, '0.96/1.001') for skey in mc if skey not in ['Wjets', 'Wjets_hWpt', 'Wjets_lWpt', 'top']),
#    'kind'  : 'weight',
#    'type'  : 'shape',
...
for samp in mc:
    ...
    elif 'Wjets' in samp and 'Wpt' in samp:
        puid_dict[samp] = [jetpuid_dict['Wjets']['Up'], jetpuid_dict['Wjets']['Down']]
...
nuisances['PS_ISR']  = {
    ...
    'samples': {
        ...
        'Wjets_hWpt': ['0.999361844313*(nCleanGenJet==0) + 1.00932187819*(nCleanGenJet==1) + 1.01036957312*(nCleanGenJet==2) + 0.980802963847*(nCleanGenJet>=3)', 
                  '1.00133729681*(nCleanGenJet==0) + 0.989165456129*(nCleanGenJet==1) + 0.988125359076*(nCleanGenJet==2) + 1.02558360248*(nCleanGenJet>=3)'],
        'Wjets_lWpt': ['0.999361844313*(nCleanGenJet==0) + 1.00932187819*(nCleanGenJet==1) + 1.01036957312*(nCleanGenJet==2) + 0.980802963847*(nCleanGenJet>=3)', 
                  '1.00133729681*(nCleanGenJet==0) + 0.989165456129*(nCleanGenJet==1) + 0.988125359076*(nCleanGenJet==2) + 1.02558360248*(nCleanGenJet>=3)'],
...
nuisances['PS_FSR']  = {
    ...
    'samples': {
        ...
        'Wjets_hWpt': ['0.951581197919*(nCleanGenJet==0) + 0.997755474747*(nCleanGenJet==1) + 1.02983517401*(nCleanGenJet==2) + 1.01143623738*(nCleanGenJet>=3)', 
                   '1.08454892632*(nCleanGenJet==0) + 1.0003688082*(nCleanGenJet==1) + 0.980741215888*(nCleanGenJet==2) + 0.97189538569*(nCleanGenJet>=3)'],
        'Wjets_lWpt': ['0.951581197919*(nCleanGenJet==0) + 0.997755474747*(nCleanGenJet==1) + 1.02983517401*(nCleanGenJet==2) + 1.01143623738*(nCleanGenJet>=3)', 
                   '1.08454892632*(nCleanGenJet==0) + 1.0003688082*(nCleanGenJet==1) + 0.980741215888*(nCleanGenJet==2) + 0.97189538569*(nCleanGenJet>=3)'],
        #'WZewk': ['*(nCleanGenJet==0) + *(nCleanGenJet==1) + *(nCleanGenJet==2) + *(nCleanGenJet>=3)', 
        #          '*(nCleanGenJet==0) + *(nCleanGenJet==1) + *(nCleanGenJet==2) + *(nCleanGenJet>=3)'],
        #'WZqcd': ['*(nCleanGenJet==0) + *(nCleanGenJet==1) + *(nCleanGenJet==2) + *(nCleanGenJet>=3)', 
...
nuisances['UE']  = {
    ...
    'skipCMS' : 1,
    'type': 'lnN',
    'samples': dict((skey, '1.015') for skey in mc if skey not in ['top', 'Wjets', 'Wjets_hWpt', 'Wjets_lWpt']), 
}
...
variations_Wjets_hWpt = [
    'LHEScaleWeight[0]*0.905266024685', 
    'LHEScaleWeight[1]*0.905061148182', 
    'LHEScaleWeight[3]*0.995537232717', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-4]*1.00126775152', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-2]*1.11218044747', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-1]*1.11839657437'
]

variations_Wjets_lWpt = [
    'LHEScaleWeight[0]*6.65042049747', 
    'LHEScaleWeight[1]*6.3721473883', 
    'LHEScaleWeight[3]*7.25619448607', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-4]*6.63863252333', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-2]*7.39435088534', 
    'LHEScaleWeight[Length$(LHEScaleWeight)-1]*7.08172905641'
]
...
nuisances['QCDscale_Wjets']  = {
    ...
    'samples'  : {
        'Wjets' : variations,
        'Wjets_hWpt' : variations_Wjets_hWpt,
        'Wjets_lWpt' : variations_Wjets_lWpt,
    }
}
...
nuisances['EWKnloW_Wjets'] = {
    ...
    'samples': {
        ...
        'Wjets_hWpt': ['1./EWKnloW[0]', 'EWKnloW[0]'],
        'Wjets_lWpt': ['1./EWKnloW[0]', 'EWKnloW[0]'],
    }
}
...
#nuisances['Wjetsnorm_lWpt']  = {
#    'name'  : 'Wjetsnorm_lWpt_2018',
#    'samples'  : {
#        #'Wjets' : '1.00',
#        #'Wjets_hWpt' : '1.00',
#        'Wjets_lWpt' : '1.00',
...
#    ]
#}
#nuisances['Wjetsnorm_hWpt']  = {
#    'name'  : 'Wjetsnorm_hWpt_2018',
#    'samples'  : {
#        #'Wjets' : '1.00',
#        'Wjets_hWpt' : '1.00',
#        #'Wjets_lWpt' : '1.00',
...
#        if 'Wjets' in nuisances[n_key]['samples']: del nuisances[n_key]['samples']['Wjets', 'Wjets_hWpt', 'Wjets_lWpt']
