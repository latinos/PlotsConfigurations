...
#python ../../scripts/propNuisance.py -i ../../Full2016_v7/darkHiggs/darkHiggs_lim_root/plots_darkHiggs_lim_2016v7.root -o darkHiggs_lim_root/plots_darkHiggs_lim_2018v7.root -c InCh_SR,InCh_SB,InCh_TCR -v BDT_2018bin,BDT_2017bin,BDT_2016bin,BDT_2018CRbin,BDT_2017CRbin,BDT_2016CRbin,BDT_UniBin,Events,BDT_2018Fbin,BDT_2017Fbin,BDT_2016Fbin -n QCDscale_V -s Wjets --smooth
#python ../../scripts/propNuisance.py -i ../../Full2016_v7/darkHiggs/darkHiggs_lim_root/plots_darkHiggs_lim_2016v7.root -o darkHiggs_lim_root/plots_darkHiggs_lim_2018v7.root -c InCh_SR,InCh_SB,InCh_TCR -v BDT_nb_2016bin,BDT_nb_2017bin,BDT_nb_2018bin,BDT_b_2016bin,BDT_b_2017bin,BDT_b_2018bin,BDT_b_UniBin,BDT_nb_UniBin -n QCDscale_V -s Wjets --smooth
...
##imkPlot.py --pycfg=conf_lim.py --inputFile=darkHiggs_lim_root/plots_darkHiggs_lim_2018v7.root --showIntegralLegend=1 --scaleToPlot=2 --plotNormalizedDistributions --onlyPlot=cSigVsBkg
...
mkPlot.py --pycfg=conf_lim_fast_postfit.py --inputFile test_postFit_CRonly/CRonly_fit_plot_test.root --showIntegralLegend=1 --scaleToPlot=3000 --logOnly --outputDirPlots test_postFit_CRonly --postFit b
