...
#TKfilter     = ['(abs(CleanJet_eta[HM_idx_j1]) < 2.4 && abs(CleanJet_eta[HM_idx_j2]) < 2.4)'] 
...
SBl      = combinecut([super_cut, mt_lmet  , met  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj_l, veto_b  , veto_1l  ])
...
SBl_h      = combinecut([super_cut, mt_lmet_h, met  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj_l, veto_b  , veto_1l  ])
SBh_h      = combinecut([super_cut, mt_lmet_h, met  , dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj_h, veto_b  , veto_1l  ])
...
#addcut('ElCh_SBl'  , combinecut([is_el, SBl  ]))
#addcut('ElCh_SBh'  , combinecut([is_el, SBh  ]))
...
#addcut('MuCh_SBl'  , combinecut([is_mu, SBl  ]))
#addcut('MuCh_SBh'  , combinecut([is_mu, SBh  ]))
