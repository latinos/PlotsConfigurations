...
for samp in curr_samps:
    ...
    for var in [0, 1, 3]:
        samples[samp+'_'+str(var)+'_Up'] = copy.deepcopy(samples[samp])
        samples[samp+'_'+str(var)+'_Up']['weight'] += ' * (LHEScaleWeight['+str(var)+'])'
        samples[samp+'_'+str(var)+'_Down'] = copy.deepcopy(samples[samp])
        samples[samp+'_'+str(var)+'_Down']['weight'] += ' * (LHEScaleWeight[nLHEScaleWeight - 1 - '+str(var)+'])'
