...
mc = [skey for skey in samples if skey not in ('FAKE', 'DATA', 'FAKE_HT')]
...
aliases['kfactMjj'] = { 
    ...
    'class': 'kFactorMjjUnc',
    'args': ('PlotsConfigurations/Configurations/monoHWW/SemiLep/Wjets_kfactors/HT_to_NLO_QCD_k_factors_mjj.root', 'k_factor_2018'),
    'samples': Wjet_samples, 
}
