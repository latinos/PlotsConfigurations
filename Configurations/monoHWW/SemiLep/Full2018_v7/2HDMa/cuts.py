...
dphi_l_jj    = ['MHlnjj_dphi_jjVl < 2.5']
dphi_ljj_met = ['']
dr_l_jj      = ['']
pt_ljj       = ['']
pt_ljj_I     = ['']
...
SC       = super_cut
SR       = combinecut([super_cut, mt_lmet  , met  , dphi_l_jj,  m_jj  , veto_b  , veto_1l  ])
SB       = combinecut([super_cut, mt_lmet  , met  , dphi_l_jj,  m_jj_I, veto_b  , veto_1l  ])
TCR      = combinecut([super_cut, mt_lmet  , met  , dphi_l_jj,  m_jj  , veto_b_I, veto_1l  ])
