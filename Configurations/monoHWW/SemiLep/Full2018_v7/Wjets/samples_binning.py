...
samples['Wjets_NLOnj2'] = {
    'name'   : files,
    'weight' : mcCommonWeight +'*EWKnloW[0]',
    'FilesPerJob' : 4,
}
addSampleWeight(samples, 'Wjets_NLOnj2', 'WJetsToLNu-0J',   '(LHE_Vpt < 120)')
addSampleWeight(samples, 'Wjets_NLOnj2', 'WJetsToLNu-1J',   '(LHE_Vpt < 120)')
addSampleWeight(samples, 'Wjets_NLOnj2', 'WJetsToLNu-2J',   '(LHE_Vpt < 120)')

samples['Wjets_NLOnjR2'] = {
    'name'   : files,
    'weight' : mcCommonWeightRaw,
    'FilesPerJob' : 4,
    'isData': ['all'],
}
addSampleWeight(samples, 'Wjets_NLOnjR2', 'WJetsToLNu-0J',   '(LHE_Vpt < 120)')
addSampleWeight(samples, 'Wjets_NLOnjR2', 'WJetsToLNu-1J',   '(LHE_Vpt < 120)')
addSampleWeight(samples, 'Wjets_NLOnjR2', 'WJetsToLNu-2J',   '(LHE_Vpt < 120)')
...
samples['Wjets_NLOpt2'] = {
    'name'   : files,
    'weight' : mcCommonWeight +'*EWKnloW[0]',
    'FilesPerJob' : 4,
}
addSampleWeight(samples, 'Wjets_NLOpt2', 'WJetsToLNu_Pt100to250',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOpt2', 'WJetsToLNu_Pt250to400',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOpt2', 'WJetsToLNu_Pt400to600',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOpt2', 'WJetsToLNu_Pt600toInf',   '(LHE_Vpt > 120)')

samples['Wjets_NLOptR2'] = {
    'name'   : files,
    'weight' : mcCommonWeightRaw,
    'FilesPerJob' : 4,
    'isData': ['all'],
}
addSampleWeight(samples, 'Wjets_NLOptR2', 'WJetsToLNu_Pt100to250',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOptR2', 'WJetsToLNu_Pt250to400',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOptR2', 'WJetsToLNu_Pt400to600',   '(LHE_Vpt > 120)')
addSampleWeight(samples, 'Wjets_NLOptR2', 'WJetsToLNu_Pt600toInf',   '(LHE_Vpt > 120)')
