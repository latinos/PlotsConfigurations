...
aliases['GenWjet_pt'] = {
    'linesToAdd':[
        '.L %s/src/PlotsConfigurations/Configurations/monoHWW/SemiLep/scripts/GenWjetPt.cc+' % os.getenv('CMSSW_BASE'),
    ],
    'class': 'GenWjetPt',
    'samples': mc
}
aliases['GenWlep_pt'] = {
    'expr': 'Sum$(GenPart_pt*(GenPart_genPartIdxMother >= 0 && abs(GenPart_pdgId[GenPart_genPartIdxMother])==24 && (abs(GenPart_pdgId) == 11 || abs(GenPart_pdgId) == 13)))',
    'samples': mc
}
