...
signal = {
    'darkHiggs_mhs_160_mx_100_mZp_500' : {
        'plot_name': 'signal m_{Z\'} 500',
        'color': 632,
    },
    'darkHiggs_mhs_160_mx_100_mZp_1500' : {
        'plot_name': 'signal m_{Z\'} 1500',
        'color': 632+1,
    },
    'darkHiggs_mhs_160_mx_100_mZp_2500' : {
        'plot_name': 'signal m_{Z\'} 2500',
        'color': 632+2,
    },
}
...
plot['top'] = {
    ...
    'isData'   : 0,
    'scale'    : 1.,
    #'scale'    : 1.013 # CRonly fit CR=1bin r=0 frozen
}
...
plot['Wjets']  = {
    ...
    'isData'   : 0,
    'scale'    : 1.0
    #'scale'    : 1.034 # CRonly fit CR=1bin r=0 frozen
}
