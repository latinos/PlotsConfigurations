...
SRjer    = combinecut([super_cut, mt_lmet  , met_jer, dphi_l_jj, dphi_ljj_met, dr_l_jj, pt_ljj  , m_jj  , veto_b  , veto_1l  ])
...
addcut('InCh_SR_jer'  , combinecut([SRjer  ]))
