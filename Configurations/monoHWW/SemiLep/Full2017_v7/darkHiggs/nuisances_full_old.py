...
makeSuffixVar('scale_e', 'ElepT', cuts=el_cuts)
...
makeSuffixVar('scale_m', 'MupT', cuts=mu_cuts)
...
for syst in jes_systs:
    ...
    #}
    makeSuffixVar('scale_'+syst, syst, folder_fix='JES')
...
#}
makeSuffixVar('resolution_j', 'JER')
