...
for et in [25, 30, 35]:
    ...
    nuisances['fake_syst']['samples'][fake_key] = '1.3'
...
for syst in ['El', 'statEl', 'Mu', 'statMu']:
    ...
    for et in [25, 30, 35]:
        ...
        mu_et = et
        fake_key = 'FAKE_Et'+str(et)
        up_do = ['FW_mu'+str(mu_et)+'_el'+str(el_et)+'_'+syst+'Up[0]', 'FW_mu'+str(mu_et)+'_el'+str(el_et)+'_'+syst+'Down[0]']
        nuisances['fakeW_'+syst]['samples'][fake_key] = up_do
