...
QER_l    = combinecut([super_cut, QER_met])
...
addcut('ElCh_QERl' , combinecut([is_el, QER_l ]))
...
addcut('MuCh_QERl' , combinecut([is_mu, QER_l ]))
...
addcut('InCh_QERl' , combinecut([QER_l ]))
