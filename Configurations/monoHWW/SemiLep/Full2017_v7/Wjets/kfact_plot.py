...
input_file = '../../Wjets_kfactors/HT_to_NLO_QCD_k_factors3.root'
...
for year in run2:
    if first:
        first = False
        tg_dict[year]['nom'].GetYaxis().SetRangeUser(0.2, 1.3)
        #tg_dict[year]['nom'].GetYaxis().SetLimits(0.2, 1.3)
