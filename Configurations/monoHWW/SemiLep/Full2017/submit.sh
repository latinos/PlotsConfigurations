...
# plots
#mkPlot.py --pycfg=configuration2HDMa_NoData.py --inputFile=rootFile2HDMa_NoData/plots_2HDMaSemlep_2017.root
#mkPlot.py --pycfg=configurationDarkHiggs_NoData.py --inputFile=rootFileDarkHiggs_NoData/plots_DarkHiggsSemlep_2017.root
#mkPlot.py --pycfg=configuration2HDMa_NoData.py --inputFile=rootFile2HDMa_NoData/plots_2HDMaSemlep_2017.root --scaleToPlot=3000. --logOnly
#mkPlot.py --pycfg=configurationDarkHiggs_NoData.py --inputFile=rootFileDarkHiggs_NoData/plots_DarkHiggsSemlep_2017.root --scaleToPlot=3000. --logOnly
