...
aliases['FixedTriggEff_1l'] = {
    'expr': '(TriggerEffWeight_1l*(1*(abs(Lepton_pdgId[0])==13) + 0.934*(abs(Lepton_pdgId[0])==11 && run_period == 1) + 0.992*(abs(Lepton_pdgId[0])==11 && run_period == 2) + 1*(abs(Lepton_pdgId[0])==11 && run_period > 2)))',
