...
WWControlRegion = set(x for x in cuts if 'WWCR' in x)
DYControlRegion = set(x for x in cuts if 'DYCR' in x)
...
variables['drll_WWCR']  = {   'name': 'drll',
                         'range' : (30, 2.5, 3.5),
                        'xaxis' : '#Delta R_{ll}',
                        'fold' : 3,
                        'cuts' : WWControlRegion
                        }
