...
DH = [skey for skey in samples if skey not in ('Fake', 'DATA','DY','top','WW','WWewk','ggWW','Vg','VgS','VZ','VVV','Higgs')]
...
aliases['topcr'] = {
    'expr': 'mth>50 && drll<2.5 && ((zeroJet && !bVeto) || bReq)'
}
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2l','LepWPCut','LepWPSF','PrefireWeight', 'btagSF','JetPUID_SF']),
    'samples': mc
}
# variations
...
aliases['genDarkHiggs_Pt'] = {
    'linesToAdd':['.L /afs/cern.ch/work/f/fernanpe/framework_monoHFullRun2/CMSSW_10_2_9/src/PlotsConfigurations/Configurations/monoHWW/Full2017_v7_3d/onTheFly/getGenDarkHiggspt.cc+'],
