...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['lumi2016']['samples'].update({'Zbar_' + mZb + '_' + Chi:'1.062'}
)
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['btagbc']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['(bPogSF_CMVAL_bc_up)/(bPogSF)', '(bPogSF_CMVAL_bc_down)/(bPogSF)']})
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['btagudsg']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['(bPogSF_CMVAL_udsg_up)/(bPogSF)', '(bPogSF_CMVAL_udsg_down)/(bPogSF)']})
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['trigg']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['(effTrigW_Up)/(effTrigW)', '(effTrigW_Down)/(effTrigW)']})
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['idiso_ele']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['((abs(std_vector_lepton_flavour[0]) == 11)*(std_vector_lepton_idisoW_Up[0])/(std_vector_lepton_idisoW[0])+(abs(std_vector_lepton_flavour[0]) == 13)) * ((abs(std_vector_lepton_flavour[1]) == 11)*(std_vector_lepton_idisoW_Up[1])/(std_vector_lepton_idisoW[1])+(abs(std_vector_lepton_flavour[1]) == 13))', '((abs(std_vector_lepton_flavour[0]) == 11)*(std_vector_lepton_idisoW_Down[0])/(std_vector_lepton_idisoW[0])+(abs(std_vector_lepton_flavour[0]) == 13)) * ((abs(std_vector_lepton_flavour[1]) == 11)*(std_vector_lepton_idisoW_Down[1])/(std_vector_lepton_idisoW[1])+(abs(std_vector_lepton_flavour[1]) == 13))']})
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['idiso_mu']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['((abs(std_vector_lepton_flavour[0]) == 13)*(std_vector_lepton_idisoW_Up[0])/(std_vector_lepton_idisoW[0])+(abs(std_vector_lepton_flavour[0]) == 11)) * ((abs(std_vector_lepton_flavour[1]) == 13)*(std_vector_lepton_idisoW_Up[1])/(std_vector_lepton_idisoW[1])+(abs(std_vector_lepton_flavour[1]) == 11))', '((abs(std_vector_lepton_flavour[0]) == 13)*(std_vector_lepton_idisoW_Down[0])/(std_vector_lepton_idisoW[0])+(abs(std_vector_lepton_flavour[0]) == 11)) * ((abs(std_vector_lepton_flavour[1]) == 13)*(std_vector_lepton_idisoW_Down[1])/(std_vector_lepton_idisoW[1])+(abs(std_vector_lepton_flavour[1]) == 11))']})
...
#         if mZb == "1000" and Chi == "150" :
#             continue
#         nuisances['jes']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['1','1']})
...
#         if mZb == "1000" and Chi == "150" :
#             continue
#         nuisances['electronpt']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['1','1']})
...
#         if mZb == "1000" and Chi == "150" :
#             continue
#         nuisances['muonpt']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['1','1']})
...
#         if mZb == "1000" and Chi == "150" :
#             continue
#         nuisances['met']['samples'].update({'Zbar_' + mZb + '_' + Chi: ['1','1']})
...
for mZb in ZbarMasses :
    for Chi in ChiMasses :
        ...
        if mZb == "1000" and Chi == "150" :
            continue
        nuisances['stat']['samples'].update({'Zbar_' + mZb + '_' + Chi: {'typeStat' : 'bbb',}})
